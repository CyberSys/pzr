...
public class SafeHouse {
   ...
   public static boolean isPlayerAllowedOnSquare(IsoPlayer var0, IsoGridSquare var1) {
      if (!ServerOptions.instance.SafehouseAllowTrepass.getValue()) {
         SafeHouse var2 = isSafeHouse(var1, (String)null, false);
         if (var2 != null && (!ServerOptions.instance.DisableSafehouseWhenPlayerConnected.getValue() || var2.getPlayerConnected() <= 0 && var2.getOpenTimer() <= 0)) {
            return var2.playerAllowed(var0);
         }
      }
