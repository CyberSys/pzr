         ...
         if (GameServer.bServer && this.chr instanceof IsoPlayer) {
            if (System.currentTimeMillis() - this.lastXPTime > 60000L) {
               ...
               if (this.lastXPGrowthRate > 1000.0F) {
                  ...
                  if (PacketValidator.doKickUser(var4, this.getClass().getSimpleName(), "UI_ValidationFailed_Type9")) {
                     LoggerManager.getLogger("kick").write(String.format("Kick: player=\"%s\" type=\"%s\" issuer=\"%s\"", var4.username, "UI_ValidationFailed_Type19", this.getClass().getSimpleName()));
                  }
               }
            }
