...
public class StartFire implements INetworkPacket {
   ...
   public boolean validate(UdpConnection var1) {
      if (GameServer.bServer && !this.smoke && ServerOptions.instance.NoFire.getValue()) {
         if (PacketValidator.doKickUser(var1, this.getClass().getSimpleName(), "UI_ValidationFailed_Type16")) {
         ...
         if (PacketValidator.doKickUser(var1, this.getClass().getSimpleName(), "UI_ValidationFailed_Type17")) {
         ...
         if (PacketValidator.doKickUser(var1, this.getClass().getSimpleName(), "UI_ValidationFailed_Type18")) {
