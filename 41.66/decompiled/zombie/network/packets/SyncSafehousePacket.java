   ...
   public boolean validate(UdpConnection var1) {
      ...
      if (this.safehouse == null) {
         if (var1.accessLevel == 1 && SafeHouse.hasSafehouse(this.ownerUsername) != null) {
            if (PacketValidator.doKickUser(var1, this.getClass().getSimpleName(), "UI_ValidationFailed_Type19")) {
            ...
            return false;
         } else if (var1.accessLevel == 1 && (this.h > 100 || this.w > 100)) {
            if (PacketValidator.doKickUser(var1, this.getClass().getSimpleName(), "UI_ValidationFailed_Type20")) {
