...
ProceduralDistributions.list = {
    ...
    CrateMannequins = {
        rolls = 4,
        items = {
            "Mov_MannequinFemale", 75,
            "Mov_MannequinMale", 75,
        },
        junk = {
            rolls = 1,
            items = {
