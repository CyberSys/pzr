...
--            subMenu:addOption("Add Hole Back", bodyPart, ISHealthPanel.onCheat, "holeback", self.character, self.otherPlayer);
            ...
            subMenu:addOption("Add Exercise Fatique", bodyPart, ISHealthPanel.onCheat, "fatique", self.character, self.otherPlayer);
            subMenu:addOption("Remove Exercise Fatique", bodyPart, ISHealthPanel.onCheat, "removeFatique", self.character, self.otherPlayer);
        end
