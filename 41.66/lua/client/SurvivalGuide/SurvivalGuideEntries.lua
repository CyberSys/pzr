...
SurvivalGuideEntries.addSurvivalGuideEntry(getText("SurvivalGuide_entrie11title"), getText("SurvivalGuide_entrie11txt"), getText("SurvivalGuide_entrie11moreinfo"));
