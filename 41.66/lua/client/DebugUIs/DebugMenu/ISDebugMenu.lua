...
function ISDebugMenu:setupButtons()
    ...
    self:addButtonInfo("Animation Viewer", showAnimationViewer);
    self:addButtonInfo("Attachment Editor", showAttachmentEditor);
    self:addButtonInfo("Chunk Debugger", showChunkDebugger);
    self:addButtonInfo("Global Objects", showGlobalObjectDebugger);
    self:addButtonInfo("Map Editor", function() showWorldMapEditor(nil) end);
