...
function ISWorldMap:createChildren()
	...
	self.forgetBtn = ISButton:new(self.closeBtn.x - 20 - btnSize, 0, btnSize, btnSize, "?", self, function(self, button) self:onForget(button) end)
	self.buttonPanel:addChild(self.forgetBtn)

	self.symbolsBtn = ISButton:new(self.forgetBtn.x - 20 - btnSize, 0, btnSize, btnSize, "S", self, self.onToggleSymbols)
	...
	self.buttonPanel:insertNewLineOfButtons(self.pyramidBtn, self.perspectiveBtn, self.centerBtn, self.symbolsBtn, self.forgetBtn, self.closeBtn)
