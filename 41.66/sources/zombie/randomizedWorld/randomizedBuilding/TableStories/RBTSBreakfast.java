...
public final class RBTSBreakfast extends RBTableStoryBase {
	...
	public void randomizeBuilding(BuildingDef buildingDef) {
		if (this.table2 != null) {
			...
			int int1;
			if (this.westTable) {
				string = this.getBowlOrMug();
				this.addWorldItem(string, this.table1.getSquare(), 0.6875F, 0.8437F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
				if (Rand.NextBool(3)) {
				...
				string = this.getBowlOrMug();
				this.addWorldItem(string, this.table1.getSquare(), 0.6719F, 0.4531F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
				if (Rand.NextBool(3)) {
				...
				if (Rand.Next(100) < 70) {
					string = this.getBowlOrMug();
					this.addWorldItem(string, this.table2.getSquare(), 0.6484F, 0.8353F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
					if (Rand.NextBool(3)) {
				...
				if (Rand.Next(100) < 50) {
					string = this.getBowlOrMug();
					this.addWorldItem(string, this.table2.getSquare(), 0.5859F, 0.3941F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
					if (Rand.NextBool(3)) {
				...
				string = this.getBowlOrMug();
				this.addWorldItem(string, this.table1.getSquare(), 0.906F, 0.718F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
				if (Rand.NextBool(3)) {
				...
				string = this.getBowlOrMug();
				this.addWorldItem(string, this.table1.getSquare(), 0.406F, 0.562F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
				if (Rand.NextBool(3)) {
				...
				if (Rand.Next(100) < 70) {
					string = this.getBowlOrMug();
					this.addWorldItem(string, this.table2.getSquare(), 0.929F, 0.726F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
					if (Rand.NextBool(3)) {
				...
				if (Rand.Next(100) < 50) {
					string = this.getBowlOrMug();
					this.addWorldItem(string, this.table2.getSquare(), 0.382F, 0.78F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
					if (Rand.NextBool(3)) {
