	...
	private IsoObject checkForTable(IsoGridSquare square, IsoObject object, ArrayList arrayList) {
		if (square == null) {
			...
			for (int int1 = 0; int1 < square.getObjects().size(); ++int1) {
				...
				if ((arrayList.isEmpty() || arrayList.contains(object2)) && object2.getProperties().isTable() && object2.getProperties().getSurface() == 34 && object2.getContainer() == null && object2 != object) {
					return object2;
				}
			}
