...
public class IsoBarbecue extends IsoObject {
	...
	public void setSprite(IsoSprite sprite) {
		if (isSpriteWithPropaneTank(sprite)) {
			byte byte1 = 8;
			this.normalSprite = sprite;
			this.noTankSprite = IsoSprite.getSprite(IsoSpriteManager.instance, (IsoSprite)sprite, byte1);
		} else if (isSpriteWithoutPropaneTank(sprite)) {
			byte byte2 = -8;
			this.normalSprite = IsoSprite.getSprite(IsoSpriteManager.instance, (IsoSprite)sprite, byte2);
