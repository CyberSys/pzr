...
public final class PlayerActionsState extends State {
	...
	public void execute(IsoGameCharacter gameCharacter) {
		if (GameClient.bClient && gameCharacter instanceof IsoPlayer && gameCharacter.isLocal() && !gameCharacter.getCharacterActions().isEmpty() && gameCharacter.getNetworkCharacterAI().getAction() != gameCharacter.getCharacterActions().get(0)) {
