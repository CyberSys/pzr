...
public final class ZomboidRadio {
	...
	private void DistributeToPlayerOnClient(IsoPlayer player, int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		if (player != null) {
			DeviceData deviceData = ChatManager.getInstance().getReceivingRadio(int3);
			if (deviceData != null) {
				this.DistributeToPlayerInternal(deviceData.getParent(), player, int1, int2, string, string2, float1, float2, float3, int4);
			}
		}
	}

	private void DistributeToPlayer(IsoPlayer player, int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		if (player != null) {
			Radio radio = player.getEquipedRadio();
			if (radio != null && radio.getDeviceData() != null && radio.getDeviceData().getIsPortable() && radio.getDeviceData().getIsTurnedOn() && radio.getDeviceData().getChannel() == int3) {
				...
				this.DistributeToPlayerInternal(radio, player, int1, int2, string, string2, float1, float2, float3, int4);
			}
		}
	}

	private void DistributeToPlayerInternal(WaveSignalDevice waveSignalDevice, IsoPlayer player, int int1, int int2, String string, String string2, float float1, float float2, float float3, int int3) {
		boolean boolean1 = false;
		int int4 = -1;
		if (int3 < 0) {
			boolean1 = true;
		...
		if (boolean1) {
			...
			if (!this.hasAppliedRangeDistortion) {
				waveSignalDevice.AddDeviceText(player, string, float1, float2, float3, string2, int4);
			} else {
				waveSignalDevice.AddDeviceText(string, 0.5F, 0.5F, 0.5F, string2, int4);
			}
		}
	}

	private void DistributeTransmission(int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		int int5;
		if (!boolean1) {
			if (!GameClient.bClient && !GameServer.bServer) {
				for (int5 = 0; int5 < IsoPlayer.numPlayers; ++int5) {
					this.DistributeToPlayer(IsoPlayer.players[int5], int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
				}
			} else if (GameClient.bClient) {
				...
				for (int int7 = 0; int7 < int6; ++int7) {
					...
					this.DistributeToPlayerOnClient(player, int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
				}
				...
				if (waveSignalDevice != null && waveSignalDevice.getDeviceData() != null && waveSignalDevice.getDeviceData().getIsTurnedOn() && boolean1 == waveSignalDevice.getDeviceData().getIsTelevision()) {
					...
					if (int3 == waveSignalDevice.getDeviceData().getChannel()) {
						...
						if (boolean2) {
							...
							if (!this.hasAppliedRangeDistortion) {
								waveSignalDevice.AddDeviceText(string, float1, float2, float3, string2, int8);
							} else {
								waveSignalDevice.AddDeviceText(string, 0.5F, 0.5F, 0.5F, string2, int8);
							}
						}
					}
				}
	...
	public void ReceiveTransmission(int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		GameMode gameMode = this.getGameMode();
		if (gameMode.equals(GameMode.Server)) {
			this.SendTransmission(int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
		} else {
			this.DistributeTransmission(int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
		}
	}
	...
	public void SendTransmission(int int1, int int2, ChatMessage chatMessage, int int3) {
		...
		this.SendTransmission(int1, int2, int4, chatMessage.getText(), (String)null, color.r, color.g, color.b, int3, false);
	}

	public void SendTransmission(int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		this.SendTransmission(-1L, int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
	}

	public void SendTransmission(long long1, int int1, int int2, int int3, String string, String string2, float float1, float float2, float float3, int int4, boolean boolean1) {
		GameMode gameMode = this.getGameMode();
		...
		if (gameMode.equals(GameMode.SinglePlayer)) {
			this.ReceiveTransmission(int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
		} else if (gameMode.equals(GameMode.Server)) {
			GameServer.sendIsoWaveSignal(long1, int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
		} else if (gameMode.equals(GameMode.Client)) {
			GameClient.sendIsoWaveSignal(int1, int2, int3, string, string2, float1, float2, float3, int4, boolean1);
		}
	}
