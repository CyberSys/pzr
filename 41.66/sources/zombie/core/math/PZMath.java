...
public final class PZMath {
	...
	public static float almostUnitIdentity(float float1) {
		return float1 * float1 * (2.0F - float1);
	}
	...
	public static float almostIdentity(float float1, float float2, float float3) {
		if (float1 > float2) {
			...
			float float4 = 2.0F * float3 - float2;
			float float5 = 2.0F * float2 - 3.0F * float3;
			float float6 = float1 / float2;
			return (float4 * float6 + float5) * float6 * float6 + float3;
		}
	}

	public static float gain(float float1, float float2) {
		float float3 = (float)(0.5 * Math.pow((double)(2.0F * (float1 < 0.5F ? float1 : 1.0F - float1)), (double)float2));
		return float1 < 0.5F ? float3 : 1.0F - float3;
	}
	...
	public static float clampFloat(float float1, float float2, float float3) {
		return clamp(float1, float2, float3);
	}
	...
	public static float roundToIntPlus05(float float1) {
		return floor(float1) + 0.5F;
	}

	public static float roundFromEdges(float float1) {
		float float2 = (float)((int)float1);
		float float3 = float1 - float2;
		if (float3 < 0.2F) {
			return float2 + 0.2F;
		} else {
			return float3 > 0.8F ? float2 + 1.0F - 0.2F : float1;
		}
	}
