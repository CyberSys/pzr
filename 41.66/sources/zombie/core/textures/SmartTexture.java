...
public class SmartTexture extends Texture {
	...
	public Texture addHole(BloodBodyPartType bloodBodyPartType) {
		...
		this.clear();
		this.result = null;
		this.commands.add(TextureCombinerCommand.get().initSeparate(texture, addHole, addHoleParams, Texture.getSharedTexture(string), 770, 0, 1, 771));
		this.dirty = true;
		return texture;
	}
	...
	public void addSeparate(String string, int int1, int int2, int int3, int int4) {
		this.addSeparate(Texture.getSharedTexture(string), int1, int2, int3, int4);
	}
	...
	public void addSeparate(String string, SmartShader smartShader, String string2, ArrayList arrayList, int int1, int int2, int int3, int int4) {
		this.addSeparate(Texture.getSharedTexture(string), smartShader, Texture.getSharedTexture(string2), arrayList, int1, int2, int3, int4);
	}
