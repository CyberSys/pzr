...
public class RakVoice {
	...
	public static native void SetChannelsRouting(long long1, boolean boolean1, int[] intArray, short short1);

	public static native boolean GetChannelStatistics(long long1, long[] longArray);
}
