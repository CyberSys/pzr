...
public class StartFire implements INetworkPacket {
	...
	public boolean validate(UdpConnection udpConnection) {
		if (GameServer.bServer && !this.smoke && ServerOptions.instance.NoFire.getValue()) {
			if (PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type16")) {
			...
			if (PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type17")) {
			...
			if (PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type18")) {
