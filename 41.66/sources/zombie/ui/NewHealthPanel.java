...
public final class NewHealthPanel extends NewWindow {
	...
	public NewHealthPanel(int int1, int int2, IsoGameCharacter gameCharacter) {
		...
		instance = this;
		byte byte1 = 2;
		this.HealthIcon = Texture.getSharedTexture("media/ui/Heart_On.png", byte1);
		this.HealthBarBack = Texture.getSharedTexture("media/ui/BodyDamage/DamageBar_Vert.png", byte1);
		this.HealthBar = Texture.getSharedTexture("media/ui/BodyDamage/DamageBar_Vert_Fill.png", byte1);
		String string = "male";
	...
	public void render() {
		if (this.isVisible()) {
			...
			double double1 = 0.15;
			double double2 = 1.0;
			this.DrawTextureScaledColor((Texture)null, 130.0, 25.0, 18.0, 1.0, double1, double1, double1, double2);
			this.DrawTextureScaledColor((Texture)null, 130.0, 25.0, 1.0, 172.0, double1, double1, double1, double2);
			this.DrawTextureScaledColor((Texture)null, 147.0, 25.0, 1.0, 172.0, double1, double1, double1, double2);
