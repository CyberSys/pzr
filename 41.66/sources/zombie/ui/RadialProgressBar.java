			...
			if (this.isVisible()) {
				if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
					if (this.radialTexture != null) {
						float float1 = (float)(this.x + this.xScroll + this.getAbsoluteX() + (double)this.radialTexture.offsetX);
						float float2 = (float)(this.y + this.yScroll + this.getAbsoluteY() + (double)this.radialTexture.offsetY);
						...
						for (int int2 = 0; int2 < segments.length; ++int2) {
							...
							if (radSegment != null && int2 <= int1) {
								if (int2 != int1) {
									SpriteRenderer.instance.renderPoly(this.radialTexture, float1 + radSegment.vertex[0].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[0].y * (float)this.radialTexture.getHeight(), float1 + radSegment.vertex[1].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[1].y * (float)this.radialTexture.getHeight(), float1 + radSegment.vertex[2].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[2].y * (float)this.radialTexture.getHeight(), float1 + radSegment.vertex[2].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[2].y * (float)this.radialTexture.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, float3 + radSegment.uv[0].x * float5, float4 + radSegment.uv[0].y * float6, float3 + radSegment.uv[1].x * float5, float4 + radSegment.uv[1].y * float6, float3 + radSegment.uv[2].x * float5, float4 + radSegment.uv[2].y * float6, float3 + radSegment.uv[2].x * float5, float4 + radSegment.uv[2].y * float6);
								} else {
									SpriteRenderer.instance.renderPoly(this.radialTexture, float1 + radSegment.vertex[0].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[0].y * (float)this.radialTexture.getHeight(), float13, float14, float1 + radSegment.vertex[2].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[2].y * (float)this.radialTexture.getHeight(), float1 + radSegment.vertex[2].x * (float)this.radialTexture.getWidth(), float2 + radSegment.vertex[2].y * (float)this.radialTexture.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F, float3 + radSegment.uv[0].x * float5, float4 + radSegment.uv[0].y * float6, float3 + float15 * float5, float4 + float16 * float6, float3 + radSegment.uv[2].x * float5, float4 + radSegment.uv[2].y * float6, float3 + radSegment.uv[2].x * float5, float4 + radSegment.uv[2].y * float6);
								}
							}
						}
					}
