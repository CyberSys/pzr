...
public abstract class IsoGameCharacter extends IsoMovingObject implements Talker,ChatElementOwner,IAnimatable,IAnimationVariableMap,IClothingItemListener,IActionStateChanged,IAnimEventCallback,IFMODParameterUpdater,ILuaVariableSource,ILuaGameCharacter {
	...
	public void renderlast() {
		...
		if (Core.bDebug) {
			...
			if (DebugOptions.instance.MultiplayerShowZombieStatus.getValue() && this instanceof IsoZombie || DebugOptions.instance.MultiplayerShowPlayerStatus.getValue() && this instanceof IsoPlayer) {
				...
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("%d: %.03f / %.03f", this.getOnlineID(), this.getHealth(), this instanceof IsoZombie ? 0.0F : this.getBodyDamage().getOverallBodyHealth()), (double)color3.r, (double)color3.g, (double)color3.b, (double)color3.a);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), "x=" + this.x + "  y=" + this.y + "  z=" + this.z, (double)color3.r, (double)color3.g, (double)color3.b, (double)color3.a);
				if (this instanceof IsoPlayer) {
					IsoPlayer player = (IsoPlayer)this;
					Color color4 = Colors.NavajoWhite;
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 18.0F)), String.format("IdleSpeed: %s , targetDist: %s ", player.getVariableString("IdleSpeed"), player.getVariableString("targetDist")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("WalkInjury: %s , WalkSpeed: %s", player.getVariableString("WalkInjury"), player.getVariableString("WalkSpeed")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("DeltaX: %s , DeltaY: %s", player.getVariableString("DeltaX"), player.getVariableString("DeltaY")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("AttackVariationX: %s , AttackVariationY: %s", player.getVariableString("AttackVariationX"), player.getVariableString("AttackVariationY")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("autoShootVarX: %s , autoShootVarY: %s", player.getVariableString("autoShootVarX"), player.getVariableString("autoShootVarY")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("recoilVarX: %s , recoilVarY: %s", player.getVariableString("recoilVarX"), player.getVariableString("recoilVarY")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("ShoveAimX: %s , ShoveAimY: %s", player.getVariableString("ShoveAimX"), player.getVariableString("ShoveAimY")), (double)color4.r, (double)color4.g, (double)color4.b, 1.0);
				}

				color3 = Colors.Yellow;
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 18.0F)), String.format("isHitFromBehind=%b/%b", this.isHitFromBehind(), this.getVariableBoolean("frombehind")), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("bKnockedDown=%b/%b", this.isKnockedDown(), this.getVariableBoolean("bknockeddown")), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("isFallOnFront=%b/%b", this.isFallOnFront(), this.getVariableBoolean("fallonfront")), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("isOnFloor=%b/%b", this.isOnFloor(), this.getVariableBoolean("bonfloor")), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("isDead=%b/%b", this.isDead(), this.getVariableBoolean("bdead")), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				if (this.advancedAnimator.getRootLayer() != null) {
					color3 = Colors.Pink;
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 18.0F)), "Animation set: " + this.advancedAnimator.animSet.m_Name, (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), "Animation state: " + this.advancedAnimator.getCurrentStateName(), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), "Animation node: " + this.advancedAnimator.getRootLayer().getDebugNodeName(), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				}

				color3 = Colors.LightBlue;
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Previous state: %s ( %s )", this.getPreviousStateName(), this.getPreviousActionContextStateName()), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Current state: %s ( %s )", this.getCurrentStateName(), this.getCurrentActionContextStateName()), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Child state: %s", this.getActionContext() != null && this.getActionContext().getChildStates() != null && this.getActionContext().getChildStates().size() > 0 && this.getActionContext().getChildStateAt(0) != null ? this.getActionContext().getChildStateAt(0).getName() : "\"\""), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
				if (this.CharacterActions != null) {
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Character actions: %d", this.CharacterActions.size()), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					...
					while (iterator.hasNext()) {
						...
						if (baseAction instanceof LuaTimedActionNew) {
							TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Action: %s", ((LuaTimedActionNew)baseAction).getMetaType()), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
						}
					}
				}
				...
				if (this instanceof IsoZombie) {
					...
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 18.0F)), "Prediction: " + this.getNetworkCharacterAI().predictionType, (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), String.format("Real state: %s", zombie2.realState), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					if (zombie2.target instanceof IsoPlayer) {
						TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), "Target: " + ((IsoPlayer)zombie2.target).username + "  =" + zombie2.vectorToTarget.getLength(), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					} else {
						TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)float3, (double)(float4 + (float5 += 11.0F)), "Target: " + zombie2.target + "  =" + zombie2.vectorToTarget.getLength(), (double)color3.r, (double)color3.g, (double)color3.b, 1.0);
					}
				}
			}
		}
	...
	public void HitSilence(HandWeapon handWeapon, IsoGameCharacter gameCharacter, boolean boolean1, float float1) {
		if (gameCharacter != null && handWeapon != null) {
			if (this.getStateMachine().getCurrent() != StaggerBackState.instance()) {
				...
				if (WeaponType.getWeaponType(gameCharacter) == WeaponType.barehand || gameCharacter instanceof IsoPlayer && ((IsoPlayer)gameCharacter).bDoShove) {
					boolean1 = true;
					this.noDamage = true;
				}
				...
				if (gameCharacter instanceof IsoPlayer && !handWeapon.bIsAimedFirearm) {
					float3 = ((IsoPlayer)gameCharacter).useChargeDelta;
					if (float3 > 1.0F) {
						float3 = 1.0F;
					}
					...
					float2 = handWeapon.getMinDamage() + (handWeapon.getMaxDamage() - handWeapon.getMinDamage()) * float3;
				} else {
					float2 = (float)Rand.Next((int)((handWeapon.getMaxDamage() - handWeapon.getMinDamage()) * 1000.0F)) / 1000.0F + handWeapon.getMinDamage();
				}

				float2 *= float1;
				float3 = float2 * handWeapon.getKnockbackMod(gameCharacter) * gameCharacter.getShovingMod();
				if (float3 > 1.0F) {
					float3 = 1.0F;
				}

				this.setHitForce(float3);
				this.setAttackedBy(gameCharacter);
				float float4 = IsoUtils.DistanceTo(gameCharacter.getX(), gameCharacter.getY(), this.getX(), this.getY());
				float4 -= handWeapon.getMinRange();
				float4 /= handWeapon.getMaxRange(gameCharacter);
				float4 = 1.0F - float4;
				if (float4 > 1.0F) {
					float4 = 1.0F;
				}
				...
				vector2.y *= handWeapon.getPushBackMod();
				this.hitDir.rotate(handWeapon.HitAngleMod);
				float float5 = gameCharacter.stats.endurance;
				float5 *= gameCharacter.knockbackAttackMod;
				if (float5 < 0.5F) {
					float5 *= 1.3F;
					if (float5 < 0.4F) {
						float5 = 0.4F;
					...
					this.setHitForce(this.getHitForce() * float5);
				}
				...
				vector22.normalize();
				float float6 = vector22.dot(vector24);
				if (float6 > -0.3F) {
					float2 *= 1.5F;
				}
				...
				if (!boolean1) {
					if (handWeapon.isAimedFirearm()) {
						this.Health -= float2 * 0.7F;
					} else {
						this.Health -= float2 * 0.15F;
					}
				}
				...
				float7 /= handWeapon.getKnockdownMod();
				if (gameCharacter instanceof IsoPlayer && !handWeapon.isAimedHandWeapon()) {
					float7 *= 2.0F - ((IsoPlayer)gameCharacter).useChargeDelta;
				}
				...
				boolean boolean2 = Rand.Next((int)float7) == 0;
	...
	public float Hit(BaseVehicle baseVehicle, float float1, boolean boolean1, float float2, float float3) {
		...
		if (Core.bDebug) {
			DebugLog.log(DebugType.Multiplayer, String.format("Vehicle id=%d hit %s id=%d: speed=%f force=%f hitDir=%s", baseVehicle.getId(), this.getClass().getSimpleName(), this.getOnlineID(), float1, this.getHitForce(), this.getHitDir()));
		}
	...
	public boolean isVehicleCollisionActive(BaseVehicle baseVehicle) {
		if (!GameClient.bClient) {
			...
			return false;
		} else if (!baseVehicle.isEngineRunning()) {
			return false;
		} else if (baseVehicle.getDriver() == null) {
			return false;
		...
		if (GameClient.bClient) {
			if (baseVehicle.getDriver() instanceof IsoPlayer) {
				if (baseVehicle.getDriver().isLocal()) {
					...
					GameClient.sendHitVehicle((IsoPlayer)baseVehicle.getDriver(), this, baseVehicle, float1, hitVars.isTargetHitFromBehind, hitVars.vehicleDamage, hitVars.hitSpeed, hitVars.isVehicleHitFromFront);
				} else {
		...
		public void update() {
			if (GameServer.bServer && this.chr instanceof IsoPlayer) {
				if (System.currentTimeMillis() - this.lastXPTime > 60000L) {
					...
					if (this.lastXPGrowthRate > 1000.0F) {
						UdpConnection udpConnection = GameServer.getConnectionFromPlayer((IsoPlayer)this.chr);
						if (PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type9")) {
							LoggerManager.getLogger("kick").write(String.format("Kick: player=\"%s\" type=\"%s\" issuer=\"%s\"", udpConnection.username, "UI_ValidationFailed_Type19", this.getClass().getSimpleName()));
						}
					}
				}
			}
