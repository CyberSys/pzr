...
public abstract class NetworkCharacterAI {
	...
	public void setDeadBody(DeadCharacterPacket deadCharacterPacket) {
		...
		if (Core.bDebug) {
			DebugLog.log(DebugType.Death, "SetDeadBody: " + (deadCharacterPacket == null ? "processed" : "postpone"));
		}
	}
	...
	public void setVehicleHit(VehicleHitPacket vehicleHitPacket) {
		...
		if (Core.bDebug) {
			DebugLog.log(DebugType.Damage, "SetVehicleHit: " + (vehicleHitPacket == null ? "processed" : "postpone"));
		}
	}
