...
public class test_VehicleInterpolation extends Assert {
	...
	public void normalTest() {
		...
		for (int int1 = 1; int1 < 30; ++int1) {
			...
			byteBuffer.position(0);
			vehicleInterpolation.interpolationDataAdd(byteBuffer, (float)int1, (float)int1, 0.0F);
	...
	public void normalTestBufferRestoring2() {
		...
		try {
			for (int int1 = 1; int1 < 40; ++int1) {
				...
				byteBuffer.position(0);
				if (int1 < 15 || int1 > 20) {
					vehicleInterpolation.interpolationDataAdd(byteBuffer, (float)int1, 0.0F, 0.0F);
				}
