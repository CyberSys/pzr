...
public class VehicleInterpolation {
	...
	public void interpolationDataAdd(ByteBuffer byteBuffer, float float1, float float2, float float3) {
		...
		for (int int1 = 0; int1 < vehicleInterpolationData.w_count; ++int1) {
			...
			vehicleInterpolationData.w_sl[int1] = byteBuffer.getFloat();
		}
	...
	public boolean interpolationDataGet(float[] floatArray) {
		...
		if (vehicleInterpolationData == null) {
			...
			for (int1 = 0; int1 < vehicleInterpolationData2.w_count; ++int1) {
				...
				floatArray[int2++] = vehicleInterpolationData2.w_sl[int1];
			}
			...
			for (int int3 = 0; int3 < vehicleInterpolationData2.w_count; ++int3) {
				...
				floatArray[int1++] = (vehicleInterpolationData2.w_sl[int3] - vehicleInterpolationData.w_sl[int3]) * float1 + vehicleInterpolationData.w_sl[int3];
			}
