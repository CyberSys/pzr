...
public final class TexturePackDevice implements IFileDevice {
	...
	private static long skipInput(InputStream inputStream, long long1) throws IOException {
		long long2 = 0L;
		while (long2 < long1) {
			long long3 = inputStream.skip(long1 - long2);
			if (long3 > 0L) {
				long2 += long3;
			}
		}
			...
			try {
				...
				try {
					...
					try {
						...
						int int4 = positionInputStream.read();
						if (int1 == 80 && int2 == 90 && int3 == 80 && int4 == 75) {
							this.m_version = TexturePackPage.readInt((InputStream)positionInputStream);
	...
	private TexturePackDevice.Page readPage(TexturePackDevice.PositionInputStream positionInputStream) throws IOException {
		...
		if (this.m_version == 0) {
			...
			int2 = TexturePackPage.readInt((InputStream)positionInputStream);
			skipInput(positionInputStream, (long)int2);
		}
		...
		TexturePackInputStream(String string, TexturePackDevice texturePackDevice) throws IOException {
			...
			if (page == null) {
				...
				if (texturePackDevice.m_version >= 1) {
					int int1 = TexturePackPage.readInt((InputStream)this);
				}
			}
		}
	}
