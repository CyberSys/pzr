...
public class javafmodJNI {
	...
	public static void init() {
		...
		try {
			if (System.getProperty("os.name").contains("OS X")) {
				...
				loadLibrary("libfmod.so.13.4");
				loadLibrary("libfmodstudio.so.13.4");
				if (System.getProperty("sun.arch.data.model").equals("64")) {
	...
	public static final native long FMOD_System_CreateRecordSound(long long1, long long2, long long3, long long4, int int1);
	...
	public static final native long FMOD_System_CreateDSPByType(long long1);
	...
	public static final native int FMOD_Channel_GetNumDSPs(long long1);
	...
	public static final native int FMOD_Channel_Get3DAttributes(long long1, long long2, long long3);
	...
	public static final native int FMOD_ChannelGroup_GetNumDSPs(long long1);
	...
	public static final native int FMOD_ChannelGroup_Set3DAttributes(long long1, long long2, long long3);

	public static final native int FMOD_ChannelGroup_Get3DAttributes(long long1, long long2, long long3);
	...
	public static final native int FMOD_Studio_EventInstance_SetParameterByName(long long1, String string, float float1);
	...
	public static final native int FMOD_Studio_EventInstance_Stop(long long1, boolean boolean1);
	...
	public static native long FMOD_Studio_System_GetBus(String string);

	public static native int FMOD_Studio_System_GetParameterDescriptionCount();

	public static native int FMOD_Studio_System_GetParameterDescriptionList(long[] longArray);

	public static native int FMOD_Studio_System_SetParameterByID(long long1, float float1, boolean boolean1);

	public static native int FMOD_Studio_System_SetParameterByName(String string, float float1, boolean boolean1);
	...
	public static native boolean FMOD_Studio_Bus_GetMute(long long1);

	public static native boolean FMOD_Studio_Bus_GetPaused(long long1);

	public static native float FMOD_Studio_Bus_GetVolume(long long1);

	public static native int FMOD_Studio_Bus_SetMute(long long1, boolean boolean1);

	public static native int FMOD_Studio_Bus_SetPaused(long long1, boolean boolean1);

	public static native int FMOD_Studio_Bus_SetVolume(long long1, float float1);

	public static native int FMOD_Studio_Bus_StopAllEvents(long long1, boolean boolean1);

	public static native long FMOD_Studio_EventDescription_GetID(long long1);

	public static native long FMOD_Studio_EventDescription_GetLength(long long1);
	...
	public static native int FMOD_Studio_EventDescription_GetParameterDescriptionCount(long long1);

	public static native long FMOD_Studio_EventDescription_GetParameterDescriptionByIndex(long long1, int int1);

	public static final native String FMOD_Studio_EventDescription_GetPath(long long1);

	public static native boolean FMOD_Studio_EventDescription_HasSustainPoint(long long1);

	public static final native boolean FMOD_Studio_EventInstance_GetPaused(long long1);

	public static native int FMOD_Studio_EventInstance_SetCallback(long long1, FMOD_STUDIO_EVENT_CALLBACK fMOD_STUDIO_EVENT_CALLBACK, int int1);

	public static final native void FMOD_Studio_EventInstance_SetPaused(long long1, boolean boolean1);

	public static native int FMOD_Studio_EventInstance_SetParameterByID(long long1, long long2, float float1, boolean boolean1);

	public static final native void FMOD_Studio_EventInstance_SetProperty(long long1, int int1, float float1);

	public static native int FMOD_Studio_EventInstance_KeyOff(long long1);

	public static native int FMOD_Studio_EventInstance_SetTimelinePosition(long long1, int int1);

	public static native String FMOD_Studio_ParameterDescription_GetName(long long1);

	public static native long FMOD_Studio_ParameterDescription_GetID(long long1);

	public static native int FMOD_Studio_ParameterDescription_GetFlags(long long1);

	public static native void FMOD_Studio_ParameterDescription_Free(long long1);
}
