...
public class WorldSoundManager {
	...
	public void addSound(IsoObject object, int int1, int int2, int int3, int int4, int int5) {
		if (int4 > 0) {
			if (GameClient.bClient) {
				GameClient.instance.sendWorldSound(object, int1, int2, int3, int4, int5, false, 0.0F, 1.0F);
			} else {
				if (SandboxOptions.instance.Lore.Hearing.getValue() == 1) {
					int4 = (int)((float)int4 * 2.0F);
				}

				if (SandboxOptions.instance.Lore.Hearing.getValue() == 3) {
					int4 = (int)((float)int4 * 0.25F);
				}

				synchronized (this.SoundList) {
					WorldSoundManager.WorldSound worldSound = this.getNew().init(object, int1, int2, int3, int4, int5, false, 0.0F, 1.0F);
					if (!GameServer.bServer) {
						int int6 = (int1 - int4) / 10;
						int int7 = (int2 - int4) / 10;
						int int8 = (int)Math.ceil((double)(((float)int1 + (float)int4) / 10.0F));
						int int9 = (int)Math.ceil((double)(((float)int2 + (float)int4) / 10.0F));
						for (int int10 = int6; int10 < int8; ++int10) {
							for (int int11 = int7; int11 < int9; ++int11) {
								IsoChunk chunk = IsoWorld.instance.CurrentCell.getChunk(int10, int11);
								if (chunk != null) {
	...
	public void addSound(IsoObject object, int int1, int int2, int int3, int int4, int int5, boolean boolean1) {
		if (int4 > 0) {
			if (GameClient.bClient) {
				GameClient.instance.sendWorldSound(object, int1, int2, int3, int4, int5, boolean1, 0.0F, 1.0F);
			} else {
				if (SandboxOptions.instance.Lore.Hearing.getValue() == 1) {
					int4 = (int)((float)int4 * 3.0F);
				}
				...
				synchronized (this.SoundList) {
					WorldSoundManager.WorldSound worldSound = this.getNew().init(object, int1, int2, int3, int4, int5, boolean1, 0.0F, 1.0F);
					if (!GameServer.bServer) {
						int int6 = (int1 - int4) / 10;
						int int7 = (int2 - int4) / 10;
						int int8 = (int)Math.ceil((double)(((float)int1 + (float)int4) / 10.0F));
	...
	public void addSound(IsoObject object, int int1, int int2, int int3, int int4, int int5, boolean boolean1, float float1, float float2) {
		if (int4 > 0) {
			if (GameClient.bClient) {
				GameClient.instance.sendWorldSound(object, int1, int2, int3, int4, int5, boolean1, float1, float2);
			} else {
				if (SandboxOptions.instance.Lore.Hearing.getValue() == 1) {
					int4 = (int)((float)int4 * 3.0F);
				}
				...
				synchronized (this.SoundList) {
					WorldSoundManager.WorldSound worldSound = this.getNew().init(object, int1, int2, int3, int4, int5, boolean1, float1, float2);
					if (!GameServer.bServer) {
						int int6 = (int1 - int4) / 10;
						int int7 = (int2 - int4) / 10;
						int int8 = (int)Math.ceil((double)(((float)int1 + (float)int4) / 10.0F));
	...
	public void addSound(boolean boolean1, int int1, int int2, int int3, int int4, int int5, boolean boolean2, float float1, float float2) {
		...
		synchronized (this.SoundList) {
			WorldSoundManager.WorldSound worldSound = this.getNew().init(boolean1, int1, int2, int3, int4, int5, boolean2, float1, float2);
			if (!GameServer.bServer) {
				int int6 = (int1 - int4) / 10;
				int int7 = (int2 - int4) / 10;
				int int8 = (int)Math.ceil((double)(((float)int1 + (float)int4) / 10.0F));
	...
	public WorldSoundManager.ResultBiggestSound getBiggestSoundZomb(int int1, int int2, int int3, boolean boolean1, IsoZombie zombie) {
		...
		int int4 = IsoWorld.instance.getCell().getWidthInTiles();
		int int5 = IsoWorld.instance.getCell().getWidthInTiles();
		IsoChunk chunk = null;
		if (zombie != null) {
			if (zombie.getCurrentSquare() == null) {
		...
		for (int int6 = 0; int6 < arrayList.size(); ++int6) {
			WorldSoundManager.WorldSound worldSound2 = (WorldSoundManager.WorldSound)arrayList.get(int6);
			if (worldSound2 != null && worldSound2.radius != 0) {
				...
				if (!(float2 > (float)(worldSound2.radius * worldSound2.radius)) && (!(float2 < worldSound2.zombieIgnoreDist * worldSound2.zombieIgnoreDist) || int3 != worldSound2.z) && (!boolean1 || !worldSound2.sourceIsZombie)) {
					...
					float float3 = float2 / (float)(worldSound2.radius * worldSound2.radius);
					...
					if (!(float3 <= 0.0F)) {
						...
						float float4 = (float)worldSound2.volume * float3;
						if (float4 > float1) {
							float1 = float4;
	...
	public float getSoundAttract(WorldSoundManager.WorldSound worldSound, IsoZombie zombie) {
		if (worldSound == null) {
			...
			if (float1 > (float)(worldSound.radius * worldSound.radius)) {
				return 0.0F;
				...
				float float2 = float1 / (float)(worldSound.radius * worldSound.radius);
				if (square != null && square2 != null && square.getRoom() != square2.getRoom()) {
					float2 *= 1.2F;
					if (square2.getRoom() == null || square.getRoom() == null) {
						float2 *= 1.4F;
				...
				if (float2 <= 0.0F) {
					...
					float float3 = (float)worldSound.volume * float2;
					return float3;
				}
			}
		}
			...
			if (!GameClient.bClient) {
				if (!GameServer.bServer || ServerGUI.isCreated()) {
					for (int int1 = 0; int1 < this.SoundList.size(); ++int1) {
						WorldSoundManager.WorldSound worldSound = (WorldSoundManager.WorldSound)this.SoundList.get(int1);
						for (double double1 = 0.0; double1 < 6.283185307179586; double1 += 0.15707963267948966) {
							this.DrawIsoLine((float)worldSound.x + (float)worldSound.radius * (float)Math.cos(double1), (float)worldSound.y + (float)worldSound.radius * (float)Math.sin(double1), (float)worldSound.x + (float)worldSound.radius * (float)Math.cos(double1 + 0.15707963267948966), (float)worldSound.y + (float)worldSound.radius * (float)Math.sin(double1 + 0.15707963267948966), (float)worldSound.z, 1.0F, 1.0F, 1.0F, 1.0F, 1);
						}
					}
								...
								for (int int3 = 0; int3 < IsoChunkMap.ChunkGridWidth; ++int3) {
									...
									if (chunk != null) {
										for (int int4 = 0; int4 < chunk.SoundList.size(); ++int4) {
											WorldSoundManager.WorldSound worldSound2 = (WorldSoundManager.WorldSound)chunk.SoundList.get(int4);
											for (double double2 = 0.0; double2 < 6.283185307179586; double2 += 0.15707963267948966) {
												this.DrawIsoLine((float)worldSound2.x + (float)worldSound2.radius * (float)Math.cos(double2), (float)worldSound2.y + (float)worldSound2.radius * (float)Math.sin(double2), (float)worldSound2.x + (float)worldSound2.radius * (float)Math.cos(double2 + 0.15707963267948966), (float)worldSound2.y + (float)worldSound2.radius * (float)Math.sin(double2 + 0.15707963267948966), (float)worldSound2.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
												float float1 = (float)(chunk.wx * 10) + 0.1F;
												float float2 = (float)(chunk.wy * 10) + 0.1F;
												float float3 = (float)((chunk.wx + 1) * 10) - 0.1F;
												float float4 = (float)((chunk.wy + 1) * 10) - 0.1F;
												this.DrawIsoLine(float1, float2, float3, float2, (float)worldSound2.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
												this.DrawIsoLine(float3, float2, float3, float4, (float)worldSound2.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
												this.DrawIsoLine(float3, float4, float1, float4, (float)worldSound2.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
												this.DrawIsoLine(float1, float4, float1, float2, (float)worldSound2.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
											}
										}
									}
								}
	...
	public class WorldSound {
		...
		public WorldSoundManager.WorldSound init(IsoObject object, int int1, int int2, int int3, int int4, int int5) {
			...
			this.stressMod = 1.0F;
			this.sourceIsZombie = object != null && object instanceof IsoZombie;
			return this;
		}
		...
		public WorldSoundManager.WorldSound init(boolean boolean1, int int1, int int2, int int3, int int4, int int5, boolean boolean2, float float1, float float2) {
			...
			this.radius = int4;
			this.volume = int5;
			this.stresshumans = boolean2;
			this.zombieIgnoreDist = float1;
			this.stressMod = float2;
			this.sourceIsZombie = boolean1;
			return this;
		}
	}
