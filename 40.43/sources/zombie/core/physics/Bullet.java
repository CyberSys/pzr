...
public class Bullet {
	...
	public static native void debugDrawWorld(int int1, int int2);
	...
	public static native void brekingVehicle(int int1, float float1);

	public static native int getCollisions(int int1, float[] floatArray);
