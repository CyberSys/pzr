...
public class RenderSettings {
	...
	public static class PlayerRenderSettings {
		...
		private void updateRenderSettings(int int1, IsoPlayer player) {
			...
			if (this.ambient < 0.2F && player.HasTrait("NightVision")) {
				this.ambient = 0.2F;
			}
		...
		private void legacyPostRender(int int1) {
			...
			if (this.applyNightVisionGoggles) {
				...
				SpriteRenderer.instance.render(RenderSettings.texture, 0.0F, 0.0F, (float)Core.getInstance().getOffscreenWidth(int1), (float)Core.getInstance().getOffscreenHeight(int1), 0.05F, 0.95F, 0.05F, this.goggleMod);
				IndieGL.glBlendFunc(770, 771);
			} else {
				IndieGL.glBlendFunc(774, 774);
				SpriteRenderer.instance.render(RenderSettings.texture, 0.0F, 0.0F, (float)Core.getInstance().getOffscreenWidth(int1), (float)Core.getInstance().getOffscreenHeight(int1), this.blendInfo.r, this.blendInfo.g, this.blendInfo.b, 1.0F);
				IndieGL.glBlendFunc(770, 771);
			}
