...
public final class GLFramebufferObjectEXT implements IGLFramebufferObject {
	...
	public void glBindFramebuffer(int int1, int int2) {
		EXTFramebufferObject.glBindFramebufferEXT(int1, int2);
	}

	public void glFramebufferTexture2D(int int1, int int2, int int3, int int4, int int5) {
		EXTFramebufferObject.glFramebufferTexture2DEXT(int1, int2, int3, int4, int5);
	}
	...
	public void glBindRenderbuffer(int int1, int int2) {
		EXTFramebufferObject.glBindRenderbufferEXT(int1, int2);
	}

	public void glRenderbufferStorage(int int1, int int2, int int3, int int4) {
		EXTFramebufferObject.glRenderbufferStorageEXT(int1, int2, int3, int4);
	}

	public void glFramebufferRenderbuffer(int int1, int int2, int int3, int int4) {
		EXTFramebufferObject.glFramebufferRenderbufferEXT(int1, int2, int3, int4);
	}

	public int glCheckFramebufferStatus(int int1) {
		return EXTFramebufferObject.glCheckFramebufferStatusEXT(int1);
	}

	public void glDeleteFramebuffers(int int1) {
		EXTFramebufferObject.glDeleteFramebuffersEXT(int1);
	}

	public void glDeleteRenderbuffers(int int1) {
		EXTFramebufferObject.glDeleteRenderbuffersEXT(int1);
	}
}
