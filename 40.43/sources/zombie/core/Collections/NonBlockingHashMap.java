...
public class NonBlockingHashMap extends AbstractMap implements ConcurrentMap,Cloneable,Serializable {
	...
	private static final NonBlockingHashMap.CHM chm(Object[] objectArray) {
		return (NonBlockingHashMap.CHM)objectArray[0];
	}
	...
	private final void print(Object[] objectArray) {
		for (int int1 = 0; int1 < len(objectArray); ++int1) {
			...
			if (object != null) {
				...
				Object object3 = NonBlockingHashMap.Prime.unbox(object2);
	...
	public boolean remove(Object object, Object object2) {
		Object object3 = this.putIfMatch(object, TOMBSTONE, object2);
		return object2 == null ? object3 == object2 : object2.equals(object3);
	}
	...
	public boolean replace(Object object, Object object2, Object object3) {
		Object object4 = this.putIfMatch(object, object3, object2);
		return object2 == null ? object4 == object2 : object2.equals(object4);
	}
	...
	private final Object putIfMatch(Object object, Object object2, Object object3) {
		if (object3 != null && object2 != null) {
			...
			assert !(object4 instanceof NonBlockingHashMap.Prime);
			assert object4 != null;
	...
	public void clear() {
		Object[] objectArray = (new NonBlockingHashMap(8))._kvs;
	...
	public Object clone() {
		try {
			...
			while (iterator.hasNext()) {
				...
				nonBlockingHashMap.put(object, object2);
			}
	...
	private static final Object get_impl(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray, Object object, int int1) {
		int int2 = len(objectArray);
		NonBlockingHashMap.CHM cHM = chm(objectArray);
		...
		while (true) {
			...
			if (keyeq(object2, object, intArray, int3, int1)) {
				if (!(object3 instanceof NonBlockingHashMap.Prime)) {
					return object3 == TOMBSTONE ? null : object3;
				}

				return get_impl(nonBlockingHashMap, cHM.copy_slot_and_check(nonBlockingHashMap, objectArray, int3, object), object, int1);
			}

			++int4;
			if (int4 >= reprobe_limit(int2) || object == TOMBSTONE) {
				return objectArray2 == null ? null : get_impl(nonBlockingHashMap, nonBlockingHashMap.help_copy(objectArray2), object, int1);
			}
	...
	private static final Object putIfMatch(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray, Object object, Object object2, Object object3) {
		assert object2 != null;
		assert !(object2 instanceof NonBlockingHashMap.Prime);
		assert !(object3 instanceof NonBlockingHashMap.Prime);
		int int1 = hash(object);
		int int2 = len(objectArray);
		NonBlockingHashMap.CHM cHM = chm(objectArray);
		int[] intArray = hashes(objectArray);
		...
		while (true) {
			...
			if (!keyeq(object4, object, intArray, int3, int1)) {
				...
				return putIfMatch(nonBlockingHashMap, objectArray2, object, object2, object3);
			}
		...
		if (object2 == object5) {
			...
			if (objectArray2 == null && (object5 == null && cHM.tableFull(int4, int2) || object5 instanceof NonBlockingHashMap.Prime)) {
				objectArray2 = cHM.resize(nonBlockingHashMap, objectArray);
			}

			if (objectArray2 != null) {
				return putIfMatch(nonBlockingHashMap, cHM.copy_slot_and_check(nonBlockingHashMap, objectArray, int3, object3), object, object2, object3);
			} else {
				do {
					assert !(object5 instanceof NonBlockingHashMap.Prime);
					...
					object5 = val(objectArray, int3);
				}		 while (!(object5 instanceof NonBlockingHashMap.Prime));
	...
	private final Object[] help_copy(Object[] objectArray) {
		...
		NonBlockingHashMap.CHM cHM = chm(objectArray2);
		if (cHM._newkvs == null) {
			return objectArray;
		} else {
	...
	private class NBHMEntry extends AbstractEntry {
		...
		public Object setValue(Object object) {
			if (object == null) {
				...
				this._val = object;
				return NonBlockingHashMap.this.put(this._key, object);
			}
		}
	}
	...
	private class SnapshotV implements Iterator,Enumeration {
		...
		public SnapshotV() {
			while (true) {
				Object[] objectArray = NonBlockingHashMap.this._kvs;
				NonBlockingHashMap.CHM cHM = NonBlockingHashMap.chm(objectArray);
				if (cHM._newkvs == null) {
		...
		Object key(int int1) {
			return NonBlockingHashMap.key(this._sskvs, int1);
		}
	...
	private static final class CHM {
		...
		private final boolean tableFull(int int1, int int2) {
			return int1 >= 10 && this._slots.estimate_get() >= (long)NonBlockingHashMap.reprobe_limit(int2);
		}
		...
		private final Object[] resize(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray) {
			...
			if (objectArray2 != null) {
				...
				int int1 = NonBlockingHashMap.len(objectArray);
				int int2 = this.size();
				int int3 = int2;
				if (int2 >= int1 >> 2) {
					int3 = int1 << 1;
				...
				long long2 = 0L;
				if (int3 <= int1 && long1 <= nonBlockingHashMap._last_resize_milli + 10000L && this._slots.estimate_get() >= (long)(int2 << 1)) {
					int3 = int1 << 1;
				}
				...
				if (objectArray2 != null) {
					...
					objectArray2[0] = new NonBlockingHashMap.CHM(this._size);
		...
		private final void help_copy_impl(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray, boolean boolean1) {
			assert NonBlockingHashMap.chm(objectArray) == this;
			Object[] objectArray2 = this._newkvs;
			...
			do {
				...
				for (int int6 = 0; int6 < int2; ++int6) {
					if (this.copy_slot(nonBlockingHashMap, int4 + int6 & int1 - 1, objectArray, objectArray2)) {
						++int5;
					}
				}

				if (int5 > 0) {
					this.copy_check_and_promote(nonBlockingHashMap, objectArray, int5);
				}
		...
		private final Object[] copy_slot_and_check(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray, int int1, Object object) {
			assert NonBlockingHashMap.chm(objectArray) == this;
			Object[] objectArray2 = this._newkvs;
			assert objectArray2 != null;
			if (this.copy_slot(nonBlockingHashMap, int1, objectArray, this._newkvs)) {
		...
		private final void copy_check_and_promote(NonBlockingHashMap nonBlockingHashMap, Object[] objectArray, int int1) {
			assert NonBlockingHashMap.chm(objectArray) == this;
			int int2 = NonBlockingHashMap.len(objectArray);
			...
			if (long1 + (long)int1 == (long)int2 && nonBlockingHashMap._kvs == objectArray && nonBlockingHashMap.CAS_kvs(objectArray, this._newkvs)) {
				nonBlockingHashMap._last_resize_milli = System.currentTimeMillis();
			}
		}

		private boolean copy_slot(NonBlockingHashMap nonBlockingHashMap, int int1, Object[] objectArray, Object[] objectArray2) {
			Object object;
			while ((object = NonBlockingHashMap.key(objectArray, int1)) == null) {
				NonBlockingHashMap.CAS_key(objectArray, int1, (Object)null, NonBlockingHashMap.TOMBSTONE);
			}

			Object object2;
			for (object2 = NonBlockingHashMap.val(objectArray, int1); !(object2 instanceof NonBlockingHashMap.Prime); object2 = NonBlockingHashMap.val(objectArray, int1)) {
				NonBlockingHashMap.Prime prime = object2 != null && object2 != NonBlockingHashMap.TOMBSTONE ? new NonBlockingHashMap.Prime(object2) : NonBlockingHashMap.TOMBPRIME;
				if (NonBlockingHashMap.CAS_val(objectArray, int1, object2, prime)) {
			...
			if (object2 == NonBlockingHashMap.TOMBPRIME) {
				return false;
			} else {
				Object object3 = ((NonBlockingHashMap.Prime)object2)._V;
				assert object3 != NonBlockingHashMap.TOMBSTONE;
				boolean boolean1;
				for (boolean1 = NonBlockingHashMap.putIfMatch(nonBlockingHashMap, objectArray2, object, object3, (Object)null) == null; !NonBlockingHashMap.CAS_val(objectArray, int1, object2, NonBlockingHashMap.TOMBPRIME); object2 = NonBlockingHashMap.val(objectArray, int1)) {
				}
