...
@AltCommandArgs({@CommandArgs(required = {"(.+)", "([a-zA-Z0-9.-]*[a-zA-Z][a-zA-Z0-9.-]*)"}, optional = "(\\d+)", argName = "add item to player"), @CommandArgs(required = {"([a-zA-Z0-9.-]*[a-zA-Z][a-zA-Z0-9.-]*)"}, optional = "(\\d+)", argName = "add item to me")})
			...
			if (item == null) {
				...
				if (player2 != null) {
					...
					if (udpConnection != null) {
						...
						PacketTypes.doPacket((short)85, byteBufferWriter);
