	...
	public void addZone(IsoMetaGrid.Zone zone, int int1, int int2) {
		...
		for (int int5 = zone.y / 10; int5 <= int4; ++int5) {
			for (int int6 = zone.x / 10; int6 <= int3; ++int6) {
				if (int6 >= int1 / 10 && int6 < (int1 + 300) / 10 && int5 >= int2 / 10 && int5 < (int2 + 300) / 10 && this.ChunkMap[int6 - int1 / 10 + (int5 - int2 / 10) * 30] != null) {
					this.ChunkMap[int6 - int1 / 10 + (int5 - int2 / 10) * 30].addZone(zone);
				}
			}
		}
	}
	...
	public void removeZone(IsoMetaGrid.Zone zone) {
		...
		for (int int5 = zone.y / 10; int5 <= int2; ++int5) {
			for (int int6 = zone.x / 10; int6 <= int1; ++int6) {
				if (int6 >= int3 / 10 && int6 < (int3 + 300) / 10 && int5 >= int4 / 10 && int5 < (int4 + 300) / 10 && this.ChunkMap[int6 - int3 / 10 + (int5 - int4 / 10) * 30] != null) {
					this.ChunkMap[int6 - int3 / 10 + (int5 - int4 / 10) * 30].removeZone(zone);
				}
			}
		}
	}
	...
	public void addRoom(RoomDef roomDef, int int1, int int2) {
		...
		for (int int5 = roomDef.y / 10; int5 <= int4; ++int5) {
			for (int int6 = roomDef.x / 10; int6 <= int3; ++int6) {
				if (int6 >= int1 / 10 && int6 < (int1 + 300) / 10 && int5 >= int2 / 10 && int5 < (int2 + 300) / 10 && this.ChunkMap[int6 - int1 / 10 + (int5 - int2 / 10) * 30] != null) {
					this.ChunkMap[int6 - int1 / 10 + (int5 - int2 / 10) * 30].addRoom(roomDef);
				}
			}
		}
	}
	...
	public void getZonesIntersecting(int int1, int int2, int int3, int int4, int int5, ArrayList arrayList) {
		...
		for (int int10 = int2 / 10; int10 <= int7; ++int10) {
			for (int int11 = int1 / 10; int11 <= int6; ++int11) {
				if (int11 >= int8 / 10 && int11 < (int8 + 300) / 10 && int10 >= int9 / 10 && int10 < (int9 + 300) / 10 && this.ChunkMap[int11 - int8 / 10 + (int10 - int9 / 10) * 30] != null) {
					this.ChunkMap[int11 - int8 / 10 + (int10 - int9 / 10) * 30].getZonesIntersecting(int1, int2, int3, int4, int5, arrayList);
				}
			}
		}
	}
	...
	public void getRoomsIntersecting(int int1, int int2, int int3, int int4, ArrayList arrayList) {
		...
		for (int int9 = int2 / 10; int9 <= int6; ++int9) {
			for (int int10 = int1 / 10; int10 <= int5; ++int10) {
				if (int10 >= int7 / 10 && int10 < (int7 + 300) / 10 && int9 >= int8 / 10 && int9 < (int8 + 300) / 10 && this.ChunkMap[int10 - int7 / 10 + (int9 - int8 / 10) * 30] != null) {
					this.ChunkMap[int10 - int7 / 10 + (int9 - int8 / 10) * 30].getRoomsIntersecting(int1, int2, int3, int4, arrayList);
				}
			}
		}
	}
