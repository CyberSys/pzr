...
public class IsoPushableObject extends IsoMovingObject {
	...
	public void update() {
		...
		if (this.connectList != null) {
			...
			while (iterator.hasNext()) {
				...
				if (pushableObject.alpha[IsoPlayer.getPlayerIndex()] > float1) {
					float1 = pushableObject.alpha[IsoPlayer.getPlayerIndex()];
				}
			}
	...
	public void load(ByteBuffer byteBuffer, int int1) throws IOException {
		...
		if (!(this instanceof IsoWheelieBin)) {
			this.sprite = IsoWorld.instance.spriteManager.getSprite(byteBuffer.getInt());
		}
	...
	public void save(ByteBuffer byteBuffer) throws IOException {
		...
		if (this.container != null) {
			...
			this.container.save(byteBuffer, false);
		} else {
