...
public class RainParticle extends WeatherParticle {
	...
	public void render(float float1, float float2) {
		...
		SpriteRenderer.instance.render(this.texture, double1 + this.rp.getX(0), double2 + this.rp.getY(0), double1 + this.rp.getX(1), double2 + this.rp.getY(1), double1 + this.rp.getX(2), double2 + this.rp.getY(2), double1 + this.rp.getX(3), double2 + this.rp.getY(3), this.color.r, this.color.g, this.color.b, this.renderAlpha);
	}
