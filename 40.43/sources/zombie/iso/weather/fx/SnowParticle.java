...
public class SnowParticle extends WeatherParticle {
	...
	public void update(float float1) {
		...
		if (this.life >= this.fadeTime) {
			...
			vector2.x += this.velocity.x * IsoWeatherFX.instance.windSpeed * float1;
			vector2 = this.position;
			vector2.y += this.velocity.y * IsoWeatherFX.instance.windSpeed * float1;
		} else {
