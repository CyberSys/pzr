	...
	private ClimMngrDebug.RunInfo calculateTotal() {
		...
		while (iterator.hasNext()) {
			...
			for (int1 = 0; int1 < runInfo2.exceedingPeriods.size(); ++int1) {
				runInfo.exceedingPeriods.add(runInfo2.exceedingPeriods.get(int1));
			}

			for (int1 = 0; int1 < runInfo2.exceedingEmpties.size(); ++int1) {
				runInfo.exceedingEmpties.add(runInfo2.exceedingEmpties.get(int1));
			}
			...
			if (int1 < runInfo.totalDaysPeriod.length) {
				...
				DebugLog.log("Total days Period is longer than allowed array, days = " + int1 * this.TotalDaysPeriodIndexMod);
			}
		}

		if (this.runs.size() > 0) {
			int int3 = this.runs.size();
			runInfo.totalPeriodDuration /= (double)int3;
			runInfo.averagePeriod /= (double)int3;
			runInfo.averageEmpty /= (double)int3;
			runInfo.averageStrength /= (float)int3;
			runInfo.averageWarmStrength /= (float)int3;
			runInfo.averageColdStrength /= (float)int3;
		}
	...
	private void saveData() {
		if (this.runs.size() > 0) {
			try {
				...
				(new File(GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + "climate")).mkdirs();
				File file = new File(GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + "climate");
				if (file.exists() && file.isDirectory()) {
					String string2 = GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + "climate" + File.separator + string + ".txt";
					...
					try {
						...
						try {
							...
							this.write("Longest weather: " + this.formatDuration(runInfo2.longestPeriod));
							this.write("Shortest weather: " + this.formatDuration(runInfo2.shortestPeriod));
							this.write("Average weather: " + this.formatDuration(runInfo2.averagePeriod));
							this.write("");
							this.write("Average total weather days per cycle: " + this.formatDuration(runInfo2.totalPeriodDuration));
							this.write("");
							this.write("Driest cycle total weather days: " + this.formatDuration(runInfo2.mostDryPeriod));
							this.write("Wettest cycle total weather days: " + this.formatDuration(runInfo2.mostWetPeriod));
							this.write("");
							this.write("Total clear periods: " + runInfo2.totalEmpty + ", average per cycle: " + runInfo2.totalEmpty / int1);
							this.write("Longest clear: " + this.formatDuration(runInfo2.longestEmpty));
							this.write("Shortest clear: " + this.formatDuration(runInfo2.shortestEmpty));
							this.write("Average clear: " + this.formatDuration(runInfo2.averageEmpty));
							this.write("");
							...
							this.write("Normal warm: " + runInfo2.countNormalWarm + ", average: " + this.round((double)runInfo2.countNormalWarm / double1));
							this.write("Normal cold: " + runInfo2.countNormalCold + ", average: " + this.round((double)runInfo2.countNormalCold / double1));
							this.write("Normal storm: " + runInfo2.countStorm + ", average: " + this.round((double)runInfo2.countStorm / (double)int1));
							this.write("Normal tropical: " + runInfo2.countTropical + ", average: " + this.round((double)runInfo2.countTropical / double1));
							this.write("Normal blizzard: " + runInfo2.countBlizzard + ", average: " + this.round((double)runInfo2.countBlizzard / double1));
							this.write("");
					...
					string2 = GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + "climate" + File.separator + string + "_DATA.txt";
					...
					string2 = GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + "climate" + File.separator + string + "_PATTERNS.txt";
					file2 = new File(string2);
					try {
						fileWriter = new FileWriter(file2, false);
						throwable = null;
