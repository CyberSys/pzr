...
public class IsoUtils {
	...
	public static float DistanceTo(float float1, float float2, float float3, float float4, float float5, float float6) {
		return (float)Math.sqrt(Math.pow((double)(float4 - float1), 2.0) + Math.pow((double)(float5 - float2), 2.0) + Math.pow((double)(float6 - float3), 2.0) * 2.0);
	}
	...
	public static float XToIsoTrue(float float1, float float2, int int1) {
		float float3 = float1 + IsoCamera.OffX[IsoPlayer.getPlayerIndex()];
		float float4 = float2 + IsoCamera.OffY[IsoPlayer.getPlayerIndex()];
	...
	public static float XToScreenInt(int int1, int int2, int int3, int int4) {
		float float1 = 0.0F;
		float1 += (float)(int1 * 32 * Core.TileScale);
		float1 -= (float)(int2 * 32 * Core.TileScale);
		return float1;
	}
	...
	public static float YToIsoTrue(float float1, float float2, int int1) {
		float float3 = float1 + IsoCamera.OffX[IsoPlayer.getPlayerIndex()];
		float float4 = float2 + IsoCamera.OffY[IsoPlayer.getPlayerIndex()];
		float float5 = (float3 + 2.0F * float4) / (64.0F * (float)Core.TileScale);
		float float6 = (float3 - 2.0F * float4) / (-64.0F * (float)Core.TileScale);
		float float7 = float5 + (float)(3 * int1);
		float6 += (float)(3 * int1);
		return float6;
	}
	...
	public static float YToScreenInt(int int1, int int2, int int3, int int4) {
		float float1 = 0.0F;
		float1 += (float)(int2 * 16 * Core.TileScale);
		float1 += (float)(int1 * 16 * Core.TileScale);
		float1 += (float)((int4 - int3) * 96 * Core.TileScale);
		return float1;
	}
