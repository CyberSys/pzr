...
public class IsoFire extends IsoObject {
	...
	public IsoFire(IsoCell cell, IsoGridSquare square, boolean boolean1, int int1, int int2) {
		...
		square.getProperties().Set(IsoFlagType.burning, "Burning");
		this.Energy = int1;
	...
	public void render(float float1, float float2, float float3, ColorInfo colorInfo, boolean boolean1) {
		...
		for (int int1 = 0; int1 < this.AttachedAnimSpriteActual.size(); ++int1) {
