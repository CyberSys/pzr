...
public class IsoCompost extends IsoObject {
	...
	public IsoCompost(IsoCell cell, IsoGridSquare square) {
		super(cell, square, IsoWorld.instance.CurrentCell.SpriteManager.getSprite("camping_01_19"));
		this.sprite = IsoWorld.instance.CurrentCell.SpriteManager.getSprite("camping_01_19");
		this.square = square;
	...
	public void updateSprite() {
		if (this.getCompost() >= 10.0F && this.sprite.getName().equals("camping_01_19")) {
			this.sprite = IsoWorld.instance.CurrentCell.SpriteManager.getSprite("camping_01_20");
