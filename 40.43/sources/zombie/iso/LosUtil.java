...
public class LosUtil {
	...
	public static boolean lineClearCollide(int int1, int int2, int int3, int int4, int int5, int int6, boolean boolean1) {
		...
		boolean boolean2;
		if (int4 == 56 && int5 == 20 && int6 == 0) {
			boolean2 = false;
		}

		if (int1 == 57 && int2 == 23 && int3 == 0) {
			boolean2 = false;
		}
		...
		if (Math.abs(int8) > Math.abs(int7) && Math.abs(int8) > Math.abs(int9)) {
			...
			for (float4 *= (float)int8; int4 != int1; int11 = (int)float2) {
				...
				if (square2 != null && square != null) {
					boolean3 = square2.CalculateCollide(square, false, false, true, true);
					if (boolean3) {
						return true;
					}
				}
	...
	public static int lineClearCollideCount(IsoMovingObject movingObject, IsoCell cell, int int1, int int2, int int3, int int4, int int5, int int6, int int7) {
		...
		if (Math.abs(int10) > Math.abs(int9) && Math.abs(int10) > Math.abs(int11)) {
			...
			int10 = int10 < 0 ? -1 : 1;
			float3 *= (float)int10;
			for (float4 *= (float)int10; int4 != int1; int13 = (int)float2) {
				int4 += int10;
				float1 += float3;
				float2 += float4;
				square2 = cell.getGridSquare(int4, (int)float1, (int)float2);
				if (square2 != null && square != null) {
					boolean1 = square.testCollideAdjacent(movingObject, square2.getX() - square.getX(), square2.getY() - square.getY(), square2.getZ() - square.getZ());
					if (boolean1) {
						return int8;
					}
				}
			...
			if (Math.abs(int9) >= Math.abs(int10) && Math.abs(int9) > Math.abs(int11)) {
				...
				int9 = int9 < 0 ? -1 : 1;
				float3 *= (float)int9;
				for (float4 *= (float)int9; int5 != int2; int13 = (int)float2) {
					int5 += int9;
					float1 += float3;
					float2 += float4;
					square2 = cell.getGridSquare((int)float1, int5, (int)float2);
				...
				int11 = int11 < 0 ? -1 : 1;
				float3 *= (float)int11;
				for (float4 *= (float)int11; int6 != int3; int12 = (int)float2) {
					int6 += int11;
					float1 += float3;
					float2 += float4;
					square2 = cell.getGridSquare((int)float1, (int)float2, int6);
