			...
			if (UIManager.getClock() == null || UIManager.getClock().isVisible()) {
				...
				if (!this.bars.isEmpty()) {
					...
					for (int int2 = 0; int2 < this.bars.size(); ++int2) {
						...
						this.DrawTextureScaledCol(UIElement.white, (double)int1, this.getHeight() - (double)float1, (double)this.BAR_WID, (double)float1, 1.0, 1.0, 1.0, 0.3499999940395355);
						int1 += this.BAR_WID + this.BAR_PAD;
					}
				}
			}
		}
