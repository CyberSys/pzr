...
public class KahluaThread {
	...
	private final void luaMainloop() {
		...
		if (this.doProfiling && Core.bDebug && this == LuaManager.thread) {
			...
			String string3 = coroutine.getThread().currentfile + " " + string2.substring(0, string2.indexOf(":"));
			string = string3;
		}
			...
			try {
				...
				case 1: 
					...
					if (Core.bDebug) {
						...
						if (boolean5 && this == LuaManager.thread && luaCallFrame.closure.prototype.locvarlines != null && luaCallFrame.closure.prototype.locvarlines[luaCallFrame.localsAssigned] == int10) {
							...
							string4 = luaCallFrame.closure.prototype.locvars[int4];
							luaCallFrame.setLocalVarToStack(string4, luaCallFrame.localBase + int7);
						}
					}
				...
				case 2: 
					...
					if (Core.bDebug) {
						...
						if (boolean4 && this == LuaManager.thread && luaCallFrame.closure.prototype.locvarlines != null && luaCallFrame.closure.prototype.locvarlines[luaCallFrame.localsAssigned] == int11) {
							...
							string5 = luaCallFrame.closure.prototype.locvars[int5];
				...
				case 6: 
					...
					if (Core.bDebug) {
						...
						if (boolean6 && this == LuaManager.thread && luaCallFrame.closure.prototype.locvarlines != null && luaCallFrame.closure.prototype.locvarlines[luaCallFrame.localsAssigned] == int5) {
							...
							String string7 = luaCallFrame.closure.prototype.locvars[int13];
							luaCallFrame.setLocalVarToStack(string7, luaCallFrame.localBase + int7);
						}
					}
				...
				case 7: 
					...
					if (object2 instanceof LuaClosure && object5 instanceof String) {
						((LuaClosure)((LuaClosure)object2)).debugName = object5.toString();
					}
				...
				case 17: 
					...
					if ((Double2 = KahluaUtil.rawTonumber(object2)) != null && (Double1 = KahluaUtil.rawTonumber(object5)) != null) {
						...
						String string8 = meta_ops[int3];
						object7 = this.getBinMetaOp(object2, object5, string8);
						if (object7 == null) {
							this.doStacktraceProper(luaCallFrame);
							KahluaUtil.fail(string8 + " not defined for operands in " + luaCallFrame.closure.debugName);
						}
					...
					if (Core.bDebug) {
						...
						if (boolean7 && this == LuaManager.thread && luaCallFrame.closure.prototype.locvarlines != null && luaCallFrame.closure.prototype.locvarlines[luaCallFrame.localsAssigned] == int13) {
							...
							String string9 = luaCallFrame.closure.prototype.locvars[int6];
							luaCallFrame.setLocalVarToStack(string9, luaCallFrame.localBase + int7);
						}
					}
				...
				case 20: 
					...
					if (object2 instanceof KahluaTable) {
						...
						object5 = KahluaUtil.toDouble((long)string6.length());
					} else {
				...
				case 21: 
					...
					int11 = int8 - 1;
					while (int10 <= int11) {
						string4 = KahluaUtil.rawTostring(object3);
						if (string4 != null) {
							int12 = 0;
							...
							if (int12 > 0) {
								...
								for (int6 = int11 - int12 + 1; int6 <= int11; ++int6) {
									stringBuffer.append(KahluaUtil.rawTostring(luaCallFrame.get(int6)));
								}
				...
				case 25: 
					...
					if (object2 instanceof Double && object5 instanceof Double) {
						...
						if (int3 == 23) {
							...
							int12 = string6.compareTo(string4);
							if (int3 == 24) {
								if (int12 < 0 == (int7 == 0)) {
									++luaCallFrame.pc;
								}
						...
						if (object2 == object5 && int3 == 23) {
							...
							string5 = meta_ops[int3];
							object6 = this.getCompMetaOp(object2, object5, string5);
							...
							if (object6 == null && int3 == 23) {
								...
								if (object6 == null) {
									this.doStacktraceProper(luaCallFrame);
									KahluaUtil.fail(string5 + " not defined for operand");
								}
	...
	public void doStacktraceProper(LuaCallFrame luaCallFrame) {
		...
		for (int int2 = int1 - 1; int2 >= 0; --int2) {
			...
			DebugLog.log(luaCallFrame2.toString2());
		}
	}
	...
	public Object tableget(Object object, Object object2) {
		...
		for (int int1 = 100; int1 > 0; --int1) {
			...
			if (object5 == null) {
				...
				DebugLog.log("-------------------------------------------------------------");
				DebugLog.log("attempted index: " + object2 + " of non-table: " + object3);
	...
	public int pcall(int int1) {
		...
		try {
			...
			object2 = throwable;
			object = throwable.getMessage() + " " + throwable.getClass().getName();
		}
