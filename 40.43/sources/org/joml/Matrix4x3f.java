...
public class Matrix4x3f implements Externalizable,Matrix4x3fc {
	...
	public Matrix4x3f(Vector3fc vector3fc, Vector3fc vector3fc2, Vector3fc vector3fc3, Vector3fc vector3fc4) {
		if (vector3fc instanceof Vector3f && vector3fc2 instanceof Vector3f && vector3fc3 instanceof Vector3f && vector3fc4 instanceof Vector3f) {
			...
			this.setVector3fc(vector3fc, vector3fc2, vector3fc3, vector3fc4);
		}
	}
	...
	public Matrix4x3f set(Matrix4fc matrix4fc) {
		...
		this.properties = (byte)(matrix4fc.properties() & 12);
		return this;
	}
	...
	public Matrix4x3f set(AxisAngle4f axisAngle4f) {
		...
		this.m00 = (float)(double3 + (double)(float1 * float1) * double5);
		this.m11 = (float)(double3 + (double)(float2 * float2) * double5);
		this.m22 = (float)(double3 + (double)(float3 * float3) * double5);
		double double6 = (double)(float1 * float2) * double5;
		double double7 = (double)float3 * double4;
		this.m10 = (float)(double6 - double7);
		this.m01 = (float)(double6 + double7);
		double6 = (double)(float1 * float3) * double5;
		double7 = (double)float2 * double4;
		this.m20 = (float)(double6 + double7);
		this.m02 = (float)(double6 - double7);
		double6 = (double)(float2 * float3) * double5;
		double7 = (double)float1 * double4;
		this.m21 = (float)(double6 - double7);
		this.m12 = (float)(double6 + double7);
		this.m30 = 0.0F;
		this.m31 = 0.0F;
		this.m32 = 0.0F;
		this.properties = 0;
	...
	public Matrix4x3f set3x3(Matrix4x3fc matrix4x3fc) {
		if (matrix4x3fc instanceof Matrix4x3f) {
			...
			this.set3x3Matrix4x3fc(matrix4x3fc);
		}
	...
	private Matrix4x3f mulGeneric(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
		...
		float float4 = this.m00 * matrix4x3fc.m10() + this.m10 * matrix4x3fc.m11() + this.m20 * matrix4x3fc.m12();
		float float5 = this.m01 * matrix4x3fc.m10() + this.m11 * matrix4x3fc.m11() + this.m21 * matrix4x3fc.m12();
		float float6 = this.m02 * matrix4x3fc.m10() + this.m12 * matrix4x3fc.m11() + this.m22 * matrix4x3fc.m12();
		float float7 = this.m00 * matrix4x3fc.m20() + this.m10 * matrix4x3fc.m21() + this.m20 * matrix4x3fc.m22();
		float float8 = this.m01 * matrix4x3fc.m20() + this.m11 * matrix4x3fc.m21() + this.m21 * matrix4x3fc.m22();
		float float9 = this.m02 * matrix4x3fc.m20() + this.m12 * matrix4x3fc.m21() + this.m22 * matrix4x3fc.m22();
		float float10 = this.m00 * matrix4x3fc.m30() + this.m10 * matrix4x3fc.m31() + this.m20 * matrix4x3fc.m32() + this.m30;
		float float11 = this.m01 * matrix4x3fc.m30() + this.m11 * matrix4x3fc.m31() + this.m21 * matrix4x3fc.m32() + this.m31;
		float float12 = this.m02 * matrix4x3fc.m30() + this.m12 * matrix4x3fc.m31() + this.m22 * matrix4x3fc.m32() + this.m32;
	...
	public Matrix4x3f mulTranslation(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
		...
		float float10 = matrix4x3fc.m30() + this.m30;
		float float11 = matrix4x3fc.m31() + this.m31;
		float float12 = matrix4x3fc.m32() + this.m32;
		matrix4x3f.m00 = float1;
		matrix4x3f.m01 = float2;
		matrix4x3f.m02 = float3;
		matrix4x3f.m10 = float4;
	...
	public Matrix4x3f fma(Matrix4x3fc matrix4x3fc, float float1, Matrix4x3f matrix4x3f) {
		matrix4x3f.m00 = this.m00 + matrix4x3fc.m00() * float1;
		matrix4x3f.m01 = this.m01 + matrix4x3fc.m01() * float1;
		matrix4x3f.m02 = this.m02 + matrix4x3fc.m02() * float1;
		matrix4x3f.m10 = this.m10 + matrix4x3fc.m10() * float1;
		matrix4x3f.m11 = this.m11 + matrix4x3fc.m11() * float1;
		matrix4x3f.m12 = this.m12 + matrix4x3fc.m12() * float1;
		matrix4x3f.m20 = this.m20 + matrix4x3fc.m20() * float1;
		matrix4x3f.m21 = this.m21 + matrix4x3fc.m21() * float1;
		matrix4x3f.m22 = this.m22 + matrix4x3fc.m22() * float1;
		matrix4x3f.m30 = this.m30 + matrix4x3fc.m30() * float1;
		matrix4x3f.m31 = this.m31 + matrix4x3fc.m31() * float1;
		matrix4x3f.m32 = this.m32 + matrix4x3fc.m32() * float1;
		matrix4x3f.properties = 0;
		return matrix4x3f;
	}
	...
	public Matrix4x3f invert(Matrix4x3f matrix4x3f) {
		return (this.properties & 4) != 0 ? matrix4x3f.identity() : this.invertGeneric(matrix4x3f);
	}
	...
	private Matrix4x3f invertGeneric(Matrix4x3f matrix4x3f) {
		...
		float float23 = (float11 - float2) * float1;
		float float24 = (float19 - float14) * float1;
		float float25 = (float4 - float13) * float1;
		float float26 = (float3 - float7) * float1;
		float float27 = (float15 - float17) * float1;
		float float28 = (float9 - float5) * float1;
		float float29 = (float2 * this.m31 - float3 * this.m32 + float7 * this.m32 - float6 * this.m30 + float10 * this.m30 - float11 * this.m31) * float1;
		float float30 = (float14 * this.m31 - float15 * this.m32 + float17 * this.m32 - float16 * this.m30 + float18 * this.m30 - float19 * this.m31) * float1;
		float float31 = (float8 * this.m30 - float12 * this.m30 + float13 * this.m31 - float4 * this.m31 + float5 * this.m32 - float9 * this.m32) * float1;
	...
	public Matrix4x3f invertUnitScale(Matrix4x3f matrix4x3f) {
		matrix4x3f.set(this.m00, this.m10, this.m20, this.m01, this.m11, this.m21, this.m02, this.m12, this.m22, -this.m00 * this.m30 - this.m01 * this.m31 - this.m02 * this.m32, -this.m10 * this.m30 - this.m11 * this.m31 - this.m12 * this.m32, -this.m20 * this.m30 - this.m21 * this.m31 - this.m22 * this.m32);
		matrix4x3f.properties = 0;
		return matrix4x3f;
	}
	...
	private Matrix4x3f scaleGeneric(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
		...
		matrix4x3f.properties = (byte)(this.properties & -13);
		return matrix4x3f;
	}
	...
	public Matrix4x3f rotateY(float float1, Matrix4x3f matrix4x3f) {
		if ((this.properties & 4) != 0) {
			...
			if (float1 != 3.1415927F && float1 != -3.1415927F) {
				if (float1 != 1.5707964F && float1 != -4.712389F) {
					if (float1 != -1.5707964F && float1 != 4.712389F) {
						float2 = (float)Math.cos((double)float1);
						float3 = (float)Math.sin((double)float1);
					} else {
						float2 = 0.0F;
						float3 = -1.0F;
					}
			...
			float float4 = -float3;
			float float5 = this.m00 * float2 + this.m20 * float4;
			float float6 = this.m01 * float2 + this.m21 * float4;
			float float7 = this.m02 * float2 + this.m22 * float4;
			matrix4x3f.m20 = this.m00 * float3 + this.m20 * float2;
			matrix4x3f.m21 = this.m01 * float3 + this.m21 * float2;
			matrix4x3f.m22 = this.m02 * float3 + this.m22 * float2;
	...
	public Matrix4x3f rotateXYZ(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
		if ((this.properties & 4) != 0) {
			...
			matrix4x3f.m20 = this.m00 * float7 + float16 * float6;
			matrix4x3f.m21 = this.m01 * float7 + float17 * float6;
			matrix4x3f.m22 = this.m02 * float7 + float18 * float6;
			matrix4x3f.m00 = float19 * float8 + float13 * float9;
			matrix4x3f.m01 = float20 * float8 + float14 * float9;
			matrix4x3f.m02 = float21 * float8 + float15 * float9;
			matrix4x3f.m10 = float19 * float12 + float13 * float8;
			matrix4x3f.m11 = float20 * float12 + float14 * float8;
			matrix4x3f.m12 = float21 * float12 + float15 * float8;
			matrix4x3f.m30 = this.m30;
			matrix4x3f.m31 = this.m31;
			matrix4x3f.m32 = this.m32;
			matrix4x3f.properties = (byte)(this.properties & -13);
	...
	public Matrix4x3f rotateZYX(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
		if ((this.properties & 4) != 0) {
			...
			matrix4x3f.m00 = float13 * float6 + this.m20 * float11;
			matrix4x3f.m01 = float14 * float6 + this.m21 * float11;
			matrix4x3f.m02 = float15 * float6 + this.m22 * float11;
			matrix4x3f.m10 = float16 * float8 + float19 * float9;
			matrix4x3f.m11 = float17 * float8 + float20 * float9;
			matrix4x3f.m12 = float18 * float8 + float21 * float9;
			matrix4x3f.m20 = float16 * float12 + float19 * float8;
			matrix4x3f.m21 = float17 * float12 + float20 * float8;
			matrix4x3f.m22 = float18 * float12 + float21 * float8;
			matrix4x3f.m30 = this.m30;
			matrix4x3f.m31 = this.m31;
			matrix4x3f.m32 = this.m32;
			matrix4x3f.properties = (byte)(this.properties & -13);
	...
	public Matrix4x3f rotateYXZ(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
		if ((this.properties & 4) != 0) {
			...
			matrix4x3f.m20 = this.m10 * float11 + float13 * float6;
			matrix4x3f.m21 = this.m11 * float11 + float14 * float6;
			matrix4x3f.m22 = this.m12 * float11 + float15 * float6;
			matrix4x3f.m00 = float16 * float8 + float19 * float9;
			matrix4x3f.m01 = float17 * float8 + float20 * float9;
			matrix4x3f.m02 = float18 * float8 + float21 * float9;
			matrix4x3f.m10 = float16 * float12 + float19 * float8;
			matrix4x3f.m11 = float17 * float12 + float20 * float8;
			matrix4x3f.m12 = float18 * float12 + float21 * float8;
			matrix4x3f.m30 = this.m30;
			matrix4x3f.m31 = this.m31;
			matrix4x3f.m32 = this.m32;
			matrix4x3f.properties = (byte)(this.properties & -13);
	...
	private Matrix4x3f translateGeneric(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
		...
		matrix4x3f.properties = (byte)(this.properties & -5);
		return matrix4x3f;
	}
	...
	public Matrix4x3f lookAlong(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
		if ((this.properties & 4) != 0) {
			...
			matrix4x3f.m20 = this.m00 * float13 + this.m10 * float17 + this.m20 * float20;
			matrix4x3f.m21 = this.m01 * float13 + this.m11 * float17 + this.m21 * float20;
			matrix4x3f.m22 = this.m02 * float13 + this.m12 * float17 + this.m22 * float20;
	...
	private Matrix4x3f rotateGeneric(Quaternionfc quaternionfc, Matrix4x3f matrix4x3f) {
		...
		float float24 = this.m01 * float14 + this.m11 * float15 + this.m21 * float16;
		float float25 = this.m02 * float14 + this.m12 * float15 + this.m22 * float16;
		matrix4x3f.m20 = this.m00 * float17 + this.m10 * float18 + this.m20 * float19;
		matrix4x3f.m21 = this.m01 * float17 + this.m11 * float18 + this.m21 * float19;
		matrix4x3f.m22 = this.m02 * float17 + this.m12 * float18 + this.m22 * float19;
		matrix4x3f.m00 = float20;
		matrix4x3f.m01 = float21;
		matrix4x3f.m02 = float22;
		matrix4x3f.m10 = float23;
	...
	public Matrix4x3f rotateTranslation(Quaternionfc quaternionfc, Matrix4x3f matrix4x3f) {
		...
		float float18 = float9 + float9 - float10 - float10;
		float float19 = float4 - float3 - float2 + float1;
		matrix4x3f.m20 = float17;
		matrix4x3f.m21 = float18;
		matrix4x3f.m22 = float19;
		matrix4x3f.m00 = float11;
		matrix4x3f.m01 = float12;
		matrix4x3f.m02 = float13;
		matrix4x3f.m10 = float14;
		matrix4x3f.m11 = float15;
		matrix4x3f.m12 = float16;
		matrix4x3f.m30 = this.m30;
		matrix4x3f.m31 = this.m31;
		matrix4x3f.m32 = this.m32;
		matrix4x3f.properties = (byte)(this.properties & -13);
	...
	public Matrix4x3f arcball(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
		...
		float float10 = (float)Math.cos((double)float5);
		float float11 = (float)Math.sin((double)float5);
		float float12 = this.m10 * float10 + this.m20 * float11;
		float float13 = this.m11 * float10 + this.m21 * float11;
		float float14 = this.m12 * float10 + this.m22 * float11;
		float float15 = this.m20 * float10 - this.m10 * float11;
		float float16 = this.m21 * float10 - this.m11 * float11;
		float float17 = this.m22 * float10 - this.m12 * float11;
		float10 = (float)Math.cos((double)float6);
		float11 = (float)Math.sin((double)float6);
		float float18 = this.m00 * float10 - float15 * float11;
		float float19 = this.m01 * float10 - float16 * float11;
		float float20 = this.m02 * float10 - float17 * float11;
		float float21 = this.m00 * float11 + float15 * float10;
		float float22 = this.m01 * float11 + float16 * float10;
		float float23 = this.m02 * float11 + float17 * float10;
	...
	public Matrix4x3f lerp(Matrix4x3fc matrix4x3fc, float float1, Matrix4x3f matrix4x3f) {
		matrix4x3f.m00 = this.m00 + (matrix4x3fc.m00() - this.m00) * float1;
		matrix4x3f.m01 = this.m01 + (matrix4x3fc.m01() - this.m01) * float1;
		matrix4x3f.m02 = this.m02 + (matrix4x3fc.m02() - this.m02) * float1;
		matrix4x3f.m10 = this.m10 + (matrix4x3fc.m10() - this.m10) * float1;
		matrix4x3f.m11 = this.m11 + (matrix4x3fc.m11() - this.m11) * float1;
		matrix4x3f.m12 = this.m12 + (matrix4x3fc.m12() - this.m12) * float1;
		matrix4x3f.m20 = this.m20 + (matrix4x3fc.m20() - this.m20) * float1;
		matrix4x3f.m21 = this.m21 + (matrix4x3fc.m21() - this.m21) * float1;
		matrix4x3f.m22 = this.m22 + (matrix4x3fc.m22() - this.m22) * float1;
		matrix4x3f.m30 = this.m30 + (matrix4x3fc.m30() - this.m30) * float1;
		matrix4x3f.m31 = this.m31 + (matrix4x3fc.m31() - this.m31) * float1;
		matrix4x3f.m32 = this.m32 + (matrix4x3fc.m32() - this.m32) * float1;
		return matrix4x3f;
	}
	...
	private final class Proxy implements Matrix4x3fc {
		...
		Proxy(Matrix4x3fc matrix4x3fc) {
			this.delegate = matrix4x3fc;
		}
		...
		public Matrix4x3f mul(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.mul(matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f mulTranslation(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.mulTranslation(matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f mulOrtho(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.mulOrtho(matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f fma(Matrix4x3fc matrix4x3fc, float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.fma(matrix4x3fc, float1, matrix4x3f);
		}

		public Matrix4x3f add(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.add(matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f sub(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.sub(matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f mulComponentWise(Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.mulComponentWise(matrix4x3fc, matrix4x3f);
		}
		...
		public Matrix4x3f invert(Matrix4x3f matrix4x3f) {
			return this.delegate.invert(matrix4x3f);
		}

		public Matrix4x3f invertOrtho(Matrix4x3f matrix4x3f) {
			return this.delegate.invertOrtho(matrix4x3f);
		}

		public Matrix4x3f invertUnitScale(Matrix4x3f matrix4x3f) {
			return this.delegate.invertUnitScale(matrix4x3f);
		}

		public Matrix4x3f transpose3x3(Matrix4x3f matrix4x3f) {
			return this.delegate.transpose3x3(matrix4x3f);
		}
		...
		public FloatBuffer get4x4(FloatBuffer floatBuffer) {
			return this.delegate.get4x4(floatBuffer);
		}

		public FloatBuffer get4x4(int int1, FloatBuffer floatBuffer) {
			return this.delegate.get4x4(int1, floatBuffer);
		}
		...
		public float[] getTransposed(float[] floatArray, int int1) {
			return this.delegate.getTransposed(floatArray, int1);
		}

		public float[] getTransposed(float[] floatArray) {
			return this.delegate.getTransposed(floatArray);
		}
		...
		public Matrix4x3f scale(Vector3fc vector3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.scale(vector3fc, matrix4x3f);
		}

		public Matrix4x3f scale(float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.scale(float1, matrix4x3f);
		}

		public Matrix4x3f scale(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.scale(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f scaleLocal(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.scaleLocal(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f rotateX(float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateX(float1, matrix4x3f);
		}

		public Matrix4x3f rotateY(float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateY(float1, matrix4x3f);
		}

		public Matrix4x3f rotateZ(float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateZ(float1, matrix4x3f);
		}

		public Matrix4x3f rotateXYZ(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateXYZ(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f rotateZYX(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateZYX(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f rotateYXZ(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateYXZ(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f rotate(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.rotate(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f rotateTranslation(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateTranslation(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f rotateLocal(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateLocal(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f translate(Vector3fc vector3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.translate(vector3fc, matrix4x3f);
		}

		public Matrix4x3f translate(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.translate(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f translateLocal(Vector3fc vector3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.translateLocal(vector3fc, matrix4x3f);
		}

		public Matrix4x3f translateLocal(float float1, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.translateLocal(float1, float2, float3, matrix4x3f);
		}

		public Matrix4x3f ortho(float float1, float float2, float float3, float float4, float float5, float float6, boolean boolean1, Matrix4x3f matrix4x3f) {
			return this.delegate.ortho(float1, float2, float3, float4, float5, float6, boolean1, matrix4x3f);
		}

		public Matrix4x3f ortho(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.ortho(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}

		public Matrix4x3f orthoLH(float float1, float float2, float float3, float float4, float float5, float float6, boolean boolean1, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoLH(float1, float2, float3, float4, float5, float6, boolean1, matrix4x3f);
		}

		public Matrix4x3f orthoLH(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoLH(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}

		public Matrix4x3f orthoSymmetric(float float1, float float2, float float3, float float4, boolean boolean1, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoSymmetric(float1, float2, float3, float4, boolean1, matrix4x3f);
		}

		public Matrix4x3f orthoSymmetric(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoSymmetric(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f orthoSymmetricLH(float float1, float float2, float float3, float float4, boolean boolean1, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoSymmetricLH(float1, float2, float3, float4, boolean1, matrix4x3f);
		}

		public Matrix4x3f orthoSymmetricLH(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.orthoSymmetricLH(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f ortho2D(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.ortho2D(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f ortho2DLH(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.ortho2DLH(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f lookAlong(Vector3fc vector3fc, Vector3fc vector3fc2, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAlong(vector3fc, vector3fc2, matrix4x3f);
		}

		public Matrix4x3f lookAlong(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAlong(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}

		public Matrix4x3f lookAt(Vector3fc vector3fc, Vector3fc vector3fc2, Vector3fc vector3fc3, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAt(vector3fc, vector3fc2, vector3fc3, matrix4x3f);
		}

		public Matrix4x3f lookAt(float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8, float float9, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAt(float1, float2, float3, float4, float5, float6, float7, float8, float9, matrix4x3f);
		}

		public Matrix4x3f lookAtLH(Vector3fc vector3fc, Vector3fc vector3fc2, Vector3fc vector3fc3, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAtLH(vector3fc, vector3fc2, vector3fc3, matrix4x3f);
		}

		public Matrix4x3f lookAtLH(float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8, float float9, Matrix4x3f matrix4x3f) {
			return this.delegate.lookAtLH(float1, float2, float3, float4, float5, float6, float7, float8, float9, matrix4x3f);
		}

		public Matrix4x3f rotate(Quaternionfc quaternionfc, Matrix4x3f matrix4x3f) {
			return this.delegate.rotate(quaternionfc, matrix4x3f);
		}

		public Matrix4x3f rotateTranslation(Quaternionfc quaternionfc, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateTranslation(quaternionfc, matrix4x3f);
		}

		public Matrix4x3f rotateLocal(Quaternionfc quaternionfc, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateLocal(quaternionfc, matrix4x3f);
		}

		public Matrix4x3f rotate(AxisAngle4f axisAngle4f, Matrix4x3f matrix4x3f) {
			return this.delegate.rotate(axisAngle4f, matrix4x3f);
		}

		public Matrix4x3f rotate(float float1, Vector3fc vector3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.rotate(float1, vector3fc, matrix4x3f);
		}

		public Matrix4x3f reflect(float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.reflect(float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f reflect(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.reflect(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}

		public Matrix4x3f reflect(Quaternionfc quaternionfc, Vector3fc vector3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.reflect(quaternionfc, vector3fc, matrix4x3f);
		}

		public Matrix4x3f reflect(Vector3fc vector3fc, Vector3fc vector3fc2, Matrix4x3f matrix4x3f) {
			return this.delegate.reflect(vector3fc, vector3fc2, matrix4x3f);
		}
		...
		public Matrix4x3f normal(Matrix4x3f matrix4x3f) {
			return this.delegate.normal(matrix4x3f);
		}
		...
		public Matrix4x3f normalize3x3(Matrix4x3f matrix4x3f) {
			return this.delegate.normalize3x3(matrix4x3f);
		}
		...
		public Matrix4x3f shadow(Vector4fc vector4fc, float float1, float float2, float float3, float float4, Matrix4x3f matrix4x3f) {
			return this.delegate.shadow(vector4fc, float1, float2, float3, float4, matrix4x3f);
		}

		public Matrix4x3f shadow(float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8, Matrix4x3f matrix4x3f) {
			return this.delegate.shadow(float1, float2, float3, float4, float5, float6, float7, float8, matrix4x3f);
		}

		public Matrix4x3f shadow(Vector4fc vector4fc, Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.shadow(vector4fc, matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f shadow(float float1, float float2, float float3, float float4, Matrix4x3fc matrix4x3fc, Matrix4x3f matrix4x3f) {
			return this.delegate.shadow(float1, float2, float3, float4, matrix4x3fc, matrix4x3f);
		}

		public Matrix4x3f pick(float float1, float float2, float float3, float float4, int[] intArray, Matrix4x3f matrix4x3f) {
			return this.delegate.pick(float1, float2, float3, float4, intArray, matrix4x3f);
		}

		public Matrix4x3f arcball(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.arcball(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}

		public Matrix4x3f arcball(float float1, Vector3fc vector3fc, float float2, float float3, Matrix4x3f matrix4x3f) {
			return this.delegate.arcball(float1, vector3fc, float2, float3, matrix4x3f);
		}
		...
		public Matrix4x3f lerp(Matrix4x3fc matrix4x3fc, float float1, Matrix4x3f matrix4x3f) {
			return this.delegate.lerp(matrix4x3fc, float1, matrix4x3f);
		}

		public Matrix4x3f rotateTowards(Vector3fc vector3fc, Vector3fc vector3fc2, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateTowards(vector3fc, vector3fc2, matrix4x3f);
		}

		public Matrix4x3f rotateTowards(float float1, float float2, float float3, float float4, float float5, float float6, Matrix4x3f matrix4x3f) {
			return this.delegate.rotateTowards(float1, float2, float3, float4, float5, float6, matrix4x3f);
		}
