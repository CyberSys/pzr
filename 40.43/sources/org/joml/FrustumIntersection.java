...
public class FrustumIntersection {
	...
	public FrustumIntersection set(Matrix4fc matrix4fc) {
		...
		float float1 = (float)(1.0 / Math.sqrt((double)(this.nxX * this.nxX + this.nxY * this.nxY + this.nxZ * this.nxZ)));
		this.nxX *= float1;
		this.nxY *= float1;
		this.nxZ *= float1;
		this.nxW *= float1;
		...
		float1 = (float)(1.0 / Math.sqrt((double)(this.pxX * this.pxX + this.pxY * this.pxY + this.pxZ * this.pxZ)));
		this.pxX *= float1;
		this.pxY *= float1;
		this.pxZ *= float1;
		this.pxW *= float1;
		...
		float1 = (float)(1.0 / Math.sqrt((double)(this.nyX * this.nyX + this.nyY * this.nyY + this.nyZ * this.nyZ)));
		this.nyX *= float1;
		this.nyY *= float1;
		this.nyZ *= float1;
		this.nyW *= float1;
		...
		float1 = (float)(1.0 / Math.sqrt((double)(this.pyX * this.pyX + this.pyY * this.pyY + this.pyZ * this.pyZ)));
		this.pyX *= float1;
		this.pyY *= float1;
		this.pyZ *= float1;
		this.pyW *= float1;
		...
		float1 = (float)(1.0 / Math.sqrt((double)(this.nzX * this.nzX + this.nzY * this.nzY + this.nzZ * this.nzZ)));
		this.nzX *= float1;
		this.nzY *= float1;
		this.nzZ *= float1;
		this.nzW *= float1;
		...
		float1 = (float)(1.0 / Math.sqrt((double)(this.pzX * this.pzX + this.pzY * this.pzY + this.pzZ * this.pzZ)));
		this.pzX *= float1;
		this.pzY *= float1;
		this.pzZ *= float1;
		this.pzW *= float1;
