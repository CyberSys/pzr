...
function Page1:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title1"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page2:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title2"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page3:create()
	local labelHgt = getTextManager():getFontFromEnum(UIFont.Cred2):getLineHeight()
	local buttonHgt = math.max(25, FONT_HGT_SMALL + 3 * 2)
...
function Page3:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title3", self.settings:getName()), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page5:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title5", self.settings:getName()), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page4:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title4", self.settings:getName()), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page6:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title6", self.settings:getName()), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page7:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_ServerSettings_Title7", self.region.file), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
