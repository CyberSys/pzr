...
function Page1:render()
	...
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title1"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page2:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title2"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page3:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title3"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page4:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title4"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page5:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title5"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page6:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(self.title, self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page7:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title7"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page8:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title8"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page9:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title9"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
...
function Page10:render()
	ISPanelJoypad.render(self)
	self:drawTextCentre(getText("UI_WorkshopSubmit_Title10"), self.width / 2, 10, 1, 1, 1, 1, UIFont.Cred2)
