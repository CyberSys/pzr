...
function ISTutorialPanel:createChildren()
	...
	local previousButton = ISButton:new(3, (panel2.height / 2), 20, 20, "", self, ISTutorialPanel.previousPage);
	...
	local nextButton = ISButton:new(24, (panel2.height / 2), 20, 20, "", self, ISTutorialPanel.nextPage);
	...
	local closeButton = ISButton:new(self.width - 23, (panel2.height / 2), 20, 20, "", self, ISTutorialPanel.closePage);
    ...
    local moreInfo = ISButton:new(closeButton:getX() - buttonWid - 1, (panel2.height / 2), buttonWid, 20, getText("IGUI_Tutorial_MoreInfo"), self, ISTutorialPanel.moreInfo);

    moreInfo:initialise();
    panel2:addChild(moreInfo);
    self.more = moreInfo;

    local tickBox = ISTickBox:new(3, (panel2.height / 2) - 20, 20, 20, "", self, ISTutorialPanel.tickBox)
    tickBox:initialise();
