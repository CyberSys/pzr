...
function ISMicrowaveUI:initialise()
    ...
    self.close = ISButton:new(self:getWidth() - btnWid - 10, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_Cancel"), self, ISMicrowaveUI.onClick);
    ...
    self.ok = ISButton:new(10, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("ContextMenu_Turn_On"), self, ISMicrowaveUI.onClick);
    self.ok.internal = "OK";
