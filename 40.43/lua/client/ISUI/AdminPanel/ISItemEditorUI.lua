...
function ISItemEditorUI:create()
    ...
    self.name = ISTextEntryBox:new(self.item:getName(), 10, y, 150, 18);
    self.name:initialise();
    self.name:instantiate();
    self:addChild(self.name);

    self.weight = ISTextEntryBox:new(luautils.round(self.item:getActualWeight(),3) .. "", 10, y, numberWidth, 18);
    ...
    self.condition = ISTextEntryBox:new(self.item:getCondition() .. "", 10, y, numberWidth, 18);
    ...
    --************** WEAPON **************--
    if self.isWeapon then
        self.minDmg = ISTextEntryBox:new(luautils.round(self.item:getMinDamage(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.maxDmg = ISTextEntryBox:new(luautils.round(self.item:getMaxDamage(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.minAngle = ISTextEntryBox:new(luautils.round(self.item:getMinAngle(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.minRange = ISTextEntryBox:new(minRangeNbr .. "", 10, y, numberWidth, 18);
        ...
        self.maxRange = ISTextEntryBox:new(luautils.round(self.item:getMaxRange(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.aimingTime = ISTextEntryBox:new(luautils.round(self.item:getAimingTime(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.recoilDelay = ISTextEntryBox:new(luautils.round(self.item:getRecoilDelay(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.reloadTime = ISTextEntryBox:new(luautils.round(self.item:getReloadTime(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.clipSize = ISTextEntryBox:new(self.item:getClipSize() .. "", 10, y, numberWidth, 18);
    ...
    --************** FOOD **************--
    if self.isFood then
        self.age = ISTextEntryBox:new(luautils.round(self.item:getAge(),3) .. "", 10, y, numberWidth, 18);
        self.age:initialise();
        ...
        self.hunger = ISTextEntryBox:new(luautils.round(self.item:getBaseHunger(),3) .. "", 10, y, numberWidth, 18);
        ...
        self.unhappy = ISTextEntryBox:new(self.item:getUnhappyChange() .. "", 10, y, numberWidth, 18);
        ...
        self.boredom = ISTextEntryBox:new(self.item:getBoredomChange() .. "", 10, y, numberWidth, 18);
        ...
        self.poisonPower = ISTextEntryBox:new(self.item:getPoisonPower() .. "", 10, y, numberWidth, 18);
        ...
        self.offAge = ISTextEntryBox:new(self.item:getOffAge() .. "", 10, y, numberWidth, 18);
        ...
        self.offAgeMax = ISTextEntryBox:new(self.item:getOffAgeMax() .. "", 10, y, numberWidth, 18);
        ...
        self.calories = ISTextEntryBox:new(self.item:getCalories() .. "", 10, y, numberWidth, 18);
        ...
        self.proteins = ISTextEntryBox:new(self.item:getProteins() .. "", 10, y, numberWidth, 18);
        ...
        self.lipids = ISTextEntryBox:new(self.item:getLipids() .. "", 10, y, numberWidth, 18);
        ...
        self.carbs = ISTextEntryBox:new(self.item:getCarbohydrates() .. "", 10, y, numberWidth, 18);
    ...
    if self.isDrainable then
        self.usedDelta = ISTextEntryBox:new(luautils.round(self.item:getUsedDelta(),3) .. "", 10, y, numberWidth, 18);
