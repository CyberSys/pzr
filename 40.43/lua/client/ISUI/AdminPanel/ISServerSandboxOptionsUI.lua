...
function ISServerSandboxOptionsUI:createPanel(page)
	if page.customui then
		...
		panel:initialise()
		panel:instantiate()
		panel.backgroundColor.a = UIManager.isFBOActive() and 0.8 or panel.backgroundColor.a
	...
	panel:initialise()
	panel:instantiate()
	panel.backgroundColor.a = UIManager.isFBOActive() and bgAlpha or panel.backgroundColor.a
--	if page.groupBox then panel.contents.backgroundColor.a = UIManager.isFBOActive() and bgAlpha or panel.contents.backgroundColor.a end
	panel:setAnchorRight(true)
	panel:setAnchorBottom(true)
	panel.settingNames = {}
	panel.controls = {}
	...
	for _,setting in ipairs(page.settings) do
		...
		elseif setting.type == "entry" or setting.type == "string" then
			...
			control:initialise()
			control:instantiate()
			control.backgroundColor.a = UIManager.isFBOActive() and 1.0 or control.backgroundColor.a
