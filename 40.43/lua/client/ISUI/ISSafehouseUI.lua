...
function ISSafehouseUI:initialise()
    ...
    local playersLbl = ISLabel:new(10, ownerLbl:getBottom() + 20, FONT_HGT_SMALL, getText("IGUI_SafehouseUI_Players"), 1, 1, 1, 1, UIFont.Small, true)
    ...
    self.no:setY(self.addPlayer:getBottom() + 20)
    self.releaseSafehouse:setY(self.addPlayer:getBottom() + 20)
