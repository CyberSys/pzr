...
function ISMoveableDefinitions.load()
    ...
    moveableDefinitions.addToolDefinition( "Hammer",        {"Hammer","HammerStone"},                                   Perks.Woodwork,         75,     "Hammering",    true  );
    moveableDefinitions.addToolDefinition( "Crowbar",       {"Crowbar"},                                                Perks.Woodwork,         150,    "Hammering",    true  );
    moveableDefinitions.addToolDefinition( "Electrician",   {"Screwdriver"},                                            Perks.Electricity,      100,    "Hammering",    true  );
    ...
    moveableDefinitions.addToolDefinition( "Shovel",        {"farming.Shovel","farming.HandShovel"},                    Perks.Farming,          100,    "bushes",       false );
    moveableDefinitions.addToolDefinition( "Wrench",        {"Base.Spanner"},                                           nil,                    100,    "Hammering",    true  );
    -- MATERIALS (BREAKAGE):
    ...
    -- Fabric
    moveableDefinitions.addMaterialDefinition( "Fabric",  "Base.Thread",  1,  10 );
    ...
    moveableDefinitions.addMaterialDefinition( "Leather",  "Base.RippedSheets",  3,  10 );
    -- Natural
    ...
    moveableDefinitions.addScrapDefinition( "AluminumScrap",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- not yet applied to anything

    moveableDefinitions.addScrapDefinition( "Brick",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to some brick objects

    moveableDefinitions.addScrapDefinition( "Door",  {"Base.Hammer","Base.HammerStone"}, {"Base.Screwdriver"},   Perks.Woodwork,  1000,     "Hammering",    true , 10);
    ...
    moveableDefinitions.addScrapDefinition( "Electric",  {"Base.Screwdriver"}, {},   Perks.Electricity,  1000,     "Hammering",    true, 10 );
    ...
    moveableDefinitions.addScrapDefinition( "Fabric",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to objects with a good amount of cloth, as couches and such

    moveableDefinitions.addScrapDefinition( "Foam",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to many seatings that have foam

    moveableDefinitions.addScrapDefinition( "Glass",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to many objects having glass (usually as second/third material

    moveableDefinitions.addScrapDefinition( "Leather",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to objects with fair amount of leather

    moveableDefinitions.addScrapDefinition( "Mechanical",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to mechanical objects not nescessaraly electric, think of bolts, cogs etc

    moveableDefinitions.addScrapDefinition( "MetalBars",  {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 0 );
    moveableDefinitions.addScrapItem( "MetalBars",  "Base.MetalBar",   1, 70, true );
    -- applied to objects with metal bars

    moveableDefinitions.addScrapDefinition( "MetalPipe", {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 4 );
    moveableDefinitions.addScrapItem( "MetalPipe",  "Base.MetalPipe",  2,  80 );

    moveableDefinitions.addScrapDefinition( "Fridge",  {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 0, "Base.UnusableMetal" );
    ...
    moveableDefinitions.addScrapDefinition( "MetalPlates",  {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 0, "Base.UnusableMetal" );
    ...
    moveableDefinitions.addScrapDefinition( "SmallMetalPlates",  {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 2, "Base.UnusableMetal" );
    ...
    moveableDefinitions.addScrapDefinition( "MetalScrap",  {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 5);
    moveableDefinitions.addScrapItem( "MetalScrap",  "Base.ScrapMetal",   1, 70, true );
    -- applied to many objects that have metal in them

    moveableDefinitions.addScrapDefinition( "Mirror",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- objects with a mirror (usually second/third material

    moveableDefinitions.addScrapDefinition( "Nails",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  700,     "Hammering",    true, 5 );
    moveableDefinitions.addScrapItem( "Nails",  "Base.Nails",   4, 80, true );
    -- added to objects having nails

    moveableDefinitions.addScrapDefinition( "Natural",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- not yet applied on anything

    moveableDefinitions.addScrapDefinition( "Paper",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to some cardboard objects

    moveableDefinitions.addScrapDefinition( "Pipes",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- anything that has piping in it

    moveableDefinitions.addScrapDefinition( "Plastic",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- plastic rubble

    moveableDefinitions.addScrapDefinition( "PlasticBag",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- applied to most recycle bins

    moveableDefinitions.addScrapDefinition( "PlasticHard",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- objects having pieces of hard plastic


    moveableDefinitions.addScrapDefinition( "Plumbing", {"Base.BlowTorch"}, {"Base.WeldingMask"},   Perks.MetalWelding,  1000,     "Hammering",    true, 1 );
    moveableDefinitions.addScrapItem( "Plumbing",  "Base.MetalPipe",  2,  80 );
    -- generic plumbing stuff (maybe some pipes, bolts etc)

    moveableDefinitions.addScrapDefinition( "Rubber",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- objects having rubber

    moveableDefinitions.addScrapDefinition( "Screws",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    moveableDefinitions.addScrapItem( "Screws",  "Base.Screws",  2,  50 );
    -- objects having screws

    moveableDefinitions.addScrapDefinition( "Sink",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.MetalWelding,  1000,     "Hammering",    true, 1 );
    ...
    moveableDefinitions.addScrapDefinition( "Stone",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Strength,  1000,     "Hammering",    true, 30 );
    ...
    moveableDefinitions.addScrapDefinition( "Transmission",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- not yet applied

    moveableDefinitions.addScrapDefinition( "WaterContainer",  {"Base.Hammer","Base.HammerStone"}, {},   Perks.Woodwork,  75,     "Hammering",    true );
    -- special material, added to the waterbin

    moveableDefinitions.addScrapDefinition( "Wood",  {"Base.Hammer","Base.HammerStone"}, {"Base.Saw"},   Perks.Woodwork,  1000,     "Hammering",    true, 7, "Base.UnusableWood" );
