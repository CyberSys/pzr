...
local function expectGlobalObject(x, y, z, luaSystem)
	if not luaSystem:getClientLuaObjectAt(x, y, z) then error "GlobalObject is null" end
end

local function expectGlobalObjectNull(x, y, z, luaSystem)
	if luaSystem:getClientLuaObjectAt(x, y, z) then error "GlobalObject is not null" end
end
...
function MapObjectTestCampfire()
	...
	expectGlobalObjectNull(x, y, z, CampfireSystem.instance)
	...
	expectGlobalObject(x, y, z, CampfireSystem.instance)
...
function MapObjectTestFarming()
	...
	-- Plow
	removeAllButFloor(x, y, z)
	expectGlobalObjectNull(x, y, z, FarmingSystem.instance)
	...
	expectGlobalObject(x, y, z, FarmingSystem.instance)
...
function MapObjectTestRainBarrel()
	...
	-- NewLargeEmpty
	removeAllButFloor(x, y, z)
	expectGlobalObjectNull(x, y, z, RainBarrelSystem.instance)
--	RainBarrelSystem.instance:removeLuaObjectAt(x, y, z)
	...
	expectGlobalObject(x, y, z, RainBarrelSystem.instance)
	...
	local luaObject = RainBarrelSystem.instance:getLuaObjectAt(x, y, z)
