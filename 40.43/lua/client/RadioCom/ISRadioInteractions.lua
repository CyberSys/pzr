...
local function doSkill(_player, _amount, _name, _perk)
    ...
    _player:setHaloNote(_name.."+"..tostring(amount));
end
...
--blade
Interactions.BAA = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Accuracy").." "..getText("IGUI_perks_Blade"), Perks.BladeParent); end       --accuracy
Interactions.BAG = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Guard").." "..getText("IGUI_perks_Blade"), Perks.BladeGuard); end        --guard
Interactions.BAM = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Maintenance").." "..getText("IGUI_perks_Blade"), Perks.BladeMaintenance); end  --maintenance
--blunt
Interactions.BUA = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Accuracy").." "..getText("IGUI_perks_Blunt"), Perks.BluntParent); end       --accuracy
Interactions.BUG = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Guard").." "..getText("IGUI_perks_Blunt"), Perks.BluntGuard); end        --guard
Interactions.BUM = function(_player, _amount) doSkill(_player, _amount, getText("IGUI_perks_Maintenance").." "..getText("IGUI_perks_Blunt"), Perks.BluntMaintenance); end  --maintenance
--crafting
...
function ISRadioInteractions:getInstance()
    ...
    function self.checkPlayer(player, _interactCodes, _x, _y, _z, _line)
                    ...
                    if amount ~= nil then
                        ...
                        if Interactions[code] ~= nil then
                            if not cooldowns[playerNum] or not cooldowns[playerNum][code] or cooldowns[playerNum][code]<=0 then
                                ...
                                cooldowns[playerNum][code] = 30; -- FIXME: ignores FPS
                            end
                        end
                    end
                end
