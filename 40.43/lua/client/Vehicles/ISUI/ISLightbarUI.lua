...
function ISLightbarUI:prerender()
	self.backgroundColor.a = UIManager.isFBOActive() and 0.75 or 0.7
	...
	self:drawTextCentre(getText("IGUI_VehicleLightbar_WALL"), 50+50/2, 160+50+5, 1, 1, 1, 1, UIFont.Small)
	if siren == 3 then
