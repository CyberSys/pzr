...
public class VehiclePart implements ChatElementOwner, WaveSignalDevice {
   ...
   public void setRandomCondition(InventoryItem var1) {
      ...
      if (this.getVehicle().isGoodCar()) {
         ...
         if (var2 != null) {
            var3 = (int)((float)var3 * var2.getBaseVehicleQuality());
         }
         ...
         if (var1 != null) {
            ...
            if (var5 > 0 && Rand.Next(100) < var5) {
               var4 = (float)Rand.Next(var3 - var3 / 3, var3);
            }
         } else {
            var5 = 30;
            if (var2 != null) {
         ...
         case 1:
            var4 -= Rand.Next(var4 * 0.1F, var4 * 0.35F);
            break;
         case 2:
            var4 -= Rand.Next(var4 * 0.05F, var4 * 0.15F);
         case 3:
         default:
            break;
         case 4:
   ...
   public void save(ByteBuffer var1) throws IOException {
      ...
      if (this.getItemContainer() == null) {
         ...
         var1.put((byte)1);
         this.getItemContainer().save(var1, false);
      }
   ...
   public void AddDeviceText(String var1, float var2, float var3, float var4, String var5, int var6) {
      if (this.deviceData != null && this.deviceData.getIsTurnedOn()) {
         ...
         if (this.deviceData.getDeviceVolume() > 0.0F) {
            ...
            if (var5 != null) {
               LuaEventManager.triggerEvent("OnDeviceText", var5, this.getX(), this.getY(), this.getZ());
            }
         }
      }
   ...
   public void repair() {
      float var1 = this.getContainerContentAmount();
      if (this.getItemType() != null && !this.getItemType().isEmpty() && this.getInventoryItem() == null) {
         String var2 = (String)this.getItemType().get(Rand.Next(this.getItemType().size()));
         if (var2 != null && !var2.isEmpty()) {
            InventoryItem var3 = InventoryItemFactory.CreateItem(var2);
            if (var3 != null) {
               this.setInventoryItem(var3);
               if (var3.getMaxCapacity() > 0) {
                  var3.setItemCapacity((float)var3.getMaxCapacity());
               }

               this.vehicle.transmitPartItem(this);
               int var4 = this.getWheelIndex();
               if (var4 != -1) {
                  this.vehicle.setTireRemoved(var4, false);
      ...
      if (this.isContainer() && this.getItemContainer() == null && var1 != (float)this.getContainerCapacity()) {
