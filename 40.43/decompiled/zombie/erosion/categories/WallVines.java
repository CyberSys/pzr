...
public class WallVines extends ErosionCategory {
   ...
   public boolean replaceExistingObject(IsoGridSquare var1, ErosionData.Square var2, ErosionData.Chunk var3, boolean var4, boolean var5) {
      ...
      for(int var7 = var6 - 1; var7 >= 1; --var7) {
         ...
         if (var8.AttachedAnimSpriteActual != null) {
            for(int var9 = 0; var9 < var8.AttachedAnimSpriteActual.size(); ++var9) {
               IsoSprite var10 = (IsoSprite)var8.AttachedAnimSpriteActual.get(var9);
               if (var10 != null && var10.getName() != null && var10.getName().startsWith("f_wallvines_1_") && this.spriteToObj.containsKey(var10.getName())) {
                  ...
                  var11.maxStage = 2;
                  var11.spawnTime = 0;
                  var8.AttachedAnimSpriteActual.remove(var9);
