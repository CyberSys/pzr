   ...
   public boolean replaceExistingObject(IsoGridSquare var1, ErosionData.Square var2, ErosionData.Chunk var3, boolean var4, boolean var5) {
      ...
      for(int var7 = var6 - 1; var7 >= 1; --var7) {
         ...
         if (var9 != null && var9.getName() != null) {
            int var10;
            if (var9.getName().startsWith("vegetation_foliage")) {
               var10 = var2.soil;
               if (var10 < 0 || var10 >= this.soilRef.length) {
                  var10 = var2.rand(var1.x, var1.y, this.soilRef.length);
               }

               int[] var14 = this.soilRef[var10];
               int var12 = var2.noiseMainInt;
               NatureBush.CategoryData var13 = (NatureBush.CategoryData)this.setCatModData(var2);
               var13.gameObj = var14[var2.rand(var1.x, var1.y, var14.length)] - 1;
               var13.maxStage = (int)Math.floor((double)((float)var12 / 60.0F));
            ...
            if (var9.getName().startsWith("f_bushes_1_")) {
               var10 = Integer.parseInt(var9.getName().replace("f_bushes_1_", ""));
               NatureBush.CategoryData var11 = (NatureBush.CategoryData)this.setCatModData(var2);
               var11.gameObj = var10 % 16;
               var11.maxStage = 1;
