...
public class Flowerbed extends ErosionCategory {
   ...
   public boolean replaceExistingObject(IsoGridSquare var1, ErosionData.Square var2, ErosionData.Chunk var3, boolean var4, boolean var5) {
      ...
      for(int var7 = var6 - 1; var7 >= 0; --var7) {
         ...
         if (var8 != null && var8.getName() != null && var8.getName().startsWith("vegetation_ornamental_01")) {
            int var9 = Integer.parseInt(var8.getName().replace("vegetation_ornamental_01_", ""));
