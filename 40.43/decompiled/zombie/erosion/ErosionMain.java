...
public class ErosionMain {
   ...
   private void initGridSquare(IsoGridSquare var1, ErosionData.Square var2) {
      int var3 = var1.getX();
      int var4 = var1.getY();
      var2.noiseMain = this.noiseMain.layeredNoise((float)var3 / 10.0F, (float)var4 / 10.0F);
      ...
      var2.magicNum = (float)var2.rand(var3, var4, 100) / 100.0F;
      var2.regions.clear();
      var2.init = true;
   }
   ...
   private boolean initConfig() {
      ...
      if (GameClient.bClient) {
         ...
         this.cfgPath = GameWindow.getGameModeCacheDir() + File.separator + Core.GameSaveWorld + File.separator + var1;
         return true;
      } else {
         ...
         var2 = new File(GameWindow.getCacheDir() + File.separator + var1);
         if (!var2.exists() && !Core.getInstance().isNoSave()) {
            File var3 = new File("media" + File.separator + "data" + File.separator + var1);
            if (var3.exists()) {
               try {
         ...
         ErosionConfig.Time var10000;
         switch(var8) {
         case 1:
            var10000 = this.cfg.time;
            var10000.tickunit /= 5;
            break;
         case 2:
            var10000 = this.cfg.time;
