...
public class ErosionObj {
   private ErosionObjSprites sprites;
   public String name;
   public int stages;
   ...
   public IsoObject createObject(IsoGridSquare var1, int var2, boolean var3, int var4) {
      ...
      if (var3) {
         if (CellLoader.isoTreeCache.isEmpty()) {
            var5 = new IsoTree(var1, var6);
         } else {
            var5 = (IsoObject)CellLoader.isoTreeCache.pop();
            ((IsoObject)var5).sprite = (IsoSprite)var1.getCell().SpriteManager.NamedMap.get(var6);
   ...
   public boolean setStageObject(int var1, IsoObject var2, int var3, boolean var4) {
      ...
      if (var1 >= 0 && var1 < this.stages && var2 != null) {
         ...
         if (var6 == null) {
            ...
            if (var2.AttachedAnimSpriteActual != null) {
               var2.AttachedAnimSpriteActual.clear();
            }
            ...
            if (this.hasChildSprite || this.hasFlower) {
               ...
               if (var2.AttachedAnimSpriteActual == null) {
                  var2.AttachedAnimSpriteActual = new ArrayList();
               }
               ...
               if (this.hasChildSprite && var3 != 0) {
                  ...
                  if (var6 != null) {
                     ...
                     var2.AttachedAnimSpriteActual.add(var7);
                  }
               }
