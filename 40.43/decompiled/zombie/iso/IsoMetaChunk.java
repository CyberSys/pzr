...
public class IsoMetaChunk {
   ...
   public float getZombieIntensity() {
      ...
      if (Rand.Next(3) == 0) {
         ...
         if (SandboxOptions.instance.Zombies.getValue() == 1) {
            ...
            var5 = (int)((float)var5 / 1.5F);
         } else if (SandboxOptions.instance.Zombies.getValue() == 4) {
            var5 = (int)((float)var5 * 1.5F);
         }

         if ((float)Rand.Next(var5) < var4 && SandboxOptions.instance.Zombies.getValue() != 5) {
            var1 = 120.0F;
            if (var1 > 12.0F) {
               var1 = 12.0F;
            }
   ...
   public float getLootZombieIntensity() {
      ...
      return SandboxOptions.instance.Zombies.getValue() == 5 ? 400.0F : var1;
   }
   ...
   public IsoMetaGrid.Zone getZoneAt(int var1, int var2, int var3) {
      if (this.zones == null) {
         ...
         for(int var4 = 0; var4 < this.zonesSize; ++var4) {
            IsoMetaGrid.Zone var5 = this.zones[var4];
            if (var5.x <= var1 && var5.y <= var2 && var1 < var5.x + var5.w && var2 < var5.y + var5.h) {
               return var5;
            }
         }
   ...
   public ArrayList getZonesAt(int var1, int var2, int var3, ArrayList var4) {
      for(int var5 = 0; var5 < this.zonesSize; ++var5) {
         ...
         if (var6.x <= var1 && var6.y <= var2 && var1 < var6.x + var6.w && var2 < var6.y + var6.h) {
            var4.add(var6);
         }
      }
