...
public class LosUtil {
   ...
   public static boolean lineClearCollide(int var0, int var1, int var2, int var3, int var4, int var5, boolean var6) {
      ...
      boolean var8;
      if (var3 == 56 && var4 == 20 && var5 == 0) {
         var8 = false;
      }

      if (var0 == 57 && var1 == 23 && var2 == 0) {
         var8 = false;
      }
      ...
      IsoGridSquare var19;
      boolean var20;
      if (Math.abs(var9) > Math.abs(var21) && Math.abs(var9) > Math.abs(var10)) {
         var17 = (float)var21 / (float)var9;
         ...
         int var13;
         if (Math.abs(var21) >= Math.abs(var9) && Math.abs(var21) > Math.abs(var10)) {
            var17 = (float)var9 / (float)var21;
            var18 = (float)var10 / (float)var21;
            var11 += (float)var3;
            var12 += (float)var5;
            var21 = var21 < 0 ? -1 : 1;
            var17 *= (float)var21;

            for(var18 *= (float)var21; var4 != var1; var15 = (int)var12) {
               var4 += var21;
               var11 += var17;
               var12 += var18;
   ...
   public static int lineClearCollideCount(IsoMovingObject var0, IsoCell var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = 0;
      int var10 = var3 - var6;
      int var11 = var2 - var5;
      int var12 = var4 - var7;
      float var13 = 0.5F;
      float var14 = 0.5F;
      IsoGridSquare var18 = var1.getGridSquare(var5, var6, var7);
      int var16;
      int var17;
      float var19;
      float var20;
      ...
      boolean var22;
      if (Math.abs(var11) > Math.abs(var10) && Math.abs(var11) > Math.abs(var12)) {
         var19 = (float)var10 / (float)var11;
         var20 = (float)var12 / (float)var11;
         var13 += (float)var6;
         var14 += (float)var7;
         var11 = var11 < 0 ? -1 : 1;
         var19 *= (float)var11;

         for(var20 *= (float)var11; var5 != var2; var17 = (int)var14) {
            var5 += var11;
            var13 += var19;
            var14 += var20;
            var21 = var1.getGridSquare(var5, (int)var13, (int)var14);
            if (var21 != null && var18 != null) {
               var22 = var18.testCollideAdjacent(var0, var21.getX() - var18.getX(), var21.getY() - var18.getY(), var21.getZ() - var18.getZ());
               if (var22) {
                  return var9;
               }
            }
         ...
         if (Math.abs(var10) >= Math.abs(var11) && Math.abs(var10) > Math.abs(var12)) {
            var19 = (float)var11 / (float)var10;
            var20 = (float)var12 / (float)var10;
            var13 += (float)var5;
            var14 += (float)var7;
            var10 = var10 < 0 ? -1 : 1;
            var19 *= (float)var10;

            for(var20 *= (float)var10; var6 != var3; var17 = (int)var14) {
               var6 += var10;
               var13 += var19;
               var14 += var20;
               var21 = var1.getGridSquare((int)var13, var6, (int)var14);
               if (var21 != null && var18 != null) {
                  var22 = var18.testCollideAdjacent(var0, var21.getX() - var18.getX(), var21.getY() - var18.getY(), var21.getZ() - var18.getZ());
                  if (var22) {
                     return var9;
            ...
            var19 = (float)var11 / (float)var12;
            var20 = (float)var10 / (float)var12;
            var13 += (float)var5;
            var14 += (float)var6;
            var12 = var12 < 0 ? -1 : 1;
            var19 *= (float)var12;

            for(var20 *= (float)var12; var7 != var4; var16 = (int)var14) {
               var7 += var12;
               var13 += var19;
               var14 += var20;
               var21 = var1.getGridSquare((int)var13, (int)var14, var7);
               if (var21 != null && var18 != null) {
                  var22 = var18.testCollideAdjacent(var0, var21.getX() - var18.getX(), var21.getY() - var18.getY(), var21.getZ() - var18.getZ());
                  if (var22) {
                     return var9;
