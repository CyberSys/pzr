...
public class IsoAnim {
   ...
   public void LoadFramesReverseAltName(String var1, String var2, String var3, int var4) {
      this.name = var3;
      StringBuffer var5 = (StringBuffer)tlsStrBuf.get();
      var5.setLength(0);
      var5.append(var1);
      var5.append("_%_");
      var5.append(var2);
   ...
   public void LoadFrames(String var1, String var2, int var3) {
      this.name = var2;
      StringBuffer var4 = (StringBuffer)tlsStrBuf.get();
      var4.setLength(0);
      var4.append(var1);
      var4.append("_%_");
      var4.append(var2);
   ...
   void LoadFramesNoDirPage(String var1, String var2, int var3) {
      ...
      for(int var6 = 0; var6 < var3; ++var6) {
         Integer var7 = new Integer(var6);
         IsoDirectionFrame var8 = new IsoDirectionFrame(TexturePackPage.getTexture(var4 + var5 + var7.toString()));
         this.Frames.add(var8);
      }
   ...
   void LoadFramesNoDirPageDirect(String var1, String var2, int var3) {
      ...
      for(int var6 = 0; var6 < var3; ++var6) {
         Integer var7 = new Integer(var6);
         IsoDirectionFrame var8 = new IsoDirectionFrame(TexturePackPage.getTexture(var4 + var5 + var7.toString() + ".png"));
         this.Frames.add(var8);
      }
   ...
   public void LoadFramesPageSimple(String var1, String var2, String var3, String var4) {
      ...
      for(int var5 = 0; var5 < 1; ++var5) {
         new Integer(var5);
         IsoDirectionFrame var7 = new IsoDirectionFrame(TexturePackPage.getTexture(var1), TexturePackPage.getTexture(var2), TexturePackPage.getTexture(var3), TexturePackPage.getTexture(var4));
         this.Frames.add(var7);
      }
   ...
   void LoadFramesPalette(String var1, String var2, int var3, PaletteManager.PaletteInfo var4) {
      this.name = var2;
      String var5 = "media/characters/" + var1 + "_";
      String var6 = "_" + var2 + "_";

      for(int var7 = 0; var7 < var3; ++var7) {
         Integer var8 = new Integer(var7);
         IsoDirectionFrame var9 = new IsoDirectionFrame(Texture.getSharedTexture(var5 + "8" + var6 + var8.toString() + ".pcx", var4.palette, var4.name), Texture.getSharedTexture(var5 + "9" + var6 + var8.toString() + ".pcx", var4.palette, var4.name), Texture.getSharedTexture(var5 + "6" + var6 + var8.toString() + ".pcx", var4.palette, var4.name), Texture.getSharedTexture(var5 + "3" + var6 + var8.toString() + ".pcx", var4.palette, var4.name), Texture.getSharedTexture(var5 + "2" + var6 + var8.toString() + ".pcx", var4.palette, var4.name));
         this.Frames.add(var9);
      }
   ...
   void LoadFramesPalette(String var1, String var2, int var3, String var4) {
      ...
      for(int var7 = 0; var7 < var3; ++var7) {
         Integer var8 = new Integer(var7);
         IsoDirectionFrame var9 = new IsoDirectionFrame(TexturePackPage.getTexture(var5 + "8" + var6 + var8.toString() + "_" + var4), TexturePackPage.getTexture(var5 + "9" + var6 + var8.toString() + "_" + var4), TexturePackPage.getTexture(var5 + "6" + var6 + var8.toString() + "_" + var4), TexturePackPage.getTexture(var5 + "3" + var6 + var8.toString() + "_" + var4), TexturePackPage.getTexture(var5 + "2" + var6 + var8.toString() + "_" + var4));
         this.Frames.add(var9);
      }
