...
public class IsoBuilding extends IsoArea {
   ...
   public float getNeedsScore(SurvivorGroup var1) {
      float var2 = 0.0F;

      for(int var3 = 0; var3 < this.container.size(); ++var3) {
         ItemContainer var4 = (ItemContainer)this.container.get(var3);

         for(int var5 = 0; var5 < var1.GroupNeeds.size(); ++var5) {
            Need var6 = (Need)var1.GroupNeeds.get(var5);
            var2 += (float)(var4.getNumItems(var6.item) * 20);
         }
      }
   ...
   public float ScoreBuildingGroupSpecific(SurvivorGroup var1) {
      float var2 = 0.0F;
      var2 += (float)(this.Rooms.size() * 5);
      var2 -= (float)(this.transparentWalls * 20);
      var2 -= (float)(this.Windows.size() * 10);

      int var5;
      for(int var3 = 0; var3 < this.container.size(); ++var3) {
         ItemContainer var4 = (ItemContainer)this.container.get(var3);

         for(var5 = 0; var5 < var1.GroupNeeds.size(); ++var5) {
            Need var6 = (Need)var1.GroupNeeds.get(var5);
            var2 += (float)(var4.getNumItems(var6.item) * 100);
         }

         var2 += (float)(var4.Items.size() * 3);
      }

      BuildingScore var7;
      if (!IsoWorld.instance.CurrentCell.getBuildingScores().containsKey(this.ID)) {
         var7 = new BuildingScore(this);
         var7.building = this;
         IsoWorld.instance.CurrentCell.getBuildingScores().put(this.ID, var7);
         this.ScoreBuildingGeneral(var7);
      }

      var7 = (BuildingScore)IsoWorld.instance.CurrentCell.getBuildingScores().get(this.ID);
      var2 += (var7.defense + var7.food + (float)var7.size + var7.weapons + var7.wood) * 10.0F;
      boolean var8 = true;
      boolean var10 = true;
      if (!this.Exits.isEmpty()) {
         IsoRoomExit var11 = (IsoRoomExit)this.Exits.get(0);
         int var9 = var11.x;
         var5 = var11.y;
      }
   ...
   public void FillContainers() {
      ...
      if (!var1 || !Core.GameMode.equals("KateBaldspot")) {
