...
public class WorldStreamer {
   ...
   public void updateMain() {
      ...
      if (!this.tempRequests.isEmpty()) {
         ...
         PacketTypes.doPacket((short)34, var6);
      ...
      if (!this.tempRequests.isEmpty()) {
         var6 = var1.startPacket();
         PacketTypes.doPacket((short)36, var6);
      ...
      for(int var4 = 0; var4 < this.pendingRequests1.size(); ++var4) {
         ...
         if ((var5.flagsUDP & 16) != 0) {
            ...
            if ((var5.flagsWS & 1) == 0 || (var5.flagsMain & 2) != 0) {
               ...
               ByteBuffer var9 = (var5.flagsWS & 1) != 0 ? null : var5.bb;
               if (var9 != null) {
                  var9 = this.decompress(var9);
                  if (this.bCompare) {
                     File var7 = ChunkMapFilenames.instance.getFilename(var5.chunk.wx, var5.chunk.wy);
                     if (var7.exists()) {
                        this.compare(var5, var9, var7);
                     }
                  }
               }
               ...
               if ((var5.flagsWS & 8) == 0) {
                  if ((var5.flagsWS & 1) == 0 && !var5.chunk.refs.isEmpty()) {
                     ...
                     this.DoChunk(var5.chunk, var9);
                  } else {
                     if (this.NetworkFileDebug) {
                        DebugLog.log(DebugType.NetworkFileDebug, var5.chunk.wx + "_" + var5.chunk.wy + " refs.isEmpty() SafeWrite=" + (var9 != null));
                     }

                     if (var9 != null) {
                        long var10 = ChunkChecksum.getChecksumIfExists(var5.chunk.wx, var5.chunk.wy);
                        this.crc32.reset();
                        this.crc32.update(var9.array(), 0, var9.position());
                        if (var10 != this.crc32.getValue()) {
                           ChunkChecksum.setChecksum(var5.chunk.wx, var5.chunk.wy, this.crc32.getValue());
                           IsoChunk.SafeWrite("map_", var5.chunk.wx, var5.chunk.wy, var9);
                        }
                     }
   ...
   private void threadLoop() throws DataFormatException, InterruptedException, IOException {
      ...
      if (this.jobList.isEmpty()) {
         ...
         for(int var3 = this.jobList.size() - 1; var3 >= 0; --var3) {
   ...
   public void requestLargeAreaZip(int var1, int var2, int var3) throws IOException {
      ...
      PacketTypes.doPacket((short)24, var4);
      var4.putInt(var1);
      var4.putInt(var2);
         ...
         try {
            ...
            if (this.bb1.compareTo(this.bb2) != 0) {
               ...
               if (this.bb1.limit() == this.bb2.limit()) {
                  ...
                  for(var5 = 0; var5 < var1.getErosionData().regions.size(); ++var5) {
                     if (((ErosionCategory.Data)var1.getErosionData().regions.get(var5)).dispSeason != ((ErosionCategory.Data)var2.getErosionData().regions.get(var5)).dispSeason) {
                        DebugLog.log("season1=" + ((ErosionCategory.Data)var1.getErosionData().regions.get(var5)).dispSeason + " season2=" + ((ErosionCategory.Data)var2.getErosionData().regions.get(var5)).dispSeason);
                        var3 = false;
                     }
                  }
               }
               ...
               if (var1.getObjects().size() == var2.getObjects().size()) {
                  ...
                  for(var5 = 0; var5 < var1.getObjects().size(); ++var5) {
                     var6 = (IsoObject)var1.getObjects().get(var5);
                     DebugLog.log("  " + var6.getClass().getName() + " " + var6.getName() + " " + (var6.sprite == null ? "no sprite" : var6.sprite.name));
                  }
               }
            }
