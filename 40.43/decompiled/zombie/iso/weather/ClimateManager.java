...
public class ClimateManager {
   ...
   public float getAirTemperatureForSquare(IsoGridSquare var1, BaseVehicle var2, boolean var3) {
      ...
      if (var1 != null) {
         ...
         if (!var5 && var2 == null) {
            ...
            var6 = (22.0F - var4) / 8.0F;
            if (var2 == null) {
               if (var1.getZ() < 1) {
                  var4 = var4 + var6 + var6 * this.dayLightLagged;
               } else {
            ...
            var6 = (var4 - 22.0F) / 3.5F;
            if (var2 == null) {
               if (var1.getZ() < 1) {
                  var4 = var4 - var6 - var6 * this.nightLagged;
               } else {
                  var6 = (float)((double)var6 * 0.5D);
                  var4 = var4 + var6 + var6 * this.dayLightLagged + var6 * this.nightLagged * 0.5F;
               }
            } else {
               var4 = var4 + var6 + var6 * this.dayLightLagged;
            }
         ...
         var6 = IsoWorld.instance.getCell().getHeatSourceHighestTemperature(var4, var1.getX(), var1.getY(), var1.getZ());
         if (var6 > var4) {
            var4 = var6;
         }
   ...
   public void triggerWinterIsComingStorm() {
      if (!GameClient.bClient && !this.weatherPeriod.isRunning()) {
         ...
         var1.strength = 0.95F;
         var1.type = 1;
         this.weatherPeriod.init(var1, this.worldAgeHours);
      }
   ...
   public boolean triggerCustomWeather(float var1, boolean var2) {
      if (!GameClient.bClient && !this.weatherPeriod.isRunning()) {
         ...
         var3.strength = var1;
         var3.type = var2 ? 1 : -1;
         this.weatherPeriod.init(var3, this.worldAgeHours);
         return true;
      } else {
         return false;
      }
   ...
   public boolean triggerCustomWeatherStage(int var1, float var2) {
      if (!GameClient.bClient && !this.weatherPeriod.isRunning()) {
         ...
         var3.strength = 0.95F;
         var3.type = 1;
         this.weatherPeriod.init(var3, this.worldAgeHours, var1, var2);
         return true;
      } else {
         return false;
      }
   ...
   private void updateTestFlare() {
      if (this.flareLaunched) {
         ...
         float var1 = this.flareLifeTime / this.flareMaxLifeTime;
         ...
         this.flareIntens = clerp(var1, 1.0F, 0.0F);
         float var2 = this.flareIntensity.value();
         this.colFlare.interp(this.globalLight.finalValue, var1, this.globalLight.finalValue);
         this.globalLightIntensity.finalValue = clerp(var1, var2, this.globalLightIntensity.finalValue);
         this.ambient.finalValue = clerp(var1, var2, this.ambient.finalValue);
         this.dayLightStrength.finalValue = clerp(var1, var2, this.dayLightStrength.finalValue);
         if (Core.getInstance().RenderShader != null && Core.getInstance().getOffscreenBuffer() != null) {
            this.desaturation.finalValue = clerp(var1, 1.0F, this.desaturation.finalValue);
         } else {
            this.desaturation.finalValue = clerp(var1, 0.0F, this.desaturation.finalValue);
         }
   ...
   private void updateValues() {
      ...
      float var1 = this.currentDay.season.getDawn();
      float var2 = this.currentDay.season.getDusk();
      float var3 = this.currentDay.season.getDayHighNoon();
      float var4 = this.gt.getTimeOfDay();
      float var5 = var4 / 24.0F;
      float var6 = lerp(var5, this.season.getCurDayPercent(), this.nextDay.season.getCurDayPercent());
      double var7 = this.getAirMassNoiseFrequencyMod(SandboxOptions.instance.getRainModifier());
      float var9 = (float)this.gt.getWorldAgeHours();
      float var10 = (float)SimplexNoise.noise(this.simplexOffsetA, this.worldAgeHours / var7);
      this.airMass = var10;
      this.airMassTemperature = (float)SimplexNoise.noise(this.simplexOffsetA, (this.worldAgeHours - 48.0D) / var7);
      float var14;
      if (this.tickIsHourChange) {
         int var11 = this.airMass < 0.0F ? -1 : 1;
         if (this.currentFront.type != var11) {
            ...
            this.currentFront.setFrontType(var11);
         }
         ...
         if (this.tickIsDayChange) {
            double var12 = Math.floor(this.worldAgeHours) + 12.0D;
            var10 = (float)SimplexNoise.noise(this.simplexOffsetA, var12 / var7);
            this.airMassDaily = var10;
            var11 = this.airMassDaily < 0.0F ? -1 : 1;
            if (var11 == this.currentFront.type) {
            ...
            this.dayDoFog = false;
            if (!this.weatherPeriod.isRunning()) {
               var14 = (float)Rand.Next(0, 1000);
               this.dayDoFog = var14 < 200.0F;
      ...
      float var41 = clerp(var5, this.currentDay.season.getDayTemperature(), this.nextDay.season.getDayTemperature());
      float var42 = clerp(var5, this.currentDay.season.getDayMeanTemperature(), this.nextDay.season.getDayMeanTemperature());
      boolean var13 = var41 < var42;
      this.baseTemperature = var42 + this.airMassTemperature * 8.0F;
      var14 = 4.0F;
      ...
      this.dayLightLagged = this.getTimeLerpHours(var4, var1 + var14, var15, true);
      float var16 = 5.0F * (1.0F - this.dayLightLagged);
      this.nightLagged = this.getTimeLerpHours(var4, var15, var1 + var14, true);
      var16 += 5.0F * this.nightLagged;
      this.temperature.internalValue = this.baseTemperature + 1.0F - var16;
      ...
      float var17 = 1.0F - (this.airMassTemperature + 1.0F) * 0.5F;
      float var18 = 1.0F - var6 * 0.4F;
      float var19 = (float)SimplexNoise.noise(this.worldAgeHours / 40.0D, this.simplexOffsetA);
      float var20 = (var19 + 1.0F) * 0.5F;
      var20 *= var17 * var18;
      var20 *= 0.65F;
      this.windIntensity.internalValue = var20;
      float var21 = (float)SimplexNoise.noise(this.worldAgeHours / 80.0D, this.simplexOffsetB);
      this.windAngleIntensity.internalValue = var21;
      this.windPower = this.windIntensity.internalValue;
      float var22 = 0.0F;
      if (var21 >= 0.0F) {
         var22 = Rand.Next(90.0F, 270.0F);
      } else {
         var22 = Rand.Next(0.0F, 180.0F);
         if (var22 > 90.0F) {
            var22 = 360.0F - (var22 - 90.0F);
         }
      }

      this.currentFront.setFrontWind(var22);
      this.cloudIntensity.internalValue = clamp01(this.windIntensity.internalValue * 2.0F);
      ClimateManager.ClimateFloat var10000 = this.cloudIntensity;
      var10000.internalValue -= this.cloudIntensity.internalValue * 0.5F * this.nightStrength.internalValue;
      this.precipitationIntensity.internalValue = 0.0F;
      float var23 = this.getTimeLerpHours(var4, var2, var1, true);
      var23 = clamp(0.0F, 1.0F, var23 * 2.0F);
      this.nightStrength.internalValue = var23;
      float var24 = 1.0F - this.nightStrength.internalValue;
      float var25 = 1.0F - 0.15F * var6 - 0.2F * this.windIntensity.internalValue;
      var24 *= var25;
      this.dayLightStrength.internalValue = var24;
      this.ambient.internalValue = this.dayLightStrength.internalValue;
      float var26 = (1.0F - this.season.getCurDayPercent()) * 0.4F;
      float var27 = (1.0F - this.nextDay.season.getCurDayPercent()) * 0.4F;
      this.desaturation.internalValue = lerp(var5, var26, var27);
      float var28 = 1.0F - clamp01((this.airMassTemperature + 0.8F) * 0.625F);
      var28 *= 0.8F;
      var28 = clamp01(var28 + this.windIntensity.internalValue);
      int var29 = this.season.getSeason();
      float var30 = this.season.getSeasonProgression();
      float var31 = 0.0F;
      int var32 = 0;
      int var33 = 0;
      if (var29 == 2) {
         var32 = ClimateManager.SeasonColor.SPRING;
         var33 = ClimateManager.SeasonColor.SUMMER;
         var31 = 0.5F + var30 * 0.5F;
      } else if (var29 == 3) {
         var32 = ClimateManager.SeasonColor.SUMMER;
         var33 = ClimateManager.SeasonColor.FALL;
         var31 = var30 * 0.5F;
      } else if (var29 == 4) {
         if (var30 < 0.5F) {
            var32 = ClimateManager.SeasonColor.SUMMER;
            ...
            var32 = ClimateManager.SeasonColor.FALL;
            var33 = ClimateManager.SeasonColor.WINTER;
            var31 = var30 - 0.5F;
         }
      } else if (var29 == 5) {
         if (var30 < 0.5F) {
            ...
            var32 = ClimateManager.SeasonColor.WINTER;
            var33 = ClimateManager.SeasonColor.SPRING;
            var31 = var30 - 0.5F;
         }
      } else if (var29 == 1) {
         if (var30 < 0.5F) {
      ...
      this.colDawn = this.seasonColorDawn.update(var28, var31, var32, var33);
      this.colDay = this.seasonColorDay.update(var28, var31, var32, var33);
      this.colDusk = this.seasonColorDusk.update(var28, var31, var32, var33);
      float var34;
      float var35;
      if (!THE_DESCENDING_FOG) {
         if (this.dayDoFog && this.dayFogStrength > 0.0F && var4 > var1 - 2.0F && var4 < var1 + 5.0F) {
            var34 = this.getTimeLerpHours(var4, var1 - 2.0F, var1 + 5.0F, true);
            var34 = clamp(0.0F, 1.0F, var34 * 2.0F);
            this.fogLerpValue = var34;
            this.cloudIntensity.internalValue = lerp(var34, this.cloudIntensity.internalValue, 0.0F);
            var35 = this.dayFogStrength;
            this.fogIntensity.internalValue = clerp(var34, 0.0F, var35);
            if (Core.getInstance().RenderShader != null && Core.getInstance().getOffscreenBuffer() != null) {
               this.desaturation.internalValue = clerp(var34, this.desaturation.internalValue, 0.8F * var35);
            } else {
               this.desaturation.internalValue = clerp(var34, this.desaturation.internalValue, 0.8F * var35);
            }
         } else {
      ...
      if (!(var4 < var1) && !(var4 > var2)) {
         if (var4 < var3 + 2.0F) {
            var37 = (var4 - var1) / (var3 + 2.0F - var1);
            this.colDawn.interp(this.colDay, var37, this.globalLight.internalValue);
            this.globalLightIntensity.internalValue = lerp(var37, var36, var34);
         } else {
            var37 = (var4 - (var3 + 2.0F)) / (var2 - (var3 + 2.0F));
            this.colDay.interp(this.colDusk, var37, this.globalLight.internalValue);
            this.globalLightIntensity.internalValue = lerp(var37, var34, var36);
         }
      } else {
         float var38 = 24.0F - var2 + var1;
         if (var4 > var2) {
            var37 = (var4 - var2) / var38;
            this.colDusk.interp(this.colDawn, var37, this.globalLight.internalValue);
         } else {
            var37 = (24.0F - var2 + var4) / var38;
            this.colDusk.interp(this.colDawn, var37, this.globalLight.internalValue);
         }

         this.globalLightIntensity.internalValue = lerp(var23, var36, var35);
      }
      ...
      IsoPlayer[] var43 = IsoPlayer.players;

      for(int var39 = 0; var39 < var43.length; ++var39) {
         IsoPlayer var40 = var43[var39];
         if (var40 != null) {
            var40.dirtyRecalcGridStackTime = 1.0F;
         }
      }
   ...
   private void updateDayInfo(int var1, int var2, int var3) {
      ...
      if (this.currentDay == null || this.currentDay.day != var1 || this.currentDay.month != var2 || this.currentDay.year != var3) {
         ...
         this.currentDay.set(var1, var2, var3);
         this.currentDay.calendar = new GregorianCalendar(var3, var2, var1, 0, 0);
         this.currentDay.dateValue = this.currentDay.calendar.getTime().getTime();
         this.currentDay.day = var1;
         this.currentDay.month = var2;
         this.currentDay.year = var3;
         ...
         this.previousDay.calendar = new GregorianCalendar(var3, var2, var1, 0, 0);
         ...
         this.nextDay.calendar = new GregorianCalendar(var3, var2, var1, 0, 0);
   ...
   private boolean writePacketContents(UdpConnection var1, byte var2) throws IOException {
      if (!GameClient.bClient && !GameServer.bServer) {
         ...
         PacketTypes.doPacket((short)200, var3);
   ...
   private boolean readPacketContents(ByteBuffer var1, byte var2, UdpConnection var3) throws IOException {
      ...
      case 6:
         ...
         for(var9 = 0; var9 < this.climateBooleans.length; ++var9) {
            this.climateBooleans[var9].readAdmin(var1);
            if (var9 == 0) {
               DebugLog.log("Snow = " + this.climateBooleans[var9].adminValue + ", enabled = " + this.climateBooleans[var9].isAdminOverride);
            }
         }
   ...
   private float getTimeLerpHours(float var1, float var2, float var3) {
      return this.getTimeLerpHours(var1, var2, var3, false);
   }

   private float getTimeLerpHours(float var1, float var2, float var3, boolean var4) {
      return this.getTimeLerp(clamp(0.0F, 1.0F, var1 / 24.0F), clamp(0.0F, 1.0F, var2 / 24.0F), clamp(0.0F, 1.0F, var3 / 24.0F), var4);
   }

   private float getTimeLerp(float var1, float var2, float var3) {
      return this.getTimeLerp(var1, var2, var3, false);
   }

   private float getTimeLerp(float var1, float var2, float var3, boolean var4) {
