...
public class WeatherPeriod {
   ...
   protected void init(ClimateManager.AirFront var1, double var2) {
      this.init(var1, var2, -1, -1.0F);
   }

   protected void init(ClimateManager.AirFront var1, double var2, int var4, float var5) {
      this.hasStartedInit = false;
      if (this.startInit(var1, var2)) {
         if (var4 >= 0 && var4 < 11) {
            this.createSingleStage(var4, var5);
         } else {
   ...
   private boolean startInit(ClimateManager.AirFront var1, double var2) {
      if (!this.isRunning && !GameClient.bClient && !((double)var1.getStrength() < 0.1D)) {
         this.startTime = var2;
   ...
   private void createWeatherPattern() {
      ...
      float var2 = this.climateManager.getDayMeanTemperature();
      ...
      if (this.frontCache.getType() == 1) {
         ...
         boolean var14 = false;
         if (this.frontCache.getStrength() > 0.75F) {
            if (var4 > 0.0F && Rand.Next(0.0F, 100.0F) < var4) {
               this.print("WeatherPeriod: tropical storm triggered.");
               var13 = true;
            } else if (var5 > 0.0F && Rand.Next(0.0F, 100.0F) < var5) {
               this.print("WeatherPeriod: blizzard triggered.");
               var12 = true;
            }
         }

         if (!var12 && !var13 && this.frontCache.getStrength() > 0.5F && var3 > 0.0F && Rand.Next(0.0F, 100.0F) < var3) {
            this.print("WeatherPeriod: storm triggered.");
            var14 = true;
         }

         float var15 = Rand.Next(24.0F, 48.0F) * this.frontCache.getStrength();
         float var16 = 0.0F;
         if (var13) {
            var10.add(this.createStage(8, (double)(8.0F + Rand.Next(0.0F, 16.0F * this.frontCache.getStrength()))));
            if (Rand.Next(0.0F, 100.0F) < 60.0F * this.frontCache.getStrength()) {
               var10.add(this.createStage(3, (double)(5.0F + Rand.Next(0.0F, 5.0F * this.frontCache.getStrength()))));
            }
            ...
            var10.add(this.createStage(7, (double)(24.0F + Rand.Next(0.0F, 24.0F * this.frontCache.getStrength()))));
         } else if (var14) {
            var10.add(this.createStage(3, (double)(5.0F + Rand.Next(0.0F, 5.0F * this.frontCache.getStrength()))));
            if (Rand.Next(0.0F, 100.0F) < 70.0F * this.frontCache.getStrength()) {
               var10.add(this.createStage(3, (double)(4.0F + Rand.Next(0.0F, 4.0F * this.frontCache.getStrength()))));
            }
            ...
            if (Rand.Next(0.0F, 100.0F) < 25.0F * this.frontCache.getStrength()) {
               var10.add(this.createStage(3, (double)(4.0F + Rand.Next(0.0F, 3.0F * this.frontCache.getStrength()))));
            }

            if (Rand.Next(0.0F, 100.0F) < 12.5F * this.frontCache.getStrength()) {
               var10.add(this.createStage(3, (double)(4.0F + Rand.Next(0.0F, 2.0F * this.frontCache.getStrength()))));
            }
         }
         ...
         while(var16 < var15) {
            ...
            case 0:
               var11 = this.createStage(5, (double)(1.0F + Rand.Next(0.0F, 3.0F * this.frontCache.getStrength())));
               break;
            case 1:
            case 2:
            case 3:
               var11 = this.createStage(1, (double)(2.0F + Rand.Next(0.0F, 4.0F * this.frontCache.getStrength())));
               break;
            default:
               var11 = this.createStage(2, (double)(2.0F + Rand.Next(0.0F, 4.0F * this.frontCache.getStrength())));
            }
         ...
         var18 = Rand.Next(12.0F, 24.0F) * this.frontCache.getStrength();
         float var19 = 0.0F;

         while(var19 < var18) {
            switch(Rand.Next(0, 10)) {
            case 0:
               var11 = this.createStage(1, (double)(2.0F + Rand.Next(0.0F, 3.0F * this.frontCache.getStrength())));
               break;
            case 1:
            case 2:
            case 3:
            case 4:
               var11 = this.createStage(6, (double)(2.0F + Rand.Next(0.0F, 3.0F * this.frontCache.getStrength())));
               break;
            default:
               var11 = this.createStage(5, (double)(2.0F + Rand.Next(0.0F, 3.0F * this.frontCache.getStrength())));
            }
      ...
      for(var20 = 0; var20 < var10.size(); ++var20) {
         this.weatherStages.add(var10.get(var20));
         if (var20 < var10.size() - 1 && Rand.Next(0.0F, 100.0F) < var18) {
      ...
      for(var20 = 0; var20 < this.weatherStages.size(); ++var20) {
         WeatherPeriod.WeatherStage var21 = (WeatherPeriod.WeatherStage)this.weatherStages.get(var20);
         var21.stageDuration = var21.stageDuration * (double)var6;
      }
      ...
      case 3:
         ...
         if (!this.currentStage.hasStartedCloud) {
            ...
            for(int var12 = 0; var12 < var11; ++var12) {
               this.thunderStorm.startThunderCloud(var4, var3, var5, var6, var7, var8, var10);
               var10 = false;
            }
   ...
   public void update(double var1) {
      if (!GameClient.bClient) {
         if (this.isRunning && this.currentStage != null && this.weatherStageIndex >= 0 && this.weatherStages.size() != 0) {
            ...
            float var3 = ClimateManager.clamp(-1.0F, 1.0F, this.currentStrength * 2.0F) * this.maxTemperatureInfluence;
            if (this.frontCache.getType() == 1) {
            ...
            if (this.isRunning) {
               ...
               this.climateManager.ambient.setOverride(0.0F, var4);
               this.climateManager.dayLightStrength.setOverride(0.0F, var4);
