...
public class RainParticle extends WeatherParticle {
   ...
   public void render(float var1, float var2) {
      ...
      SpriteRenderer.instance.render(this.texture, var3 + this.rp.getX(0), var5 + this.rp.getY(0), var3 + this.rp.getX(1), var5 + this.rp.getY(1), var3 + this.rp.getX(2), var5 + this.rp.getY(2), var3 + this.rp.getX(3), var5 + this.rp.getY(3), this.color.r, this.color.g, this.color.b, this.renderAlpha);
   }
