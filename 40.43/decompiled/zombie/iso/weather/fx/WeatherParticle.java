...
public abstract class WeatherParticle {
   ...
   public void render(float var1, float var2) {
      SpriteRenderer.instance.render(this.texture, var1 + (float)this.bounds.getX(), var2 + (float)this.bounds.getY(), this.oWidth, this.oHeight, this.color.r, this.color.g, this.color.b, this.renderAlpha);
   }
}
