...
public class IsoRainSplash extends IsoObject {
   ...
   public IsoRainSplash(IsoCell var1, IsoGridSquare var2) {
      if (var2 != null) {
         if (!var2.getProperties().Is(IsoFlagType.HasRainSplashes)) {
            ...
            var2.getProperties().Set(IsoFlagType.HasRainSplashes, "Has Rain Splashes");
   ...
   public void update() {
      ...
      for(var1 = 0; var1 < this.AttachedAnimSprite.size(); ++var1) {
         ...
         IsoSprite var3 = (IsoSprite)this.AttachedAnimSpriteActual.get(var1);
         var2.update();
      ...
      for(var1 = 0; var1 < IsoPlayer.numPlayers; ++var1) {
         if (Core.getInstance().RenderShader != null && Core.getInstance().getOffscreenBuffer() != null) {
            this.alpha[var1] = 0.25F;
            this.targetAlpha[var1] = 0.25F;
         } else {
            this.alpha[var1] = 0.6F;
            this.targetAlpha[var1] = 0.6F;
         }
      }
