...
public class IsoFire extends IsoObject {
   ...
   public void save(ByteBuffer var1) throws IOException {
      ArrayList var2 = this.AttachedAnimSprite;
      ArrayList var3 = this.AttachedAnimSpriteActual;
      this.AttachedAnimSprite = null;
      this.AttachedAnimSpriteActual = null;
      super.save(var1);
      this.AttachedAnimSprite = var2;
      this.AttachedAnimSpriteActual = var3;
      this.sprite = null;
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if (this.perm) {
         ...
         case -1:
            ...
            while(true) {
               if (var3 >= this.numFlameParticles) {
                  break label48;
               }
   ...
   public IsoFire(IsoCell var1, IsoGridSquare var2, boolean var3, int var4, int var5) {
      ...
      var2.getProperties().Set(IsoFlagType.burning, "Burning");
      this.Energy = var4;
   ...
   public void update() {
      if (this.square != null) {
         if (!GameServer.bServer && (IsoFireManager.fireSound == -1L || IsoFireManager.fireEmitter == null || !IsoFireManager.fireEmitter.isPlaying(IsoFireManager.fireSound))) {
            if (IsoFireManager.fireEmitter == null) {
               IsoFireManager.fireEmitter = (BaseSoundEmitter)(Core.SoundDisabled ? new DummySoundEmitter() : new FMODSoundEmitter());
            }

            IsoFireManager.fireSound = IsoFireManager.fireEmitter.playSoundImpl("Fire", this.square);
         }
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            ...
            IsoSprite var4 = (IsoSprite)this.AttachedAnimSpriteActual.get(var2);
            var3.update();
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5) {
      ...
      this.offsetX = 0.0F;
      this.offsetY = 0.0F;
      float var6 = (float)Core.TileScale;
      ...
      for(int var7 = 0; var7 < this.AttachedAnimSpriteActual.size(); ++var7) {
         ...
         if (var8 != null && var8.CurrentAnim != null && var8.def != null) {
            Texture var9 = ((IsoDirectionFrame)var8.CurrentAnim.Frames.get((int)var8.def.Frame)).directions[this.dir.index()];
            if (var9 != null) {
               var8.soffX = (short)((int)(-((float)(var9.getWidthOrig() / 2) * var6)));
               var8.soffY = (short)((int)(-((float)var9.getHeightOrig() * var6)));
               ((IsoSpriteInstance)this.AttachedAnimSprite.get(var7)).setScale(var6, var6);
            }
         }
      }
   ...
   public void addToWorld() {
      if (this.perm) {
         if (!this.getCell().getStaticUpdaterObjectList().contains(this)) {
   ...
   public void removeFromWorld() {
      ...
      if (IsoFireManager.fireSound != -1L && IsoFireManager.fireEmitter.isPlaying(IsoFireManager.fireSound)) {
         IsoFireManager.fireEmitter.stopSound(IsoFireManager.fireSound);
      }
