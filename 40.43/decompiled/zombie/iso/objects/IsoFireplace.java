...
public class IsoFireplace extends IsoObject {
   ...
   public IsoFireplace(IsoCell var1, IsoGridSquare var2, IsoSprite var3) {
      ...
      String var4 = var3 != null && var3.getProperties().Is("container") ? var3.getProperties().Val("container") : "fireplace";
      this.container = new ItemContainer(var4, var2, this, 1, 1);
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5) {
      ...
      if (this.AttachedAnimSprite != null) {
         for(int var6 = 0; var6 < this.AttachedAnimSprite.size(); ++var6) {
            ...
            var7.getParentSprite().render(var7, this, var1, var2, var3, this.dir, this.offsetX, this.offsetY, var4, true);
         }
