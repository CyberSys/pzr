...
public class IsoBarricade extends IsoObject implements Thumpable {
   ...
   private void chooseSprite() {
      IsoSpriteManager var1 = IsoWorld.instance.spriteManager;
      int var2;
      String var3;
      if (this.metalHealth > 0) {
         ...
         switch(this.dir) {
         case W:
            this.sprite = var1.getSprite(var4 + "_" + 55);
            break;
         case N:
            this.sprite = var1.getSprite(var4 + "_" + 53);
            break;
         case E:
            this.sprite = var1.getSprite(var4 + "_" + 52);
            break;
         case S:
            this.sprite = var1.getSprite(var4 + "_" + 54);
            break;
         default:
            this.sprite.LoadFramesNoDirPageSimple("media/ui/missing-tile.png");
         }
      ...
      if (!this.isDestroyed()) {
         if (var1 instanceof IsoZombie) {
            ...
            if (var2 != this.getNumPlanks()) {
               ((IsoGameCharacter)((IsoGameCharacter)var1)).getEmitter().playSound("BreakBarricadePlank");
               if (GameServer.bServer) {
   ...
   public void WeaponHit(IsoGameCharacter var1, HandWeapon var2) {
      if (GameClient.bClient) {
         ...
         String var3 = !this.isMetal() && !this.isMetalBar() ? "HitBarricadePlank" : "HitBarricadeMetal";
         SoundManager.instance.PlayWorldSound(var3, false, this.getSquare(), 1.0F, 20.0F, 2.0F, false);
         if (GameServer.bServer) {
            GameServer.PlayWorldSoundServer(var3, false, this.getSquare(), 1.0F, 20.0F, 2.0F, false);
         }
         ...
         if (this.isDestroyed()) {
            if (var1 != null) {
               String var4 = !this.isMetal() && !this.isMetalBar() ? "BreakBarricadePlank" : "BreakBarricadeMetal";
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      byte var3 = var1.get();
      this.dir = IsoDirections.fromIndex(var3);
      byte var4 = var1.get();

      for(int var5 = 0; var5 < var4; ++var5) {
         short var6 = var1.getShort();
         if (var5 < 4) {
            this.plankHealth[var5] = var6;
         }
      }
   ...
   public void save(ByteBuffer var1) throws IOException {
      ...
      for(int var2 = 0; var2 < 4; ++var2) {
         var1.putShort((short)this.plankHealth[var2]);
      }
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5) {
      ...
      BarricadeAble var7 = this.getBarricadedObject();
      if (var7 != null && this.square.lighting[var6].targetDarkMulti() <= var7.getSquare().lighting[var6].targetDarkMulti()) {
         var4 = var7.getSquare().lighting[var6].lightInfo();
         this.targetAlpha[var6] = ((IsoObject)var7).targetAlpha[var6];
      }
