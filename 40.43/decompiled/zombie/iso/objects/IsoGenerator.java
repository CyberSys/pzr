...
public class IsoGenerator extends IsoObject {
   ...
   public IsoGenerator(InventoryItem var1, IsoCell var2, IsoGridSquare var3) {
      super(var2, var3, IsoWorld.instance.CurrentCell.SpriteManager.getSprite("appliances_misc_01_0"));
      if (var1 != null) {
      ...
      if (this.isActivated()) {
         ...
         if ((int)GameTime.getInstance().getWorldAgeHours() != this.lastHour) {
            ...
            for(int var4 = 0; var4 < var1; ++var4) {
               float var5 = (float)Math.max(1, this.numberOfElectricalItems / 3);
               var5 *= 0.5F;
   ...
   public void setSurroundingElectricity() {
      ...
      int var2 = this.square.getX() - GENERATOR_RADIUS;
      int var3 = this.square.getX() + GENERATOR_RADIUS;
      int var4 = this.square.getY() - GENERATOR_RADIUS;
      int var5 = this.square.getY() + GENERATOR_RADIUS;
      ...
      for(var8 = var6; var8 < var7; ++var8) {
         for(var9 = var2; var9 <= var3; ++var9) {
            for(var10 = var4; var10 <= var5; ++var10) {
               if (IsoUtils.DistanceToSquared((float)var9, (float)var10, (float)this.getSquare().getX(), (float)this.getSquare().getY()) <= (float)(GENERATOR_RADIUS * GENERATOR_RADIUS)) {
                  var1 = this.getCell().getGridSquare(var9, var10, var8);
                  if (var1 != null && !var1.getProperties().Is(IsoFlagType.exterior)) {
                     var1.setHaveElectricity(this.isActivated());

                     for(var11 = 0; var11 < var1.getObjects().size(); ++var11) {
                        IsoObject var12 = (IsoObject)var1.getObjects().get(var11);
                        if (var12 != null && !(var12 instanceof IsoWorldInventoryObject)) {
                           if (var12 instanceof IsoStove || var12 instanceof IsoRadio || var12 instanceof IsoTelevision) {
                              ++this.numberOfElectricalItems;
                           }

                           if (var12.getContainerByType("fridge") != null) {
                              ++this.numberOfElectricalItems;
                           }

                           if (var12.getContainerByType("freezer") != null) {
                              ++this.numberOfElectricalItems;
                           }

                           var12.checkHaveElectricity();
                        }
                     }
                  }
               }
      ...
      if (this.square != null && this.square.chunk != null) {
         ...
         for(var10 = -2; var10 <= 2; ++var10) {
            for(var11 = -2; var11 <= 2; ++var11) {
               IsoChunk var13 = GameServer.bServer ? ServerMap.instance.getChunk(var8 + var11, var9 + var10) : IsoWorld.instance.CurrentCell.getChunk(var8 + var11, var9 + var10);
               if (var13 != null && this.touchesChunk(var13)) {
                  if (this.isActivated()) {
                     var13.addGeneratorPos(this.square.x, this.square.y, this.square.z);
                  } else {
                     var13.removeGeneratorPos(this.square.x, this.square.y, this.square.z);
                  }
               }
            }
         }
   ...
   private void updateFridgeFreezerItems() {
      if (this.square != null) {
         int var1 = this.square.getX() - GENERATOR_RADIUS;
         int var2 = this.square.getX() + GENERATOR_RADIUS;
         int var3 = this.square.getY() - GENERATOR_RADIUS;
         int var4 = this.square.getY() + GENERATOR_RADIUS;
         ...
         for(int var7 = var5; var7 < var6; ++var7) {
            for(int var8 = var1; var8 <= var2; ++var8) {
               for(int var9 = var3; var9 <= var4; ++var9) {
                  if (IsoUtils.DistanceToSquared((float)var8, (float)var9, (float)this.square.x, (float)this.square.y) <= (float)(GENERATOR_RADIUS * GENERATOR_RADIUS)) {
   ...
   public void syncIsoObject(boolean var1, byte var2, UdpConnection var3, ByteBuffer var4) {
      if (this.square == null) {
         ...
         if (GameClient.bClient && !var1) {
            ...
            PacketTypes.doPacket((short)12, var13);
            ...
            while(var12.hasNext()) {
               ...
               PacketTypes.doPacket((short)12, var15);
            ...
            if (GameServer.bServer) {
               ...
               while(var9.hasNext()) {
                  ...
                  if (var3 != null && var10.getConnectedGUID() != var3.getConnectedGUID()) {
                     ...
                     PacketTypes.doPacket((short)12, var11);
   ...
   private boolean touchesChunk(IsoChunk var1) {
      ...
      if (var2 == null) {
         ...
         int var5 = var3 + 10 - 1;
         int var6 = var4 + 10 - 1;
         if (var2.x - GENERATOR_RADIUS > var5) {
            return false;
         } else if (var2.x + GENERATOR_RADIUS < var3) {
            return false;
         } else if (var2.y - GENERATOR_RADIUS > var6) {
            return false;
         } else {
            return var2.y + GENERATOR_RADIUS >= var4;
         }
      }
   }
   ...
   public static boolean isPoweringSquare(int var0, int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var5 >= var6 && var5 < var7) {
         return IsoUtils.DistanceToSquared((float)var0, (float)var1, (float)var3, (float)var4) <= (float)(GENERATOR_RADIUS * GENERATOR_RADIUS);
      } else {
         return false;
      }
   }
