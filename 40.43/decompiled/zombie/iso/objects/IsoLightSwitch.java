...
public class IsoLightSwitch extends IsoObject {
   ...
   public IsoLightSwitch(IsoCell var1, IsoGridSquare var2, IsoSprite var3, int var4) {
      ...
      if (var5 != null && this.lightRoom) {
         ...
         if (var5.lightSwitches.size() > 0) {
            this.lights = ((IsoLightSwitch)var5.lightSwitches.get(0)).lights;
            this.Activated = ((IsoLightSwitch)var5.lightSwitches.get(0)).Activated;
         } else {
            this.Activated = var5.def.bLightsActive;
            var5.createLights(this.Activated);
            this.lights = var5.lights;
         }
   ...
   public void addLightSourceFromSprite() {
      if (this.sprite != null && this.sprite.getProperties().Is("lightR")) {
         ...
         IsoLightSource var4 = new IsoLightSource(this.square.getX(), this.square.getY(), this.square.getZ(), var1, var2, var3, 10);
         var4.bActive = this.Activated;
         var4.bHydroPowered = true;
         var4.switches.add(this);
         this.lights.add(var4);
      }
   ...
   public void addBattery(IsoGameCharacter var1, InventoryItem var2) {
      if (this.canBeModified && this.useBattery && !this.hasBattery && var2 != null && var2.getFullType().equals("Base.Battery")) {
         ...
         if (var1.getPrimaryHandItem() == var2) {
            var1.setPrimaryHandItem((InventoryItem)null);
         }

         if (var1.getSecondaryHandItem() == var2) {
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      if (this.square != null) {
         IsoRoom var3 = this.square.getRoom();
         if (var3 != null && this.lightRoom) {
            if (var3.lightSwitches.size() > 0) {
               this.Activated = var3.def.bLightsActive;
               this.lights = ((IsoLightSwitch)var3.lightSwitches.get(0)).lights;
            } else {
               this.Activated = var3.def.bLightsActive;
               var3.createLights(this.Activated);
               this.lights = var3.lights;
            }

            var3.lightSwitches.add(this);
         } else {
            float var4 = 0.9F;
            float var5 = 0.8F;
            float var6 = 0.7F;
            if (this.sprite != null && this.sprite.getProperties().Is("lightR")) {
               if (var2 >= 76) {
                  ...
                  var4 = Float.parseFloat(this.sprite.getProperties().Val("lightR")) / 255.0F;
                  var5 = Float.parseFloat(this.sprite.getProperties().Val("lightG")) / 255.0F;
                  var6 = Float.parseFloat(this.sprite.getProperties().Val("lightB")) / 255.0F;
               }
            }

            IsoLightSource var7 = new IsoLightSource((int)this.getX(), (int)this.getY(), (int)this.getZ(), var4, var5, var6, 8);
            var7.bActive = this.Activated;
            var7.bWasActive = var7.bActive;
            var7.bHydroPowered = true;
            var7.switches.add(this);
   ...
   public boolean onMouseLeftClick(int var1, int var2) {
      if (IsoPlayer.getInstance() == null) {
         ...
         int var3 = Math.abs(this.square.getX() - IsoPlayer.getInstance().getCurrentSquare().getX()) + Math.abs(this.square.getY() - IsoPlayer.getInstance().getCurrentSquare().getY() + Math.abs(this.square.getZ() - IsoPlayer.getInstance().getCurrentSquare().getZ()));
         if (var3 < 4 && !IsoPlayer.getInstance().getCurrentSquare().isWallTo(this.square)) {
         ...
         if (GameClient.bClient && !var1) {
            ...
            if (GameServer.bServer) {
               ...
               while(var4.hasNext()) {
                  ...
                  } else if (var5.ReleventTo((float)this.square.x, (float)this.square.y)) {
                     var6 = var5.startPacket();
                     PacketTypes.doPacket((short)12, var6);
   ...
   public static void chunkLoaded(IsoChunk var0) {
      ...
      var3 = (var0.wx + 1) * 10;
      var4 = var0.wy * 10;
      int var10 = (var0.wy + 1) * 10;

      for(int var11 = 0; var11 < var1.size(); ++var11) {
         IsoRoom var7 = (IsoRoom)var1.get(var11);
         if (var7.lights.isEmpty()) {
            var7.createLights(var7.def.bLightsActive);
         }

         int var8;
         for(var8 = 0; var8 < var7.lights.size(); ++var8) {
            IsoLightSource var9 = (IsoLightSource)var7.lights.get(var8);
            if (var9.x >= var2 && var9.x < var3 && var9.y >= var4 && var9.y < var10) {
               var9.chunk = var0;
               var9.life = -1;
               if (!IsoWorld.instance.CurrentCell.getLamppostPositions().contains(var9)) {
                  IsoWorld.instance.CurrentCell.getLamppostPositions().add(var9);
               }
            }
         }

         for(var8 = 0; var8 < var7.roomLights.size(); ++var8) {
            IsoRoomLight var12 = (IsoRoomLight)var7.roomLights.get(var8);
            if (!var0.roomLights.contains(var12)) {
               var0.roomLights.add(var12);
            }
         }
      }
