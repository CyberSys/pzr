...
public class Stash {
   ...
   public void load(KahluaTableImpl var1) {
      ...
      String var9 = var1.rawgetStr("traps");
      if (var9 != null) {
         String[] var5 = var9.split("-");
         if (var5.length == 2) {
      ...
      KahluaTable var10 = (KahluaTable)var1.rawget("containers");
      if (var10 != null) {
         this.containers = new ArrayList();
         KahluaTableIterator var6 = var10.iterator();
      ...
      if ("Map".equals(this.type)) {
         this.annotations = (KahluaTableImpl)var1.rawget("annotations");
      }
