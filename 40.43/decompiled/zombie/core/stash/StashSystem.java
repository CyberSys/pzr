...
public class StashSystem {
   ...
   public static void initAllStashes() {
      ...
      KahluaTable var0 = (KahluaTable)LuaManager.env.rawget("stash");
   ...
   public static void doStashItem(Stash var0, InventoryItem var1) {
      ...
      if ("Map".equals(var0.type)) {
         if (var0.annotations != null) {
            ...
            KahluaTableIterator var4 = var0.annotations.iterator();

            while(var4.advance()) {
               KahluaTableImpl var5 = (KahluaTableImpl)var4.getValue();
               if (var5.rawget("symbol") != null) {
                  var2.rawset(var2.size() + 1, var5);
               }

               if (var5.rawget("text") != null) {
                  var5.rawset("text", Translator.getText(var5.rawgetStr("text")));
                  var3.rawset(var3.size() + 1, var5);
               }
            }

            var1.getModData().rawset("symbols", var2);
            var1.getModData().rawset("notes", var3);
         }
         ...
         if (var2.buildingX > var0.x && var2.buildingX < var0.x2 && var2.buildingY > var0.y && var2.buildingY < var0.y2) {
            if (var0.hasBeenVisited) {
               ...
               if (var3 != null) {
                  ...
                  KahluaTable var5 = (KahluaTable)((KahluaTable)LuaManager.env.rawget("SuburbsDistributions")).rawget(var3.spawnTable);
                  var0.setAllExplored(true);
                  doSpecificBuildingProperties(var3, var0);

                  for(int var6 = var0.x - 1; var6 < var0.x2 + 1; ++var6) {
                     for(int var7 = var0.y - 1; var7 < var0.y2 + 1; ++var7) {
                        for(int var8 = 0; var8 < 8; ++var8) {
                           ...
                           if (var9 != null) {
                              for(int var10 = 0; var10 < var9.getObjects().size(); ++var10) {
                                 ...
                                 if (var11.getContainer() != null && var9.getRoom() != null && var9.getRoom().getBuilding().getDef() == var0 && var9.getRoom().getName() != null && var5.rawget(var11.getContainer().getType()) != null) {
                                    KahluaTable var12 = (KahluaTable)((KahluaTable)LuaManager.env.rawget("SuburbsDistributions")).rawget(var9.getRoom().getName());
                                    boolean var13 = false;
                                    if (var12 == null || var12.rawget(var11.getContainer().getType()) == null) {
                                       var11.getContainer().clear();
                                       var13 = true;
                                    }

                                    LuaManager.caller.pcall(LuaManager.thread, var4.rawget("fillContainerType"), var5, var11.getContainer(), "", null);
                                    if (var13) {
                                       var11.getContainer().setExplored(true);
                                    }
                                 }

                                 if (var3.barricades > -1 && (var11 instanceof IsoDoor || var11 instanceof IsoWindow) && Rand.Next(100) < var3.barricades) {
                                    if (var11 instanceof IsoDoor) {
                                       ((IsoDoor)var11).addRandomBarricades();
                                    } else {
                                       ((IsoWindow)var11).addRandomBarricades();
                                    }
                                 }
                              }
                           }
   ...
   private static void doSpecificBuildingProperties(Stash var0, BuildingDef var1) {
      ...
      if (var0.containers != null) {
         ...
         for(int var3 = 0; var3 < var0.containers.size(); ++var3) {
            ...
            if (!var2.isEmpty()) {
               RoomDef var16 = (RoomDef)var2.get(Rand.Next(0, var2.size()));
               var5 = var16.getFreeSquare();
            }

            if (var5 != null) {
               if (var4.containerItem != null && !var4.containerItem.isEmpty()) {
                  KahluaTable var19 = (KahluaTable)LuaManager.env.rawget("ItemPicker");
                  KahluaTable var20 = (KahluaTable)((KahluaTable)LuaManager.env.rawget("SuburbsDistributions")).rawget(var0.spawnTable);
                  if (var20 == null) {
                     DebugLog.log("Container distribution " + var0.spawnTable + " not found");
                     return;
                  }

                  InventoryItem var8 = InventoryItemFactory.CreateItem(var4.containerItem);
                  if (var8 == null) {
                     DebugLog.log("Item " + var4.containerItem + " Doesn't exist.");
                     return;
                  }

                  KahluaTable var9 = (KahluaTable)var20.rawget(var8.getType());
                  LuaManager.caller.pcall(LuaManager.thread, var19.rawget("rollContainerItem"), var8, null, var9);
                  var5.AddWorldInventoryItem(var8, 0.0F, 0.0F, 0.0F);
               } else {
                  IsoThumpable var18 = new IsoThumpable(var5.getCell(), var5, var4.containerSprite, false, (KahluaTable)null);
                  var18.setIsThumpable(false);
                  var18.container = new ItemContainer(var4.containerType, var5, var18, 10, 10);
      ...
      if (var0.minTrapToSpawn > -1) {
         for(var10 = var0.minTrapToSpawn; var10 < var0.maxTrapToSpawn; ++var10) {
            IsoGridSquare var11 = var1.getFreeSquareInRoom();
            if (var11 != null) {
               HandWeapon var13 = (HandWeapon)InventoryItemFactory.CreateItem((String)possibleTrap.get(Rand.Next(0, possibleTrap.size())));
      ...
      if (var0.zombies > -1) {
         for(var10 = 0; var10 < var1.rooms.size(); ++var10) {
            ...
            if (IsoWorld.getZombiesEnabled()) {
               ...
               VirtualZombieManager.instance.addZombiesToMap(var17, var12, false);
            }
         }
      }
