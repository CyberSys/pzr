...
public class Rand {
   ...
   public static int Next(int var0, CellularAutomatonRNG var1) {
      if (var0 <= 0) {
         return 0;
      } else {
         ++id;
   ...
   public static long Next(long var0, CellularAutomatonRNG var2) {
      if (var0 <= 0L) {
         ...
         return (long)var2.nextInt((int)var0);
      }
   }
   ...
   public static int AdjustForFramerate(int var0) {
      if (GameServer.bServer) {
         ...
         var0 = (int)((float)var0 * ((float)PerformanceSettings.LockFPS / 30.0F));
      }
