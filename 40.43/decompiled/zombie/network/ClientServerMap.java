...
public final class ClientServerMap {
   ...
   public static boolean isChunkLoaded(int var0, int var1) {
      if (!GameClient.bClient) {
         ...
         for(int var2 = 0; var2 < IsoPlayer.numPlayers; ++var2) {
            ...
            if (var3 != null) {
               int var4 = var0 / 7 - var3.getMinX();
               int var5 = var1 / 7 - var3.getMinY();
   ...
   public void sendPacket(UdpConnection var1) {
      if (GameServer.bServer) {
         ...
         PacketTypes.doPacket((short)15, var2);
               ...
               for(var11 = 0; var11 < IsoChunkMap.ChunkGridWidth; ++var11) {
                  ...
                  if (var12 != null) {
                     ...
                     if (var13 && var9 != null) {
                        ...
                        if (var14 != null && !isLoaded[var11 + (var10 - 1) * IsoChunkMap.ChunkGridWidth]) {
                           for(int var15 = 0; var15 < var3; ++var15) {
                              ...
                              SpriteRenderer.instance.render(var9, var16 - (float)(var9.getWidth() / 2), var17, (float)var9.getWidth(), (float)var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F);
                           }
                        }
                        ...
                        if (var22 != null && !isLoaded[var11 + (var10 + 1) * IsoChunkMap.ChunkGridWidth]) {
                           for(int var24 = 0; var24 < var3; ++var24) {
                              ...
                              SpriteRenderer.instance.render(var9, var17 - (float)(var9.getWidth() / 2), var18, (float)var9.getWidth(), (float)var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F);
                           }
                        }
                        ...
                        if (var25 != null && !isLoaded[var11 - 1 + var10 * IsoChunkMap.ChunkGridWidth]) {
                           for(int var26 = 0; var26 < var3; ++var26) {
                              ...
                              SpriteRenderer.instance.render(var9, var18 - (float)(var9.getWidth() / 2), var19, (float)var9.getWidth(), (float)var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F);
                           }
                        }
                        ...
                        if (var27 != null && !isLoaded[var11 + 1 + var10 * IsoChunkMap.ChunkGridWidth]) {
                           for(int var28 = 0; var28 < var3; ++var28) {
                              ...
                              SpriteRenderer.instance.render(var9, var19 - (float)(var9.getWidth() / 2), var20, (float)var9.getWidth(), (float)var9.getHeight(), 1.0F, 1.0F, 1.0F, 1.0F);
                           }
                        }
                     }
                     ...
                     if (!var13) {
                        ...
                        SpriteRenderer.instance.renderPoly((int)var16, (int)var17, (int)(var16 + (float)(var3 * 64 / 2 * var2)), (int)(var17 - (float)(var3 * 32 / 2 * var2)), (int)(var16 + (float)(var3 * 64 * var2)), (int)var17, (int)(var16 + (float)(var3 * 64 / 2 * var2)), (int)(var17 + (float)(var3 * 32 / 2 * var2)), var4, var5, var6, var7);
                     }
                  }
               }
            }
