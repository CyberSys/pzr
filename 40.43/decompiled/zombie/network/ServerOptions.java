...
public class ServerOptions {
   ...
   public ServerOptions.DoubleServerOption SpeedLimit = new ServerOptions.DoubleServerOption(this, "SpeedLimit", 10.0D, 150.0D, 50.0D);
   ...
   public ServerOptions.DoubleServerOption HoursForWorldItemRemoval = new ServerOptions.DoubleServerOption(this, "HoursForWorldItemRemoval", 0.0D, 3.4028234663852886E38D, 0.0D);
   ...
   public ServerOptions.DoubleServerOption ZombieUpdateRadiusLowPriority = new ServerOptions.DoubleServerOption(this, "ZombieUpdateRadiusLowPriority", 0.0D, 500.0D, 0.0D);
   public ServerOptions.DoubleServerOption ZombieUpdateRadiusHighPriority = new ServerOptions.DoubleServerOption(this, "ZombieUpdateRadiusHighPriority", 0.0D, 500.0D, 15.8D);
   ...
   public void init() {
      this.initOptions();
      File var1 = new File(GameWindow.getCacheDir() + File.separator + "Server");
      if (!var1.exists()) {
         var1.mkdirs();
      }

      File var2 = new File(GameWindow.getCacheDir() + File.separator + "Server" + File.separator + GameServer.ServerName + ".ini");
      if (var2.exists()) {
         try {
   ...
   public void resetRegionFile() {
      File var1 = new File(GameWindow.getCacheDir() + File.separator + "Server" + File.separator + GameServer.ServerName + "_spawnregions.lua");
      var1.delete();
   ...
   private void initSpawnRegionsFile(File var1) {
      if (!var1.exists()) {
         ...
         try {
            ...
            var2.write(Translator.getText("UI_ServerOptions_SpawnRegionFile1") + System.lineSeparator());
            var2.write(Translator.getText("UI_ServerOptions_SpawnRegionFile2") + System.lineSeparator());
            var2.write(Translator.getText("UI_ServerOptions_SpawnRegionFile3") + System.lineSeparator());
            ...
            var2.write("\t\t-- " + Translator.getText("UI_ServerOptions_SpawnRegionFile5") + System.lineSeparator());
            ...
            var2.write(Translator.getText("UI_ServerOptions_SpawnRegionFile1") + System.lineSeparator());
            var2.write(Translator.getText("UI_ServerOptions_SpawnRegionFile4") + System.lineSeparator());
   ...
   public boolean loadServerTextFile(String var1) {
      ...
      String var3 = GameWindow.getCacheDir() + File.separator + "Server" + File.separator + var1 + ".ini";
      if (var2.read(var3)) {
