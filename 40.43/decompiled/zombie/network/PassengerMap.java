...
public final class PassengerMap {
      ...
      if (var7 != null && var7.getVehicle() != null) {
         ...
         if (var8 instanceof IsoPlayer && var8 != var7) {
            ...
            if (var9 != null) {
               ...
               PacketTypes.doPacket((short)16, var10);
                     ...
                     for(int var14 = 0; var14 < 7; ++var14) {
                        for(int var15 = 0; var15 < 7; ++var15) {
                           ...
                           if (!var16) {
                              ...
                              SpriteRenderer.instance.renderPoly((int)var19, (int)var20, (int)(var19 + (float)(var4 * 64 / 2 * var3)), (int)(var20 - (float)(var4 * 32 / 2 * var3)), (int)(var19 + (float)(var4 * 64 * var3)), (int)var20, (int)(var19 + (float)(var4 * 64 / 2 * var3)), (int)(var20 + (float)(var4 * 32 / 2 * var3)), var5, var6, var7, var8);
                           }
                        }
                     }
                  } else {
   ...
   private static final class PassengerLocal {
      ...
      void clientSendPacket(UdpConnection var1) {
         ...
         PacketTypes.doPacket((short)16, var2);
