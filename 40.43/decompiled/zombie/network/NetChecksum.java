   ...
   public static final class Comparer {
      ...
      private void sendTotalChecksum() {
         if (GameClient.bClient) {
            ...
            PacketTypes.doPacket((short)91, var1);
      ...
      private void sendGroupChecksum() {
         if (GameClient.bClient) {
            if (this.currentIndex >= NetChecksum.GroupOfFiles.groups.size()) {
               ...
               PacketTypes.doPacket((short)91, var2);
      ...
      private void sendFileMismatch(UdpConnection var1, short var2, String var3, byte var4) {
         if (GameServer.bServer) {
            ...
            PacketTypes.doPacket((short)91, var5);
      ...
      private void sendError(UdpConnection var1, String var2) {
         if (GameServer.bServer) {
            ...
            PacketTypes.doPacket((short)91, var3);
      ...
      public void serverPacket(ByteBuffer var1, UdpConnection var2) {
         if (GameServer.bServer) {
            ...
            case 1:
               ...
               PacketTypes.doPacket((short)91, var19);
            ...
            case 2:
               ...
               if (var4 >= 0 && var5 >= var4 && var5 < var4 + 10) {
                  ...
                  while(true) {
                     ...
                     PacketTypes.doPacket((short)91, var15);
      ...
      public void addFile(String var1, String var2) throws NoSuchAlgorithmException {
         ...
         try {
            ...
            try {
               ...
               while(true) {
                  int var5;
                  while((var5 = var3.read(this.fileBytes)) != -1) {
                     if (this.convertLineEndings) {
                        boolean var6 = false;
                        int var7 = 0;

                        for(int var8 = 0; var8 < var5 - 1; ++var8) {
                           if (this.fileBytes[var8] == 13 && this.fileBytes[var8 + 1] == 10) {
                              this.convertBytes[var7++] = 10;
                              var6 = true;
                           } else {
                              var6 = false;
                              this.convertBytes[var7++] = this.fileBytes[var8];
                           }
                        }

                        if (!var6) {
                           this.convertBytes[var7++] = this.fileBytes[var5 - 1];
                        }

                        this.md.update(this.convertBytes, 0, var7);
                        NetChecksum.GroupOfFiles.updateFile(this.convertBytes, var7);
                     } else {
                        this.md.update(this.fileBytes, 0, var5);
                        NetChecksum.GroupOfFiles.updateFile(this.fileBytes, var5);
                     }
                  }
