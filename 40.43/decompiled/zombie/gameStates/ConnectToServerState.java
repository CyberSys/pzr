...
public class ConnectToServerState extends GameState {
   ...
   private void WorkshopConfirm() {
      ...
      for(int var1 = 0; var1 < this.workshopItems.size(); ++var1) {
         ...
         noise("WorkshopConfirm GetItemState()=" + SteamWorkshopItem.ItemState.toString(var3) + " ID=" + var2.ID);
   ...
   private void CheckMods() {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ChooseGameInfo.Mod var7 = var4.new Mod(GameWindow.ReadStringUTF(var1));
         var7.setUrl(GameWindow.ReadStringUTF(var1));
         var7.setName(GameWindow.ReadStringUTF(var1));
         var2.add(var7.getDir());
         var3.put(var7.getDir(), var7);
      }

      GameClient.instance.ServerMods.clear();
      GameClient.instance.ServerMods.addAll(var2);
      var2.clear();
      String var8 = ZomboidFileSystem.instance.loadModsAux(GameClient.instance.ServerMods, var2);
      if (var8 != null) {
         String var9 = Translator.getText("UI_OnConnectFailed_ModRequired", var8);
         if (var3.get(var8) != null && !"".equals(((ChooseGameInfo.Mod)var3.get(var8)).getUrl())) {
            var9 = var9 + " MODURL=" + ((ChooseGameInfo.Mod)var3.get(var8)).getUrl();
         }

         LuaEventManager.triggerEvent("OnConnectFailed", var9);
         GameClient.connection.forceDisconnect();
         this.state = ConnectToServerState.State.Exit;
      } else {
   ...
   private class WorkshopItem implements ISteamWorkshopCallback {
      ...
      void CheckItemState() {
         ...
         ConnectToServerState.noise("GetItemState()=" + SteamWorkshopItem.ItemState.toString(var1) + " ID=" + this.ID);
