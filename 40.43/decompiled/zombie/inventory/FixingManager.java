...
public class FixingManager {
   public static ArrayList getFixes(InventoryItem var0) {
      ...
      for(int var2 = 0; var2 < ScriptManager.instance.getAllFixing().size(); ++var2) {
         Fixing var3 = (Fixing)ScriptManager.instance.getAllFixing().get(var2);
         if (var3.getRequiredItem().contains(var0.getType())) {
            var1.add(var3);
         }
      }
         ...
         if (var2 != var0.getInventory().getItems().get(var4)) {
            ...
            if (var5 != null && var5.getType().equals(var1.getFixerName())) {
               if (!(var5 instanceof DrainableComboItem)) {
                  ...
                  int var6 = (int)Math.floor((double)(((DrainableComboItem)var5).getUsedDelta() / ((DrainableComboItem)var5).getUseDelta()));
   ...
   public static double getChanceOfFail(InventoryItem var0, IsoGameCharacter var1, Fixing var2, Fixing.Fixer var3) {
      ...
      if (var1.HasTrait("Lucky")) {
         var4 -= 5.0D;
      }

      if (var1.HasTrait("Unlucky")) {
         var4 += 5.0D;
      }
