...
public class Radio extends Moveable implements Talker, IUpdater, WaveSignalDevice {
   ...
   public void AddDeviceText(String var1, float var2, float var3, float var4, String var5, int var6) {
      ...
      if (var7 != null && this.deviceData != null && this.deviceData.getDeviceVolume() > 0.0F && !var7.HasTrait("Deaf")) {
         if (!ZomboidRadio.isStaticSound(var1)) {
         ...
         if (var5 != null) {
            LuaEventManager.triggerEvent("OnDeviceText", var5, -1, -1, -1, var1);
         }
      }
   ...
   public void update() {
      if (this.deviceData != null) {
         if (!GameServer.bServer && !GameClient.bClient || GameClient.bClient) {
            IsoPlayer var1 = IsoPlayer.instance;
   ...
   public void load(ByteBuffer var1, int var2, boolean var3) throws IOException {
      ...
      if (var1.get() == 1) {
         this.deviceData.load(var1, var2, var3);
      }
