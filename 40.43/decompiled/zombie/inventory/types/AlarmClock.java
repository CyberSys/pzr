...
public class AlarmClock extends InventoryItem {
         ...
         if (this.isRinging()) {
            ...
            if (var4 != null && !(this.ringSince + 0.5D < var2)) {
               if (!GameClient.bClient && var4 != null) {
                  WorldSoundManager.instance.addSound((IsoObject)null, var4.getX(), var4.getY(), var4.getZ(), this.getSoundRadius(), 3);
               }
            } else {
               this.stopRinging();
            }
   ...
   public void updateSound(BaseSoundEmitter var1) {
      ...
      if (var2 != null) {
         ...
         if (GameClient.bClient && sendEvery.Check() && this.isInLocalPlayerInventory()) {
            GameClient.instance.sendWorldSound((IsoObject)null, var2.x, var2.y, var2.z, this.getSoundRadius(), 3, false, 0.0F, 1.0F);
         }
   ...
   private void wakeUpPlayers(IsoGridSquare var1) {
      if (!GameServer.bServer) {
         ...
         for(int var5 = 0; var5 < IsoPlayer.numPlayers; ++var5) {
            ...
            if (var6 != null && !var6.isDead() && var6.getCurrentSquare() != null && !var6.HasTrait("Deaf")) {
   ...
   public void syncAlarmClock_World() {
      if (GameClient.bClient) {
         ...
         PacketTypes.doPacket((short)46, var1);
   ...
   public void syncStopRinging() {
      if (GameClient.bClient) {
         ...
         if (var2 != null) {
            ...
            var1.putShort((short)var2.OnlineID);
