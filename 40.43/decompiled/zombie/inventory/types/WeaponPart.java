...
public class WeaponPart extends InventoryItem {
   ...
   public void DoTooltip(ObjectTooltip var1, ObjectTooltip.Layout var2) {
      ...
      var3.setValue(this.partType, 1.0F, 1.0F, 0.8F, 1.0F);
      var3 = var2.addItem();
      String var4 = Translator.getText("Tooltip_weapon_CanBeMountOn") + this.mountOn.toString().replaceAll("\\[", "").replaceAll("\\]", "");
   ...
   public void setMountOn(ArrayList var1) {
      ...
      for(int var2 = 0; var2 < var1.size(); ++var2) {
         ...
         if (var4 != null) {
            this.mountOn.add(var4.getDisplayName());
         }
      }
   ...
   public void setPartType(String var1) {
      this.partType = Translator.getText("Tooltip_weapon_" + var1);
   }
