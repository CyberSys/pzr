...
public class RadioGlobalsManager {
   private Map globals = new HashMap();
   private RadioGlobalInt bufferInt = new RadioGlobalInt("bufferInt", 0);
   private RadioGlobalString bufferString = new RadioGlobalString("bufferString", "");
   private RadioGlobalBool bufferBoolean = new RadioGlobalBool("bufferBoolean", false);
   private RadioGlobalFloat bufferFloat = new RadioGlobalFloat("bufferFloat", 0.0F);
