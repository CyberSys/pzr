...
public class RadioScriptManager {
   ...
   public void Save(FileWriter var1) throws IOException {
      Iterator var2 = this.channels.entrySet().iterator();

      while(var2.hasNext()) {
         Entry var3 = (Entry)var2.next();
         var1.write(var3.getKey() + "," + ((RadioChannel)var3.getValue()).getCurrentScriptLoop() + "," + ((RadioChannel)var3.getValue()).getCurrentScriptMaxLoops());
