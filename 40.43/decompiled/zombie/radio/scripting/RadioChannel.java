      ...
      if (this.airingBroadcast != null) {
         ...
         if (this.airCounter < 0.0F) {
            ...
            if (var1 == null) {
               ...
               ChatMessage var2 = null;
               if (ChatServer.isInited()) {
                  var2 = ChatServer.getInstance().createRadiostationMessage(var1.getText(), this.frequency);
               } else {
                  var2 = ChatManager.getInstance().createRadiostationMessage(var1.getText(), this.frequency);
               }
