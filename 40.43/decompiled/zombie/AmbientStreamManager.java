...
public class AmbientStreamManager extends BaseAmbientStreamManager {
         ...
         if (UIManager.getSpeedControls() == null || UIManager.getSpeedControls().getCurrentGameSpeed() != 0) {
            if (IsoPlayer.instance != null) {
               if (IsoPlayer.instance.getCurrentSquare() != null) {
                  ...
                  boolean var6 = IsoPlayer.instance.getCurrentSquare().getRoom() != null;
                  ...
                  for(var5 = 0; var5 < this.rainAmbient.size(); ++var5) {
                     ...
                     if (((AmbientStreamManager.AmbientLoop)this.rainAmbient.get(var5)).channel != 0L) {
                        javafmod.FMOD_Studio_SetParameter(((AmbientStreamManager.AmbientLoop)this.rainAmbient.get(var5)).channel, "Intensity", ClimateManager.getInstance().getPrecipitationIntensity());
                     }
                  }
   ...
   public void doGunEvent() {
      ...
      if (!var1.isEmpty()) {
         ...
         var4 += this.tempo.x;
         var5 += this.tempo.y;
         WorldSoundManager.instance.addSound((IsoObject)null, (int)var4, (int)var5, 0, var6, var6);
         float var9 = 1.0F;
   ...
   public void doAlarm(RoomDef var1) {
      if (!var1.building.isAllExplored()) {
   ...
   public class Ambient {
      ...
      public Ambient(String var2, float var3, float var4, float var5, float var6) {
         this(var2, var3, var4, var5, var6, false);
      }

      public Ambient(String var2, float var3, float var4, float var5, float var6, boolean var7) {
         ...
         this.emitter.y = var4;
         this.emitter.z = 0.0F;
         this.emitter.playAmbientSound(var2);
         this.update();
      ...
      public void update() {
         ...
         if (this.trackMouse && IsoPlayer.instance != null) {
            ...
            float var2 = (float)(Core.getInstance().getScreenHeight() - Mouse.getY() - 1);
            ...
            int var3 = (int)IsoPlayer.instance.getZ();
            this.emitter.x = (float)((int)IsoUtils.XToIso(var1 - 30.0F, var2 - 366.0F, (float)var3));
            this.emitter.y = (float)((int)IsoUtils.YToIso(var1 - 30.0F, var2 - 366.0F, (float)var3));
         }
