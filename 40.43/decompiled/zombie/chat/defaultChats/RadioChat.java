...
public class RadioChat extends RangeBasedChat {
   ...
   public void showMessage(ChatMessage var1) {
      Radio var2 = this.getChatOwner().getEquipedRadio();
      if (var2 != null && var2.getDeviceData() != null) {
         boolean var3 = var2.getDeviceData().getIsTurnedOn();
         var3 &= var2.getDeviceData().getIsTwoWay();
         var3 &= var2.getDeviceData().getIsPortable();
         var3 &= !var2.getDeviceData().getMicIsMuted();
         if (var3) {
   ...
   public void sendToServer(ChatMessage var1) {
      int var2 = (int)this.getChatOwner().getX();
      int var3 = (int)this.getChatOwner().getY();
      int var4 = this.getChatOwner().getEquipedRadio().getDeviceData().getTransmitRange();
      ZomboidRadio.getInstance().SendTransmission(var2, var3, var1, var4);
   }
