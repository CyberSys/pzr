...
public abstract class ChatBase {
   ...
   public void sendMessageToPlayer(UdpConnection var1, ChatMessage var2) {
      synchronized(this.memberLock) {
         ...
         if (!var4) {
            ...
            this.sendMessagePacket((short)186, var1, var2);
         }
      }
   }

   public void sendMessageToPlayer(int var1, ChatMessage var2) {
      UdpConnection var3 = ChatUtility.findConnection(var1);
      if (var3 != null) {
         this.sendMessagePacket((short)186, var3, var2);
   ...
   public void addMember(int var1) {
      synchronized(this.memberLock) {
   ...
   public void leaveMember(Integer var1) {
      synchronized(this.memberLock) {
         if (this.hasMember(var1)) {
   ...
   private boolean hasMember(int var1) {
      return this.members.contains(var1);
   }

   public void removeMember(Integer var1) {
      synchronized(this.memberLock) {
         if (this.hasMember(var1)) {
            this.members.remove(var1);
         }
   ...
   public void sendPlayerJoinChatPacket(UdpConnection var1) {
      ...
      PacketTypes.doPacket((short)183, var2);
      this.packChat(var2);
      var1.endPacketImmediate();
   }

   public void sendPlayerLeaveChatPacket(Integer var1) {
   ...
   public void sendPlayerLeaveChatPacket(UdpConnection var1) {
      ByteBufferWriter var2 = var1.startPacket();
      PacketTypes.doPacket((short)184, var2);
   ...
   public void sendToServer(ChatMessage var1) {
      ...
      this.sendMessagePacket((short)185, this.serverConnection, var1);
   }

   private void sendMessagePacket(short var1, UdpConnection var2, ChatMessage var3) {
      ByteBufferWriter var4 = var2.startPacket();
      PacketTypes.doPacket(var1, var4);
      this.packMessage(var4, var3);
