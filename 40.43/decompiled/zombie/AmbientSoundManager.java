...
public class AmbientSoundManager extends BaseAmbientStreamManager {
   ...
   public void doGunEvent() {
      ...
      if (!var1.isEmpty()) {
         ...
         var4 += this.tempo.x;
         var5 += this.tempo.y;
         WorldSoundManager.instance.addSound((IsoObject)null, (int)var4 + Rand.Next(-10, 10), (int)var5 + Rand.Next(-10, 10), 0, 600, 600);
         switch(Rand.Next(6)) {
         case 0:
   ...
   public class Ambient {
      ...
      public void update() {
         ...
         if (var1 - this.startTime >= (long)this.worldSoundDelay) {
            WorldSoundManager.instance.addSound((IsoObject)null, (int)this.x, (int)this.y, 0, 600, 600);
         }
