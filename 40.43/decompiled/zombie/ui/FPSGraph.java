      ...
      if (this.isVisible()) {
         if (UIManager.getClock() == null || UIManager.getClock().isVisible()) {
            ...
            if (var2 >= 0 && var2 < this.upsGraph.bars.size()) {
               ...
               this.DrawTextureScaledCol(UIElement.white, (double)(var2 * this.BAR_WID + this.BAR_WID / 2), 0.0D, 1.0D, this.getHeight(), 1.0D, 1.0D, 1.0D, 0.5D);
            }
   ...
   private class Graph {
      ...
      public void render(float var1, float var2, float var3) {
         if (!this.bars.isEmpty()) {
            ...
            int var6 = Math.max(PerformanceSettings.LockFPS, PerformanceSettings.LightingFPS);
            int var7 = FPSGraph.this.BAR_WID;
            ...
            for(int var9 = 1; var9 < this.bars.size() - 1; ++var9) {
               ...
               SpriteRenderer.instance.renderline((Texture)null, FPSGraph.this.getAbsoluteX().intValue() + var7 - FPSGraph.this.BAR_WID + FPSGraph.this.BAR_WID / 2, FPSGraph.this.getAbsoluteY().intValue() + (int)(var5 - var8), FPSGraph.this.getAbsoluteX().intValue() + var7 + FPSGraph.this.BAR_WID / 2, FPSGraph.this.getAbsoluteY().intValue() + (int)(var5 - var10), var1, var2, var3, 0.35F, 1);
               var7 += FPSGraph.this.BAR_WID;
               var8 = var10;
            }
