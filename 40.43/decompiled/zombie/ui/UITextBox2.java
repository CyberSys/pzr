...
public class UITextBox2 extends UIElement {
   ...
   public void render() {
      if (this.isVisible()) {
         if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
            ...
            super.render();
            this.Paginate();
            int var18 = TextManager.instance.getFontFromEnum(this.font).getLineHeight();
            var2 = this.getInset();
            ...
            if (this.bClearButton && this.clearButtonTexture != null && !this.Lines.isEmpty()) {
               ...
               this.DrawTexture(this.clearButtonTexture, (double)(this.width - (float)var2 - 2.0F - (float)this.clearButtonTexture.getWidth()), (double)(var2 + (var18 - this.clearButtonTexture.getHeight()) / 2), (double)(var4 * this.clearButtonTransition.fraction() + 0.35F * (1.0F - this.clearButtonTransition.fraction())));
            }
                  ...
                  if (this.Lines.get(var9) != null) {
                     if (var9 >= 0 && var9 < this.HighlightLines.length) {
                        if (this.HighlightLines[var9] == 1) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var18, this.NuetralColour);
                        } else if (this.HighlightLines[var9] == 2) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var18, this.NuetralColour2);
                        } else if (this.HighlightLines[var9] == 3) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var18, this.BadColour);
                        } else if (this.HighlightLines[var9] == 4) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var18, this.GoodColour);
                        }
                     }
            ...
            if (this.DoingTextEntry) {
               if (this.BlinkState) {
                  var8 = 0;
                  if (this.Lines.size() > 0) {
                     var9 = this.TextEntryCursorPos - this.TextOffsetOfLineStart.get(this.CursorLine);
                     var9 = Math.min(var9, ((String)this.Lines.get(this.CursorLine)).length());
                     var8 = TextManager.instance.getFontFromEnum(this.font).getWidth(((String)this.Lines.get(this.CursorLine)).substring(0, var9), true);
                     if (var8 > 0) {
                        --var8;
                     }
                  }

                  this.DrawTextureScaledCol(Texture.getSharedTexture("media/white.png"), (double)(-this.XOffset + var2 + var8), (double)(var2 + this.CursorLine * var18), 1.0D, (double)var18, this.TextEntryCursorColour);
               }

               if (this.Lines.size() > 0 && this.ToSelectionIndex != this.TextEntryCursorPos) {
                  var8 = Math.min(this.TextEntryCursorPos, this.ToSelectionIndex);
                  var9 = Math.max(this.TextEntryCursorPos, this.ToSelectionIndex);
                  int var20 = this.toDisplayLine(var8);
                  int var11 = this.toDisplayLine(var9);

                  for(int var12 = var20; var12 <= var11; ++var12) {
                     int var13 = this.TextOffsetOfLineStart.get(var12);
                     int var14 = var13 + ((String)this.Lines.get(var12)).length();
                     var13 = Math.max(var13, var8);
                     var14 = Math.min(var14, var9);
                     String var15 = (String)this.Lines.get(var12);
                     int var16 = TextManager.instance.getFontFromEnum(this.font).getWidth(var15.substring(0, var13 - this.TextOffsetOfLineStart.get(var12)), true);
                     int var17 = TextManager.instance.getFontFromEnum(this.font).getWidth(var15.substring(0, var14 - this.TextOffsetOfLineStart.get(var12)), true);
                     this.DrawTextureScaledCol((Texture)null, (double)(-this.XOffset + var2 + var16), (double)(var2 + var12 * var18), (double)(var17 - var16), (double)var18, this.TextEntryCursorColour2);
                  }
               }
            }
         ...
         if (!this.multipleLine) {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
               ...
               if (var6.length() == 0) {
                  ...
                  this.TextOffsetOfLineStart.add(var2);
                  ++var2;
               } else {
                  do {
                     int var8 = var6.indexOf(" ", var7 + 1);
                     int var9 = var8;
                     if (var8 == -1) {
                        var9 = var6.length();
                     }

                     int var10 = TextManager.instance.MeasureStringX(this.font, var6.substring(0, var9));
                     byte var11 = 17;
                     if ((double)var10 >= this.getWidth() - (double)(this.getInset() * 2) - (double)var11 && var7 > 0) {
                        String var12 = var6.substring(0, var7);
   ...
   public void onPressUp() {
      if (this.getTable() != null && this.getTable().rawget("onPressUp") != null) {
         Object[] var1 = LuaManager.caller.pcall(LuaManager.thread, this.getTable().rawget("onPressUp"));
      }
   ...
   public void onPressDown() {
      if (this.getTable() != null && this.getTable().rawget("onPressDown") != null) {
         Object[] var1 = LuaManager.caller.pcall(LuaManager.thread, this.getTable().rawget("onPressDown"));
      }
   ...
   public void onCommandEntered() {
      if (this.getTable() != null && this.getTable().rawget("onCommandEntered") != null) {
         Object[] var1 = LuaManager.caller.pcall(LuaManager.thread, this.getTable().rawget("onCommandEntered"), (Object)this.table);
      }
   ...
   public void onOtherKey(int var1) {
      if (this.getTable() != null && this.getTable().rawget("onOtherKey") != null) {
         Object[] var2 = LuaManager.caller.pcall(LuaManager.thread, this.getTable().rawget("onOtherKey"), (Object)var1);
      }
