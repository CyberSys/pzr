...
public class TextDrawObject {
   ...
   private void addText(String var1) {
      ...
      TextDrawObject.DrawLine var2 = this.currentLine;
      var2.charW = var2.charW + var1.length();
   }
      ...
      if (this.allowFonts && var3.equals("fnt")) {
         ...
         if ((this.allowImages || this.allowChatIcons) && var3.equals("img")) {
            ...
            if (var4 != null) {
               ...
               if (var5.length == 3) {
                  int var6 = this.tryColorInt(var5[0]);
                  var7 = this.tryColorInt(var5[1]);
                  var8 = this.tryColorInt(var5[2]);
   ...
   public void calculateDimensions() {
      ...
      while(var2.hasNext()) {
         var3 = (TextDrawObject.DrawLine)var2.next();
         var3.h = 0;
         var3.w = 0;
         Iterator var4 = var3.elements.iterator();
      ...
      if (this.equalizeLineHeights) {
         ...
         for(var2 = this.lines.iterator(); var2.hasNext(); this.height += var1) {
            var3 = (TextDrawObject.DrawLine)var2.next();
            var3.h = var1;
         }
      }
   ...
   public void DrawRaw(TextDrawHorizontal var1, double var2, double var4, float var6, float var7, float var8, float var9, boolean var10) {
      ...
      double var13 = var4;
      double var15 = 0.0D;
      int var17 = Core.getInstance().getOffscreenTrueWidth();
      int var18 = Core.getInstance().getOffscreenTrueWidth();
      byte var19 = 20;
      ...
      if (!(var11 - (double)var19 >= (double)var17) && !(var11 + (double)this.getWidth() + (double)var19 <= 0.0D) && !(var4 - (double)var19 >= (double)var18) && !(var4 + (double)this.getHeight() + (double)var19 <= 0.0D)) {
         ...
         TextDrawObject.DrawLine var22;
         for(Iterator var21 = this.lines.iterator(); var21.hasNext(); var13 += (double)var22.h) {
            var22 = (TextDrawObject.DrawLine)var21.next();
            var11 = var2;
            if (var1 == TextDrawHorizontal.Center) {
            ...
            TextDrawObject.DrawElement var24;
            for(Iterator var23 = var22.elements.iterator(); var23.hasNext(); var11 += (double)var24.w) {
               var24 = (TextDrawObject.DrawElement)var23.next();
               ...
               if (var24.isImage && var24.tex != null) {
                  if (var10 && var24.isTextImage) {
                     SpriteRenderer.instance.render(var24.tex, (int)(var11 - 1.0D), (int)(var13 + var15 - 1.0D), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20);
                     SpriteRenderer.instance.render(var24.tex, (int)(var11 + 1.0D), (int)(var13 + var15 + 1.0D), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20);
                     SpriteRenderer.instance.render(var24.tex, (int)(var11 - 1.0D), (int)(var13 + var15 + 1.0D), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20);
                     SpriteRenderer.instance.render(var24.tex, (int)(var11 + 1.0D), (int)(var13 + var15 - 1.0D), var24.w, var24.h, this.outlineR, this.outlineG, this.outlineB, var20);
                  }
                  ...
                  if (var24.useColor) {
                     SpriteRenderer.instance.render(var24.tex, (int)var11, (int)(var13 + var15), var24.w, var24.h, var24.R, var24.G, var24.B, var9);
                  } else if (var24.isTextImage) {
                     SpriteRenderer.instance.render(var24.tex, (int)var11, (int)(var13 + var15), var24.w, var24.h, var6, var7, var8, var9);
                  } else {
                     SpriteRenderer.instance.render(var24.tex, (int)var11, (int)(var13 + var15), var24.w, var24.h, 1.0F, 1.0F, 1.0F, var9);
                  }
   ...
   private class DrawElement {
      ...
      private TextDrawObject.DrawElement softclone() {
         TextDrawObject.DrawElement var1 = TextDrawObject.this.new DrawElement();
         if (this.useColor) {
            var1.R = this.R;
            var1.G = this.G;
            var1.B = this.B;
