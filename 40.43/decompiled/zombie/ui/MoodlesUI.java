...
public class MoodlesUI extends UIElement {
   ...
   public void render() {
      if (this.UseCharacter != null) {
         float var1 = (float)PerformanceSettings.LockFPS / 30.0F;
         ...
         for(int var3 = 0; var3 < MoodleType.ToIndex(MoodleType.MAX); ++var3) {
            if (this.MoodleSlotsPos[var3] != 10000.0F) {
               ...
               this.DrawTexture(var5, (double)(0 + (int)var4), (double)((int)this.MoodleSlotsPos[var3]), (double)this.alpha);
               this.DrawTexture(var6, (double)(0 + (int)var4), (double)((int)this.MoodleSlotsPos[var3]), (double)this.alpha);
               int var9;
               int var10;
               if (this.UseCharacter.getMoodles().getMoodleChevronCount(var3) > 0) {
                  ...
                  for(var9 = 0; var9 < this.UseCharacter.getMoodles().getMoodleChevronCount(var3); ++var9) {
                     var10 = var9 * 4;
                     this.DrawTextureCol(var7 ? chevronUp : chevronDown, (double)(0 + (int)var4 + 16), (double)((int)this.MoodleSlotsPos[var3] + 20 - var10), var8);
                     this.DrawTextureCol(var7 ? chevronUpBorder : chevronDownBorder, (double)(0 + (int)var4 + 16), (double)((int)this.MoodleSlotsPos[var3] + 20 - var10), var8);
                  }
               }
