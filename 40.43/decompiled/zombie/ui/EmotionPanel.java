...
public class EmotionPanel extends UIElement {
   HUDButton a = new HUDButton("angry", 0.0D, 0.0D, "media/ui/Emotion_Aggressive.png", "media/ui/Emotion_Aggressive_MouseOver.png", this);
   HUDButton b;
   HUDButton c;
   int selected = 1;
   Texture aggSel;
   ...
   public EmotionPanel(int var1, int var2) {
      this.b = new HUDButton("neutral", this.a.getWidth(), 0.0D, "media/ui/Emotion_Neutral.png", "media/ui/Emotion_Neutral_MouseOver.png", this);
      this.c = new HUDButton("happy", this.a.getWidth() + this.b.getWidth(), 0.0D, "media/ui/Emotion_Friendly.png", "media/ui/Emotion_Friendly_MouseOver.png", this);
   ...
   public void ButtonClicked(String var1) {
      ...
      if (IsoCamera.CamCharacter.getMoodles().getMoodleLevel(MoodleType.Angry) <= 2 && var1.equals("neutral")) {
         IsoPlayer.instance.setDialogMood(1);
      }

      if (IsoCamera.CamCharacter.getMoodles().getMoodleLevel(MoodleType.Angry) <= 1 && var1.equals("happy")) {
