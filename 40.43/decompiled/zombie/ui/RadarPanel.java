   ...
   private void renderZombies() {
      ...
      for(var6 = 0; var6 < this.zombiePosOccupied.length; ++var6) {
         if (this.zombiePosOccupied[var6]) {
            ...
            SpriteRenderer.instance.render((Texture)null, var1 + (var3 + 1.0F) * (float)Math.cos(var23) - var4, var2 + (var3 + 1.0F) * (float)Math.sin(var23) - var4, 1.0F * this.zoom, 1.0F * this.zoom, 1.0F, 1.0F, 0.0F, 1.0F);
         }
      }
