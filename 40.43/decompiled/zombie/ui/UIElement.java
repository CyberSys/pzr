...
public class UIElement {
   ...
   public void DrawText(UIFont var1, String var2, double var3, double var5, double var7, double var9, double var11, double var13, double var15) {
      TextManager.instance.DrawString(var1, var3 + this.getAbsoluteX() + this.xScroll, var5 + this.getAbsoluteY() + this.yScroll, (float)var7, var2, var9, var11, var13, var15);
   }
   ...
   public void DrawTextureAngle(Texture var1, double var2, double var4, double var6) {
      if (this.isVisible()) {
         ...
         float var10 = 1.0F;
         float var11 = 1.0F;
         float var12 = (float)(var1.getWidth() / 2);
         float var13 = (float)(var1.getHeight() / 2);
         double var14 = Math.toRadians(180.0D + var6);
         double var16 = Math.cos(var14) * (double)var12;
         double var18 = Math.sin(var14) * (double)var12;
         double var20 = Math.cos(var14) * (double)var13;
         double var22 = Math.sin(var14) * (double)var13;
         double var24 = var16 - var22;
         double var26 = var20 + var18;
         double var28 = -var16 - var22;
         double var30 = var20 - var18;
         double var32 = -var16 + var22;
         double var34 = -var20 - var18;
         double var36 = var16 + var22;
         double var38 = -var20 + var18;
         var24 += this.getAbsoluteX() + var2;
         var26 += this.getAbsoluteY() + var4;
         ...
         SpriteRenderer.instance.render(var1, var24, var26, var28, var30, var32, var34, var36, var38, var8, var9, var10, var11, var8, var9, var10, var11, var8, var9, var10, var11, var8, var9, var10, var11);
      }
   }
   ...
   public void DrawTexture(Texture var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, double var18, double var20, double var22, double var24) {
      SpriteRenderer.instance.render(var1, var2, var4, var6, var8, var10, var12, var14, var16, (float)var18, (float)var20, (float)var22, (float)var24, (float)var18, (float)var20, (float)var22, (float)var24, (float)var18, (float)var20, (float)var22, (float)var24, (float)var18, (float)var20, (float)var22, (float)var24);
   }
   ...
   public void DrawTexture(Texture var1, double var2, double var4, double var6) {
      if (this.isVisible()) {
         ...
         if (var12 + var1.getHeight() >= 0 && var12 <= 4096) {
            var6 = Math.min(var6 * (double)UIManager.FBO_ALPHA_MULT, 1.0D);
            SpriteRenderer.instance.render(var1, (float)(var8 + this.xScroll), (float)(var10 + this.yScroll), (float)var1.getWidth(), (float)var1.getHeight(), 1.0F, 1.0F, 1.0F, (float)var6);
         }
      }
   }
   ...
   public void DrawTextureCol(Texture var1, double var2, double var4, Color var6) {
      if (this.isVisible()) {
         ...
         if (var13 + var12 >= 0 && var13 <= 4096) {
            float var14 = Math.min(var6.a * UIManager.FBO_ALPHA_MULT, 1.0F);
            SpriteRenderer.instance.render(var1, (float)(var7 + this.xScroll), (float)(var9 + this.yScroll), (float)var11, (float)var12, var6.r, var6.g, var6.b, var14);
         }
      }
   }
   ...
   public void DrawTextureScaled(Texture var1, double var2, double var4, double var6, double var8, double var10) {
      if (this.isVisible()) {
         ...
         var10 = Math.min(var10 * (double)UIManager.FBO_ALPHA_MULT, 1.0D);
         SpriteRenderer.instance.render(var1, (float)(var12 + this.xScroll), (float)(var14 + this.yScroll), (float)var6, (float)var8, 1.0F, 1.0F, 1.0F, (float)var10);
      }
   }
   ...
   public void DrawTextureScaledUniform(Texture var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14) {
      if (this.isVisible() && var1 != null) {
         ...
         SpriteRenderer.instance.render(var1, (float)(var16 + this.xScroll), (float)(var18 + this.yScroll), (float)((double)var1.getWidth() * var6), (float)((double)var1.getHeight() * var6), (float)var8, (float)var10, (float)var12, (float)var14);
      }
   }
   ...
   public void DrawTextureScaledAspect(Texture var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16) {
      if (this.isVisible() && var1 != null) {
         ...
         var16 = Math.min(var16 * (double)UIManager.FBO_ALPHA_MULT, 1.0D);
         SpriteRenderer.instance.render(var1, (float)(var18 + this.xScroll), (float)(var20 + this.yScroll), (float)var6, (float)var8, (float)var10, (float)var12, (float)var14, (float)var16);
      }
   }
   ...
   public void DrawTextureScaledCol(Texture var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16) {
      ...
      if (this.isVisible()) {
         ...
         if (!((double)var22 + var8 < 0.0D) && var22 <= 4096) {
            var16 = Math.min(var16 * (double)UIManager.FBO_ALPHA_MULT, 1.0D);
            SpriteRenderer.instance.render(var1, (float)(var23 + this.xScroll), (float)(var20 + this.yScroll), (float)var6, (float)var8, (float)var10, (float)var12, (float)var14, (float)var16);
         }
      }
   }
   ...
   public void DrawTextureScaledCol(Texture var1, double var2, double var4, double var6, double var8, Color var10) {
      ...
      if (this.isVisible()) {
         ...
         float var15 = Math.min(var10.a * UIManager.FBO_ALPHA_MULT, 1.0F);
         SpriteRenderer.instance.render(var1, (float)(var16 + this.xScroll), (float)(var13 + this.yScroll), (float)var6, (float)var8, var10.r, var10.g, var10.b, var15);
      }
   }
   ...
   public void DrawTextureIgnoreOffset(Texture var1, double var2, double var4, int var6, int var7, Color var8) {
      if (this.isVisible()) {
         ...
         SpriteRenderer.instance.render(var1, (float)(var9 + this.xScroll), (float)(var11 + this.yScroll), (float)var6, (float)var7, var8.r, var8.g, var8.b, var8.a);
      }
   }
   ...
   public void DrawTexture_FlippedX(Texture var1, double var2, double var4, int var6, int var7, Color var8) {
      if (this.isVisible()) {
         double var9 = var2 + this.getAbsoluteX();
         double var11 = var4 + this.getAbsoluteY();
         SpriteRenderer.instance.renderflipped(var1, (float)(var9 + this.xScroll), (float)(var11 + this.yScroll), (float)var6, (float)var7, var8.r, var8.g, var8.b, var8.a);
      }
   }
   ...
   void onRightMouseUpOutside(double var1, double var3) {
      if (this.getTable() != null && this.getTable().rawget("onRightMouseUpOutside") != null) {
         Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseUpOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
      }
   ...
   void onRightMouseDownOutside(double var1, double var3) {
      if (this.getTable() != null && this.getTable().rawget("onRightMouseDownOutside") != null) {
         Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseDownOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
      }
   ...
   void onMouseUpOutside(double var1, double var3) {
      if (this.getTable() != null && this.getTable().rawget("onMouseUpOutside") != null) {
         Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseUpOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
      }
   ...
   void onMouseDownOutside(double var1, double var3) {
      if (this.getTable() != null && this.getTable().rawget("onMouseDownOutside") != null) {
         Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseDownOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
      }
      ...
      if (this.clicked && UIManager.isDoubleClick((double)((int)this.clickX), (double)((int)this.clickY), (double)((int)var1), (double)((int)var3), (double)this.leftDownTime) && this.getTable() != null && this.getTable().rawget("onMouseDoubleClick") != null) {
         ...
         if (this.Parent != null && this.Parent.maxDrawHeight != -1 && (double)this.Parent.maxDrawHeight <= var3) {
            ...
            if (this.getTable() != null && this.getTable().rawget("onFocus") != null) {
               Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onFocus"), this.table, var1 - this.xScroll, var3 - this.yScroll);
            }
            ...
            for(int var6 = this.getControls().size() - 1; var6 >= 0; --var6) {
               ...
               if (!var9 && (var1 > var7.getXScrolled(this) && var3 > var7.getYScrolled(this) && var1 < var7.getXScrolled(this) + var7.getWidth() && var3 < var7.getYScrolled(this) + var7.getHeight() || var7.isCapture())) {
                  ...
                  Object[] var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), var7.getTable().rawget("onMouseDownOutside"), var7.getTable(), var1 - this.xScroll, var3 - this.yScroll);
               }
            }
            ...
            if (this.getTable() != null) {
               ...
               if (var9) {
                  if (this.getTable().rawget("onMouseDownOutside") != null) {
                     var10 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseDownOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
                     if (var10.length == 1) {
                        return true;
                     }

                     if (var10.length > 1 && var10[1] instanceof Boolean && (Boolean)((Boolean)var10[1])) {
                        return Boolean.TRUE;
                     }
                  }
               } else if (this.getTable().rawget("onMouseDown") != null) {
                  var10 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseDown"), this.table, var1 - this.xScroll, var3 - this.yScroll);
                  if (var10.length == 1) {
                     return true;
                  }
   ...
   private Boolean onMouseDoubleClick(double var1, double var3) {
      if (this.Parent != null && this.Parent.maxDrawHeight != -1 && (double)this.Parent.maxDrawHeight <= this.y) {
         ...
         if (this.getTable().rawget("onMouseDoubleClick") != null) {
            Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseDoubleClick"), this.table, var1 - this.xScroll, var3 - this.yScroll);
            if (var5.length == 1) {
               return true;
            }

            if (var5.length > 1 && var5[1] instanceof Boolean && (Boolean)((Boolean)var5[1])) {
               return Boolean.TRUE;
            }
         }
   ...
   public Boolean onMouseWheel(double var1) {
      ...
      if (this.getTable() != null && this.getTable().rawget("onMouseWheel") != null) {
         Object[] var5 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseWheel"), this.table, var1);
         if (var5.length > 1 && var5[1] instanceof Boolean && (Boolean)((Boolean)var5[1])) {
            return Boolean.TRUE;
         }
      }
   ...
   public Boolean onMouseMove(double var1, double var3) {
      ...
      if (this.Parent != null && this.Parent.maxDrawHeight != -1 && (double)this.Parent.maxDrawHeight <= this.y) {
         ...
         if (this.getTable() != null && this.getTable().rawget("onMouseMove") != null) {
            Object[] var7 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseMove"), this.table, var1, var3);
         }
         ...
         for(int var8 = this.getControls().size() - 1; var8 >= 0; --var8) {
            ...
            } else if (!var10 && var9.onMouseMove(var1, var3)) {
               var10 = true;
            }
         }
   ...
   public void onMouseMoveOutside(double var1, double var3) {
      ...
      if (this.getTable() != null && this.getTable().rawget("onMouseMoveOutside") != null) {
         Object[] var7 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseMoveOutside"), this.table, var1, var3);
      }

      for(int var9 = this.getControls().size() - 1; var9 >= 0; --var9) {
         UIElement var8 = (UIElement)this.getControls().get(var9);
         var8.onMouseMoveOutside(var1, var3);
      }
   ...
   public Boolean onMouseUp(double var1, double var3) {
      if (this.Parent != null && this.Parent.maxDrawHeight != -1 && (double)this.Parent.maxDrawHeight <= var3) {
         ...
         for(int var6 = this.getControls().size() - 1; var6 >= 0; --var6) {
            ...
            } else if (var7.onMouseUp(var1 - (double)var7.getXScrolled(this).intValue(), var3 - (double)var7.getYScrolled(this).intValue())) {
               var5 = true;
            }
         }
         ...
         if (this.getTable() != null) {
            ...
            if (var5) {
               if (this.getTable().rawget("onMouseUpOutside") != null) {
                  var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseUpOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
                  if (var8.length == 1) {
                     return true;
                  }

                  if (var8.length > 1 && var8[1] instanceof Boolean && (Boolean)((Boolean)var8[1])) {
                     return Boolean.TRUE;
                  }
               }
            } else if (this.getTable().rawget("onMouseUp") != null) {
               var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onMouseUp"), this.table, var1 - this.xScroll, var3 - this.yScroll);
               if (var8.length == 1) {
                  return true;
               }
      ...
      if (!this.isVisible()) {
         ...
         for(int var6 = this.getControls().size() - 1; var6 >= 0; --var6) {
            ...
            if (!var5 && (var1 >= var7.getXScrolled(this) && var3 >= var7.getYScrolled(this) && var1 < var7.getXScrolled(this) + var7.getWidth() && var3 < var7.getYScrolled(this) + var7.getHeight() || var7.isCapture())) {
               ...
               Object[] var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), var7.getTable().rawget("onRightMouseDownOutside"), var7.getTable(), var1 - this.xScroll, var3 - this.yScroll);
            }
         }
         ...
         if (this.getTable() != null) {
            ...
            if (var5) {
               if (this.getTable().rawget("onRightMouseDownOutside") != null) {
                  var9 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseDownOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
                  if (var9.length == 1) {
                     return true;
                  }

                  if (var9.length > 1 && var9[1] instanceof Boolean && (Boolean)((Boolean)var9[1])) {
                     return Boolean.TRUE;
                  }
               }
            } else if (this.getTable().rawget("onRightMouseDown") != null) {
               var9 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseDown"), this.table, var1 - this.xScroll, var3 - this.yScroll);
               if (var9.length == 1) {
                  return true;
               }
   ...
   public Boolean onRightMouseUp(double var1, double var3) {
      if (!this.isVisible()) {
         ...
         for(int var6 = this.getControls().size() - 1; var6 >= 0; --var6) {
            ...
            } else if (var7.onRightMouseUp(var1 - (double)var7.getXScrolled(this).intValue(), var3 - (double)var7.getYScrolled(this).intValue())) {
               var5 = true;
            }
         }
         ...
         if (this.getTable() != null) {
            ...
            if (var5) {
               if (this.getTable().rawget("onRightMouseUpOutside") != null) {
                  var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseUpOutside"), this.table, var1 - this.xScroll, var3 - this.yScroll);
                  if (var8.length == 1) {
                     return true;
                  }
               ...
               var8 = LuaManager.caller.pcall(UIManager.getDefaultThread(), this.getTable().rawget("onRightMouseUp"), this.table, var1 - this.xScroll, var3 - this.yScroll);
               if (var8.length == 1) {
                  return true;
               }
      ...
      if (this.enabled) {
         if (this.isVisible()) {
            if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
               ...
               for(int var1 = 0; var1 < this.getControls().size(); ++var1) {
                  ((UIElement)this.getControls().get(var1)).render();
               }
               ...
               if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
                  ...
                  Double var4 = -this.getXScroll();
                  Double var5 = -this.getYScroll();
                  this.DrawTextureScaledColor((Texture)null, var4, var5, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var4 + 1.0D, var5, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var4 + (double)this.width - 1.0D, var5, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
                  this.DrawTextureScaledColor((Texture)null, var4 + 1.0D, var5 + (double)this.height - 1.0D, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
               }
   ...
   public void setStencilRect(double var1, double var3, double var5, double var7) {
      ...
      SpriteRenderer.instance.render(white, (int)var1, (int)var3, (int)var5, (int)var7, 0.0F, 0.0F, 0.0F, 0.01F);
