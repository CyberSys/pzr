...
public class ServerPulseGraph extends UIElement {
   ...
   private int BAR_WID = 4;
   private int BAR_PAD = 1;
   ...
   public void add(long var1) {
      if (var1 < 0L) {
         ...
         while(this.bars.size() > this.NUM_BARS) {
   ...
   public void update() {
      if (this.isVisible()) {
         ...
         this.setWidth((double)(this.NUM_BARS * this.BAR_WID + (this.NUM_BARS - 1) * this.BAR_PAD));
         super.update();
      }
   }
         ...
         if (UIManager.getClock() == null || UIManager.getClock().isVisible()) {
            ...
            if (!this.bars.isEmpty()) {
               ...
               for(int var2 = 0; var2 < this.bars.size(); ++var2) {
                  ...
                  this.DrawTextureScaledCol(UIElement.white, (double)var1, this.getHeight() - (double)var3, (double)this.BAR_WID, (double)var3, 1.0D, 1.0D, 1.0D, 0.3499999940395355D);
                  var1 += this.BAR_WID + this.BAR_PAD;
               }
