...
public class UI_BodyPart extends UIElement {
   ...
   public void render() {
      ...
      if (this.scratchTex != null && var1.IsScratched(this.BodyPartType)) {
      ...
      } else if (this.bandageTex != null && var1.IsBandaged(this.BodyPartType) && var1.getBodyPart(this.BodyPartType).getBandageLife() > 0.0F) {
