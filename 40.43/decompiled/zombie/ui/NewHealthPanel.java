...
public class NewHealthPanel extends NewWindow {
   ...
   public NewHealthPanel(int var1, int var2, IsoGameCharacter var3) {
      ...
      this.visible = false;
      instance = this;
      boolean var4 = TextureID.bUseCompression;
      ...
      TextureID.bUseCompression = var4;
      String var5 = "male";
      if (var3.isFemale()) {
         var5 = "female";
      }
   ...
   public void render() {
      if (this.isVisible()) {
         ...
         this.DrawText(Translator.getText("IGUI_health_Overall_Body_Status"), 165.0D, 0.0D, 1.0D, 1.0D, 1.0D, 1.0D);
         float var4 = (100.0F - var1.getHealth()) * 0.01F;
         if (var4 < 0.2F) {
            var4 = 0.2F;
         }

         this.DrawText(this.getDamageStatusString(), 165.0D, (double)var3, 1.0D, (double)(1.0F - var4), (double)(1.0F - var4), 1.0D);
         if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
            Double var5 = -this.getXScroll();
            Double var6 = -this.getYScroll();
            this.DrawTextureScaledColor((Texture)null, var5, var6, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var5 + 1.0D, var6, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var5 + (double)this.width - 1.0D, var6, 1.0D, (double)this.height, 1.0D, 1.0D, 1.0D, 0.5D);
            this.DrawTextureScaledColor((Texture)null, var5 + 1.0D, var6 + (double)this.height - 1.0D, (double)this.width - 2.0D, 1.0D, 1.0D, 1.0D, 1.0D, 0.5D);
         }
