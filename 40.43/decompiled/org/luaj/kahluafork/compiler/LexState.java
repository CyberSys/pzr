...
public class LexState {
   ...
   public static Prototype compile(int var0, Reader var1, String var2, String var3) {
      ...
      IsoGridSquare.Checksum *= (long)var0;
   ...
   private static String trim(String var0, int var1) {
      return var0.length() > var1 ? var0.substring(0, var1 - 3) + "..." : var0;
   }
   ...
   void inclinenumber() {
      IsoGridSquare.Checksum += (long)this.current;
   ...
   void error_expected(int var1) {
      this.syntaxerror(LUA_QS(this.token2str(var1)) + " expected");
   }
   ...
   void check_match(int var1, int var2, int var3) {
      if (!this.testnext(var1)) {
         if (var3 == this.linenumber) {
            ...
            this.syntaxerror(LUA_QS(this.token2str(var1)) + " expected (to close " + LUA_QS(this.token2str(var2)) + " at line " + var3 + ")");
         }
      }
   ...
   void singlevar(ExpDesc var1) {
      ...
      if (var3.singlevaraux(var2, var1, 1) == 8) {
         ...
         IsoGridSquare.Checksum /= (long)var1.f;
         IsoGridSquare.Checksum += (long)var3.linedefined;
      }
