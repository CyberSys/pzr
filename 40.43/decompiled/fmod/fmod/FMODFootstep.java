...
public class FMODFootstep {
   ...
   public boolean isUpstairs(IsoGameCharacter var1) {
      IsoGridSquare var2 = IsoPlayer.instance.getCurrentSquare();
   ...
   public String getSoundToPlay(IsoGameCharacter var1) {
      if (FMODManager.instance.getNumListeners() == 1) {
         for(int var2 = 0; var2 < IsoPlayer.numPlayers; ++var2) {
            ...
            if (var3 != null && var3 != var1 && !var3.HasTrait("Deaf")) {
      ...
      if (var5 != null && var5.getSprite() != null && var5.getSprite().getName() != null) {
         ...
         if (var6.contains("blends_natural_01")) {
            return this.grass;
         } else if (var6.contains("floors_interior_tilesandwood_01_")) {
            ...
            return var6.contains("interior_carpet_") ? this.wood : this.concrete;
         }
      } else {
