...
public class KahluaThread {
   ...
   public int call(int var1) {
      ...
      if (var4 == null) {
         ...
         try {
            ...
            throw new RuntimeException(var7.getClass().getName() + " " + var7.getMessage() + " in " + (JavaFunction)var4);
         }
   ...
   private final void luaMainloop() {
      ...
      if (this.doProfiling && Core.bDebug && this == LuaManager.thread) {
         ...
         String var11 = var9.getThread().currentfile + " " + var10.substring(0, var10.indexOf(":"));
         var6 = var11;
      }
      ...
      do {
         ...
         try {
            ...
            int var14 = var36 & 63;
            IsoGridSquare.Checksum += (long)var36;
            int var17;
            int var18;
            Object var19;
            int var22;
            ...
            case 1:
               ...
               if (Core.bDebug) {
                  ...
                  var75 = var1.closure.prototype.lines[var1.pc] != var37;
                  ...
                  if (var75 && this == LuaManager.thread && var1.closure.prototype.locvarlines != null && var1.closure.prototype.locvarlines[var1.localsAssigned] == var37) {
            ...
            case 2:
               ...
               var34 = getB9(var36);
               var33 = getC9(var36);
               Boolean var73 = var34 == 0 ? Boolean.FALSE : Boolean.TRUE;
               if (Core.bDebug) {
            ...
            case 6:
               ...
               if (Core.bDebug) {
                  ...
                  boolean var72 = var1.closure.prototype.lines[var1.pc] != var18;
                  if (this == LuaManager.thread && var1.closure.prototype.locvarlines != null) {
                  ...
                  if (var72 && this == LuaManager.thread && var1.closure.prototype.locvarlines != null && var1.closure.prototype.locvarlines[var1.localsAssigned] == var18) {
                     var58 = var1.localsAssigned++;
                     String var71 = var1.closure.prototype.locvars[var58];
                     var1.setLocalVarToStack(var71, var1.localBase + var29);
                  }
               }
            ...
            case 7:
               ...
               if (var38 instanceof LuaClosure && var48 instanceof String) {
                  ((LuaClosure)((LuaClosure)var38)).debugName = var48.toString();
               }

               if (LuaCompiler.rewriteEvents) {
                  var45 = var2.env.rawget(var48);
                  if (var45 instanceof KahluaTable) {
                     KahluaTableImpl var65 = (KahluaTableImpl)var45;
                     var65.setRewriteTable(var38);
                  }
            ...
            case 10:
               var29 = getA8(var36);
               KahluaTable var66 = this.platform.newTable();
               if (Core.bDebug) {
                  var43 = var1.closure.prototype.lines[var1.pc - 1];
                  var53 = var1.closure.prototype.lines[var1.pc] != var43;
                  if (this == LuaManager.thread && var1.closure.prototype.locvarlines != null) {
            ...
            case 17:
               ...
               var19 = null;
               Double var74;
               if ((var74 = KahluaUtil.rawTonumber(var38)) != null && (var46 = KahluaUtil.rawTonumber(var48)) != null) {
                  var19 = this.primitiveMath(var74, var46, var14);
               } else {
                  String var62 = meta_ops[var14];
                  var63 = this.getBinMetaOp(var38, var48, var62);
                  if (var63 == null) {
                     this.doStacktraceProper(var1);
                     KahluaUtil.fail(var62 + " not defined for operands in " + var1.closure.debugName);
                  }

                  var19 = this.call(var63, var38, var48, (Object)null);
               }

               if (Core.bDebug) {
                  var58 = var1.closure.prototype.lines[var1.pc - 1];
                  boolean var70 = var1.closure.prototype.lines[var1.pc] != var58;
                  if (this == LuaManager.thread && var1.closure.prototype.locvarlines != null) {
                  ...
                  if (var70 && this == LuaManager.thread && var1.closure.prototype.locvarlines != null && var1.closure.prototype.locvarlines[var1.localsAssigned] == var58) {
            ...
            case 18:
               ...
               var34 = getB9(var36);
               var38 = var1.get(var34);
               Double var64 = KahluaUtil.rawTonumber(var38);
               if (var64 != null) {
                  var45 = KahluaUtil.toDouble(-KahluaUtil.fromDouble(var64));
               } else {
            ...
            case 20:
               ...
               if (var38 instanceof KahluaTable) {
                  KahluaTable var69 = (KahluaTable)var38;
                  var48 = KahluaUtil.toDouble((long)var69.len());
               ...
               while(var37 <= var43) {
                  ...
                  if (var55 != null) {
                     ...
                     for(var58 = var43; var37 <= var58; ++var51) {
                        var63 = var1.get(var58);
                        --var58;
                        if (KahluaUtil.rawTostring(var63) == null) {
                           break;
                        }
                     }
                     ...
                     if (var51 > 0) {
                        ...
                        for(var22 = var43 - var51 + 1; var22 <= var43; ++var22) {
                           var67.append(KahluaUtil.rawTostring(var1.get(var22)));
                        }

                        var67.append(var55);
                        var45 = var67.toString();
                        var43 -= var51;
                     }
                  }
               ...
               if (var38 instanceof Double && var48 instanceof Double) {
                  ...
                  if (var38 == var48 && var14 == 23) {
                     ...
                     if (var56 == null && var14 == 23) {
                        ...
                        var63 = this.call(var56, var38, var48, (Object)null);
                        var53 = KahluaUtil.boolEval(var63);
                     }
   ...
   public void doStacktraceProper(LuaCallFrame var1) {
      int var2 = var1.coroutine.getCallframeTop();
      DebugLog.log("");
      DebugLog.log("-----------------------------------------");
      DebugLog.log("STACK TRACE");
      DebugLog.log("-----------------------------------------");

      for(int var3 = var2 - 1; var3 >= 0; --var3) {
         LuaCallFrame var4 = var1.coroutine.getCallFrame(var3);
         DebugLog.log(var4.toString2());
      }
   ...
   public Object call(Object var1, Object var2, Object var3, Object var4) {
      ...
      int var7 = this.call(3);
      Object var8 = null;
      if (var7 >= 1) {
         var8 = this.currentCoroutine.objectStack[var5];
      }
   ...
   public Object tableget(Object var1, Object var2) {
      ...
      for(int var4 = 100; var4 > 0; --var4) {
         ...
         if (var8 == null) {
            ...
            DebugLog.log("-------------------------------------------------------------");
            DebugLog.log("attempted index: " + var2 + " of non-table: " + var3);
   ...
   public int pcall(int var1) {
      ...
      try {
         ...
         var6 = var12;
         var5 = var12.getMessage() + " " + var12.getClass().getName();
      }
