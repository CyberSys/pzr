...
public class KahluaTableImpl implements KahluaTable {
   ...
   public int rawgetInt(Object var1) {
      return this.rawget(var1) != null ? ((Double)this.rawget(var1)).intValue() : -1;
   }

   public boolean rawgetBool(Object var1) {
      return this.rawget(var1) != null ? (Boolean)this.rawget(var1) : false;
   }

   public float rawgetFloat(Object var1) {
      return this.rawget(var1) != null ? ((Double)this.rawget(var1)).floatValue() : -1.0F;
   }
   ...
   public void setRewriteTable(Object var1) {
      for(KahluaTableImpl var2 = this; var2 != null; var2 = var2.getRewriteTable()) {
      }
