...
function InterpolationPeriodDebug:createChildren()
	...
	y = self:addLabelValue(x+5, y, labelWidth, "value","TInterpolateX","TInterpolateX:",0);
	y = self:addLabelValue(x+5, y, labelWidth, "value","TInterpolateY","TInterpolateY:",0);
	y = y+8;
...
function InterpolationPeriodDebug:initVariables()
	...
	self:addVarInfo("TInterpolateX","TInterpolateX",-100,100,"TInterpolateX");
	self:addVarInfo("TInterpolateY","TInterpolateY",-100,100,"TInterpolateY");
...
function InterpolationPeriodDebug:updateValues()
	...
	self.historyM1:applyMinMax(minmaxX, 7); -- TInterpolateX
	self.historyM1:applyMinMax(minmaxY, 8); -- TInterpolateY
	self.historyM1:applyMinMax(minmaxT, 11); -- ServerT
	self.historyM1:applyMinMax(minmaxT, 12); -- TargetT
	...
	self:getValueLabel("TInterpolateX").name = tostring(self.zombieInfo.TInterpolateX);
	self:getValueLabel("TInterpolateY").name = tostring(self.zombieInfo.TInterpolateY);
	self:getValueLabel("TargetT").name = tostring(self.zombieInfo.TargetT);
	self:getValueLabel("ServerT").name = tostring(self.zombieInfo.ServerT);
