...
local function mergeDistributions()
    ...
    SuburbsDistributions.clinic = SuburbsDistributions.medclinic
    ...
    SuburbsDistributions.jayschicken_dining = SuburbsDistributions.dining
    ...
    SuburbsDistributions.room1 = SuburbsDistributions.empty
