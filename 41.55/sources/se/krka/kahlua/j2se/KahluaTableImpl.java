...
public final class KahluaTableImpl implements KahluaTable {
	...
	public int rawgetInt(Object object) {
		return this.rawget(object) instanceof Double ? ((Double)this.rawget(object)).intValue() : -1;
	}

	public boolean rawgetBool(Object object) {
		return this.rawget(object) instanceof Boolean ? (Boolean)this.rawget(object) : false;
	}

	public float rawgetFloat(Object object) {
		return this.rawget(object) instanceof Double ? ((Double)this.rawget(object)).floatValue() : -1.0F;
	}
