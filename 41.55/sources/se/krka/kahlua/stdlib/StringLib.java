...
public final class StringLib implements JavaFunction {
				...
				if (char1 == '%') {
					...
					while (true) {
						...
						default: 
							...
							int int8 = stringBuilder.length();
							if (!boolean3) {
								this.extend(stringBuilder, int5, (char)int7);
							}
							...
							case 'f': 
								...
								if (boolean8) {
									...
									this.appendPrecisionNumber(stringBuilder, double1, int6, boolean1);
								} else {
									this.appendScientificNumber(stringBuilder, double1, int6, boolean1, false);
								}
							...
							case 'g': 
								...
								if (boolean8) {
									...
									if (double2 != 0.0 && (!(double2 >= 1.0E-4) || !(double2 < (double)KahluaUtil.ipow(10L, int6)))) {
										this.appendScientificNumber(stringBuilder, double2, int6 - 1, boolean1, true);
										break;
									}
									...
									this.appendSignificantNumber(stringBuilder, double2, int6 - int11, boolean1);
								}
							...
							case 'x': 
								...
								if (long1 != 0L || int6 > 0) {
									stringBufferAppend(stringBuilder, (double)long1, byte1, false, int6);
								}

								break;
							
							case 'c': 
								stringBuilder.append((char)this.getDoubleArg(luaCallFrame, int3).shortValue());
								break;
							...
							case 'i': 
								...
								if (long3 != 0L || int6 > 0) {
									stringBufferAppend(stringBuilder, (double)long3, byte1, false, int6);
								}
							...
							case 's': 
								...
								this.append(stringBuilder, string3, 0, int9);
							
							}

							int int12;
							if (boolean3) {
								int12 = stringBuilder.length();
								int9 = int5 - (int12 - int8);
								if (int9 > 0) {
									this.extend(stringBuilder, int9, ' ');
								}
							} else {
								int12 = stringBuilder.length();
								...
								if (int9 > 0) {
									stringBuilder.delete(int8, int8 + int9);
								}

								if (boolean2) {
									int10 = int8 + (int5 - int9);
									char char3 = stringBuilder.charAt(int10);
									if (char3 == '+' || char3 == '-' || char3 == ' ') {
										stringBuilder.setCharAt(int10, '0');
										stringBuilder.setCharAt(int8, char3);
									}
								}
							}

							if (boolean7) {
								this.stringBufferUpperCase(stringBuilder, int8);
							}
	...
	private void append(StringBuilder stringBuilder, String string, int int1, int int2) {
		for (int int3 = int1; int3 < int2; ++int3) {
			stringBuilder.append(string.charAt(int3));
		}
	}

	private void extend(StringBuilder stringBuilder, int int1, char char1) {
		int int2 = stringBuilder.length();
		stringBuilder.setLength(int2 + int1);
		for (int int3 = int1 - 1; int3 >= 0; --int3) {
			stringBuilder.setCharAt(int2 + int3, char1);
		}
	}

	private void stringBufferUpperCase(StringBuilder stringBuilder, int int1) {
		int int2 = stringBuilder.length();
		for (int int3 = int1; int3 < int2; ++int3) {
			char char1 = stringBuilder.charAt(int3);
			if (char1 >= 'a' && char1 <= 'z') {
				stringBuilder.setCharAt(int3, (char)(char1 - 32));
			}
		}
	}

	private static void stringBufferAppend(StringBuilder stringBuilder, double double1, int int1, boolean boolean1, int int2) {
		int int3;
		for (int3 = stringBuilder.length(); double1 > 0.0 || int2 > 0; --int2) {
			double double2 = Math.floor(double1 / (double)int1);
			stringBuilder.append(digits[(int)(double1 - double2 * (double)int1)]);
			double1 = double2;
		}

		int int4 = stringBuilder.length() - 1;
		if (int3 > int4 && boolean1) {
			...
			for (int int6 = int5 - 1; int6 >= 0; --int6) {
				...
				char char2 = stringBuilder.charAt(int8);
				stringBuilder.setCharAt(int7, char2);
				stringBuilder.setCharAt(int8, char1);
			}
		}
	}

	private void appendPrecisionNumber(StringBuilder stringBuilder, double double1, int int1, boolean boolean1) {
		...
		stringBufferAppend(stringBuilder, double2, 10, true, 0);
		if (boolean1 || int1 > 0) {
			stringBuilder.append('.');
		}

		stringBufferAppend(stringBuilder, double3, 10, false, int1);
	}

	private void appendSignificantNumber(StringBuilder stringBuilder, double double1, int int1, boolean boolean1) {
		double double2 = Math.floor(double1);
		stringBufferAppend(stringBuilder, double2, 10, true, 0);
		...
		stringBuilder.append('.');
		int4 = stringBuilder.length();
		this.extend(stringBuilder, int2, '0');
		int int5 = stringBuilder.length();
		stringBufferAppend(stringBuilder, double3, 10, false, 0);
	...
	private void appendScientificNumber(StringBuilder stringBuilder, double double1, int int1, boolean boolean1, boolean boolean2) {
		int int2 = 0;
		int int3;
		...
		if (boolean2) {
			this.appendSignificantNumber(stringBuilder, double1, int1, boolean1);
		} else {
			this.appendPrecisionNumber(stringBuilder, double1, int1, boolean1);
		}

		stringBuilder.append('e');
		stringBuilder.append(char1);
		stringBufferAppend(stringBuilder, (double)int3, 10, true, 2);
	}
	...
	private static int gsub(LuaCallFrame luaCallFrame, int int1) {
		...
		while (int3 < int2) {
			...
			if (stringPointer3 != null) {
				++int3;
				addValue(matchState, object, stringBuilder, stringPointer2, stringPointer3);
			}
		...
		return luaCallFrame.push(stringBuilder.append(stringPointer2.getString()).toString(), new Double((double)int3));
	}
	...
	private static void addValue(StringLib.MatchState matchState, Object object, StringBuilder stringBuilder, StringLib.StringPointer stringPointer, StringLib.StringPointer stringPointer2) {
		String string = KahluaUtil.rawTostring(object);
		if (string != null) {
			stringBuilder.append(addString(matchState, string, stringPointer, stringPointer2));
		} else {
		...
		for (int int1 = 0; int1 < string.length(); ++int1) {
			...
			if (char1 != '%') {
				...
				if (!Character.isDigit(char1)) {
					...
					stringBuilder.append(stringPointer.getStringSubString(int2));
				} else {
					...
					stringBuilder.append(KahluaUtil.tostring(object, (KahluaThread)null));
				}
			}
		}
