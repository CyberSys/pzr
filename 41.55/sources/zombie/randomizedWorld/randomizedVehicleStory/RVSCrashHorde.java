...
public final class RVSCrashHorde extends RandomizedVehicleStoryBase {
	...
	public void randomizeVehicleStory(IsoMetaGrid.Zone zone, IsoChunk chunk) {
		...
		if (square != null) {
			...
			BaseVehicle baseVehicle = this.addVehicle(zone, square, chunk, "bad", (String)null, (Integer)null, directions, (String)null);
			...
			ArrayList arrayList = this.addZombiesOnVehicle(Rand.Next(5, 10), (String)null, (Integer)null, baseVehicle);
			if (arrayList != null) {
