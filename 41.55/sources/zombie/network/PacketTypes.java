...
public class PacketTypes {
	public static final short UNUSED0 = 0;
	...
	public static final short UNUSED7 = 7;
	public static final short UNUSED8 = 8;
	...
	public static final short GlobalObjects = 38;
	...
	public static final short UNUSED125 = 125;
	...
	public static final short PlayerAttachedItem = 173;
	public static final short ZombieHelmetFalling = 174;
	public static final short AddBrokenGlass = 175;
	public static final short GotHitByVehicle = 176;
	public static final short SyncPerks = 177;
	public static final short SyncWeight = 178;
	public static final short SyncInjuries = 179;
	public static final short SyncHitReactionFromZombie = 180;
	public static final short SyncEquippedRadioFreq = 181;
	...
	public static final short UNUSED188 = 188;
	...
	public static final short SendSafehouseInvite = 193;
	public static final short AcceptedSafehouseInvite = 194;
	public static final short EventUpdate = 210;
	public static final short Statistic = 211;
	public static final short StatisticRequest = 212;
	public static final short HitVehicle = 213;
	public static final short UNUSED214 = 214;
	public static final short UNUSED215 = 215;
	public static final short ZombieAttackTarget = 216;
	public static final short UNUSED27 = 217;
	public static final short PlayerUpdate = 218;
	public static final short GlobalModData = 32000;
	public static final short GlobalModDataRequest = 32001;
	...
	public static void doPacket(short short1, ByteBufferWriter byteBufferWriter) {
	...
	public static String packetTypeToString(short short1) {
		return packetTypeNames != null ? (String)packetTypeNames.get(short1) : "<wrong>";
	}
