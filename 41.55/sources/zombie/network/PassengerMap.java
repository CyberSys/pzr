							...
							for (int int4 = 0; int4 < 7; ++int4) {
								for (int int5 = 0; int5 < 7; ++int5) {
									...
									if (!boolean1) {
										...
										SpriteRenderer.instance.renderPoly((float)((int)float8), (float)((int)float9), (float)((int)(float8 + (float)(byte1 * 64 / 2 * int2))), (float)((int)(float9 - (float)(byte1 * 32 / 2 * int2))), (float)((int)(float8 + (float)(byte1 * 64 * int2))), (float)((int)float9), (float)((int)(float8 + (float)(byte1 * 64 / 2 * int2))), (float)((int)(float9 + (float)(byte1 * 32 / 2 * int2))), float1, float2, float3, float4);
									}
								}
							}
						} else {
