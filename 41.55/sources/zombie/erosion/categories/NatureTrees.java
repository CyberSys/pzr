			...
			for (int int3 = 0; int3 < 6; ++int3) {
				for (int int4 = 0; int4 < intArray.length; ++int4) {
					...
					if (int3 > 3) {
						...
						if (int4 == 0) {
							String string4 = string3.replace("_1", "JUMBO_1");
							string = string4 + "_" + int5;
							erosionObjSprites.setBase(int3, (String)string, 0);
						} else if (int4 == 1) {
							String string5 = string3.replace("_1", "JUMBO_1");
							erosionIceQueen.addSprite(string, string5 + "_" + int5);
						} else if (boolean1) {
