...
public final class Colors {
	...
	public static Color GetColorFromIndex(int int1) {
		return (Color)colors.get(int1);
	}
	...
	public static Color GetColorByName(String string) {
		return (Color)colorMap.get(string.toLowerCase());
	}
	...
	public static boolean ColorExists(String string) {
		return colorSet.contains(string.toLowerCase());
	}
}
