...
public final class CharacterTextures {
	...
	Texture getTexture(String string, String string2, IsoDirections directions, int int1) {
	...
	void addTexture(String string, String string2, IsoDirections directions, int int1, Texture texture) {
		CharacterTextures.CTAnimSet cTAnimSet = this.getAnimSet(string);
		if (cTAnimSet == null) {
		...
		cTAnimSet.addEntry(string2, directions, int1, texture);
	}
	...
	private static final class CTAnimSet {
		...
		void addEntry(String string, IsoDirections directions, int int1, Texture texture) {
			...
			cTState.addEntry(directions, int1, texture);
		}
	}
	...
	private static final class CTState {
		...
		void addEntry(IsoDirections directions, int int1, Texture texture) {
			CharacterTextures.CTEntryList cTEntryList = this.m_entries[directions.index()];
			CharacterTextures.CTEntry cTEntry = new CharacterTextures.CTEntry();
			cTEntry.m_frame = int1;
			cTEntry.m_texture = texture;
