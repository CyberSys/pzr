...
public final class GLFramebufferObject30 implements IGLFramebufferObject {
	...
	public void glBindFramebuffer(int int1, int int2) {
		GL30.glBindFramebuffer(int1, int2);
	}

	public void glFramebufferTexture2D(int int1, int int2, int int3, int int4, int int5) {
		GL30.glFramebufferTexture2D(int1, int2, int3, int4, int5);
	}
