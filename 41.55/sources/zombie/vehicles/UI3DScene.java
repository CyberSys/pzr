...
public final class UI3DScene extends UIElement {
		...
		if (this.isVisible()) {
			...
			if (this.m_bDrawGrid) {
				...
				if (this.m_view == UI3DScene.View.UserDefined) {
					...
					if (this.intersect_ray_plane(plane, ray, vector3f2) != 1) {
						vector3f2.set(0.0F);
					}
	...
	public Object fromLua1(String string, Object object) {
		...
		case 28: 
			...
			float float6 = this.uiToSceneY(float2, float2);
	...
	public Object fromLua2(String string, Object object, Object object2) {
		...
		switch (byte1) {
		case 0: 
			sceneModel2 = (UI3DScene.SceneModel)this.getSceneObjectById((String)object, UI3DScene.SceneModel.class, true);
			if (sceneModel2.m_modelScript.getAttachmentById((String)object2) != null) {
			...
			sceneModel2.m_modelScript.addAttachment(modelAttachment);
		...
		case 3: 
			...
			if (sceneObject != null) {
				...
				if (modelScript == null) {
					...
					sceneModel = new UI3DScene.SceneModel(this, (String)object, modelScript, model);
		...
		case 7: 
			sceneModel2 = (UI3DScene.SceneModel)this.getSceneObjectById((String)object, UI3DScene.SceneModel.class, true);
			modelAttachment = sceneModel2.m_modelScript.getAttachmentById((String)object2);
			if (modelAttachment == null) {
				throw new IllegalArgumentException("model script \"" + object + "\" attachment \"" + object2 + "\" not found");
			}

			sceneModel2.m_modelScript.removeAttachment(modelAttachment);
			return null;
		...
		case 18: 
			...
			case 3: 
				sceneModel = (UI3DScene.SceneModel)this.getSceneObjectById((String)object2, UI3DScene.SceneModel.class, true);
				this.m_gizmoParent = sceneModel;
				this.m_gizmoOrigin = this.m_gizmoParent;
				this.m_gizmoChild = null;
				break;
