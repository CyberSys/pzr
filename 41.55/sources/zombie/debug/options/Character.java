...
public class Character extends OptionGroup {
	...
	public static final class DebugOG extends OptionGroup {
		...
		public DebugOG(IDebugOptionGroup iDebugOptionGroup) {
			super(iDebugOptionGroup, "Debug");
		...
		public static final class RenderOG extends OptionGroup {
			...
			public RenderOG(IDebugOptionGroup iDebugOptionGroup) {
				super(iDebugOptionGroup, "Render");
		...
		public static final class AnimateOG extends OptionGroup {
			...
			public AnimateOG(IDebugOptionGroup iDebugOptionGroup) {
				super(iDebugOptionGroup, "Animate");
