...
public final class IsoWater {
	...
	public void update(ClimateManager climateManager) {
		...
		this.WaterWindIntensity = climateManager.getWindIntensity();
		this.WaterRainIntensity = climateManager.getRainIntensity();
		this.WaterTime += 0.0166F * GameTime.getInstance().getMultiplier();
		this.WaterParamWindINT.add((float)Math.sin((double)(this.WaterWindAngle * 6.0F)) * this.WaterWindIntensity * 0.05F, (float)Math.cos((double)(this.WaterWindAngle * 6.0F)) * this.WaterWindIntensity * 0.05F);
	}
