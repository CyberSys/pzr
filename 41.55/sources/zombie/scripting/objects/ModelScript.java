...
public final class ModelScript extends BaseScriptObject {
	...
	private static void checkMesh(String string, String string2) {
		if (!StringUtils.isNullOrWhitespace(string2)) {
			...
			if (!ZomboidFileSystem.instance.ActiveFileMap.containsKey("media/models_x/" + string3 + ".x") && !ZomboidFileSystem.instance.ActiveFileMap.containsKey("media/models/" + string3 + ".txt")) {
