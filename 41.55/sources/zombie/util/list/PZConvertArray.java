...
public final class PZConvertArray extends AbstractList implements RandomAccess {
	...
	public PZConvertArray(Object[] objectArray, Function function) {
		this(objectArray, function, (Function)null);
	}

	public PZConvertArray(Object[] objectArray, Function function, Function function2) {
		this.m_array = (Object[])Objects.requireNonNull(objectArray);
	...
	public Object get(int int1) {
		return this.convertST(this.m_array[int1]);
	}
	...
	public Object setS(int int1, Object object) {
		Object object2 = this.m_array[int1];
