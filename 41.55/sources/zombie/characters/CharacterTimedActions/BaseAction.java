...
public class BaseAction {
	...
	public void stopTimedActionAnim() {
		...
		if (GameClient.bClient && this.chr instanceof IsoPlayer && ((IsoPlayer)this.chr).isLocalPlayer() && !this.animVariables.isEmpty()) {
			GameClient.sendEventUpdate((IsoPlayer)this.chr, (String)null, true);
		}
	...
	public void setActionAnim(String string) {
		...
		if (GameClient.bClient && this.chr instanceof IsoPlayer && ((IsoPlayer)this.chr).isLocalPlayer() && !specificNetworkAnim.contains(string)) {
			GameClient.sendEventUpdate((IsoPlayer)this.chr, string, true);
		}
