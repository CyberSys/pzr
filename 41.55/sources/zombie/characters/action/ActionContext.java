...
public final class ActionContext {
	...
	public void reportEvent(int int1, String string) {
		...
		if (GameClient.bClient && this.m_owner instanceof IsoPlayer && ((IsoPlayer)this.m_owner).isLocalPlayer()) {
			GameClient.sendEventUpdate((IsoPlayer)this.m_owner, string, false);
		}
	}
