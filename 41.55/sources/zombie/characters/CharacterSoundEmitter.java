...
public final class CharacterSoundEmitter extends BaseCharacterSoundEmitter implements ICommonSoundEmitter {
	...
	public long playVocals(String string) {
		if (GameServer.bServer) {
			...
			if (fMODVoice == null) {
				...
				long long2 = this.vocals.playSoundImpl(fMODVoice.sound, false, (IsoObject)null);
	...
	public void playFootsteps(String string, float float1) {
		if (!GameServer.bServer) {
			this.footsteps.playSoundImpl(string, false, (IsoObject)null);
		}
	}
	...
	public long playSound(String string) {
		...
		return this.character.isInvisible() && !DebugOptions.instance.Character.Debug.PlaySoundWhenInvisible.getValue() ? 0L : this.extra.playSound(string);
	}
