...
public final class DebugChunkState extends GameState {
	...
	public void renderScene() {
		...
		if (this.ZoneRect.getValue()) {
			IsoMetaGrid.Zone zone = IsoWorld.instance.MetaGrid.getZoneAt(this.gridX, this.gridY, this.m_z);
			if (zone != null) {
			...
			if (vehicleZone != null) {
				...
				float float3 = 0.5F;
				float float4 = 1.0F;
				this.DrawIsoLine((float)vehicleZone.x, (float)vehicleZone.y, (float)(vehicleZone.x + vehicleZone.w), (float)vehicleZone.y, float1, float2, float3, float4, 1);
				this.DrawIsoLine((float)vehicleZone.x, (float)(vehicleZone.y + vehicleZone.h), (float)(vehicleZone.x + vehicleZone.w), (float)(vehicleZone.y + vehicleZone.h), float1, float2, float3, float4, 1);
				this.DrawIsoLine((float)vehicleZone.x, (float)vehicleZone.y, (float)vehicleZone.x, (float)(vehicleZone.y + vehicleZone.h), float1, float2, float3, float4, 1);
				this.DrawIsoLine((float)(vehicleZone.x + vehicleZone.w), (float)vehicleZone.y, (float)(vehicleZone.x + vehicleZone.w), (float)(vehicleZone.y + vehicleZone.h), float1, float2, float3, float4, 1);
			}
		}
