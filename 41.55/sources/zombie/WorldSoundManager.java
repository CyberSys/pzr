	...
	public WorldSoundManager.WorldSound addSound(Object object, int int1, int int2, int int3, int int4, int int5, boolean boolean1, float float1, float float2) {
		if (int4 <= 0) {
			...
			synchronized (this.SoundList) {
				...
				ZombiePopulationManager.instance.addWorldSound(worldSound);
				return worldSound;
			}
		}
	}

	public WorldSoundManager.WorldSound addSound(boolean boolean1, int int1, int int2, int int3, int int4, int int5, boolean boolean2, float float1, float float2) {
		WorldSoundManager.WorldSound worldSound = this.addSound((Object)null, int1, int2, int3, int4, int5, boolean2, float1, float2);
		if (worldSound != null) {
