...
public final class ClimbThroughWindowState extends State {
   ...
   public void execute(IsoGameCharacter var1) {
      ...
      if (!this.isWindowClosing(var1)) {
         ...
         int var6;
         int var7;
         if (!var1.getVariableBoolean("ClimbWindowStarted") || !"back".equals(var4) && !"fallback".equals(var4)) {
            if (var1.getVariableBoolean("ClimbWindowStarted")) {
               var6 = (Integer)var2.get(PARAM_END_X);
               var7 = (Integer)var2.get(PARAM_END_Y);
               var5 = this.isPastInnerEdgeOfSquare(var1, var6, var7, var3);
            }
         } else {
            var6 = (Integer)var2.get(PARAM_START_X);
            var7 = (Integer)var2.get(PARAM_START_Y);
            var5 = this.isPastInnerEdgeOfSquare(var1, var6, var7, var3.RotLeft(4));
         }

         var1.setCollidable(var5);
         int var8;
         int var9;
         if (var1 instanceof IsoZombie) {
            boolean var12 = var2.get(PARAM_ZOMBIE_ON_FLOOR) == Boolean.TRUE;
            if (!var1.isFallOnFront() && var12) {
               var7 = (Integer)var2.get(PARAM_OPPOSITE_X);
               var8 = (Integer)var2.get(PARAM_OPPOSITE_Y);
               var9 = (Integer)var2.get(PARAM_Z);
            ...
            var1.setOnFloor(var12);
            ((IsoZombie)var1).bKnockedDown = var12;
            var1.setFallOnFront(var12);
         }

         float var13 = (float)(Integer)var2.get(PARAM_START_X) + 0.5F;
         float var14 = (float)(Integer)var2.get(PARAM_START_Y) + 0.5F;
         if (!var1.getVariableBoolean("ClimbWindowStarted")) {
            if (var1.x != var13 && (var3 == IsoDirections.N || var3 == IsoDirections.S)) {
               this.slideX(var1, var13);
            }

            if (var1.y != var14 && (var3 == IsoDirections.W || var3 == IsoDirections.E)) {
         ...
         if (var1 instanceof IsoPlayer && var4.equalsIgnoreCase("obstacle")) {
            var15 = (float)(Integer)var2.get(PARAM_END_X) + 0.5F;
            var16 = (float)(Integer)var2.get(PARAM_END_Y) + 0.5F;
            if (var1.DistToSquared(var15, var16) < 0.5625F) {
         ...
         if (var1 instanceof IsoPlayer && !var1.getVariableBoolean("ClimbWindowEnd") && !"fallfront".equals(var4) && !"back".equals(var4) && !"fallback".equals(var4)) {
            var8 = (Integer)var2.get(PARAM_OPPOSITE_X);
            var9 = (Integer)var2.get(PARAM_OPPOSITE_Y);
            int var17 = (Integer)var2.get(PARAM_Z);
            IsoGridSquare var11 = IsoWorld.instance.CurrentCell.getGridSquare(var8, var9, var17);
            if (var11 != null) {
         ...
         if (var1.getVariableBoolean("ClimbWindowStarted") && !"back".equals(var4) && !"fallback".equals(var4) && !"lunge".equals(var4) && !"obstacle".equals(var4) && !"obstacleEnd".equals(var4)) {
            var15 = (float)(Integer)var2.get(PARAM_START_X);
            var16 = (float)(Integer)var2.get(PARAM_START_Y);
            switch(var3) {
            case N:
               var16 -= 0.1F;
               break;
            ...
            if ((int)var1.y != (int)var16 && (var3 == IsoDirections.N || var3 == IsoDirections.S)) {
               this.slideY(var1, var16);
            }
         }
