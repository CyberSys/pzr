...
public final class ImportedSkeleton {
   ...
   private void processAiScene(ImportedSkeletonParams var1) {
      ...
      for(int var12 = 0; var12 < var10.size(); ++var12) {
         AiNode var13 = (AiNode)var10.get(var12);
      ...
      for(int var28 = 0; var28 < this.boneIndices.size(); ++var28) {
         this.bindPose.add(var27);
         this.skinOffsetMatrices.add(var27);
      }

      List var29 = var7.getBones();

      int var30;
      for(var30 = 0; var30 < var10.size(); ++var30) {
         AiNode var31 = (AiNode)var10.get(var30);
         String var32 = var31.getName();
         AiBone var17 = JAssImpImporter.FindAiBone(var32, var29);
         if (var17 != null) {
            ...
            if (var18 != null) {
               ...
               var21.setIdentity();
               String var22 = var31.getParent().getName();
               AiBone var23 = JAssImpImporter.FindAiBone(var22, var29);
               if (var23 != null) {
               ...
               Matrix4f var37 = new Matrix4f(var21);
               var37.invert();
               Matrix4f var25 = new Matrix4f();
               Matrix4f.mul(var20, var37, var25);
               var25.invert();
               int var26 = (Integer)this.boneIndices.get(var32);
      ...
      var30 = this.bindPose.size();

      for(var15 = 0; var15 < var30; ++var15) {
         Matrix4f var33 = new Matrix4f((Matrix4f)this.bindPose.get(var15));
         var33.invert();
         this.invBindPose.add(var15, var33);
      }

      if (var3 == JAssImpImporter.LoadMode.AnimationOnly || var4 == null) {
         var15 = var2.getNumAnimations();
         if (var15 > 0) {
            List var34 = var2.getAnimations();

            for(int var35 = 0; var35 < var15; ++var35) {
               AiAnimation var36 = (AiAnimation)var34.get(var35);
               if (var9) {
                  this.processAnimation(var36, var9, 1.0F, (Quaternion)null);
               } else {
                  this.processAnimation(var36, var9, var5, var6);
               }
            }
                  ...
                  for(int var20 = 0; var20 < var13.size(); ++var20) {
                     ...
                     if (var11) {
                        if (var16) {
                           ...
                           boolean var23 = var22.BoneName.equalsIgnoreCase("Translation_Data");
                           if (!var23) {
