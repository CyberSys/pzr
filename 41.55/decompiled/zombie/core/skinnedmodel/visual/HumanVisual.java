            ...
            if (var6 == null) {
               ...
               if (StringUtils.isNullOrWhitespace(var7)) {
                  ...
                  if (!var4.RandomData.m_Active) {
                     ...
                     int var9;
                     if (!var8.isMultiItem(var7)) {
                        var9 = var2.indexOf(var7);
                        if (var9 != -1) {
                           var1.remove(var9);
                           var2.remove(var9);
                        }
                     ...
                     for(var9 = 0; var9 < var1.size(); ++var9) {
                        if (var8.isExclusive(var7, (String)var2.get(var9))) {
                           var1.remove(var9);
                           var2.remove(var9);
                           --var9;
                        }
                     ...
                     var9 = var8.indexOf(var7);
                     int var10 = var1.size();

                     for(int var11 = 0; var11 < var1.size(); ++var11) {
                        if (var8.indexOf((String)var2.get(var11)) > var9) {
                           var10 = var11;
                           break;
                        }
                     }

                     ItemVisual var12 = new ItemVisual();
                     var12.setItemType(var5.getFullName());
                     var12.synchWithOutfit(var4);
                     var1.add(var10, var12);
                     var2.add(var10, var7);
                     return var12;
                  }
               }
