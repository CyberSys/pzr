                  ...
                  while((var8 = var5.readLine()) != null) {
                     if (!var8.trim().isEmpty()) {
                        if (var8.startsWith("[VERSION]")) {
                           ...
                           if ("news".equals(var7)) {
                              addNewsLine(var8, var6.newsList);
                           } else if ("balance".equals(var7)) {
                              addNewsLine(var8, var6.balance);
                           } else if ("bugfix".equals(var7)) {
                              addNewsLine(var8, var6.bugfix);
                           } else {
                              addNewsLine(var8, var6.other);
                           }
                        }
                     }
                  }
