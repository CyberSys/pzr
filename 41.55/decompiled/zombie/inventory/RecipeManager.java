...
public final class RecipeManager {
   ...
   private static boolean CanPerform(Recipe var0, IsoGameCharacter var1) {
      if (StringUtils.isNullOrWhitespace(var0.getCanPerform())) {
         return true;
      } else {
         Object var2 = LuaManager.getFunctionObject(var0.getCanPerform());
         if (var2 == null) {
            return false;
         } else {
            Boolean var3 = LuaManager.caller.protectedCallBoolean(LuaManager.thread, var2, var0, var1);
   ...
   public static boolean HasAllRequiredItems(Recipe var0, IsoGameCharacter var1, InventoryItem var2, ArrayList var3) {
      ...
      for(int var5 = 0; var5 < var4.size(); ++var5) {
         ...
         if (var0.noBrokenItems() && var6.isBroken()) {
            return false;
         }

         if ("Clothing".equals(var6.getCategory()) && var6.isFavorite()) {
            return false;
         }
      }
      ...
      void getItemsFromContainer(IsoGameCharacter var1, ItemContainer var2, InventoryItem var3) {
         for(int var4 = 0; var4 < var2.getItems().size(); ++var4) {
            ...
            if (var3 != null && var3 == var5 || !var1.isEquippedClothing(var5) || this.isKeep(var5.getFullType())) {
               ...
               } else if (this.allSourceTypes.contains(var5.getFullType()) && var5.getCondition() > 0 || this.recipe.AllowDestroyedItem) {
                  this.allItems.add(RecipeManager.RMRecipeItem.alloc(var5));
               }
            }
         }
   ...
   private static final class RMRecipeItemList {
      ...
      void getItemsFrom(ArrayList var1, RecipeManager.RMRecipe var2) {
         ...
         for(int var4 = 0; var4 < var1.size(); ++var4) {
            ...
            } else if (var3.equals(var5.item.getFullType()) && (!(var2.recipe.getHeat() > 0.0F) || !(var5.item instanceof DrainableComboItem) || !var5.item.IsCookable || !(var5.item.getInvHeat() + 1.0F < var2.recipe.getHeat())) && (!(var2.recipe.getHeat() < 0.0F) || !(var5.item instanceof DrainableComboItem) || !var5.item.IsCookable || !(var5.item.getInvHeat() > var2.recipe.getHeat())) && var2.Test(var5.item)) {
