...
public final class ModelScript extends BaseScriptObject {
   ...
   private static void checkMesh(String var0, String var1) {
      if (!StringUtils.isNullOrWhitespace(var1)) {
         ...
         if (!ZomboidFileSystem.instance.ActiveFileMap.containsKey("media/models_x/" + var2 + ".x") && !ZomboidFileSystem.instance.ActiveFileMap.containsKey("media/models/" + var2 + ".txt")) {
            reported.add(var1);
