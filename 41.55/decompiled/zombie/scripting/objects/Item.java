...
public final class Item extends BaseScriptObject {
   ...
   public InventoryItem InstanceItem(String var1) {
      ...
      if (this.recordedMediaCat != null) {
         MediaData var18 = ZomboidRadio.getInstance().getRecordedMedia().getRandomFromCategory(this.recordedMediaCat);
         if (var18 != null) {
            ((InventoryItem)var2).setRecordedMediaIndex(var18.getIndex());
         }
      }

      long var19 = OutfitRNG.getSeed();
      OutfitRNG.setSeed((long)Rand.Next(Integer.MAX_VALUE));
      ((InventoryItem)var2).synchWithVisual();
      OutfitRNG.setSeed(var19);
