...
public final class RVSFlippedCrash extends RandomizedVehicleStoryBase {
   ...
   public void randomizeVehicleStory(IsoMetaGrid.Zone var1, IsoChunk var2) {
      ...
      if (var4 != null) {
         ...
         var6 = var6.setSmashed(var8, true);
         var6.setBloodIntensity("Front", Rand.Next(0.3F, 1.0F));
         var6.setBloodIntensity("Rear", Rand.Next(0.3F, 1.0F));
         var6.setBloodIntensity("Left", Rand.Next(0.3F, 1.0F));
         var6.setBloodIntensity("Right", Rand.Next(0.3F, 1.0F));
         ArrayList var9 = this.addZombiesOnVehicle(Rand.Next(2, 4), (String)null, (Integer)null, var6);
         if (var9 != null) {
