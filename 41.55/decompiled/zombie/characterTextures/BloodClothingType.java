...
public enum BloodClothingType {
   ...
   public static void addHole(BloodBodyPartType var0, HumanVisual var1, ArrayList var2, boolean var3) {
      ...
      for(int var5 = var2.size() - 1; var5 >= 0; --var5) {
         ItemVisual var6 = (ItemVisual)var2.get(var5);
         Item var7 = var6.getScriptItem();
         if (var7 != null && (var6.getInventoryItem() == null || !var6.getInventoryItem().isBroken())) {
            ArrayList var8 = var7.getBloodClothingType();
            if (var8 != null) {
               for(int var9 = 0; var9 < var8.size(); ++var9) {
                  BloodClothingType var10 = (BloodClothingType)var7.getBloodClothingType().get(var9);
                  if (((ArrayList)coveredParts.get(var10)).contains(var0) && var7.canHaveHoles && var6.getHole(var0) == 0.0F) {
                     var4 = var6;
                     break;
                  }
               }
               ...
               if (var4 != null) {
                  var4.setHole(var0);
                  Clothing var11 = (Clothing)Type.tryCastTo(var4.getInventoryItem(), Clothing.class);
                  if (var11 != null) {
                     var11.removePatch(var0);
                     var11.setCondition(var11.getCondition() - var11.getCondLossPerHole());
                  }
