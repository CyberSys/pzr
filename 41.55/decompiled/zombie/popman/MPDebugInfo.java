...
public final class MPDebugInfo {
   ...
   public void render(ZombiePopulationRenderer var1, float var2) {
      ...
      for(var5 = 0; var5 < this.loadedAreas.count; ++var5) {
         int var11 = var5 * 4;
         int var13 = this.loadedAreas.areas[var11++];
         int var8 = this.loadedAreas.areas[var11++];
         int var9 = this.loadedAreas.areas[var11++];
         int var10 = this.loadedAreas.areas[var11++];
         var1.outlineRect((float)(var13 * 10), (float)(var8 * 10), (float)(var9 * 10), (float)(var10 * 10), 0.7F, 0.7F, 0.7F, 1.0F);
      }

      for(var5 = 0; var5 < this.repopEvents.size(); ++var5) {
         MPDebugInfo.MPRepopEvent var14 = (MPDebugInfo.MPRepopEvent)this.repopEvents.get(var5);
         if (!(var14.worldAge + this.REPOP_DISPLAY_HOURS < var3)) {
            var7 = 1.0F - (var3 - var14.worldAge) / this.REPOP_DISPLAY_HOURS;
            var7 = Math.max(var7, 0.1F);
            var1.outlineRect((float)(var14.wx * 10), (float)(var14.wy * 10), 50.0F, 50.0F, 0.0F, 0.0F, 1.0F, var7);
         }
      }

      for(var5 = 0; var5 < IsoWorld.instance.CurrentCell.getZombieList().size(); ++var5) {
         IsoZombie var15 = (IsoZombie)IsoWorld.instance.CurrentCell.getZombieList().get(var5);
         var7 = 1.0F;
         float var16 = 1.0F;
         float var20 = 0.0F;
         var1.renderZombie(var15.x, var15.y, var7, var16, var20);
      }

      if (GameClient.bClient && DebugOptions.instance.MultiplayerShowPosition.getValue()) {
         float var12 = (float)((IsoChunkMap.ChunkGridWidth / 2 + 2) * 10);
         ...
         while(var17.hasNext()) {
            ...
            Vector2 var24 = (Vector2)var21.getValue();
            var1.renderZombie(var24.x, var24.y, var22.r, var22.g, var22.b);
            var1.renderCircle(var24.x, var24.y, var12, var22.r, var22.g, var22.b, var22.a);
            var1.renderString(var24.x, var24.y, var18 == null ? String.valueOf(var21.getKey()) : var18.getUsername(), (double)var22.r, (double)var22.g, (double)var22.b, (double)var22.a);
         }

         if (IsoPlayer.getInstance() != null) {
            IsoPlayer var19 = IsoPlayer.getInstance();
            Color var23 = var19.getSpeakColour();
            var1.renderZombie(var19.x, var19.y, var23.r, var23.g, var23.b);
            var1.renderCircle(var19.x, var19.y, var12, var23.r, var23.g, var23.b, var23.a);
