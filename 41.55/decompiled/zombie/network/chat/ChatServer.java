...
public class ChatServer {
   ...
   public void initPlayer(int var1) {
      ...
      if (var3 != null && var2 != null) {
         ...
         PacketTypes.doPacket((short)191, var6);
   ...
   private void sendPlayerNotFoundMessage(UdpConnection var1) {
      ...
      PacketTypes.doPacket((short)192, var2);
   ...
   public void disconnectPlayer(int var1) {
   ...
   public void joinAdminChat(Integer var1) {
      if (adminChat == null) {
   ...
   public void leaveAdminChat(Integer var1) {
   ...
   private void addMemberToSafehouseChat(String var1, Integer var2) {
      if (!safehouseChats.containsKey(var1)) {
   ...
   private void addMemberToFactionChat(String var1, Integer var2) {
      if (!factionChats.containsKey(var1)) {
   ...
   private void sendInitPlayerChatPacket(UdpConnection var1) {
      ByteBufferWriter var2 = var1.startPacket();
      PacketTypes.doPacket((short)182, var2);
   ...
   private void addDefaultChats(Integer var1) {
