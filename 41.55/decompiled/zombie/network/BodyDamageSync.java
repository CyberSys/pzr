...
public class BodyDamageSync {
   ...
   public void startSendingUpdates(int var1, int var2) {
   ...
   public void stopSendingUpdates(int var1, int var2) {
      if (GameClient.bClient) {
   ...
   public void startReceivingUpdates(int var1) {
      if (GameClient.bClient) {
         ...
         PacketTypes.doPacket((short)112, var2);
         var2.putByte((byte)1);
         var2.putShort((short)IsoPlayer.players[0].getOnlineID());
         var2.putShort((short)var1);
         GameClient.connection.endPacketImmediate();
      }
   }

   public void stopReceivingUpdates(int var1) {
      if (GameClient.bClient) {
   ...
   public void serverPacket(ByteBuffer var1) {
      ...
      if (var2 == 1) {
         var3 = var1.getShort();
         var4 = var1.getShort();
         var5 = (Long)GameServer.IDToAddressMap.get(Integer.valueOf(var4));
         if (var5 != null) {
            var6 = GameServer.udpEngine.getActiveConnection(var5);
            if (var6 != null) {
               var7 = var6.startPacket();
               PacketTypes.doPacket((short)112, var7);
               var7.putByte((byte)1);
               var7.putShort(var3);
               var7.putShort(var4);
   ...
   public void clientPacket(ByteBuffer var1) {
      ...
      if (var2 == 1) {
         ...
         IsoPlayer var5 = (IsoPlayer)GameClient.IDToPlayerMap.get(Integer.valueOf(var3));
         if (var5 != null) {
      ...
      void update() {
         ...
         if (var1 - this.sendTime >= 500L) {
            ...
            if (bb.position() > 0) {
               ...
               PacketTypes.doPacket((short)112, var5);
               var5.putByte((byte)3);
               var5.putShort((short)IsoPlayer.players[this.localIndex].getOnlineID());
               var5.putShort((short)this.remoteID);
