...
public class ServerMap {
   ...
   public void preupdate() {
      ...
      if (this.bQueuedQuit) {
         ...
         PacketTypes.doPacket((short)52, var18);
      ...
      try {
         for(int var3 = 0; var3 < this.LoadedCells.size(); ++var3) {
            ...
            if (!var4.bLoaded) {
               ...
               int var7;
               if (!var5) {
                  var6 = var4.WX - this.getMinX();
                  var7 = var4.WY - this.getMinY();
                  if (!var2) {
                     ServerLOS.instance.suspend();
                     var2 = true;
                  }
                  ...
                  --var3;
               } else if (var4.bPhysicsCheck) {
                  for(var6 = 0; var6 < 5; ++var6) {
                     for(var7 = 0; var7 < 5; ++var7) {
                        if (var4.chunks[var7][var6] != null) {
                           var4.chunks[var7][var6].update();
                        }
                     }
                  }

                  var4.bPhysicsCheck = false;
               }
            }
         }
