...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
   ...
   public void update() {
      if (this.removedFromWorld) {
         ...
         if (this.getVehicleTowedBy() != null && this.getVehicleTowedBy().getController() != null) {
            var17 = this.getVehicleTowedBy() != null && this.getVehicleTowedBy().getController().isEnable;
            var2 = this.getVehicleTowing() != null && this.getVehicleTowing().getDriver() != null;
         }

         if (this.physics != null) {
            boolean var3 = this.getDriver() != null || var17 || var2;
            ...
            if (var6 != null && var6.enable) {
               ...
               var8 = var6.rel_pos.cross(var6.impulse, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
            ...
            if (System.currentTimeMillis() - this.engineCheckTime > 1000L && !GameClient.bClient) {
               ...
               if (!GameClient.bClient) {
                  if (this.engineState != BaseVehicle.engineStateTypes.Idle) {
                     int var25 = (int)((double)this.engineLoudness * this.engineSpeed / 2500.0D);
                     double var27 = Math.min(this.getEngineSpeed(), 2000.0D);
                     var25 = (int)((double)var25 * (1.0D + var27 / 4000.0D));
                     if (Rand.Next((int)(120.0F * GameTime.instance.getInvMultiplier())) == 0) {
                        WorldSoundManager.instance.addSoundRepeating(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), Math.max(8, var25), var25 / 40, false);
                     }

                     if (Rand.Next((int)(35.0F * GameTime.instance.getInvMultiplier())) == 0) {
                        WorldSoundManager.instance.addSoundRepeating(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), Math.max(8, var25 / 2), var25 / 40, false);
                     }

                     if (Rand.Next((int)(2.0F * GameTime.instance.getInvMultiplier())) == 0) {
                        WorldSoundManager.instance.addSoundRepeating(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), Math.max(8, var25 / 4), var25 / 40, false);
                     }

                     WorldSoundManager.instance.addSoundRepeating(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), Math.max(8, var25 / 6), var25 / 40, false);
                  }
            ...
            this.setZ(0.0F);
            IsoGridSquare var26 = this.getCell().getGridSquare((double)this.x, (double)this.y, (double)this.z);
            if (var26 == null) {
               float var28 = 5.0E-4F;
               int var9 = this.chunk.wx * 10;
               int var10 = this.chunk.wy * 10;
               int var11 = var9 + 10;
               int var12 = var10 + 10;
               float var13 = this.x;
               float var14 = this.y;
               this.x = Math.max(this.x, (float)var9 + var28);
               this.x = Math.min(this.x, (float)var11 - var28);
               this.y = Math.max(this.y, (float)var10 + var28);
               this.y = Math.min(this.y, (float)var12 - var28);
               this.z = 0.2F;
               Transform var15 = this.tempTransform;
               Transform var16 = this.tempTransform2;
               this.getWorldTransform(var15);
               var16.basis.set((Matrix3fc)var15.basis);
               var16.origin.set(this.x - WorldSimulation.instance.offsetX, this.z, this.y - WorldSimulation.instance.offsetY);
               this.setWorldTransform(var16);
            ...
            if (this.jniIsCollide) {
               this.jniIsCollide = false;
               var8 = (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc();
               if (GameServer.bServer) {
                  var8.set((Vector3fc)this.netLinearVelocity);
               } else {
                  var8.set((Vector3fc)this.jniLinearVelocity);
               }

               var8.negate();
               var8.add(this.lastLinearVelocity);
               var8.y = 0.0F;
               float var30 = Math.abs(var8.length());
               if (var30 > 2.0F) {
                  ...
                  if (Core.bDebug) {
                     DebugLog.log("CRASH lastSpeed=" + this.lastLinearVelocity.length() + " speed=" + var8 + " delta=" + var30 + " netLinearVelocity=" + this.netLinearVelocity.length());
                  }

                  Vector3f var31 = this.getForwardVector((Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
                  float var32 = var8.normalize().dot(var31);
                  ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var31);
                  this.crash(Math.abs(var30 * 3.0F), var32 > 0.0F);
                  this.damageObjects(Math.abs(var30) * 30.0F);
               }
         ...
         int var18;
         for(var18 = 0; var18 < this.impulseFromSquishedZombie.length; ++var18) {
            BaseVehicle.VehicleImpulse var19 = this.impulseFromSquishedZombie[var18];
            if (var19 != null) {
               var19.enable = false;
            }
         }
         ...
         for(var18 = 0; var18 < IsoPlayer.numPlayers; ++var18) {
            if (this.current == null || !this.current.lighting[var18].bCanSee()) {
               this.setTargetAlpha(var18, 0.0F);
            }

            IsoPlayer var20 = IsoPlayer.players[var18];
            if (var20 != null && this.DistToSquared(var20) < 225.0F) {
               this.setTargetAlpha(var18, 1.0F);
            }
         }

         for(var18 = 0; var18 < this.getScript().getPassengerCount(); ++var18) {
            if (this.getCharacter(var18) != null) {
               Vector3f var21 = this.getPassengerWorldPos(var18, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
               this.getCharacter(var18).setX(var21.x);
               this.getCharacter(var18).setY(var21.y);
               this.getCharacter(var18).setZ(var21.z * 1.0F);
         ...
         if (this.engineState == BaseVehicle.engineStateTypes.Running || var17) {
         ...
         VehiclePart var22 = this.getPartById("GasTank");
         if (var22 != null && var22.getContainerContentAmount() > (float)var22.getContainerCapacity()) {
            var22.setContainerContentAmount((float)var22.getContainerCapacity());
         }

         boolean var23 = false;

         for(int var5 = 0; var5 < this.getMaxPassengers(); ++var5) {
            BaseVehicle.Passenger var24 = this.getPassenger(var5);
            if (var24.character != null) {
               var23 = true;
               break;
            }
         }
   ...
   private void addDamageFront(int var1) {
      ...
      if (var2 != null && var2.getCondition() < 25) {
         var2 = this.getPartById("Engine");
         if (var2 != null) {
   ...
   public boolean isCharacterAdjacentTo(IsoGameCharacter var1) {
      if ((int)var1.z != (int)this.z) {
         ...
         float var8 = var5.z - var4.z / 2.0F;
         float var9 = var5.z + var4.z / 2.0F;
         if (var3.x >= var6 - 0.4F && var3.x < var7 + 0.4F && var3.z >= var8 - 0.4F && var3.z < var9 + 0.4F) {
            ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var3);
            return true;
         } else {
            ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var3);
   ...
   public boolean testCollisionWithVehicle(BaseVehicle var1) {
      ...
      if (var2 != null && var3 != null) {
         ...
         Vector3f var10 = var2.getExtents();
         Vector3f var5 = var2.getCenterOfMassOffset();
         Vector3f var6 = var3.getExtents();
         Vector3f var7 = var3.getCenterOfMassOffset();
         Vector3f var8 = (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc();
         float var9 = 0.5F;
         this.getWorldPos(var5.x + var10.x * var9, 0.0F, var5.z + var10.z * var9, var8, var2);
         testVecs1[0].set(var8.x, var8.y);
         this.getWorldPos(var5.x - var10.x * var9, 0.0F, var5.z + var10.z * var9, var8, var2);
         testVecs1[1].set(var8.x, var8.y);
         this.getWorldPos(var5.x - var10.x * var9, 0.0F, var5.z - var10.z * var9, var8, var2);
         testVecs1[2].set(var8.x, var8.y);
         this.getWorldPos(var5.x + var10.x * var9, 0.0F, var5.z - var10.z * var9, var8, var2);
         testVecs1[3].set(var8.x, var8.y);
         var9 = 0.5F;
         var1.getWorldPos(var7.x + var6.x * var9, 0.0F, var7.z + var6.z * var9, var8, var3);
         testVecs2[0].set(var8.x, var8.y);
         var1.getWorldPos(var7.x - var6.x * var9, 0.0F, var7.z + var6.z * var9, var8, var3);
         testVecs2[1].set(var8.x, var8.y);
         var1.getWorldPos(var7.x - var6.x * var9, 0.0F, var7.z - var6.z * var9, var8, var3);
         testVecs2[2].set(var8.x, var8.y);
         var1.getWorldPos(var7.x + var6.x * var9, 0.0F, var7.z - var6.z * var9, var8, var3);
         testVecs2[3].set(var8.x, var8.y);
         ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var8);
         ...
         if (!(Math.abs(var1.x - this.x) < 0.01F) && !(Math.abs(var1.y - this.y) < 0.01F)) {
            ...
            if (var6 < 0.05F) {
               ...
               if (GameClient.bClient) {
                  ...
                  var1.Hit(this, var10, var8, var9.set(-var7.x, -var7.z));
                  IsoGameCharacter var18 = this.getDriver();
                  if (var18 instanceof IsoPlayer && this.isDriver(IsoPlayer.getInstance())) {
                     if (var1 instanceof IsoZombie) {
                        ((IsoZombie)var1).networkAI.reanimateTimer = (float)(Rand.Next(60) + 30);
                     }

                     GameClient.sendHitVehicle(var18, var1, this, var10, var8, var9.x, var9.y);
                  }
   ...
   public BaseVehicle setSmashed(String var1, boolean var2) {
      ...
      if (var3 == null) {
         ...
         var9.setScriptName(var3);
         var9.setScript();
         var9.setSkinIndex(var4);
         var9.setX(this.x);
         var9.setY(this.y);
         var9.setZ(this.z);
         var9.setDir(this.getDir());
         float var10;
         if (!var2) {
            for(var10 = this.dir.toAngle() + 3.1415927F + Rand.Next(-0.5F, 0.5F); (double)var10 > 6.283185307179586D; var10 = (float)((double)var10 - 6.283185307179586D)) {
            }

            var9.savedRot.setAngleAxis(var10, 0.0F, 1.0F, 0.0F);
         } else {
            var10 = 3.0F;
            var9.savedRot.setAngleAxis(var10, 1.0F, 0.0F, 0.0F);
         }

         var9.jniTransform.setRotation(var9.savedRot);
         if (IsoChunk.doSpawnedVehiclesInInvalidPosition(var9)) {
            var9.setSquare(this.square);
         ...
         var9.setGeneralPartCondition(0.5F, 60.0F);
         VehiclePart var8 = var9.getPartById("Engine");
         if (var8 != null) {
            var8.setCondition(0);
         }

         var9.engineQuality = 0;
         return var9;
      }
   }
