...
public final class DebugChunkState extends GameState {
   ...
   public void renderScene() {
      ...
      if (this.ZoneRect.getValue()) {
         IsoMetaGrid.Zone var7 = IsoWorld.instance.MetaGrid.getZoneAt(this.gridX, this.gridY, this.m_z);
         if (var7 != null) {
            this.DrawIsoLine((float)var7.x, (float)var7.y, (float)(var7.x + var7.w), (float)var7.y, 1.0F, 1.0F, 0.0F, 1.0F, 1);
            this.DrawIsoLine((float)var7.x, (float)(var7.y + var7.h), (float)(var7.x + var7.w), (float)(var7.y + var7.h), 1.0F, 1.0F, 0.0F, 1.0F, 1);
            this.DrawIsoLine((float)var7.x, (float)var7.y, (float)var7.x, (float)(var7.y + var7.h), 1.0F, 1.0F, 0.0F, 1.0F, 1);
            this.DrawIsoLine((float)(var7.x + var7.w), (float)var7.y, (float)(var7.x + var7.w), (float)(var7.y + var7.h), 1.0F, 1.0F, 0.0F, 1.0F, 1);
         }

         IsoMetaGrid.VehicleZone var10 = IsoWorld.instance.MetaGrid.getVehicleZoneAt(this.gridX, this.gridY, this.m_z);
         if (var10 != null) {
            float var12 = 0.5F;
            float var4 = 1.0F;
            float var5 = 0.5F;
            float var6 = 1.0F;
            this.DrawIsoLine((float)var10.x, (float)var10.y, (float)(var10.x + var10.w), (float)var10.y, var12, var4, var5, var6, 1);
            this.DrawIsoLine((float)var10.x, (float)(var10.y + var10.h), (float)(var10.x + var10.w), (float)(var10.y + var10.h), var12, var4, var5, var6, 1);
            this.DrawIsoLine((float)var10.x, (float)var10.y, (float)var10.x, (float)(var10.y + var10.h), var12, var4, var5, var6, 1);
            this.DrawIsoLine((float)(var10.x + var10.w), (float)var10.y, (float)(var10.x + var10.w), (float)(var10.y + var10.h), var12, var4, var5, var6, 1);
         }
      }

      IsoGridSquare var8;
      if (this.BuildingRect.getValue()) {
         var8 = IsoWorld.instance.getCell().getGridSquare(this.gridX, this.gridY, this.m_z);
         if (var8 != null && var8.getBuilding() != null) {
            BuildingDef var11 = var8.getBuilding().getDef();
            this.DrawIsoLine((float)var11.getX(), (float)var11.getY(), (float)var11.getX2(), (float)var11.getY(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var11.getX2(), (float)var11.getY(), (float)var11.getX2(), (float)var11.getY2(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var11.getX2(), (float)var11.getY2(), (float)var11.getX(), (float)var11.getY2(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
            this.DrawIsoLine((float)var11.getX(), (float)var11.getY2(), (float)var11.getX(), (float)var11.getY(), 1.0F, 1.0F, 1.0F, 1.0F, 2);
         }
      }
      ...
      if (this.RoomLightRects.getValue()) {
         ...
         for(var2 = 0; var2 < var9.size(); ++var2) {
            IsoRoomLight var13 = (IsoRoomLight)var9.get(var2);
            if (var13.z == this.m_z) {
               this.DrawIsoRect((float)var13.x, (float)var13.y, (float)var13.width, (float)var13.height, 0.0F, 1.0F, 1.0F, 1.0F, 1);
            }
         }
      }
      ...
      if (this.m_table != null && this.m_table.rawget("selectedSquare") != null) {
         var8 = (IsoGridSquare)Type.tryCastTo(this.m_table.rawget("selectedSquare"), IsoGridSquare.class);
         if (var8 != null) {
            this.DrawIsoRect((float)var8.x, (float)var8.y, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 1.0F, 2);
         }
      }
