   ...
   public WorldSoundManager.WorldSound addSound(Object var1, int var2, int var3, int var4, int var5, int var6, boolean var7, float var8, float var9) {
      if (var5 <= 0) {
         ...
         synchronized(this.SoundList) {
            ...
            ZombiePopulationManager.instance.addWorldSound(var11);
            return var11;
         }
      }
   }

   public WorldSoundManager.WorldSound addSound(boolean var1, int var2, int var3, int var4, int var5, int var6, boolean var7, float var8, float var9) {
      WorldSoundManager.WorldSound var10 = this.addSound((Object)null, var2, var3, var4, var5, var6, var7, var8, var9);
      if (var10 != null) {
