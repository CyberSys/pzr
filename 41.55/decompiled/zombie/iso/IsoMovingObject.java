...
public class IsoMovingObject extends IsoObject implements Mover {
   ...
   public void postupdateClient() {
      ...
      if (!this.destroyed) {
         ...
         this.impulsex = 0.0F;
         this.impulsey = 0.0F;
         if (!GameClient.bClient && this.isZombie() && (int)this.z == 0 && this.getCurrentBuilding() == null && !this.isInLoadedArea((int)this.nx, (int)this.ny) && (((IsoZombie)this).getCurrentState() == PathFindState.instance() || ((IsoZombie)this).getCurrentState() == WalkTowardState.instance())) {
            ...
            if (this instanceof IsoGameCharacter && !this.isOnFloor() && ((IsoGameCharacter)this).getVehicle() == null && this.isCollidable() && (!(this instanceof IsoPlayer) || !((IsoPlayer)this).isNoClip())) {
               Vector2f var1 = PolygonalMap2.instance.resolveCollision((IsoGameCharacter)this, this.nx, this.ny, IsoMovingObject.L_postUpdate.vector2f);
               if (var1.x != this.nx || var1.y != this.ny) {
                  if (this instanceof IsoPlayer && !((IsoPlayer)this).isLocalPlayer()) {
                     var2 = GameTime.getInstance().getMultiplier() / 5.0F;
                     this.nx += (var1.x - this.nx) * var2;
                     this.ny += (var1.y - this.ny) * var2;
                  } else {
                     this.nx = var1.x;
                     this.ny = var1.y;
                  }
            ...
            float var6;
            if (this.Collidable) {
               if (!Core.getInstance().isCollideZombies() && this instanceof IsoZombie && Core.GameMode.equals("Tutorial")) {
                  return;
               }
            ...
            this.checkHitWall();
            IsoPlayer var11 = (IsoPlayer)Type.tryCastTo(this, IsoPlayer.class);
            if (var11 != null && var11.isLocalPlayer() && !var11.isCurrentState(CollideWithWallState.instance()) && !this.collidedN && !this.collidedS && !this.collidedW && !this.collidedE) {
               this.setCollideType((String)null);
            }

            var6 = this.nx - this.x;
            float var7 = this.ny - this.y;
            float var8 = !(Math.abs(var6) > 0.0F) && !(Math.abs(var7) > 0.0F) ? 0.0F : this.getGlobalMovementMod();
            if (Math.abs(var6) > 0.01F || Math.abs(var7) > 0.01F) {
               var6 *= var8;
               var7 *= var8;
            }
            ...
            if (this.current == null) {
               for(int var9 = (int)this.z; var9 >= 0; --var9) {
                  this.current = this.getCell().getGridSquare((int)this.x, (int)this.y, var9);
                  if (this.current != null) {
                     break;
                  }
               }
   ...
   public void postupdate() {
      if (GameClient.bClient && (this instanceof IsoZombie || this instanceof IsoPlayer)) {
                  ...
                  for(int var5 = 0; var5 < var4.getMovingObjects().size(); ++var5) {
                     ...
                     if (var6 != this && var6.isSolidForSeparate() && !(Math.abs(this.z - var6.z) > 0.3F)) {
                        ...
                        if (var7 != null) {
                           ...
                           if (!(var11 >= var9)) {
                              if (var2 != null && var2.getVariableFloat("WalkSpeed", 0.0F) > 0.2F && var2.runningTime > 0.5F && var2.getBumpedChr() != var6 && !"charge".equals(var2.getAttackType())) {
                                 boolean var12 = !this.isOnFloor() && (var1.getBumpedChr() != null || (System.currentTimeMillis() - var2.getLastBump()) / 100L < 15L || var2.isSprinting()) && (var8 == null || !var8.isNPC());
                                 if (var12) {
                                    ++var1.bumpNbr;
                                    int var13 = 10 - var1.bumpNbr * 3;
                                    var13 += var1.getPerkLevel(PerkFactory.Perks.Fitness);
                                    var13 += var1.getPerkLevel(PerkFactory.Perks.Strength);
                                    ...
                                    BodyPart var14 = var1.getBodyDamage().getBodyPart(BodyPartType.Torso_Lower);
                                    if (var14.getAdditionalPain(true) > 20.0F) {
                                       var13 = (int)((float)var13 - (var14.getAdditionalPain(true) - 20.0F) / 20.0F);
                                    }

                                    var13 = Math.min(80, var13);
                                    var13 = Math.max(1, var13);
                                    if (Rand.Next(var13) == 0 || var1.isSprinting()) {
                                 ...
                                 boolean var16 = var1.isBehind(var7);
                                 String var15 = var1.getBumpType();
                                 if (var16) {
                                    if (var15.equals("left")) {
                                       var15 = "right";
                                    } else {
                                       var15 = "left";
                                    }
                                 ...
                                 var7.setBumpType(var15);
                                 var7.setHitFromBehind(var16);
                                 if (var12) {
   ...
   private void slideAwayFromWalls() {
      if (this.current != null) {
         ...
         if (var1 != null && (this.isOnFloor() || var1.bKnockedDown)) {
            if (!var1.isCrawling() || var1.getPath2() == null && !var1.isMoving()) {
               if (!var1.isCurrentState(ClimbOverFenceState.instance()) && !var1.isCurrentState(ClimbThroughWindowState.instance())) {
                  if (var1.hasAnimationPlayer() && var1.getAnimationPlayer().isReady()) {
                     ...
                     var2.y += var3.y * 0.3F;
                     float var5;
                     if (var1.bKnockedDown && (var1.isCurrentState(ZombieFallDownState.instance()) || var1.isCurrentState(StaggerBackState.instance()))) {
   ...
   private boolean DoCollide(int var1) {
      ...
      if (this instanceof IsoMolotovCocktail) {
         for(var2 = (int)this.z; var2 > 0; --var2) {
            for(var3 = -1; var3 <= 1; ++var3) {
               for(var4 = -1; var4 <= 1; ++var4) {
                  IsoGridSquare var5 = this.getCell().createNewGridSquare((int)this.nx + var4, (int)this.ny + var3, var2, false);
                  if (var5 != null) {
      ...
      if (this.current != this.last && this.last != null && this.current != null) {
         ...
         var2 = this.current.getX() - this.last.getX();
         var3 = this.current.getY() - this.last.getY();
         var4 = this.current.getZ() - this.last.getZ();
         boolean var12 = false;
         boolean var6 = false;
         if (var2 != 0 && var3 == 0) {
            var12 = true;
         ...
         boolean var7 = false;
         if (this.last.testCollideAdjacent(this, var2, var3, var4) || this.current == null) {
            var7 = true;
         }
         ...
         if (this instanceof IsoGameCharacter) {
            IsoGameCharacter var8 = (IsoGameCharacter)this;
            if (var8.getPath2() != null) {
               PathFindBehavior2 var10 = var8.getPathFindBehavior2();
               if ((int)var10.getTargetX() == (int)this.x && (int)var10.getTargetY() == (int)this.y && (int)var10.getTargetZ() == (int)this.z) {
                  return false;
               }
            }
         }

         IsoGridSquare var9 = this.getFeelerTile(this.feelersize);
         IsoGameCharacter var11 = (IsoGameCharacter)Type.tryCastTo(this, IsoGameCharacter.class);
         if (var11 != null) {
            if (var11.isClimbing()) {
               var9 = this.current;
            }

            if (var9 != null && var9 != this.current && var11.getPath2() != null && !var11.getPath2().crossesSquare(var9.x, var9.y, var9.z)) {
               var9 = this.current;
            }
         }

         if (var9 != null && var9 != this.current && this.current != null && this.current.testCollideAdjacent(this, var9.getX() - this.current.getX(), var9.getY() - this.current.getY(), var9.getZ() - this.current.getZ())) {
            if (this.last != null) {
               if (this.current.getX() < var9.getX()) {
                  this.collidedE = true;
               }
               ...
               if (this.current.getY() < var9.getY()) {
                  this.collidedS = true;
               }
   ...
   private boolean checkVaultOver() {
      ...
      if (!var1.isCurrentState(ClimbOverFenceState.instance()) && !var1.isIgnoreAutoVault()) {
         if (!var1.IsRunning() && !var1.isSprinting()) {
            return false;
         } else {
   ...
   public void setMovingSquareNow() {
      if (this.movingSq != null) {
         if (this.movingSq.getMovingObjects().contains(this)) {
            this.movingSq.getMovingObjects().remove(this);
         }
