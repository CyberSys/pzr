...
public final class LightingJNI {
   ...
   public static float calculateVisionCone(IsoGameCharacter var0) {
      ...
      if (var0.getVehicle() == null) {
         ...
         if (var0.getVehicle().getHeadlightsOn() && var0.getVehicle().getHeadlightCanEmmitLight()) {
            var1 = 1.5F - 3.0F * (1.0F - ClimateManager.getInstance().getDayLightStrength());
            if (var1 < -0.8F) {
               var1 = -0.8F;
            }
         } else {
   ...
   public static final class JNILighting implements IsoGridSquare.ILighting {
      ...
      private void checkRoomSeen() {
         IsoRoom var1 = this.square.getRoom();
         if (var1 != null && var1.def != null && !var1.def.bExplored) {
            IsoPlayer var2 = IsoPlayer.players[this.playerIndex];
            if (var2 != null) {
               if (this.square.z == (int)var2.z) {
                  byte var3 = 10;
                  if (var2.getBuilding() == var1.building) {
                     var3 = 50;
                  }

                  if (IsoUtils.DistanceToSquared(var2.x, var2.y, (float)this.square.x + 0.5F, (float)this.square.y + 0.5F) < (float)(var3 * var3)) {
                     var1.def.bExplored = true;
                     var1.onSee();
                     var1.seen = 0;
                  }
