...
public final class IsoDeadBody extends IsoMovingObject implements Talker, IHumanVisual {
   ...
   public IsoDeadBody(IsoGameCharacter var1, boolean var2) {
      ...
      if (var4 != null) {
         ...
         if (var1 instanceof IsoZombie) {
            if ((GameServer.bServer || GameClient.bClient) && var3 != null && var3.networkAI != null && var3.networkAI.deadZombie != null) {
               this.x = var3.networkAI.deadZombie.x;
               this.y = var3.networkAI.deadZombie.y;
               this.z = var3.networkAI.deadZombie.z;
               this.dir = var3.networkAI.deadZombie.direction;
               this.m_angle = var3.networkAI.deadZombie.angle;
               this.fallOnFront = var3.networkAI.deadZombie.isFallOnFront;
               this.bCrawling = var3.networkAI.deadZombie.isCrawling;
               if (this.bCrawling) {
            ...
            for(int var4 = 0; var4 < AllBodies.size(); ++var4) {
               ...
               if (!var5.updateFakeDead() && (ServerOptions.instance.RemovePlayerCorpsesOnCorpseRemoval.getValue() || var5.wasZombie)) {
                  ...
                  if (!(var8 < var1 + (var5.isSkeleton() ? var2 : 0.0F))) {
                     ...
                     if (GameServer.bServer) {
                        GameServer.removeCorpseFromMap(var5);
                     }
   ...
   public void reanimate() {
      ...
      if (GameServer.bServer) {
         ...
         GameServer.sendZombieUpdate(var3);
         GameServer.removeCorpseFromMap(this);
      }
