...
public class IsoDoor extends IsoObject implements BarricadeAble, Thumpable {
   ...
   private static void toggleDoubleDoorObject(IsoObject var0) {
      ...
      if (var1 != -1) {
         ...
         var0.sprite = IsoSprite.getSprite(IsoSpriteManager.instance, var6.getName(), var7);
         ...
         if (var1 != 2 && var1 != 3) {
            ...
            PolygonalMap2.instance.squareChanged(var8);
            ...
            if (var3 != null) {
               ...
               var17.setCanBeLockByPadlock(var3.canBeLockByPadlock());
               var17.setCanBePlastered(var3.canBePlastered());
               var17.setIsHoppable(var3.isHoppable());
               var17.setIsDismantable(var3.isDismantable());
               var17.setName(var3.getName());
               var17.setIsDoor(true);
               var17.setIsThumpable(var3.isThumpable());
               var17.setThumpDmg(var3.getThumpDmg());
               var17.setThumpSound(var3.getThumpSound());
               var17.open = !var5;
