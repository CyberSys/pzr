...
public final class IsoGridSquare {
   ...
   public void RecalcProperties() {
      ...
      boolean var8 = false;
      boolean var9 = false;
      int var10 = this.Objects.size();
      IsoObject[] var11 = (IsoObject[])this.Objects.getElements();

      for(int var12 = 0; var12 < var10; ++var12) {
         IsoObject var13 = var11[var12];
         if (var13 != null) {
            PropertyContainer var14 = var13.getProperties();
            if (var14 != null && !var14.Is(IsoFlagType.blueprint)) {
               if (var13.getType() == IsoObjectType.tree) {
                  this.hasTree = true;
               }

               this.hasTypes.set(var13.getType(), true);
               this.Properties.AddProperties(var14);
               if (var14.Is(IsoFlagType.water)) {
                  var4 = false;
               } else {
                  if (!var4 && var14.Is(IsoFlagType.solidfloor)) {
                     var4 = true;
                  }

                  if (!var3 && var14.Is(IsoFlagType.solidtrans)) {
                     var3 = true;
                  }

                  if (!var5 && var14.Is(IsoFlagType.solidfloor) && !var14.Is(IsoFlagType.transparentFloor)) {
                     var5 = true;
                  }
               }

               if (!var6 && var14.Is(IsoFlagType.collideN) && !var14.Is(IsoFlagType.HoppableN)) {
                  var6 = true;
               }

               if (!var7 && var14.Is(IsoFlagType.collideW) && !var14.Is(IsoFlagType.HoppableW)) {
                  var7 = true;
               }

               if (!var8 && var14.Is(IsoFlagType.cutN) && !var14.Is(IsoFlagType.transparentN)) {
                  var8 = true;
               }

               if (!var9 && var14.Is(IsoFlagType.cutW) && !var14.Is(IsoFlagType.transparentW)) {
                  var9 = true;
               }
            }
         }
   ...
   boolean renderMinusFloor(int var1, boolean var2, boolean var3, boolean var4, boolean var5, boolean var6, Shader var7) {
      if (!DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.RenderMinusFloor.getValue()) {
         ...
         IsoGridSquare var10 = IsoCamera.frameState.CamCharacterSquare;
         ColorInfo var11 = this.lightInfo[var9];
         boolean var12 = this.lighting[var9].bCouldSee();
         float var13 = this.lighting[var9].darkMulti();
         boolean var14 = IsoWorld.instance.CurrentCell.CanBuildingSquareOccludePlayer(this, var9);
         var11.a = 1.0F;
         defColorInfo.r = 1.0F;
         defColorInfo.g = 1.0F;
         defColorInfo.b = 1.0F;
         ...
         float var15 = this.CachedScreenX - IsoCamera.frameState.OffX;
         float var16 = this.CachedScreenY - IsoCamera.frameState.OffY;
         boolean var17 = true;
         IsoCell var18 = this.getCell();
         if (var15 + (float)(32 * Core.TileScale) <= (float)var18.StencilX1 || var15 - (float)(32 * Core.TileScale) >= (float)var18.StencilX2 || var16 + (float)(32 * Core.TileScale) <= (float)var18.StencilY1 || var16 - (float)(96 * Core.TileScale) >= (float)var18.StencilY2) {
            var17 = false;
         }
         ...
         int var22 = var2 ? var20 - 1 : 0;
         int var23 = var2 ? 0 : var20 - 1;
         boolean var24 = false;
         boolean var25 = false;
         boolean var26 = false;
         boolean var27 = false;
         int var28;
         if (!var2) {
            for(var28 = var22; var28 <= var23; ++var28) {
               IsoObject var29 = var21[var28];
               IsoGridSquare var30;
               if (this.isWindowOrWindowFrame(var29, true) && (var5 || var6)) {
                  var30 = this.nav[IsoDirections.N.index()];
                  var26 = var12 || var30 != null && var30.isCouldSee(var9);
               }

               if (this.isWindowOrWindowFrame(var29, false) && (var5 || var4)) {
                  var30 = this.nav[IsoDirections.W.index()];
                  var27 = var12 || var30 != null && var30.isCouldSee(var9);
               }

               if (var29.sprite != null && (var29.sprite.getType() == IsoObjectType.doorFrN || var29.sprite.getType() == IsoObjectType.doorN) && (var5 || var6)) {
                  var30 = this.nav[IsoDirections.N.index()];
                  var24 = var12 || var30 != null && var30.isCouldSee(var9);
               }

               if (var29.sprite != null && (var29.sprite.getType() == IsoObjectType.doorFrW || var29.sprite.getType() == IsoObjectType.doorW) && (var5 || var4)) {
                  var30 = this.nav[IsoDirections.W.index()];
                  var25 = var12 || var30 != null && var30.isCouldSee(var9);
               }
            }
         }

         var28 = IsoWorld.instance.CurrentCell.GetEffectivePlayerRoomId();
         bWallCutawayN = false;
         bWallCutawayW = false;
         int var46 = var22;
         ...
         while(true) {
            ...
            IsoObject var47 = var21[var46];
            boolean var31 = true;
            IsoObjectType var32 = IsoObjectType.MAX;
            if (var47.sprite != null) {
               var32 = var47.sprite.getType();
            }

            CircleStencil = false;
            if (var47.sprite != null && (var47.sprite.solidfloor || var47.sprite.renderLayer == 1)) {
               var31 = false;
            }

            if (var47 instanceof IsoFire) {
               var31 = !var3;
            }

            if (this.z >= var1 && (var47.sprite == null || !var47.sprite.alwaysDraw)) {
               var31 = false;
            }

            boolean var33 = var47.sprite != null && (var47.sprite.isBush || var47.sprite.canBeRemoved || var47.sprite.attachedFloor);
            if ((!var3 || var33 && this.bFlattenGrassEtc) && (var3 || !var33 || !this.bFlattenGrassEtc)) {
               if (var47.sprite != null && (var32 == IsoObjectType.WestRoofB || var32 == IsoObjectType.WestRoofM || var32 == IsoObjectType.WestRoofT) && this.z == var1 - 1 && this.z == (int)IsoCamera.CamCharacter.getZ()) {
                  var31 = false;
               }

               boolean var34 = var32 == IsoObjectType.doorFrW || var32 == IsoObjectType.doorW || var47.sprite != null && var47.sprite.cutW;
               boolean var35 = var32 == IsoObjectType.doorFrN || var32 == IsoObjectType.doorN || var47.sprite != null && var47.sprite.cutN;
               boolean var36 = var47 instanceof IsoDoor && ((IsoDoor)var47).open || var47 instanceof IsoThumpable && ((IsoThumpable)var47).open;
               boolean var37 = var47.container != null;
               boolean var38 = var47.sprite != null && var47.sprite.getProperties().Is(IsoFlagType.waterPiped);
               if (var47.sprite != null && var32 == IsoObjectType.MAX && !(var47 instanceof IsoDoor) && !(var47 instanceof IsoWindow) && !var37 && !var38) {
                  if (!var34 && var47.sprite.getProperties().Is(IsoFlagType.attachedW) && (var14 || var4 || var5)) {
                     var31 = !bWallCutawayW;
                  } else if (!var35 && var47.sprite.getProperties().Is(IsoFlagType.attachedN) && (var14 || var5 || var6)) {
                     var31 = !bWallCutawayN;
                  }
               }

               if (var47.sprite != null && !var47.sprite.solidfloor && IsoPlayer.getInstance().isClimbing()) {
                  var31 = true;
               }

               if (this.isSpriteOnSouthOrEastWall(var47)) {
                  if (!var2) {
                     var31 = false;
                  }
               ...
               if (var31) {
                  IndieGL.glAlphaFunc(516, 0.0F);
                  var47.bAlphaForced = false;
                  if (var36) {
                     var47.setTargetAlpha(var9, 0.6F);
                     var47.setAlpha(var9, 0.6F);
                  }

                  if (var47.sprite == null || !var34 && !var35) {
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.Objects.getValue()) {
                        if (this.getRoomID() != -1 && this.getRoomID() != var28 && IsoPlayer.players[var9].isSeatedInVehicle() && IsoPlayer.players[var9].getVehicle().getCurrentSpeedKmHour() >= 50.0F) {
                           break;
                        }

                        if (this.getRoomID() != -1 || !var6 && !var4 || var32 != IsoObjectType.WestRoofB && var32 != IsoObjectType.WestRoofM && var32 != IsoObjectType.WestRoofT) {
                           if (var10 != null && !var12 && this.getRoomID() != var28 && var13 < 0.5F) {
                              var47.setTargetAlpha(var9, var13 * 2.0F);
                           } else {
                              if (!var36) {
                                 var47.setTargetAlpha(var9, 1.0F);
                              }

                              if (IsoPlayer.getInstance() != null && var47.getProperties() != null && (var47.getProperties().Is(IsoFlagType.solid) || var47.getProperties().Is(IsoFlagType.solidtrans) || var47.getProperties().Is(IsoFlagType.attachedCeiling)) || var32.index() > 2 && var32.index() < 9 && IsoCamera.frameState.CamCharacterZ <= var47.getZ()) {
                                 byte var39 = 2;
                                 float var40 = 0.75F;
                                 if (var32.index() > 2 && var32.index() < 9) {
                                    var39 = 4;
                                    var40 = 0.5F;
                                 }

                                 int var41 = this.getX() - (int)IsoPlayer.getInstance().getX();
                                 int var42 = this.getY() - (int)IsoPlayer.getInstance().getY();
                                 if (var41 > 0 && var41 < var39 && var42 >= 0 && var42 < var39 || var42 > 0 && var42 < var39 && var41 >= 0 && var41 < var39) {
                                    var47.setTargetAlpha(var9, var40);
                                 }

                                 IsoZombie var43 = IsoCell.getInstance().getNearestVisibleZombie(var9);
                                 if (var43 != null && var43.getCurrentSquare() != null && var43.getCurrentSquare().isCanSee(var9)) {
                                    int var44 = this.getX() - (int)var43.x;
                                    int var45 = this.getY() - (int)var43.y;
                                    if (var44 > 0 && var44 < var39 && var45 >= 0 && var45 < var39 || var45 > 0 && var45 < var39 && var44 >= 0 && var44 < var39) {
                                       var47.setTargetAlpha(var9, var40);
                                    }
                                 }
                              }
                           ...
                           var47.setTargetAlpha(var9, 0.0F);
                        }

                        if (var47 instanceof IsoWindow) {
                           IsoWindow var48 = (IsoWindow)var47;
                           if (var47.getTargetAlpha(var9) < 1.0E-4F) {
                              IsoGridSquare var49 = var48.getOppositeSquare();
                              if (var49 != null && var49 != this && var49.lighting[var9].bSeen()) {
                                 var47.setTargetAlpha(var9, var49.lighting[var9].darkMulti() * 2.0F);
                              }
                           }

                           if (var47.getTargetAlpha(var9) > 0.4F) {
                              if ((var5 || var6) && var47.sprite.getProperties().Is(IsoFlagType.windowN)) {
                                 var47.setTargetAlpha(var9, 0.4F);
                                 bWallCutawayN = true;
                              } else if ((var5 || var4) && var47.sprite.getProperties().Is(IsoFlagType.windowW)) {
                                 var47.setTargetAlpha(var9, 0.4F);
                                 bWallCutawayW = true;
                              }
                           }
                        ...
                        if (var47 instanceof IsoTree) {
                           if (var17 && this.x >= (int)IsoCamera.frameState.CamCharacterX && this.y >= (int)IsoCamera.frameState.CamCharacterY && var10 != null && var10.Is(IsoFlagType.exterior)) {
                              ((IsoTree)var47).bRenderFlag = true;
                              var47.setTargetAlpha(var9, Math.min(0.99F, var47.getTargetAlpha(var9)));
                           } else {
                              ((IsoTree)var47).bRenderFlag = false;
                           }
                        }

                        var47.render((float)this.x, (float)this.y, (float)this.z, var11, true, false, (Shader)null);
                     }
                  } else if (PerformanceSettings.LightingFrameSkip < 3) {
                     if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.DoorsAndWalls.getValue()) {
                        CircleStencil = true;
                        if (var10 != null && this.getRoomID() != -1 && var28 == -1 && var14) {
                           var47.setTargetAlpha(var9, 0.5F);
                           var47.setAlpha(var9, 0.5F);
                        } else if (!var36) {
                           var47.setTargetAlpha(var9, 1.0F);
                           var47.setAlpha(var9, 1.0F);
                        }

                        var47.bAlphaForced = true;
                        if (var47.sprite.cutW && var47.sprite.cutN) {
                           var8 = this.DoWallLightingNW(var47, var8, var4, var5, var6, var24, var25, var26, var27, var7);
                        } else if (var47.sprite.getType() != IsoObjectType.doorFrW && var32 != IsoObjectType.doorW && !var47.sprite.cutW) {
                           if (var32 == IsoObjectType.doorFrN || var32 == IsoObjectType.doorN || var47.sprite.cutN) {
                              var8 = this.DoWallLightingN(var47, var8, var5, var6, var24, var26, var7);
                           }
                        } else {
                           var8 = this.DoWallLightingW(var47, var8, var4, var5, var25, var27, var7);
                        }

                        if (var47 instanceof IsoWindow && var47.getTargetAlpha(var9) < 1.0F) {
                           bWallCutawayN |= var47.sprite.cutN;
                           bWallCutawayW |= var47.sprite.cutW;
                        }
                     }
                  } else if (DebugOptions.instance.Terrain.RenderTiles.IsoGridSquare.DoorsAndWalls_SimpleLighting.getValue()) {
                     if (this.z != (int)IsoCamera.frameState.CamCharacterZ || var32 == IsoObjectType.doorFrW || var32 == IsoObjectType.doorFrN || var47 instanceof IsoWindow) {
                        var17 = false;
                     }

                     if (var47.getTargetAlpha(var9) < 1.0F) {
                        if (!var17) {
                           var47.setTargetAlpha(var9, 1.0F);
                        }

                        var47.setAlphaToTarget(var9);
                  ...
                  if ((var47.highlightFlags & 2) != 0) {
                     var47.highlightFlags &= -4;
                  }
               }
            }
   ...
   public void syncIsoTrap(HandWeapon var1) {
      ByteBufferWriter var2 = GameClient.connection.startPacket();
      PacketTypes.doPacket((short)110, var2);
      var2.putInt(this.getX());
      var2.putInt(this.getY());
      var2.putInt(this.getZ());
            ...
            if (!(IsoUtils.DistanceTo((float)var4 + 0.5F, (float)var5 + 0.5F, (float)this.getX() + 0.5F, (float)this.getY() + 0.5F) > (float)var1)) {
               ...
               if (var6 != LosUtil.TestResults.Blocked && var6 != LosUtil.TestResults.ClearThroughClosedDoor) {
                  ...
                  if (var7 != null) {
                     ...
                     if (var3 == IsoTrap.ExplosionMode.Fire && Rand.Next(100 - var2.getFirePower()) == 0) {
