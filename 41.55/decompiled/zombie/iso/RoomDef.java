...
public final class RoomDef {
   ...
   public void forEachChunk(BiConsumer var1) {
      for(int var2 = 0; var2 < this.rects.size(); ++var2) {
         ...
         int var4 = var3.x / 10;
         int var5 = var3.y / 10;
         int var6 = (var3.x + var3.w) / 10;
         int var7 = (var3.y + var3.h) / 10;
         if ((var3.x + var3.w) % 10 == 0) {
            --var6;
         }

         if ((var3.y + var3.h) % 10 == 0) {
            --var7;
         }

         for(int var8 = var5; var8 <= var7; ++var8) {
            for(int var9 = var4; var9 <= var6; ++var9) {
               IsoChunk var10 = IsoWorld.instance.CurrentCell.getChunk(var9, var8);
               if (var10 != null) {
                  var1.accept(this, var10);
               }
            }
         }
      }
