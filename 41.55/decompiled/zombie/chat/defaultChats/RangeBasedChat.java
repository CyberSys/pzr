...
public abstract class RangeBasedChat extends ChatBase {
   ...
   protected void showInSpeechBubble(ChatMessage var1) {
      ...
      if (var3 != null && !"".equalsIgnoreCase(var3) && !var3.equalsIgnoreCase(currentPlayerName)) {
         ...
         var9.getChatElement().addChatLine(var8, var5, var6, var7, UIFont.Dialogue, this.getRange(), this.customTag, this.isAllowBBcode(), this.isAllowImages(), this.isAllowChatIcons(), this.isAllowColors(), this.isAllowFonts(), this.isEqualizeLineHeights());
      } else {
         overHeadChat.addChatLine(var8, var5, var6, var7, UIFont.Dialogue, this.getRange(), this.customTag, this.isAllowBBcode(), this.isAllowImages(), this.isAllowChatIcons(), this.isAllowColors(), this.isAllowFonts(), this.isEqualizeLineHeights());
      }
