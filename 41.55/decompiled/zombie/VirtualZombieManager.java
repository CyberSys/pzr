...
public final class VirtualZombieManager {
   ...
   private boolean isBlockedInAllDirections(int var1, int var2, int var3) {
      ...
      if (var5 == null) {
         ...
         boolean var6 = IsoGridSquare.getMatrixBit(var5.pathMatrix, (int)1, (int)0, (int)1) && var5.nav[IsoDirections.N.index()] != null;
         boolean var7 = IsoGridSquare.getMatrixBit(var5.pathMatrix, (int)1, (int)2, (int)1) && var5.nav[IsoDirections.S.index()] != null;
         boolean var8 = IsoGridSquare.getMatrixBit(var5.pathMatrix, (int)0, (int)1, (int)1) && var5.nav[IsoDirections.W.index()] != null;
         boolean var9 = IsoGridSquare.getMatrixBit(var5.pathMatrix, (int)2, (int)1, (int)1) && var5.nav[IsoDirections.E.index()] != null;
