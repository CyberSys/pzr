   ...
   private static void receiveObjectChange(ByteBuffer var0) {
      ...
      if (var1 == 1) {
         ...
         if (var1 == 3) {
            ...
            var7 = IsoWorld.instance.CurrentCell.getGridSquare(var2, var11, var13);
            if (var7 == null) {
               delayPacket(var2, var11, var13);
               return;
            }
            ...
            if (Core.bDebug) {
               DebugLog.log("receiveObjectChange: itemID=" + var5 + " is invalid x,y,z=" + var2 + "," + var11 + "," + var13);
            }
         } else {
            var2 = var0.getInt();
            var11 = var0.getInt();
            ...
            if (var5 >= 0 && var5 < var7.getObjects().size()) {
               ...
               DebugLog.log("receiveObjectChange: index=" + var5 + " is invalid x,y,z=" + var2 + "," + var11 + "," + var13);
            }
         }
      }
