...
public class NetworkPlayerVariables {
   ...
   public static int getBooleanVariables(IsoPlayer var0) {
      ...
      var2 |= var0.isOnDeathDone() ? 4096 : 0;
      var2 |= var0.isSitOnGround() ? 8192 : 0;
      var2 |= var0.networkAI.pressedMovement ? 16384 : 0;
      var2 |= var0.getVariableBoolean("ExerciseEnded") ? '耀' : 0;
      var2 |= var0.getVariableBoolean("IsPerformingAnAction") ? 65536 : 0;
      return var2;
   }
   ...
   public static void setBooleanVariables(IsoPlayer var0, int var1) {
      ...
      if (!var0.bDoShove && (var1 & 512) != 0) {
         var0.bDoShove = (var1 & 512) != 0;
      }

      var0.networkAI.moving = (var1 & 1024) != 0;
      var0.setOnFloor((var1 & 2048) != 0);
      var0.setOnDeathDone((var1 & 4096) != 0);
      var0.setSitOnGround((var1 & 8192) != 0);
      var0.networkAI.pressedMovement = (var1 & 16384) != 0;
      var0.setVariable("ExerciseEnded", (var1 & '耀') != 0);
      var0.setVariable("IsPerformingAnAction", (var1 & 65536) != 0);
   }
}
