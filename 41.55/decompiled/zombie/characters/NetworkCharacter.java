...
public class NetworkCharacter {
   ...
   public static enum PredictionMoveTypes {
      None,
      ExtrapolationMoving,
      ExtrapolationStatic,
      Thump,
      ...
      // $FF: synthetic method
      private static NetworkCharacter.PredictionMoveTypes[] $values() {
         return new NetworkCharacter.PredictionMoveTypes[]{None, ExtrapolationMoving, ExtrapolationStatic, Thump, Climb, Lunge, LungeHalf, Walk, WalkHalf, PathFind};
      }
   }
}
