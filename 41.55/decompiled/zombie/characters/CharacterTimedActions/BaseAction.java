...
public class BaseAction {
   ...
   public void setActionAnim(String var1) {
      ...
      if (GameClient.bClient && this.chr instanceof IsoPlayer && ((IsoPlayer)this.chr).isLocalPlayer() && !specificNetworkAnim.contains(var1)) {
         GameClient.sendEventUpdate((IsoPlayer)this.chr, var1, true);
      }
