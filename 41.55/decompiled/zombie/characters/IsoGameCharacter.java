...
public abstract class IsoGameCharacter extends IsoMovingObject implements Talker, ChatElementOwner, IAnimatable, IAnimationVariableMap, IClothingItemListener, IActionStateChanged, IAnimEventCallback, IFMODParameterUpdater, ILuaVariableSource, ILuaGameCharacter {
   ...
   public void setWornItem(String var1, InventoryItem var2, boolean var3) {
      ...
      if (var3 && var4 != null && this instanceof IsoPlayer && !this.getInventory().hasRoomFor(this, var4)) {
         ...
         if (var6 != null) {
            ...
            float var9 = var6.getApparentZ(var7, var8);
   ...
   private float processHitDamage(HandWeapon var1, IsoGameCharacter var2, float var3, boolean var4, float var5) {
   ...
   public void renderlast() {
      ...
      if (this.hasInitTextObjects && this.isoPlayer != null || this.chatElement.getHasChatToDisplay()) {
         ...
         if (this.isoPlayer != null && (this == IsoCamera.frameState.CamCharacter || this.getCurrentSquare() != null && this.getCurrentSquare().getCanSee(var1)) || IsoPlayer.getInstance().isCanSeeAll()) {
            ...
            if (!GameClient.bClient && this.isoPlayer != null && this.isoPlayer.getVehicle() == null) {
               String var16 = "";
               BaseVehicle var20 = this.isoPlayer.getNearVehicle();
               if (this.getVehicle() == null && var20 != null && var20.getPartById("Engine") != null && (this.isoPlayer.getInventory().haveThisKeyId(var20.getKeyId()) != null || var20.isHotwired() || SandboxOptions.getInstance().VehicleEasyUse.getValue()) && UIManager.VisibleAllUI) {
                  Color var24 = Color.HSBtoRGB(var20.colorHue, var20.colorSaturation * 0.5F, var20.colorValue, IsoGameCharacter.L_renderLast.color);
                  int var10000 = var24.getRedByte();
                  var16 = " [img=media/ui/CarKey.png," + var10000 + "," + var24.getGreenByte() + "," + var24.getBlueByte() + "]";
               }
         ...
         if (this.isoPlayer != null && this.hasInitTextObjects && (this.playerIsSelf() || this.canSeeCurrent)) {
            ...
            if (this.playerIsSelf() && this.haloNote != null && this.haloNote.getInternalClock() > 0.0F) {
               var21 = this.haloNote.getInternalClock() / (this.haloDispTime / 4.0F);
               var21 = PZMath.min(var21, 1.0F);
               var5 -= (float)(this.haloNote.getHeight() + 2);
               this.haloNote.AddBatchedDraw((double)((int)var4), (double)((int)var5), true, var21);
            }
         }
         ...
         if (!this.m_invisible || this == IsoCamera.frameState.CamCharacter || var22) {
            this.chatElement.renderBatched(IsoPlayer.getPlayerIndex(), (int)var4, (int)var5, var23);
         }
      }

      Vector2 var13;
      AnimationPlayer var18;
      if (Core.bDebug && DebugOptions.instance.Character.Debug.Render.Angle.getValue() && this.hasActiveModel()) {
         var13 = tempo;
         var18 = this.getAnimationPlayer();
      ...
      if (Core.bDebug && DebugOptions.instance.MultiplayerShowPrediction.getValue()) {
         if (this instanceof IsoZombie) {
            IsoZombie var14 = (IsoZombie)this;
            ...
            } else if (var14.networkAI.getOwner() != -1) {
               if (var14.networkAI.isLocalControl()) {
            ...
            var5 = IsoUtils.XToScreenExact(var14.networkAI.targetX + 0.4F, var14.networkAI.targetY + 0.4F, (float)var14.networkAI.targetZ, 0);
            var6 = IsoUtils.YToScreenExact(var14.networkAI.targetX + 0.4F, var14.networkAI.targetY + 0.4F, (float)var14.networkAI.targetZ, 0);
            int var26 = (int)(GameTime.getServerTime() / 1000000L);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)var6, "ETA: " + (var14.networkAI.targetT - var26), (double)Colors.LimeGreen.r, (double)Colors.LimeGreen.g, (double)Colors.LimeGreen.b, 0.6499999761581421D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)(var6 + 10.0F), "Type: " + var14.networkAI.predictionType, (double)Colors.LimeGreen.r, (double)Colors.LimeGreen.g, (double)Colors.LimeGreen.b, 0.6499999761581421D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)(var6 + 20.0F), "Target: " + var14.networkAI.moveToTarget, (double)Colors.LimeGreen.r, (double)Colors.LimeGreen.g, (double)Colors.LimeGreen.b, 0.6499999761581421D);
            var5 = IsoUtils.XToScreenExact(this.x + 0.4F, this.y + 0.4F, this.z, 0);
            var6 = IsoUtils.YToScreenExact(this.x + 0.4F, this.y + 0.4F, this.z, 0);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)var6, "ID: " + this.getOnlineID(), (double)Colors.LightYellow.r, (double)Colors.LightYellow.g, (double)Colors.LightYellow.b, 0.75D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)(var6 + 10.0F), "State: " + this.getCurrentStateName(), (double)Colors.LightYellow.r, (double)Colors.LightYellow.g, (double)Colors.LightYellow.b, 0.75D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)(var6 + 20.0F), "Previous: " + this.getPreviousStateName(), (double)Colors.LightYellow.r, (double)Colors.LightYellow.g, (double)Colors.LightYellow.b, 0.75D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var5, (double)(var6 + 30.0F), "Health: " + this.getHealth(), (double)Colors.LightYellow.r, (double)Colors.LightYellow.g, (double)Colors.LightYellow.b, 0.75D);
      ...
      if (Core.bDebug) {
         ...
         if (DebugOptions.instance.MultiplayerShowStatus.getValue() && (this instanceof IsoZombie || this instanceof IsoPlayer)) {
            ...
            Color var17 = this.isDead() ? Colors.OrangeRed : Colors.NavajoWhite;
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var4, (double)var5, String.format("%d: %f", this.getOnlineID(), this.getHealth()), (double)var17.r, (double)var17.g, (double)var17.b, 0.699999988079071D);
            TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)var4, (double)(var5 + 10.0F), String.format("State: %s/%s", this.getPreviousActionContextStateName(), this.getCurrentActionContextStateName()), (double)var17.r, (double)var17.g, (double)var17.b, 0.699999988079071D);
         }
      }

      if (this.inventory != null) {
         int var15;
         for(var15 = 0; var15 < this.inventory.Items.size(); ++var15) {
            InventoryItem var25 = (InventoryItem)this.inventory.Items.get(var15);
            if (var25 instanceof IUpdater) {
               ((IUpdater)var25).renderlast();
            }
         }
         ...
         if (Core.bDebug && DebugOptions.instance.CollideWithObstaclesRenderRadius.getValue()) {
            ...
            LineDrawer.DrawIsoCircle(this.x, this.y, this.z, var4, 16, var5, var6, var21, 1.0F);
         }

         if (DebugOptions.instance.Animation.Debug.getValue() && this.hasActiveModel()) {
            var15 = (int)IsoUtils.XToScreenExact(this.x, this.y, this.z, 0);
            int var27 = (int)IsoUtils.YToScreenExact(this.x, this.y, this.z, 0);
            TextManager.instance.DrawString((double)var15, (double)var27, this.getAnimationDebug());
         }
         ...
         if (var1.IsAiming()) {
            ...
            for(int var29 = 0; var29 < SwipeStatePlayer.HitList.size(); ++var29) {
               ...
               if (var12 != null) {
                  ...
                  TextManager.instance.DrawStringCentre(var25, (double)var23, (double)(var24 + (float)TextManager.instance.getFontHeight(var25)), String.valueOf(var11.chance) + "%", 1.0D, 1.0D, 1.0D, 1.0D);
                  var14 = 1.0F;
                  var15 = 1.0F;
                  float var26 = 1.0F;
   ...
   protected void updateMovementMomentum() {
      ...
      if (this.isPlayerMoving() && !this.isAiming()) {
         ...
         var3 = var2 + var1;
         var4 = var3 / 0.55F;
         var5 = PZMath.clamp(var4, 0.0F, 1.0F);
         this.m_momentumScalar = var5;
      } else {
   ...
   public float calculateBaseSpeed() {
      ...
      BodyPart var5 = this.getBodyDamage().getBodyPart(BodyPartType.UpperLeg_L);
      if (var5.getAdditionalPain(true) > 20.0F) {
         var1 -= (var5.getAdditionalPain(true) - 20.0F) / 100.0F;
      }

      for(int var6 = 0; var6 < this.bagsWorn.size(); ++var6) {
         InventoryContainer var4 = (InventoryContainer)this.bagsWorn.get(var6);
         this.bagRunSpeedModifier += this.calcRunSpeedModByBag(var4);
      }
      ...
      float var7 = var1 * (1.0F - Math.abs(1.0F - this.fullSpeedMod) / 2.0F);
      return var7;
   }
   ...
   public void loadChange(String var1, ByteBuffer var2) {
      ...
      if ("addItem".equals(var1)) {
         try {
            InventoryItem var3 = InventoryItem.loadItem(var2, 184);
            if (var3 != null) {
   ...
   public void setMoving(boolean var1) {
      ...
      if (GameClient.bClient && this instanceof IsoPlayer && ((IsoPlayer)this).bRemote) {
         ((IsoPlayer)this).JustMoved = ((IsoPlayer)this).m_isPlayerMoving = var1;
      }
