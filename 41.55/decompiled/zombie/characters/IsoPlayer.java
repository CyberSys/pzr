...
public final class IsoPlayer extends IsoLivingCharacter implements IHumanVisual {
   ...
   private void updateAimingStance() {
      ...
      if (this.isAiming() && !this.isCurrentState(SwipeStatePlayer.instance())) {
         ...
         SwipeStatePlayer.HitInfo var2 = s_targetsStanding.isEmpty() ? null : (SwipeStatePlayer.HitInfo)s_targetsStanding.get(0);
         SwipeStatePlayer.HitInfo var3 = s_targetsProne.isEmpty() ? null : (SwipeStatePlayer.HitInfo)s_targetsProne.get(0);
         if (SwipeStatePlayer.instance().isProneTargetBetter(this, var2, var3)) {
            var2 = null;
         }

         boolean var4 = this.getVariableBoolean("AttackAnim") || this.getVariableBoolean("ShoveAnim") || this.getVariableBoolean("StompAnim");
         if (!var4) {
         ...
         if (var2 != null) {
            boolean var5 = !this.getVariableBoolean("AttackAnim") && var1.getSwingAnim() != null && var1.CloseKillMove != null && var2.distSq < var1.getMinRange() * var1.getMinRange();
   ...
   private void updateGodModeKey() {
      if (Core.bDebug) {
         if (GameKeyboard.isKeyPressed(Core.getInstance().getKey("ToggleGodModeInvisible"))) {
            ...
            if (this == var1) {
               boolean var5 = !var1.isGodMod();
               DebugLog.General.println("Toggle GodMode: %s", var5 ? "ON" : "OFF");
               var1.setInvisible(var5);
               var1.setGhostMode(var5);
               var1.setGodMod(var5);

               for(int var3 = 0; var3 < numPlayers; ++var3) {
                  if (players[var3] != null && players[var3] != var1) {
                     players[var3].setInvisible(var5);
                     players[var3].setGhostMode(var5);
                     players[var3].setGodMod(var5);
                  }
               }

               if (GameClient.bClient) {
                  GameClient.sendPlayerExtraInfo(var1);
                  if (DebugOptions.instance.MultiplayerShowTeleport.getValue() && !var5) {
                     Iterator var6 = GameClient.IDToZombieMap.valueCollection().iterator();

                     while(var6.hasNext()) {
                        IsoZombie var4 = (IsoZombie)var6.next();
                        var4.teleportDebug = null;
                        var4.debugData.clear();
                     }
                  }
               }
            }
   ...
   private void highlightRangedTargetsInternal() {
      ...
      if (Core.getInstance().getOptionAimOutline() != 2 || var1.isRanged()) {
         ...
         for(int var4 = 0; var4 < SwipeStatePlayer.HitList.size(); ++var4) {
            ...
            if (var6 instanceof IsoZombie || var6 instanceof IsoPlayer) {
   ...
   public boolean isPushedByForSeparate(IsoMovingObject var1) {
      if (!this.isPlayerMoving() && var1.isZombie() && ((IsoZombie)var1).isAttacking()) {
         ...
         return !GameClient.bClient || this.isLocalPlayer() && this.JustMoved ? super.isPushedByForSeparate(var1) : false;
      }
   }
   ...
   public void pressedAttack(String var1) {
      ...
      if (!this.attackStarted && !this.isCurrentState(PlayerHitReactionState.instance())) {
         if (!GameClient.bClient || !this.isCurrentState(PlayerHitReactionPVPState.instance()) || ServerOptions.instance.PVPMeleeWhileHitReaction.getValue()) {
            if (this.primaryHandModel != null && !StringUtils.isNullOrEmpty(this.primaryHandModel.maskVariableValue) && this.secondaryHandModel != null && !StringUtils.isNullOrEmpty(this.secondaryHandModel.maskVariableValue)) {
               ...
               if (!this.attackStarted) {
                  this.setVariable("StartedAttackWhileSprinting", var2);
               }
               ...
               this.isCrit = false;
               this.attackFromBehind = false;
               WeaponType var3 = WeaponType.getWeaponType((IsoGameCharacter)this);
               this.setAttackType((String)PZArrayUtil.pickRandom(var3.possibleAttack));
               this.combatSpeed = this.calculateCombatSpeed();
               SwipeStatePlayer.AttackVars var4 = SwipeStatePlayer.instance().attackVars;
               SwipeStatePlayer.instance().CalcAttackVars(this, var4);
               if (var4.bDoShove && !this.isAuthorizeShoveStomp()) {
                  this.bDoShove = false;
                  this.setForceShove(false);
                  this.initiateAttack = false;
                  this.attackStarted = false;
                  ...
                  this.useHandWeapon = var4.weapon;
                  this.setAimAtFloor(var4.bAimAtFloor);
                  this.bDoShove = var4.bDoShove;
                  this.targetOnGround = var4.targetOnGround;
                  if (var4.weapon != null && !StringUtils.isNullOrEmpty(var4.weapon.getFireMode())) {
                     this.setVariable("FireMode", var4.weapon.getFireMode());
                  } else {
                     this.clearVariable("FireMode");
                  }

                  int var5;
                  if (this.useHandWeapon != null && var3.isRanged && !this.bDoShove) {
                  ...
                  ArrayList var11 = SwipeStatePlayer.HitList;
                  SwipeStatePlayer.instance().CalcHitList(this, true, var4);
                  if (StringUtils.isNullOrEmpty(var1)) {
                     IsoGameCharacter var7 = null;
                     if (!var11.isEmpty()) {
                        var7 = (IsoGameCharacter)Type.tryCastTo(((SwipeStatePlayer.HitInfo)var11.get(0)).object, IsoGameCharacter.class);
                     }
                     ...
                     if (var7 == null) {
                        ...
                        if (var3.canMiss && !this.isAimAtFloor()) {
                     ...
                     this.attackFromBehind = this.isBehind(var7);
                     float var8 = IsoUtils.DistanceTo(var7.x, var7.y, this.x, this.y);
                     this.setVariable("TargetDist", var8);
                     int var9 = this.calculateCritChance(var7);
                     if (var7 instanceof IsoZombie) {
                        IsoZombie var10 = this.getClosestZombieToOtherZombie((IsoZombie)var7);
                        if (!var4.bAimAtFloor && (double)var8 > 1.25D && var3 == WeaponType.spear && (var10 == null || (double)IsoUtils.DistanceTo(var7.x, var7.y, var10.x, var10.y) > 1.7D)) {
                           this.setAttackType("overhead");
                           var9 += 30;
                        }
                     }

                     var7.setHitFromBehind(this.attackFromBehind);
                     if (this.attackFromBehind) {
                        if (var7 instanceof IsoZombie && ((IsoZombie)var7).target == null) {
                           var9 += 30;
                        } else {
                           var9 += 5;
                        }
                     ...
                     if (var7 instanceof IsoPlayer && var3.isRanged && !this.bDoShove) {
                        var9 = (int)(var4.weapon.getStopPower() * (1.0F + (float)this.getPerkLevel(PerkFactory.Perks.Aiming) / 15.0F));
                     }

                     this.isCrit = Rand.Next(100) < var9;
                     if (this.attackFromBehind && var4.bCloseKill && var7 instanceof IsoZombie && ((IsoZombie)var7).target == null) {
                        this.isCrit = true;
                     }

                     if (this.isCrit && !var4.bCloseKill && !this.bDoShove && var3 == WeaponType.knife) {
                        this.isCrit = false;
                     }

                     this.setAttackWasSuperAttack(false);
                     if (this.stats.NumChasingZombies > 1 && var4.bCloseKill && !this.bDoShove && var3 == WeaponType.knife) {
                        this.isCrit = false;
                     }
                     ...
                     if (DebugLog.isEnabled(DebugType.Combat)) {
                        DebugLog.Combat.debugln("Hit zombie dist: " + var8 + " crit: " + this.isCrit + " (" + var9 + "%) from behind: " + this.attackFromBehind);
                     }
                  }

                  if (!StringUtils.isNullOrEmpty(var1)) {
                     this.setAttackType(var1);
                  }
                  ...
                  if (this.useHandWeapon != null && var3.isRanged) {
   ...
   public void hitConsequences(HandWeapon var1, IsoGameCharacter var2, boolean var3, float var4, boolean var5) {
      this.setM_bKnockedDown(var2.isCrit);
      ...
      if (var3) {
         if (!GameServer.bServer) {
            ...
            this.setHitReaction("HitReaction");
            var6 = this.testDotSide(var2);
            this.setHitFromBehind("BEHIND".equals(var6));
         }
      } else {
         if (!GameClient.bClient) {
         ...
         var6 = var2.getVariableString("ZombieHitReaction");
         if ("Bite".equals(var6)) {
            String var7 = this.testDotSide(var2);
   ...
   public boolean canClimbOverWall(IsoDirections var1) {
      if (this.isSafeToClimbOver(var1) && this.current != null) {
                  ...
                  if (var17 != null) {
                     ...
                     if (var4 != null && var12 != var4 && var18 != null && var18.isInvisible() && var4.accessLevel.isEmpty()) {
                        ...
                        if (!this.isAsleep() && (var23 || var16 < var21 && var22)) {
                           ...
                           } else if (var19 != null && var19 != var4 && var2) {
                           }
                        } else {
                           if (var12 != instance) {
                        ...
                        if (var16 < 2.0F && var12.getTargetAlpha(var3) == 1.0F) {
   ...
   public boolean checkCanSeeClient(IsoPlayer var1) {
      ...
      if (GameClient.bClient && var1 != this && this.isLocalPlayer()) {
         if (!this.getAccessLevel().equals("None") && this.canSeeAll) {
            ...
            IsoGridSquare.ILighting var6 = var1.getCurrentSquare().lighting[this.getPlayerNum()];
            if (!var6.bCouldSee()) {
               return this.checkSpottedPLayerTimer(var1);
            } else if (var1.isSneaking() && !var1.isSprinting()) {
               float var7 = var1.getCurrentSquare().DistTo(this.getCurrentSquare());
               if (var7 > 30.0F) {
                  var1.spottedByPlayer = false;
               }
               ...
               if (var1.spottedByPlayer) {
                  ...
                  var1.doRenderShadow = true;
                  float var8 = (float)(Math.pow((double)Math.max(40.0F - var7, 0.0F), 3.0D) / 12000.0D);
                  ...
                  float var11 = (var6.lightInfo().getR() + var6.lightInfo().getG() + var6.lightInfo().getB()) / 3.0F;
   ...
   private boolean updateRemotePlayer() {
      if (this.bRemote || GameClient.bClient && this.NetRemoteState == NetRemoteState_Attack && !this.def.Finished) {
         ...
         if (GameClient.bClient) {
            this.updateMovementRates();
            float var1 = this.networkAI.targetX;
            float var2 = this.networkAI.targetY;
            float var3 = (float)this.networkAI.targetZ;
            int var4 = this.networkAI.targetT;
            PathFindBehavior2 var5 = this.getPathFindBehavior2();
            if (!this.networkAI.events.isEmpty()) {
               NetworkPlayerAI.Event var6 = (NetworkPlayerAI.Event)this.networkAI.events.peek();
               if (this.networkAI.events.contains(var6) && var6.process(this)) {
                  DebugLog.log(DebugType.Multiplayer, "Event processed: " + var6.getDescription());
                  this.JustMoved = this.m_isPlayerMoving = this.networkAI.moving = false;
                  this.networkAI.events.remove(var6);
                  this.networkAI.lastEvent = var6;
               ...
               if (!var6.isMovableEvent()) {
                  tempo.set(var6.x - this.x, var6.y - this.y);
                  var1 = var6.x;
                  var2 = var6.y;
                  var3 = var6.z;
                  var4 = (int)((float)(GameTime.getServerTime() / 1000000L) + tempo.getLength() / 0.00122F);
               }

               if (var6.isTimeout()) {
                  DebugLog.log(DebugType.Multiplayer, "Event timeout: " + var6.getDescription());
                  this.JustMoved = this.m_isPlayerMoving = this.networkAI.moving = false;
                  this.networkAI.events.remove(var6);
                  this.networkAI.lastEvent = var6;
                  if (this.networkAI.usePathFind) {
            ...
            } else if (!this.networkAI.moving && this.strike == null && this.strikes.isEmpty() && IsoUtils.DistanceManhatten(var1, var2, this.x, this.y) < 0.7F) {
            ...
            if (this.strike != null) {
               var1 = this.strike.zom.x;
               var2 = this.strike.zom.y;
               var3 = this.strike.zom.z;
               var4 = (int)(Math.sqrt((double)this.getDistanceSq(this.strike.zom)) / 0.0012199999764561653D);
               long var11 = this.strike.lifeTime - System.currentTimeMillis();
               if (var11 < 0L || var11 > 3000L) {
                  this.strike = null;
               }
            } else if (!this.strikes.isEmpty()) {
               NetworkStrikeAI.Strike var10 = (NetworkStrikeAI.Strike)this.strikes.get(0);
               long var7 = var10.lifeTime - System.currentTimeMillis();
               if (var7 >= 0L && var7 <= 3000L) {
                  if (NetworkStrikeAI.canStrike(var10)) {
                     NetworkStrikeAI.executeStrike(var10);
                     NetworkStrikeAI.deleteStrike(var10);
                  } else {
                     if (var10.zom.strike == null) {
                        var10.zom.strike = var10;
                        DebugLog.log("updateRemotePlayer setStrikeToZombie objType:" + var10.objType);
                     }

                     var1 = var10.zom.x;
                     var2 = var10.zom.y;
                     var3 = var10.zom.z;
                     var4 = (int)((double)(GameTime.getServerTime() / 1000000L) + Math.sqrt((double)this.getDistanceSq(var10.zom)) / 0.0012199999764561653D);
                  }
               } else {
                  NetworkStrikeAI.deleteStrike(var10);
               }
            ...
            if (this.networkAI.forcePathFinder && !PolygonalMap2.instance.lineClearCollide(this.x, this.y, tempVector2.x, tempVector2.y, (int)this.z, this.vehicle, false, true) && IsoUtils.DistanceManhatten(var1, var2, this.x, this.y) < 2.0F) {
               this.networkAI.forcePathFinder = false;
            }
            ...
            if (!this.networkAI.needToMovingUsingPathFinder && !this.networkAI.forcePathFinder) {
               ...
               var5.walkingOnTheSpot.reset(this.x, this.y);
               this.getDeferredMovement(tempVector2_2);
               var13 = var5.calcSpeedMul(var1, var2, var4, tempVector2_2.getLength());
               NetworkPlayerAI var10001 = this.networkAI;
               float var10000 = var13 * NetworkPlayerAI.controlQuality + 1.0F;
               var10001 = this.networkAI;
               var13 = var10000 - NetworkPlayerAI.controlQuality;
               var5.moveToPoint(var1, var2, var13);
               if (this.JustMoved) {
                  this.JustMoved = this.m_isPlayerMoving = IsoUtils.DistanceManhatten(var1, var2, this.x, this.y) > 0.2F || (int)this.z != (int)var3;
               } else {
                  this.JustMoved = this.m_isPlayerMoving = IsoUtils.DistanceManhatten(var1, var2, this.x, this.y) > 1.0F || (int)this.z != (int)var3;
               }
               ...
               if (!this.networkAI.usePathFind) {
                  var5.pathToLocationF(var1, var2, var3);
                  var5.walkingOnTheSpot.reset(this.x, this.y);
                  var5.setTargetT(var4);
                  this.networkAI.usePathFind = true;
               }

               PathFindBehavior2.BehaviorResult var12 = var5.update();
               if (var12 == PathFindBehavior2.BehaviorResult.Failed) {
                  ...
                  if (this.networkAI.forcePathFinder) {
                     ...
                     DebugLog.General.warn(String.format("Player %d teleport from (%.2f, %.2f, %.2f) to (%.2f, %.2f %.2f)", this.getOnlineID(), this.x, this.y, this.z, var1, var2, var3));
                  }
               } else if (var12 == PathFindBehavior2.BehaviorResult.Succeeded) {
                  int var14 = (int)var5.getTargetX();
                  int var8 = (int)var5.getTargetY();
                  IsoChunk var9 = GameServer.bServer ? ServerMap.instance.getChunk(var14 / 10, var8 / 10) : IsoWorld.instance.CurrentCell.getChunkForGridSquare(var14, var8, 0);
                  if (var9 == null) {
            ...
            if (!this.m_isPlayerMoving || this.isAiming()) {
               ...
               tempo.normalize();
               var13 = this.legsSprite.modelSlot.model.AnimPlayer.getRenderedAngle();
               if ((double)var13 > 6.283185307179586D) {
      ...
      if (!this.isInvisible()) {
         if (this.networkAI.moving) {
            if (this.footstepTimer.Check()) {
               byte var1 = this.networkAI.footstepSoundRadius;
               WorldSoundManager.instance.addSound(this, (int)this.getX(), (int)this.getY(), (int)this.getZ(), var1, var1, false);
            }
         }
      }
   }
   ...
   public void setM_bKnockedDown(boolean var1) {
      this.m_bKnockedDown = var1;
   }
