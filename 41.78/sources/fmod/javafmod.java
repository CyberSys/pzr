...
public class javafmod {
	...
	public static long FMOD_System_CreateRecordSound(long long1, long long2, long long3, long long4, int int1) {
		return javafmodJNI.FMOD_System_CreateRecordSound(long1, long2, long3, long4, int1);
	}
	...
	public static int FMOD_Studio_LoadSampleData(long long1) {
		return javafmodJNI.FMOD_Studio_LoadSampleData(long1);
	}
	...
	public static int FMOD_Studio_System_SetParameterByID(FMOD_STUDIO_PARAMETER_ID fMOD_STUDIO_PARAMETER_ID, float float1, boolean boolean1) {
		return fMOD_STUDIO_PARAMETER_ID == null ? 0 : javafmodJNI.FMOD_Studio_System_SetParameterByID(fMOD_STUDIO_PARAMETER_ID.address(), float1, boolean1);
	}

	public static int FMOD_Studio_System_SetParameterByName(String string, float float1, boolean boolean1) {
		return javafmodJNI.FMOD_Studio_System_SetParameterByName(string, float1, boolean1);
	}

	public static boolean FMOD_Studio_Bus_GetMute(long long1) {
		return long1 == 0L ? false : javafmodJNI.FMOD_Studio_Bus_GetMute(long1);
	}

	public static boolean FMOD_Studio_Bus_GetPaused(long long1) {
		return long1 == 0L ? false : javafmodJNI.FMOD_Studio_Bus_GetMute(long1);
	}

	public static float FMOD_Studio_Bus_GetVolume(long long1) {
		return long1 == 0L ? 0.0F : javafmodJNI.FMOD_Studio_Bus_GetVolume(long1);
	}

	public static int FMOD_Studio_Bus_SetMute(long long1, boolean boolean1) {
		return long1 == 0L ? -1 : javafmodJNI.FMOD_Studio_Bus_SetMute(long1, boolean1);
	}

	public static int FMOD_Studio_Bus_SetPaused(long long1, boolean boolean1) {
		return long1 == 0L ? -1 : javafmodJNI.FMOD_Studio_Bus_SetPaused(long1, boolean1);
	}

	public static int FMOD_Studio_Bus_SetVolume(long long1, float float1) {
		return long1 == 0L ? -1 : javafmodJNI.FMOD_Studio_Bus_SetVolume(long1, float1);
	}

	public static int FMOD_Studio_Bus_StopAllEvents(long long1, boolean boolean1) {
		return long1 == 0L ? -1 : javafmodJNI.FMOD_Studio_Bus_StopAllEvents(long1, boolean1);
	}
	...
	public static int FMOD_Channel_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNEL sWIGTYPE_p_FMOD_CHANNEL, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR2) {
		return javafmodJNI.FMOD_Channel_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNEL.getCPtr(sWIGTYPE_p_FMOD_CHANNEL), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR2));
	}
	...
	public static int FMOD_ChannelGroup_Set3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP sWIGTYPE_p_FMOD_CHANNELGROUP, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR2) {
		return javafmodJNI.FMOD_ChannelGroup_Set3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP.getCPtr(sWIGTYPE_p_FMOD_CHANNELGROUP), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR2));
	}

	public static int FMOD_ChannelGroup_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP sWIGTYPE_p_FMOD_CHANNELGROUP, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR, SWIGTYPE_p_FMOD_VECTOR sWIGTYPE_p_FMOD_VECTOR2) {
		return javafmodJNI.FMOD_ChannelGroup_Get3DAttributes(SWIGTYPE_p_FMOD_CHANNELGROUP.getCPtr(sWIGTYPE_p_FMOD_CHANNELGROUP), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR), SWIGTYPE_p_FMOD_VECTOR.getCPtr(sWIGTYPE_p_FMOD_VECTOR2));
	}
	...
	public static int FMOD_Studio_EventInstance_SetCallback(long long1, FMOD_STUDIO_EVENT_CALLBACK fMOD_STUDIO_EVENT_CALLBACK, int int1) {
		return javafmodJNI.FMOD_Studio_EventInstance_SetCallback(long1, fMOD_STUDIO_EVENT_CALLBACK, int1);
	}

	public static int FMOD_Studio_EventInstance_SetParameterByID(long long1, FMOD_STUDIO_PARAMETER_ID fMOD_STUDIO_PARAMETER_ID, float float1, boolean boolean1) {
		return fMOD_STUDIO_PARAMETER_ID == null ? 0 : javafmodJNI.FMOD_Studio_EventInstance_SetParameterByID(long1, fMOD_STUDIO_PARAMETER_ID.address(), float1, boolean1);
	}

	public static int FMOD_Studio_EventInstance_SetParameterByID(long long1, FMOD_STUDIO_PARAMETER_ID fMOD_STUDIO_PARAMETER_ID, float float1) {
		boolean boolean1 = false;
		return FMOD_Studio_EventInstance_SetParameterByID(long1, fMOD_STUDIO_PARAMETER_ID, float1, boolean1);
	}

	public static int FMOD_Studio_EventInstance_SetParameterByName(long long1, String string, float float1) {
		return javafmodJNI.FMOD_Studio_EventInstance_SetParameterByName(long1, string, float1);
	}
	...
	public static int FMOD_Studio_EventInstance_SetVolume(long long1, float float1) {
	...
	public static int FMOD_Studio_EventInstance_Stop(long long1, boolean boolean1) {
		return javafmodJNI.FMOD_Studio_EventInstance_Stop(long1, boolean1);
	}
}
