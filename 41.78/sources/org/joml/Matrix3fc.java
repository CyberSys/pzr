...
public interface Matrix3fc {
	...
	Matrix3fc getToAddress(long long1);
	...
	Vector3f transformTranspose(float float1, float float2, float float3, Vector3f vector3f);
	...
	Matrix3f rotateLocalX(float float1, Matrix3f matrix3f);

	Matrix3f rotateLocalY(float float1, Matrix3f matrix3f);

	Matrix3f rotateLocalZ(float float1, Matrix3f matrix3f);
	...
	Matrix3f obliqueZ(float float1, float float2, Matrix3f matrix3f);

	boolean equals(Matrix3fc matrix3fc, float float1);

	Matrix3f reflect(float float1, float float2, float float3, Matrix3f matrix3f);
