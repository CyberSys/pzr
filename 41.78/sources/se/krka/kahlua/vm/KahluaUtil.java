		...
		try {
			...
			label48: {
				try {
					...
					luaClosure = Prototype.loadByteCode(inputStream, kahluaTable);
	...
	public static String rawTostring2(Object object) {
		if (object instanceof String) {
			...
			if (object.toString().equals("breakpoint")) {
				...
				String string2 = methodDebugInformation.getReturnType();
				return "Java: " + string2 + " " + object.toString() + "(" + string + ")";
			}
		} else {
