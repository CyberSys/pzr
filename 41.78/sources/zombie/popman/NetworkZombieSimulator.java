				...
				if (zombie == null) {
					...
					if (square != null) {
						...
						if (zombie != null) {
							...
							zombie.networkAI.reanimatedBodyID = zombiePacket.reanimatedBodyID;
							...
							if (zombie.isReanimatedPlayer()) {
								IsoDeadBody deadBody = IsoDeadBody.getDeadBody(zombie.networkAI.reanimatedBodyID);
								if (deadBody != null) {
								...
								zombie.getStateMachine().changeState(ZombieOnGroundState.instance(), (Iterable)null);
								zombie.bNeverDoneAlpha = false;
							}
