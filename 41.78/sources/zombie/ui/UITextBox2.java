		...
		if (this.isVisible()) {
			if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
				...
				if (this.bClearButton && this.clearButtonTexture != null && !this.Lines.isEmpty()) {
					...
					this.DrawTexture(this.clearButtonTexture, (double)(this.width - (float)int2 - 2.0F - (float)this.clearButtonTexture.getWidth()), (double)(int2 + (int1 - this.clearButtonTexture.getHeight()) / 2), (double)(float1 * this.clearButtonTransition.fraction() + 0.35F * (1.0F - this.clearButtonTransition.fraction())));
				}
				...
				Double Double3 = this.clampToParentY((double)(this.getAbsoluteY().intValue() + int2));
				Double Double4 = this.clampToParentY((double)(this.getAbsoluteY().intValue() + (int)this.height - int2));
						...
						if (this.Lines.get(int4) != null) {
							if (int4 >= 0 && int4 < this.HighlightLines.length) {
								if (this.HighlightLines[int4] == 1) {
									this.DrawTextureScaledCol((Texture)null, (double)(int2 - 1), (double)int5, (double)(this.getWidth().intValue() - int2 * 2 + 2), (double)int1, this.NuetralColour);
								} else if (this.HighlightLines[int4] == 2) {
									this.DrawTextureScaledCol((Texture)null, (double)(int2 - 1), (double)int5, (double)(this.getWidth().intValue() - int2 * 2 + 2), (double)int1, this.NuetralColour2);
								} else if (this.HighlightLines[int4] == 3) {
									this.DrawTextureScaledCol((Texture)null, (double)(int2 - 1), (double)int5, (double)(this.getWidth().intValue() - int2 * 2 + 2), (double)int1, this.BadColour);
								} else if (this.HighlightLines[int4] == 4) {
									this.DrawTextureScaledCol((Texture)null, (double)(int2 - 1), (double)int5, (double)(this.getWidth().intValue() - int2 * 2 + 2), (double)int1, this.GoodColour);
								}
							}

							String string = (String)this.Lines.get(int4);
							if (this.Centred) {
								TextManager.instance.DrawStringCentre(this.font, (double)this.getAbsoluteX().intValue() + this.getWidth() / 2.0 + (double)int2, (double)(this.getAbsoluteY().intValue() + int5), string, (double)this.textColor.r, (double)this.textColor.g, (double)this.textColor.b, 1.0);
							} else {
								TextManager.instance.DrawString(this.font, (double)(-this.XOffset + this.getAbsoluteX().intValue() + int2), (double)(this.getAbsoluteY().intValue() + int5), string, (double)this.textColor.r, (double)this.textColor.g, (double)this.textColor.b, 1.0);
							}
				...
				if (this.DoingTextEntry) {
					...
					if (this.BlinkState) {
						...
						this.DrawTextureScaledCol(Texture.getWhite(), (double)(-this.XOffset + int2 + int4), (double)(int2 + this.CursorLine * int1), 1.0, (double)int1, this.TextEntryCursorColour);
					}
					...
					if (this.Lines.size() > 0 && this.ToSelectionIndex != this.TextEntryCursorPos) {
						...
						for (int int9 = int7; int9 <= int8; ++int9) {
							...
							String string2 = (String)this.Lines.get(int9);
							int int12 = angelCodeFont.getWidth(string2, 0, int10 - this.TextOffsetOfLineStart.get(int9) - 1, true);
							int int13 = angelCodeFont.getWidth(string2, 0, int11 - this.TextOffsetOfLineStart.get(int9) - 1, true);
							this.DrawTextureScaledCol((Texture)null, (double)(-this.XOffset + int2 + int12), (double)(int2 + int9 * int1), (double)(int13 - int12), (double)int1, this.TextEntryCursorColour2);
						}
					}
				}
