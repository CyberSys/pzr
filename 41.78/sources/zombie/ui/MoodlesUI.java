...
public final class MoodlesUI extends UIElement {
	...
	public void render() {
		if (this.UseCharacter != null) {
			float float1 = (float)(UIManager.getMillisSinceLastRender() / 33.3);
			this.OscilatorStep += this.OscilatorRate * float1 * 0.5F;
			...
			for (int int2 = 0; int2 < MoodleType.ToIndex(MoodleType.MAX); ++int2) {
				if (this.MoodleSlotsPos[int2] != 10000.0F) {
					...
					texture2 = this.Tired;
					label93: switch (this.GoodBadNeutral[int2]) {
					case 0: 
						texture = this.Back_Neutral;
						break;
					...
					this.DrawTexture(texture, (double)((int)float2), (double)((int)this.MoodleSlotsPos[int2]), (double)this.alpha);
					this.DrawTexture(texture2, (double)((int)float2), (double)((int)this.MoodleSlotsPos[int2]), (double)this.alpha);
					int int3;
					int int4;
					if (this.UseCharacter.getMoodles().getMoodleChevronCount(int2) > 0) {
						...
						for (int3 = 0; int3 < this.UseCharacter.getMoodles().getMoodleChevronCount(int2); ++int3) {
							int4 = int3 * 4;
							this.DrawTextureCol(boolean1 ? chevronUp : chevronDown, (double)((int)float2 + 16), (double)((int)this.MoodleSlotsPos[int2] + 20 - int4), color);
							this.DrawTextureCol(boolean1 ? chevronUpBorder : chevronDownBorder, (double)((int)float2 + 16), (double)((int)this.MoodleSlotsPos[int2] + 20 - int4), color);
						}
					}
	...
	public void update() {
		...
		if (this.UseCharacter != null) {
			...
			float float1 = (float)PerformanceSettings.getLockFPS() / 30.0F;
			float[] floatArray;
			int int1;
