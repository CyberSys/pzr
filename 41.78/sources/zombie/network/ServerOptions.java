...
public class ServerOptions {
	...
	public ServerOptions.DoubleServerOption CarEngineAttractionModifier = new ServerOptions.DoubleServerOption(this, "CarEngineAttractionModifier", 0.0, 10.0, 0.5);
	...
	public ServerOptions.DoubleServerOption AntiCheatProtectionType2ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType2ThresholdMultiplier", 1.0, 10.0, 3.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType3ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType3ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType4ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType4ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType9ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType9ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType15ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType15ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType20ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType20ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType22ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType22ThresholdMultiplier", 1.0, 10.0, 1.0);
	public ServerOptions.DoubleServerOption AntiCheatProtectionType24ThresholdMultiplier = new ServerOptions.DoubleServerOption(this, "AntiCheatProtectionType24ThresholdMultiplier", 1.0, 10.0, 6.0);
	...
	public void init() {
		...
		File file = new File(string + File.separator + "Server");
		if (!file.exists()) {
			file.mkdirs();
		}

		string = ZomboidFileSystem.instance.getCacheDir();
		File file2 = new File(string + File.separator + "Server" + File.separator + GameServer.ServerName + ".ini");
		if (file2.exists()) {
			try {
			...
			this.initSpawnRegionsFile(new File(string2 + File.separator + "Server" + File.separator + GameServer.ServerName + "_spawnregions.lua"));
			this.saveServerTextFile(GameServer.ServerName);
		}
	...
	public void resetRegionFile() {
		String string = ZomboidFileSystem.instance.getCacheDir();
		File file = new File(string + File.separator + "Server" + File.separator + GameServer.ServerName + "_spawnregions.lua");
		file.delete();
	...
	private void initSpawnRegionsFile(File file) {
		if (!file.exists()) {
			...
			try {
				...
				fileWriter.write("--\t\t{ name = \"Twiggy\'s Bar\", serverfile = \"" + string + "_spawnpoints.lua\" }," + System.lineSeparator());
				fileWriter.write("\t}" + System.lineSeparator());
				fileWriter.write("end" + System.lineSeparator());
				fileWriter.close();
				String string2 = file.getParent();
				fileWriter = new FileWriter(string2 + File.separator + GameServer.ServerName + "_spawnpoints.lua");
	...
	public boolean loadServerTextFile(String string) {
		...
		String string2 = ZomboidFileSystem.instance.getCacheDir();
		String string3 = string2 + File.separator + "Server" + File.separator + string + ".ini";
		if (configFile.read(string3)) {
	...
	public boolean saveServerTextFile(String string) {
		...
		return configFile.write(string3, 0, arrayList);
	}
	...
	public static class StringServerOption extends StringConfigOption implements ServerOptions.ServerOption {
		...
		public StringServerOption(ServerOptions serverOptions, String string, String string2, int int1) {
	...
	public static class TextServerOption extends StringConfigOption implements ServerOptions.ServerOption {
		...
		public TextServerOption(ServerOptions serverOptions, String string, String string2, int int1) {
			super(string, string2, int1);
			serverOptions.addOption(this);
		}
	...
	public static class IntegerServerOption extends IntegerConfigOption implements ServerOptions.ServerOption {
		...
		public String getTooltip() {
			String string = Translator.getTextOrNull("UI_ServerOption_" + this.name + "_tooltip");
