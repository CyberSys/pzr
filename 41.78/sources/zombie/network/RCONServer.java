...
public class RCONServer {
	...
	private RCONServer(int int1, String string, boolean boolean1) {
		this.password = string;
		try {
			this.welcomeSocket = new ServerSocket();
			if (boolean1) {
				this.welcomeSocket.bind(new InetSocketAddress("127.0.0.1", int1));
	...
	public static void init(int int1, String string, boolean boolean1) {
		instance = new RCONServer(int1, string, boolean1);
	}
