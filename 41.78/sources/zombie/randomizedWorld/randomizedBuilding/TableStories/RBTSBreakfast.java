	...
	public void randomizeBuilding(BuildingDef buildingDef) {
		if (this.table2 != null) {
			...
			if (this.westTable) {
				...
				this.addWorldItem(string, this.table1.getSquare(), 0.6875F, 0.7437F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
				if (Rand.NextBool(3)) {
				...
				if (Rand.Next(100) < 70) {
					string = this.getBowlOrMug();
					this.addWorldItem(string, this.table2.getSquare(), 0.6484F, 0.7353F, this.table1.getSurfaceOffsetNoTable() / 96.0F);
					if (Rand.NextBool(3)) {
