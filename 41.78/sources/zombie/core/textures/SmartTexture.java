...
public class SmartTexture extends Texture {
	...
	public void addOverlay(String string, String string2, float float1, int int1) {
		...
		this.addSeparate((String)string, masked, (String)string2, arrayList, 774, 771, 772, 771);
	}
	...
	public void addDirtOverlay(String string, String string2, float float1, int int1) {
		...
		ArrayList arrayList = new ArrayList();
		arrayList.add(new TextureCombinerShaderParam("intensity", float1));
		this.addSeparate((String)string, dirtMask, (String)string2, arrayList, 774, 771, 772, 771);
	}
	...
	public void addOverlay(String string) {
		...
		this.addSeparate((String)string, 774, 771, 772, 771);
	}

	public void addRect(String string, int int1, int int2, int int3, int int4) {
		this.commands.add(TextureCombinerCommand.get().init(getTextureWithFlags(string), int1, int2, int3, int4));
		this.dirty = true;
	}
	...
	public void addTint(String string, int int1, float float1, float float2, float float3) {
		this.addTint(getTextureWithFlags(string), int1, float1, float2, float3);
	}
	...
	public void addHue(String string, int int1, float float1) {
		this.addHue(getTextureWithFlags(string), int1, float1);
	}
	...
	public void removeHole(String string, BloodBodyPartType bloodBodyPartType) {
		...
		this.removeHole(getTextureWithFlags(string), getTextureWithFlags(string2), bloodBodyPartType);
	}
	...
	public void mask(String string, String string2, int int1) {
		this.mask(getTextureWithFlags(string), getTextureWithFlags(string2), int1);
	}
	...
	public void maskHue(String string, String string2, int int1, float float1) {
		this.maskHue(getTextureWithFlags(string), getTextureWithFlags(string2), int1, float1);
	}
	...
	public void maskTint(String string, String string2, int int1, float float1, float float2, float float3) {
		this.maskTint(getTextureWithFlags(string), getTextureWithFlags(string2), int1, float1, float2, float3);
	}
	...
	public void addMaskedTexture(CharacterMask characterMask, String string, String string2, int int1, ImmutableColor immutableColor, float float1) {
		addMaskedTexture(this, characterMask, string, getTextureWithFlags(string2), int1, immutableColor, float1);
	}
    ...
    characterMaskx.mask(texturex, getTextureWithFlags(stringx + "/" + smartTexturex + ".png"), int1x);
});
    ...
    characterMaskx.maskHue(texturex, getTextureWithFlags(stringx + "/" + smartTexturex + ".png"), int1x, float1x);
});
		characterMask.forEachVisible(consumer);
	}
    ...
    characterMaskx.maskTint(texturex, getTextureWithFlags(stringx + "/" + smartTexturex + ".png"), int1x, immutableColorx.r, immutableColorx.g, immutableColorx.b);
});
		characterMask.forEachVisible(consumer);
	}
	...
	public void add(String string, SmartShader smartShader, String string2, int int1, int int2) {
		this.add(getTextureWithFlags(string), smartShader, getTextureWithFlags(string2), int1, int2);
	}
	...
	public void add(String string, int int1, int int2) {
		this.add(getTextureWithFlags(string), int1, int2);
	}

	public void add(Texture texture, int int1, int int2) {
		this.addSeparate((Texture)texture, int1, int2, 1, 771);
	}

	public void addSeparate(String string, int int1, int int2, int int3, int int4) {
		this.addSeparate(getTextureWithFlags(string), int1, int2, int3, int4);
	}

	public void addSeparate(Texture texture, int int1, int int2, int int3, int int4) {
		this.commands.add(TextureCombinerCommand.get().initSeparate(texture, int1, int2, int3, int4));
		this.dirty = true;
	}

	public void add(String string, SmartShader smartShader, String string2, ArrayList arrayList, int int1, int int2) {
		this.add(getTextureWithFlags(string), smartShader, getTextureWithFlags(string2), arrayList, int1, int2);
	}

	public void add(Texture texture, SmartShader smartShader, Texture texture2, ArrayList arrayList, int int1, int int2) {
		this.addSeparate((Texture)texture, smartShader, (Texture)texture2, arrayList, int1, int2, 1, 771);
	}
	...
	public void addSeparate(String string, SmartShader smartShader, String string2, ArrayList arrayList, int int1, int int2, int int3, int int4) {
		this.addSeparate(getTextureWithFlags(string), smartShader, getTextureWithFlags(string2), arrayList, int1, int2, int3, int4);
	}
	...
	public void addSeparate(Texture texture, SmartShader smartShader, Texture texture2, ArrayList arrayList, int int1, int int2, int int3, int int4) {
		this.commands.add(TextureCombinerCommand.get().initSeparate(texture, smartShader, arrayList, texture2, int1, int2, int3, int4));
		this.dirty = true;
	}
