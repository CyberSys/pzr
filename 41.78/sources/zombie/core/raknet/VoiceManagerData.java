...
public class VoiceManagerData {
	...
	public static class RadioData {
		...
		public boolean isReceivingAvailable(int int1) {
			return this.freq != 0 && this.deviceData != null && this.deviceData.getIsTurnedOn() && this.deviceData.getChannel() == int1 && this.deviceData.getDeviceVolume() != 0.0F && !this.deviceData.isPlayingMedia();
		}
