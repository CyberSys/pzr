...
public final class ZLogger {
	...
	public void write(String string, String string2, boolean boolean1) {
		try {
			this.writeUnsafe(string, string2, boolean1);
		} catch (Exception exception) {
			exception.printStackTrace();
		}
	}

	public synchronized void writeUnsafe(String string, String string2, boolean boolean1) throws Exception {
		...
		if (!boolean1) {
			...
			stringBuilder.append(string, 0, int1);
		}
