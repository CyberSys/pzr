...
public class IsoLot {
	...
	public static void Dispose() {
		Iterator iterator = InfoHeaders.values().iterator();
		while (iterator.hasNext()) {
			LotHeader lotHeader = (LotHeader)iterator.next();
			lotHeader.Dispose();
		}
		...
		InfoFileNames.clear();
		pool.forEach((iteratorx)->{
			RandomAccessFile lotHeader = iteratorx.m_in;
			if (lotHeader != null) {
				iteratorx.m_in = null;
				try {
					lotHeader.close();
