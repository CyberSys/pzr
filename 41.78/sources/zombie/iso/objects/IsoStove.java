...
public class IsoStove extends IsoObject implements Activatable {
	...
	public void update() {
		...
		boolean boolean1 = GameServer.bServer || !GameClient.bClient && !GameServer.bServer;
		if (boolean1 && this.Activated() && this.hasMetal && Rand.Next(Rand.AdjustForFramerate(200)) == 100) {
