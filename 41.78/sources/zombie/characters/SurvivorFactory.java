...
public final class SurvivorFactory {
	...
	public static String getRandomForename(boolean boolean1) {
		return boolean1 ? (String)FemaleForenames.get(Rand.Next(FemaleForenames.size())) : (String)MaleForenames.get(Rand.Next(MaleForenames.size()));
	}
