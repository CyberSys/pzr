...
public class LoadingQueueState extends GameState {
	...
	public GameStateMachine.StateAction update() {
		if (!GameClient.bClient) {
			...
			boolean boolean1 = GameWindow.ActivatedJoyPad != null && GameWindow.ActivatedJoyPad.isAPressed();
			if (boolean1) {
			...
			if (!boolean1 && !Keyboard.isKeyDown(1) && GameClient.instance.bConnected) {
	...
	public static void onPlaceInQueue(int int1) {
		placeInQueue = int1;
		ui.setPlaceInQueue(int1);
	}
}
