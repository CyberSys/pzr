...
public final class ConnectToServerState extends GameState {
	...
	private void receiveResetID(ByteBuffer byteBuffer) {
		int int1 = byteBuffer.getInt();
		GameClient.instance.setResetID(int1);
	}
	...
	private void Finish() {
		...
		try {
			...
			try {
				...
				DebugLog.Multiplayer.printException(ioException2, "receiveSandboxOptions error", LogSeverity.Error);
				throw ioException2;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(ioException3, "receiveGameTime error", LogSeverity.Error);
				throw ioException3;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(exception2, "receiveErosionMain error", LogSeverity.Error);
				throw exception2;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(ioException4, "receiveGlobalObjects error", LogSeverity.Error);
				throw ioException4;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(exception3, "receiveResetID error", LogSeverity.Error);
				throw exception3;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(exception4, "receiveBerries error", LogSeverity.Error);
				throw exception4;
			}
			...
			try {
				...
				DebugLog.Multiplayer.printException(ioException5, "receiveWorldDictionary error", LogSeverity.Error);
				throw ioException5;
			}
