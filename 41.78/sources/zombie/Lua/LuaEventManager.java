...
public final class LuaEventManager implements JavaFunction {
	...
	public static void triggerEvent(String string, Object object, Object object2, Object object3, Object object4, Object object5, Object object6, Object object7) {
		synchronized (EventMap) {
			Event event = checkEvent(string);
			if (event != null) {
				if (a7index == a7.length) {
					a7 = (Object[][])Arrays.copyOf(a7, a7.length * 2);
					for (int int1 = a7index; int1 < a7.length; ++int1) {
						a7[int1] = new Object[7];
					}
				}

				Object[] objectArray = a7[a7index];
				objectArray[0] = object;
				objectArray[1] = object2;
				objectArray[2] = object3;
				objectArray[3] = object4;
	...
	public static void triggerEvent(String string, Object object, Object object2, Object object3, Object object4, Object object5, Object object6, Object object7, Object object8) {
		synchronized (EventMap) {
			Event event = checkEvent(string);
			if (event != null) {
				if (a8index == a8.length) {
					a8 = (Object[][])Arrays.copyOf(a8, a8.length * 2);
					for (int int1 = a8index; int1 < a8.length; ++int1) {
						a8[int1] = new Object[8];
					}
				}

				Object[] objectArray = a8[a8index];
				objectArray[0] = object;
				objectArray[1] = object2;
				objectArray[2] = object3;
				objectArray[3] = object4;
