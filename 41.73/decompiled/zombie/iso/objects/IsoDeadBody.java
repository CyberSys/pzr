         ...
         if (var6 <= 3 && var6 != this.getHumanVisual().zombieRotStage) {
            ...
            if (var7 >= 1 && var8 != "Winter") {
               for(int var9 = 0; var9 < var7; ++var9) {
                  ...
                  if (this.wasZombie) {
                     if (Rand.Next(2) == 0) {
                        var10 = InventoryItemFactory.CreateItem("Maggots");
                        this.getContainer().addItem(var10);
                        ((Food)var10).setPoisonPower(3);
                     }

                     if (Rand.Next(2) == 0) {
                        var10 = InventoryItemFactory.CreateItem("Maggots");
                        this.getSquare().AddWorldInventoryItem(var10, (float)(Rand.Next(10) / 10), (float)(Rand.Next(10) / 10), 0.0F);
                        ((Food)var10).setPoisonPower(3);
                     }
                  } else {
                     if (Rand.Next(2) == 0) {
