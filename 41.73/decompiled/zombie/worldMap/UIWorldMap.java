...
public class UIWorldMap extends UIElement {
      ...
      if (GameClient.bClient) {
         if (this.m_renderer.getBoolean("Players")) {
            if (this.m_renderer.getBoolean("RemotePlayers")) {
               Iterator var1 = GameClient.positions.entrySet().iterator();

               while(var1.hasNext()) {
                  Entry var2 = (Entry)var1.next();
                  IsoPlayer var3 = (IsoPlayer)GameClient.IDToPlayerMap.get(var2.getKey());
                  if (this.shouldShowRemotePlayer(var3)) {
                     Vector2 var4 = (Vector2)var2.getValue();
                     this.renderPlayer(var4.x, var4.y);
                     String var5 = var3 == null ? String.valueOf(var2.getKey()) : var3.getUsername();
                     this.renderPlayerName(var4.x, var4.y, var5);
                  }
               }
   ...
   private boolean shouldShowRemotePlayer(IsoPlayer var1) {
   ...
   private boolean isInSameFaction(IsoPlayer var1, IsoPlayer var2) {
      Faction var3 = Faction.getPlayerFaction(var1);
      Faction var4 = Faction.getPlayerFaction(var2);
      return var3 != null && var3 == var4;
   }

   private boolean isInSameSafehouse(IsoPlayer var1, IsoPlayer var2) {
