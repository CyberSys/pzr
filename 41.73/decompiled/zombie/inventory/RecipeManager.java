...
public final class RecipeManager {
   ...
   private static RecipeManager.SourceItems getAvailableItems(Recipe var0, IsoGameCharacter var1, ArrayList var2, InventoryItem var3, ArrayList var4, boolean var5) {
      ...
      if (var3 != null && var0.InSameInventory) {
         ItemContainer var7 = var1.getInventory();
         int var8;
         ItemContainer var9;
         if (var3.getOutermostContainer() == var7) {
            for(var8 = var2.size() - 1; var8 >= 0; --var8) {
               var9 = (ItemContainer)var2.get(var8);
               if (var9 != var3.getContainer()) {
                  var2.remove(var9);
               }
            }
         } else {
            for(var8 = var2.size() - 1; var8 >= 0; --var8) {
               var9 = (ItemContainer)var2.get(var8);
               if (var9 == var7 || var9.getCharacter() == var1) {
                  var2.remove(var9);
               }
            }
         }
      ...
      if (var3 != null && !RecipeContainsItem(var0, var3)) {
         ...
         RecipeManager.RMRecipe var10 = RecipeManager.RMRecipe.alloc(var0);
         var10.getItemsFromContainers(var1, var2, var3);
         if (var5 || var10.hasItems()) {
            var10.getAvailableItems(var6, var5);
         }

         RecipeManager.RMRecipe.release(var10);
         return var6;
      }
   }
