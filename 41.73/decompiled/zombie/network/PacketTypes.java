...
public class PacketTypes {
   ...
   public static final HashSet packetTypesLogExcludeFilter = new HashSet();
   ...
   static {
      ...
      packetTypesLogExcludeFilter.add(PacketTypes.PacketType.ObjectModData);
      ...
      packetTypesLogExcludeFilter.add(PacketTypes.PacketType.WaveSignal);
