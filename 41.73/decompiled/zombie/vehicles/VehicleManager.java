...
public final class VehicleManager {
   ...
   private void clientReceiveUpdateFull(ByteBuffer var1, short var2, float var3, float var4, float var5) throws IOException {
      ...
      if (this.IDToVehicle.containsKey(var2)) {
         ...
         this.tempVehicle.load(var1, 194);
         ...
         if (var9 != null && var8 == null) {
            ...
            if ((var3 & 1) != 0) {
               ...
               if ((var3 & 4096) != 0) {
                  ...
                  if (var1.get() == 1) {
                     try {
                        var12 = InventoryItem.loadItem(var1, 194);
               ...
               if ((var3 & 16) != 0) {
                  for(var10 = var1.get(); var10 != -1; var10 = var1.get()) {
                     ...
                     var21.getModData().load((ByteBuffer)var1, 194);
               ...
               if ((var3 & 128) != 0) {
                  for(var10 = var1.get(); var10 != -1; var10 = var1.get()) {
                     ...
                     if (var26) {
                        try {
                           var25 = InventoryItem.loadItem(var1, 194);
                        } catch (Exception var17) {
                           var17.printStackTrace();
                           return;
                        }
