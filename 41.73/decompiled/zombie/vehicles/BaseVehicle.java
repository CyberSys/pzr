...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
   ...
   public void update() {
      if (this.removedFromWorld) {
         ...
         if (this.physics != null) {
            boolean var3 = this.getDriver() != null || var1 || var2;
            ...
            if (!GameServer.bServer && var6 != null && var6.enable) {
               var6.enable = false;
               float var7 = 1.0F;
            ...
            short var25 = 1000;
            int var11;
            if (System.currentTimeMillis() - this.engineCheckTime > (long)var25 && !GameClient.bClient) {
            ...
            this.updateTransform();
            Vector3f var30 = allocVector3f().set((Vector3fc)this.jniLinearVelocity);
            if (this.jniIsCollide && this.limitCrash.Check()) {
               this.jniIsCollide = false;
               this.limitCrash.Reset();
               Vector3f var31 = allocVector3f();
               var31.set((Vector3fc)var30).sub(this.lastLinearVelocity);
               var31.y = 0.0F;
               float var34 = var31.length();
               DebugLog.Vehicle.debugln("Vehicle vid=%d velocity last=%s/%f current=%s/%f delta=%f", this.VehicleID, this.lastLinearVelocity, this.lastLinearVelocity.length(), var30, var30.length(), var34);
               if (var30.lengthSquared() > this.lastLinearVelocity.lengthSquared() && var34 > 6.0F) {
                  DebugLog.Vehicle.trace("Vehicle vid=%d got sharp speed increase delta=%f", this.VehicleID, var34);
                  var34 = 6.0F;
               }
               ...
               if (var34 > 1.0F) {
                  ...
                  DebugLog.Vehicle.trace("Vehicle vid=%d crash delta=%f", this.VehicleID, var34);
            ...
            this.lastLinearVelocity.set((Vector3fc)var30);
         ...
         VehiclePart var22 = this.getPartById("lightbar");
         if (var22 != null && this.lightbarLightsMode.isEnable() && var22.getCondition() == 0 && !GameClient.bClient) {
            this.setLightbarLightsMode(0);
         }

         if (var22 != null && this.lightbarSirenMode.isEnable() && var22.getCondition() == 0 && !GameClient.bClient) {
         ...
         for(int var24 = 0; var24 < this.getMaxPassengers(); ++var24) {
            BaseVehicle.Passenger var26 = this.getPassenger(var24);
            if (var26.character != null) {
               var5 = true;
               break;
            }
         }
