...
--    self.bottomPanel:setX(logoX)
    ...
    if self.inGame then
        self.modListDetail = ISButton:new(self.width - 40 - 60, self.height - FONT_HGT_SMALL - 20 - 10 - (FONT_HGT_SMALL + 1 * 2), 60, FONT_HGT_SMALL + 1 * 2, getText("UI_NewGame_Mods") , self, MainScreen.onClickModList);
