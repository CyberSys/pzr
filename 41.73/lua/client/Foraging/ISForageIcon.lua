...
function ISForageIcon:setCanRollForSearchFocus(_canRoll)
	--prevent rolling this icon for search focus ever again (saved to the zoneData)
	self.canRollForSearchFocus			= _canRoll;
	self.icon.canRollForSearchFocus		= _canRoll;
...
function ISForageIcon:doSearchFocusCheck()
	...
	if searchWindow and searchWindow.searchFocusCategory and forageSystem.catDefs[searchWindow.searchFocusCategory] then
