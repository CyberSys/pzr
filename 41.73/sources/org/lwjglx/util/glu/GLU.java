...
public class GLU {
	...
	public static void gluLookAt(float float1, float float2, float float3, float float4, float float5, float float6, float float7, float float8, float float9) {
		Project.gluLookAt(float1, float2, float3, float4, float5, float6, float7, float8, float9);
	}

	public static void gluOrtho2D(float float1, float float2, float float3, float float4) {
		gluOrtho2D(float1, float2, float3, float4);
	}

	public static void gluPerspective(float float1, float float2, float float3, float float4) {
		Project.gluPerspective(float1, float2, float3, float4);
	}
	...
	public static boolean gluProject(float float1, float float2, float float3, FloatBuffer floatBuffer, FloatBuffer floatBuffer2, IntBuffer intBuffer, FloatBuffer floatBuffer3) {
		return Project.gluProject(float1, float2, float3, floatBuffer, floatBuffer2, intBuffer, floatBuffer3);
	}
	...
	public static int gluScaleImage(int int1, int int2, int int3, int int4, ByteBuffer byteBuffer, int int5, int int6, int int7, ByteBuffer byteBuffer2) {
		return MipMap.gluScaleImage(int1, int2, int3, int4, byteBuffer, int5, int6, int7, byteBuffer2);
	}

	public static String gluErrorString(int int1) {
		switch (int1) {
		case 100900: 
		...
		default: 
			return org.lwjglx.opengl.Util.translateGLErrorString(int1);
