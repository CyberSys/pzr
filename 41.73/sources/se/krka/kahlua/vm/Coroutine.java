...
public class Coroutine {
	...
	public final void closeUpvalues(int int1) {
		...
		while (true) {
			...
			UpValue upValue = (UpValue)this.liveUpvalues.get(int2);
			if (upValue.getIndex() < int1) {
				return;
			}

			upValue.close();
			this.liveUpvalues.remove(int2);
		}
	}
	...
	public final UpValue findUpvalue(int int1) {
		...
		do {
			...
			upValue = (UpValue)this.liveUpvalues.get(int2);
		...
		this.liveUpvalues.add(int2 + 1, upValue);
		return upValue;
	}
	...
	public String getCurrentStackTrace(int int1, int int2, int int3) {
		...
		for (int int4 = this.callFrameTop - 1 - int1; int4 >= int3 && int2-- > 0; --int4) {
			stringBuilder.append(this.getStackTrace(this.callFrameStack[int4]));
		}
	...
	public void addStackTrace(LuaCallFrame luaCallFrame) {
		String string = this.stackTrace;
		this.stackTrace = string + this.getStackTrace(luaCallFrame);
	}
