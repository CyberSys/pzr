				...
				while (true) {
					while (kahluaTableIterator.advance()) {
						...
						if ("_objects".equals(object)) {
							KahluaTable kahluaTable2 = (KahluaTable)Type.tryCastTo(object2, KahluaTable.class);
							int int1 = 1;
							for (int int2 = kahluaTable2.len(); int1 <= int2; ++int1) {
								KahluaTable kahluaTable3 = (KahluaTable)Type.tryCastTo(kahluaTable2.rawget(int1), KahluaTable.class);
								int int3 = ((Double)kahluaTable3.rawget("x")).intValue();
								int int4 = ((Double)kahluaTable3.rawget("y")).intValue();
								int int5 = ((Double)kahluaTable3.rawget("z")).intValue();
								kahluaTable3.rawset("x", (Object)null);
								kahluaTable3.rawset("y", (Object)null);
								kahluaTable3.rawset("z", (Object)null);
								CGlobalObject cGlobalObject = (CGlobalObject)Type.tryCastTo(cGlobalObjectSystem.newObject(int3, int4, int5), CGlobalObject.class);
