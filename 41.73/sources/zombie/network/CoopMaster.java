...
public class CoopMaster {
	...
	private void launchServer(String string, String string2, int int1, boolean boolean1) throws IOException {
		...
		arrayList.add("-Djava.class.path=" + string4);
		string4 = System.getProperty("user.dir");
		arrayList.add("-Duser.dir=" + string4);
		string4 = System.getProperty("user.home");
		arrayList.add("-Duser.home=" + string4);
		...
		String string5 = this.getGarbageCollector();
		if (string5 != null) {
