...
public class PacketValidator {
	...
	public static boolean checkType1(UdpConnection udpConnection, Character character, Character character2, String string) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType1.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type1")) {
	...
	public static boolean checkType2(UdpConnection udpConnection, IMovable iMovable, String string) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType2.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type2")) {
	...
	public static boolean checkType3(UdpConnection udpConnection, IPositional iPositional, IPositional iPositional2, String string) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType3.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type3")) {
	...
	public static boolean checkType4(UdpConnection udpConnection, Hit hit, String string) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType4.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type4")) {
	...
	public static boolean checkType5(UdpConnection udpConnection, Zombie zombie, String string) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType5.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type5")) {
    ...
    return playerx.getOnlineID() == player2.getOnlineID();
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType6.getValue() && doKickUser(udpConnection, string, "UI_ValidationFailed_Type6")) {
	...
	public static boolean checkType7(UdpConnection udpConnection, String string, String string2) {
		...
		if (!boolean1 && ServerOptions.instance.AntiCheatProtectionType7.getValue() && doKickUser(udpConnection, string2, "UI_ValidationFailed_Type7")) {
	...
	public static boolean doLogUser(UdpConnection udpConnection, String string, String string2) {
		if (!isUntouchable(udpConnection) && doAntiCheatProtection()) {
