	...
	public boolean validate(UdpConnection udpConnection) {
		...
		if (this.safehouse == null) {
			if (udpConnection.accessLevel == 1 && SafeHouse.hasSafehouse(this.ownerUsername) != null) {
				if (ServerOptions.instance.AntiCheatProtectionType19.getValue() && PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type19")) {
				...
				if (udpConnection.accessLevel != 1 || !((double)this.h > double1) && !((double)this.w > double1)) {
					...
					if (ServerOptions.instance.AntiCheatProtectionType20.getValue() && PacketValidator.doKickUser(udpConnection, this.getClass().getSimpleName(), "UI_ValidationFailed_Type20")) {
