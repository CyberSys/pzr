...
public class LoginQueue {
	...
	public static void receiveLoginQueueDone(ByteBuffer byteBuffer, UdpConnection udpConnection, short short1) {
		...
		ConnectionManager.log("Receive queue done", udpConnection);
		if (udpConnection.checkState != UdpConnection.CheckState.Success) {
	...
	public static void receiveServerLoginQueueRequest(ByteBuffer byteBuffer, UdpConnection udpConnection, short short1) {
		...
		ConnectionManager.log("Receive server queue request", udpConnection);
	}
	...
	public static String getDescription() {
		...
		return "login-queue=[" + int1 + "/" + PreferredLoginQueue.size() + "/\"" + (currentLoginQueue == null ? "" : currentLoginQueue.getConnectedGUID()) + "\"]";
	}
