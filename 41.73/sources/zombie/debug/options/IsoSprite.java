...
public final class IsoSprite extends OptionGroup {
	...
	public final BooleanDebugOption ItemHeight;
	public final BooleanDebugOption Surface;
	...
	public IsoSprite() {
		...
		this.ItemHeight = newDebugOnlyOption(this.Group, "Render.ItemHeight", false);
		this.Surface = newDebugOnlyOption(this.Group, "Render.Surface", false);
