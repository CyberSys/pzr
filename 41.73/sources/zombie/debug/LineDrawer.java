...
public final class LineDrawer {
	...
	public static void DrawIsoRect(float float1, float float2, float float3, float float4, int int1, float float5, float float6, float float7) {
		DrawIsoRect(float1, float2, float3, float4, int1, 0, float5, float6, float7);
	}

	public static void DrawIsoRect(float float1, float float2, float float3, float float4, int int1, int int2, float float5, float float6, float float7) {
		if (float3 < 0.0F) {
			float3 = -float3;
			float1 -= float3;
		}
		...
		float float16 = (float)(-int2 * Core.TileScale);
		float9 += float16;
		float11 += float16;
		float13 += float16;
		float15 += float16;
	...
	public static void addRectYOffset(float float1, float float2, float float3, float float4, float float5, int int1, float float6, float float7, float float8) {
		LineDrawer.DrawableLine drawableLine = pool.isEmpty() ? new LineDrawer.DrawableLine() : (LineDrawer.DrawableLine)pool.pop();
		lines.add(drawableLine.init(float1, float2, float3, float1 + float4, float2 + float5, float3, float6, float7, float8, (String)null, false));
		drawableLine.yPixelOffset = int1;
	}
