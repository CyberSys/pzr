...
public class IsoWaveSignal extends IsoObject implements WaveSignalDevice,ChatElementOwner,Talker {
	...
	public void Say(String string) {
		this.AddDeviceText(string, 1.0F, 1.0F, 1.0F, (String)null, (String)null, -1, false);
	}

	public void AddDeviceText(String string, float float1, float float2, float float3, String string2, String string3, int int1) {
		this.AddDeviceText(string, float1, float2, float3, string2, string3, int1, true);
	}

	public void AddDeviceText(String string, int int1, int int2, int int3, String string2, String string3, int int4) {
		this.AddDeviceText(string, (float)int1 / 255.0F, (float)int2 / 255.0F, (float)int3 / 255.0F, string2, string3, int4, true);
	}

	public void AddDeviceText(String string, int int1, int int2, int int3, String string2, String string3, int int4, boolean boolean1) {
		this.AddDeviceText(string, (float)int1 / 255.0F, (float)int2 / 255.0F, (float)int3 / 255.0F, string2, string3, int4, boolean1);
	}

	public void AddDeviceText(String string, float float1, float float2, float float3, String string2, String string3, int int1, boolean boolean1) {
		if (this.deviceData != null && this.deviceData.getIsTurnedOn()) {
			...
			if (this.deviceData.getDeviceVolume() > 0.0F) {
				...
				if (string3 != null) {
					LuaEventManager.triggerEvent("OnDeviceText", string2, string3, this.getX(), this.getY(), this.getZ(), string, this);
				}
			}
		}
	}
