...
public class IsoGenerator extends IsoObject {
	...
	public void setSurroundingElectricity() {
		...
		if (this.square != null && this.square.chunk != null) {
			int int1 = this.square.chunk.wx;
			int int2 = this.square.chunk.wy;
			int int3;
			for (int int4 = -2; int4 <= 2; ++int4) {
				for (int3 = -2; int3 <= 2; ++int3) {
					IsoChunk chunk = GameServer.bServer ? ServerMap.instance.getChunk(int1 + int3, int2 + int4) : IsoWorld.instance.CurrentCell.getChunk(int1 + int3, int2 + int4);
			...
			for (int int10 = int8; int10 < int9; ++int10) {
				for (int int11 = int3; int11 <= int5; ++int11) {
					for (int int12 = int6; int12 <= int7; ++int12) {
						if (!(IsoUtils.DistanceToSquared((float)int11 + 0.5F, (float)int12 + 0.5F, (float)this.getSquare().getX() + 0.5F, (float)this.getSquare().getY() + 0.5F) > 400.0F)) {
							...
							if (square != null) {
								...
								for (int int13 = 0; int13 < square.getObjects().size(); ++int13) {
									IsoObject object = (IsoObject)square.getObjects().get(int13);
									if (object != null && !(object instanceof IsoWorldInventoryObject)) {
										...
										if (object instanceof IsoStackedWasherDryer) {
											IsoStackedWasherDryer stackedWasherDryer = (IsoStackedWasherDryer)object;
											float float1 = 0.0F;
											...
											if (float1 > 0.0F) {
												this.addPoweredItem(object, float1);
											}
										}
										...
										if (object instanceof IsoRadio && ((IsoRadio)object).getDeviceData().getIsTurnedOn() && !((IsoRadio)object).getDeviceData().getIsBatteryPowered()) {
	...
	private void addPoweredItem(IsoObject object, float float1) {
		...
		this.itemsPowered.put(string + " x" + int1, String.format(" (%.2f L/h)", float1 * (float)int1));
		if (int1 == 1) {
		...
		if (square != null) {
			for (int int1 = 0; int1 < AllGenerators.size(); ++int1) {
				...
				if (generator.getSquare() != null) {
					float float1 = IsoUtils.DistanceToSquared((float)square.x + 0.5F, (float)square.y + 0.5F, (float)generator.getSquare().getX() + 0.5F, (float)generator.getSquare().getY() + 0.5F);
					if (float1 <= 400.0F) {
						generator.updateSurrounding = true;
					}
				}
