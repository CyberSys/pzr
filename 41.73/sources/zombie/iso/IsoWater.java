...
public final class IsoWater {
	...
	public void update(ClimateManager climateManager) {
		...
		this.WaterTime += 0.0166F * float1;
		this.WaterParamWindINT.add((float)Math.sin((double)(this.WaterWindAngle * 6.0F)) * this.WaterWindIntensity * 0.05F * (float1 / 1.6F), (float)Math.cos((double)(this.WaterWindAngle * 6.0F)) * this.WaterWindIntensity * 0.15F * (float1 / 1.6F));
	}
