...
public final class Mask implements Serializable,Cloneable {
	...
	public Mask(Mask mask, int int1, int int2, int int3, int int4) {
		this.width = int3;
		this.height = int4;
		this.mask = new BooleanGrid(int3, int4);
		for (int int5 = 0; int5 < int3; ++int5) {
			for (int int6 = 0; int6 < int4; ++int6) {
				this.mask.setValue(int5, int6, mask.mask.getValue(int1 + int5, int2 + int6));
			}
		}
	}

	public Mask(boolean[] booleanArray, int int1, int int2, int int3, int int4, int int5, int int6) {
		this.width = int5;
		this.height = int6;
		this.mask = new BooleanGrid(int5, int6);
		for (int int7 = 0; int7 < int5; ++int7) {
			for (int int8 = 0; int8 < int6; ++int8) {
				this.mask.setValue(int7, int8, booleanArray[int3 + int7 + (int4 + int8) * int1]);
			}
		}
	}

	public Mask(BooleanGrid booleanGrid, int int1, int int2, int int3, int int4, int int5, int int6) {
		this.width = int5;
		this.height = int6;
		this.mask = new BooleanGrid(int5, int6);
		for (int int7 = 0; int7 < int5; ++int7) {
			for (int int8 = 0; int8 < int6; ++int8) {
				this.mask.setValue(int7, int8, booleanGrid.getValue(int3 + int7, int4 + int8));
			}
		}
	}
	...
	public Mask(ITexture iTexture, BooleanGrid booleanGrid) {
		...
		iTexture.setMask(this);
		this.mask = new BooleanGrid(this.width, this.height);
		for (int int1 = 0; int1 < iTexture.getHeight(); ++int1) {
			for (int int2 = 0; int2 < iTexture.getWidth(); ++int2) {
				this.mask.setValue(int2, int1, booleanGrid.getValue(int2, int1));
			}
		}
	}
	...
	public Mask(ITexture iTexture) {
		...
		RenderThread.invokeOnRenderContext(()->{
			WrappedBuffer int5x = iTexture.getData();
			ByteBuffer byteBuffer = int5x.getBuffer();
			byteBuffer.rewind();
