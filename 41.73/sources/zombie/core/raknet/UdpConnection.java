...
public class UdpConnection {
	...
	public long steamID;
	public int sessionSalt;
	public UdpConnection.CheckState checkState;
	public final UpdateLimit checkLimit;
	public final UpdateLimit timeSyncLimit;
	public long ownerID;
	public String idStr;
	...
	public UdpConnection(UdpEngine udpEngine, long long1, int int1) {
		...
		this.checkLimit = new UpdateLimit(10000L);
		this.timeSyncLimit = new UpdateLimit(15000L);
	...
	public void setFullyConnected() {
		this.timeSyncLimit.Reset(15000L);
		this.incorrectTime = 0;
		this.checkLimit.Reset(10000L);
	...
	public String getDescription() {
		long long1 = this.connectedGUID;
		return "connection guid=\"" + long1 + "\" username=\"" + this.username + "\" access=\"" + this.accessLevel + "\" ip=\"" + this.ip + "\" steamID=\"" + this.steamID + "\" players=\"" + Arrays.stream(this.players).filter(Objects::nonNull).count() + "\" preferred=\"" + this.preferredInQueue + "\" wait=\"" + LoginQueue.isInTheQueue(this) + "\" queued=\"" + this.wasInLoadingQueue + "\" full=\"" + this.bFullyConnected + "\" mtu=\"" + this.getMTUSize() + "\"";
	}
	...
	public String getPlayerDescription() {
		...
		for (short short1 = 0; short1 < 4; ++short1) {
			stringBuilder.append(" ").append(short1).append("=[").append(this.playerIDs[short1]);
			if (this.players[short1] != null) {
				stringBuilder.append(" ").append(this.players[short1].getOnlineID()).append(" ").append(this.players[short1].getUsername());
			}
	...
	public static enum CheckState {
		...
		private static UdpConnection.CheckState[] $values() {
			return new UdpConnection.CheckState[]{None, Sent, Success};
		}
	}
}
