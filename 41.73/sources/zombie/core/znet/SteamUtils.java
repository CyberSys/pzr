...
public class SteamUtils {
	...
	public static boolean showGamepadTextInput(boolean boolean1, boolean boolean2, String string, int int1, String string2) {
		return n_ShowGamepadTextInput(boolean1 ? 1 : 0, boolean2 ? 1 : 0, string, int1, string2);
	}

	public static boolean showFloatingGamepadTextInput(boolean boolean1, int int1, int int2, int int3, int int4) {
		if (m_floatingGamepadTextInputVisible) {
			return true;
		} else {
			m_floatingGamepadTextInputVisible = n_ShowFloatingGamepadTextInput(boolean1 ? 1 : 0, int1, int2, int3, int4);
	...
	private static native boolean n_ShowGamepadTextInput(int int1, int int2, String string, int int3, String string2);

	private static native boolean n_ShowFloatingGamepadTextInput(int int1, int int2, int int3, int int4, int int5);
