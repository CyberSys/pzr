...
public class LoadingQueueUI extends UIElement {
	...
	public void render() {
		this.onresize();
		double double1 = 0.4000000059604645;
		double double2 = 0.4000000059604645;
		double double3 = 0.4000000059604645;
		double double4 = 1.0;
		this.DrawTextureScaledColor((Texture)null, 0.0, 0.0, 1.0, (double)this.height, double1, double2, double3, double4);
		this.DrawTextureScaledColor((Texture)null, 1.0, 0.0, (double)this.width - 2.0, 1.0, double1, double2, double3, double4);
		this.DrawTextureScaledColor((Texture)null, (double)this.width - 1.0, 0.0, 1.0, (double)this.height, double1, double2, double3, double4);
		this.DrawTextureScaledColor((Texture)null, 1.0, (double)this.height - 1.0, (double)this.width - 2.0, 1.0, double1, double2, double3, double4);
	...
	public void setPlaceInQueue(int int1) {
		placeInQueue = int1;
	}
}
