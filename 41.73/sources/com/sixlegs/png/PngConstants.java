...
public abstract class PngConstants {
	...
	public static boolean isAncillary(int int1) {
		return (int1 & 536870912) != 0;
	}

	public static boolean isPrivate(int int1) {
		return (int1 & 2097152) != 0;
	}
	...
	public static String getChunkName(int int1) {
		return (char)(int1 >>> 24 & 255) + (char)(int1 >>> 16 & 255) + (char)(int1 >>> 8 & 255) + (char)(int1 & 255);
	}

	public static int getChunkType(String string) {
		return (string.charAt(0) & 255) << 24 | (string.charAt(1) & 255) << 16 | (string.charAt(2) & 255) << 8 | string.charAt(3) & 255;
	}
}
